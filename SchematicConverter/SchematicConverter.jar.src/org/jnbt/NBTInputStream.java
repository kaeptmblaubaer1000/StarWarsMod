...
/*     */
{
	...
	/*     */
	{
		...
		/*     */case 0:
				...
				/*     */case 7:
				/* 134 */int length = this.is.readInt();
				/* 135 */byte[] bytes = new byte[length];
				/* 136 */this.is.readFully(bytes);
				/* 137 */return new ByteArrayTag(name, bytes);
				/*     */case 8:
				/* 139 */int length2 = this.is.readShort();
				/* 140 */byte[] bytes2 = new byte[length2];
				/* 141 */this.is.readFully(bytes2);
				/* 142 */return new StringTag(name, new String(bytes2, NBTConstants.CHARSET));
				/*     */case 9:
				/* 144 */int childType = this.is.readByte();
				/* 145 */int length3 = this.is.readInt();
				/*     */
				/* 147 */List<Tag> tagList = new ArrayList();
				/* 148 */for (int i = 0; i < length3; i++)
				{
				...
				/*     */case 10:
				/* 158 */Map<String, Tag> tagMap = new HashMap();
				/*     */for (;;)
				{
...
/*
 * Location:
 * F:\Forge\schematicconverter\SchematicConverter.jar!\org\jnbt\NBTInputStream
