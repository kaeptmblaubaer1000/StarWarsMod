...
public class ModelMedicalConsole2 extends ModelBase {
    ...
    public ModelMedicalConsole2() {
        ...
        this.shape1_19 = new ModelRenderer(this, 80, 46);
        this.shape1_19.setRotationPoint(0.0F, -18.0F, 0.0F);
        this.shape1_19.addBox(-1.0F, -7.5F, 1.2F, 1, 1, 2, 0.0F);
        this.setRotateAngle(shape1_19, -0.20943951023931953F, 0.0F, 0.0F);
        this.shape1_20 = new ModelRenderer(this, 110, 46);
        this.shape1_20.setRotationPoint(0.0F, -18.0F, 0.0F);
        this.shape1_20.addBox(-5.5F, -14.5F, 1.2F, 1, 1, 2, 0.0F);
        this.setRotateAngle(shape1_20, -0.20943951023931953F, 0.0F, 0.0F);
        ...
        this.shape1_21 = new ModelRenderer(this, 127, 42);
        this.shape1_21.setRotationPoint(0.0F, -18.0F, 0.0F);
        this.shape1_21.addBox(2.5F, -1.5F, 1.2F, 1, 1, 2, 0.0F);
        this.setRotateAngle(shape1_21, -0.20943951023931953F, 0.0F, 0.0F);
        ...
        this.shape1_22 = new ModelRenderer(this, 155, 41);
        this.shape1_22.setRotationPoint(0.0F, -18.0F, 0.0F);
        this.shape1_22.addBox(4.5F, -1.5F, 1.2F, 1, 1, 2, 0.0F);
        this.setRotateAngle(shape1_22, -0.20943951023931953F, 0.0F, 0.0F);
        ...
        this.shape1_18 = new ModelRenderer(this, 60, 45);
        this.shape1_18.setRotationPoint(0.0F, -18.0F, 0.0F);
        this.shape1_18.addBox(-3.0F, -7.5F, 1.2F, 1, 1, 2, 0.0F);
        this.setRotateAngle(shape1_18, -0.20943951023931953F, 0.0F, 0.0F);
