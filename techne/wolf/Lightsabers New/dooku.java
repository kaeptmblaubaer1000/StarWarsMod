 ...
 */
public class Duku'sHilt extends ModelBase {
    ...
    public Duku'sHilt() {
        ...
        this.setRotateAngle(Shape11, 0.0F, -0.0F, 0.2094395160675048F);
        ...
        this.setRotateAngle(Shape20, 0.0F, -0.0F, 0.5061454772949219F);
        ...
        this.setRotateAngle(Shape3, 0.0F, -0.0F, -0.2094395160675048F);
        ...
        this.setRotateAngle(Shape28, 0.0F, -0.0F, -0.2094395160675048F);
        ...
        this.setRotateAngle(Shape6, 0.0F, -0.0F, 0.5061454772949219F);
        ...
        this.setRotateAngle(Shape12, 0.0F, -0.0F, -0.12217304855585097F);
        ...
        this.setRotateAngle(Shape25, 0.0F, -0.0F, -0.4886921942234039F);
        ...
        this.setRotateAngle(Shape9, 0.0F, -0.0F, 0.767944872379303F);
        ...
        this.setRotateAngle(Shape2, 0.0F, -0.0F, -0.2094395160675048F);
        ...
        this.setRotateAngle(Shape21, 0.0F, -0.0F, 0.5061454772949219F);
        ...
        this.setRotateAngle(Shape19, 0.0F, -0.0F, 0.5061454772949219F);
        ...
        this.setRotateAngle(Shape8, 0.0F, -0.0F, 0.5061454772949219F);
        ...
        this.setRotateAngle(Shape29, 0.0F, -0.0F, -0.2094395160675048F);
        ...
        this.setRotateAngle(Shape23, 0.0F, -0.0F, -0.4886921942234039F);
        ...
        this.setRotateAngle(Shape1, 0.0F, -0.0F, 0.5061454772949219F);
        ...
        this.setRotateAngle(Shape7, 0.0F, -0.0F, 0.5061454772949219F);
        ...
        this.setRotateAngle(Shape27, 0.0F, -0.0F, -0.2094395160675048F);
