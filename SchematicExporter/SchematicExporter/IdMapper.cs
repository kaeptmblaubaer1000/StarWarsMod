...
namespace SchematicExporter
{
    internal class IdMapper
    {
        ...
        private void PopulateItems()
        {
            ...
            _items.Add(423, new Item("blockBeneOre", ClassPswm));
            _items.Add(424, new Item("blockExoniumOre", ClassPswm));
            _items.Add(425, new Item("blockKeleriumOre", ClassPswm));
            _items.Add(426, new Item("blockIoniteOre", ClassPswm));
            _items.Add(427, new Item("blockCortosisOre", ClassPswm));
            _items.Add(428, new Item("blockHeliciteOre", ClassPswm));
            _items.Add(429, new Item("blockRubindumOre", ClassPswm));
            _items.Add(430, new Item("blockDolomiteOre", ClassPswm));
            _items.Add(431, new Item("blockTempleStone", ClassPswm));
            _items.Add(432, new Item("blockTempleStoneSlab", ClassPswm));
            _items.Add(433, new Item("blockTempleStoneLit", ClassPswm));
            _items.Add(434, new Item("blockTempleStoneSlabLit", ClassPswm));
            _items.Add(435, new Item("ancientJediStatue", ClassPswm));
            _items.Add(436, new Item("blockTempleStoneStairsBrick", ClassPswm));
            _items.Add(437, new Item("blockTempleStoneStairsSlabTopDark", ClassPswm));
            _items.Add(438, new Item("blockTempleStoneStairs", ClassPswm));
            _items.Add(439, new Item("blockTempleStoneStairsStabTop", ClassPswm));
            _items.Add(440, new Item("blockTempleStoneStairsFancy", ClassPswm));
            ...
            _items.Add(4096, new Item("gaffiStick", ClassPswm));
            _items.Add(4098, new Item("blasterRifle", ClassPswm));
            _items.Add(4099, new Item("hiltMetalCompound", ClassPswm));
            _items.Add(4100, new Item("hiltMetalAlloy", ClassPswm));
            _items.Add(4101, new Item("plasmaEmitter", ClassPswm));
            _items.Add(4102, new Item("containmentField", ClassPswm));
            _items.Add(4103, new Item("lightsaberCrystal", ClassPswm));
            _items.Add(4105, new Item("banthaHorn", ClassPswm));
            _items.Add(4109, new Item("endorChest", ClassPswm));
            _items.Add(4110, new Item("endorHelmet", ClassPswm));
            _items.Add(4111, new Item("endorBoots", ClassPswm));
            _items.Add(4112, new Item("endorLegs", ClassPswm));
            _items.Add(4113, new Item("ewokSpear", ClassPswm));
            _items.Add(4114, new Item("chromiumDust", ClassPswm));
            _items.Add(4115, new Item("titaniumChromiumDust", ClassPswm));
            _items.Add(4116, new Item("titaniumChromiumIngot", ClassPswm));
            _items.Add(4117, new Item("titaniumDust", ClassPswm));
            _items.Add(4118, new Item("hyperdriveEngine", ClassPswm));
            _items.Add(4119, new Item("hyperdriveMotivator", ClassPswm));
            _items.Add(4120, new Item("hyperdriveTatooine", ClassPswm));
            _items.Add(4121, new Item("hyperdriveEarth", ClassPswm));
            _items.Add(4122, new Item("spawnSpeederBike", ClassPswm));
            _items.Add(4123, new Item("hyperdriveHoth", ClassPswm));
            _items.Add(4124, new Item("hyperdriveKashyyyk", ClassPswm));
            _items.Add(4125, new Item("spawnLandspeeder", ClassPswm));
            _items.Add(4126, new Item("hyperdriveYavinFour", ClassPswm));
            _items.Add(4127, new Item("hyperdriveEndor", ClassPswm));
            _items.Add(4128, new Item("rebelPilotLegs", ClassPswm));
            _items.Add(4129, new Item("rebelPilotChest", ClassPswm));
            _items.Add(4130, new Item("rebelPilotHelmet", ClassPswm));
            _items.Add(4131, new Item("rebelPilotBoots", ClassPswm));
            _items.Add(4132, new Item("blasterPistol", ClassPswm));
            _items.Add(4134, new Item("stormtrooperLegs", ClassPswm));
            _items.Add(4135, new Item("stormtrooperHelmet", ClassPswm));
            _items.Add(4136, new Item("stormtrooperBoots", ClassPswm));
            _items.Add(4137, new Item("stormtrooperChest", ClassPswm));
            _items.Add(4138, new Item("tiePilotBoots", ClassPswm));
            _items.Add(4139, new Item("tiePilotHelmet", ClassPswm));
            _items.Add(4140, new Item("tiePilotChest", ClassPswm));
            _items.Add(4141, new Item("tiePilotLegs", ClassPswm));
            _items.Add(4142, new Item("hothLegs", ClassPswm));
            _items.Add(4143, new Item("hothHelmet", ClassPswm));
            _items.Add(4144, new Item("hothChest", ClassPswm));
            _items.Add(4145, new Item("hothBoots", ClassPswm));
            _items.Add(4146, new Item("droidCaller", ClassPswm));
            _items.Add(4147, new Item("spawnAstromech", ClassPswm));
            _items.Add(4148, new Item("spawnProtocol", ClassPswm));
            _items.Add(4149, new Item("spawnGonk", ClassPswm));
            _items.Add(4150, new Item("bobaBoots", ClassPswm));
            _items.Add(4151, new Item("sandtrooperChest", ClassPswm));
            _items.Add(4152, new Item("sandtrooperLegs", ClassPswm));
            _items.Add(4153, new Item("sandtrooperBoots", ClassPswm));
            _items.Add(4154, new Item("bobaLegs", ClassPswm));
            _items.Add(4155, new Item("bobaChest", ClassPswm));
            _items.Add(4156, new Item("bobaJetpackChest", ClassPswm));
            _items.Add(4157, new Item("bobaHelmet", ClassPswm));
            _items.Add(4158, new Item("sandtrooperHelmet", ClassPswm));
            _items.Add(4159, new Item("bobaJetpack", ClassPswm));
            _items.Add(4160, new Item("gamorreanAx", ClassPswm));
            _items.Add(4161, new Item("bowcaster", ClassPswm));
            _items.Add(4162, new Item("blasterHeavy", ClassPswm));
            _items.Add(4163, new Item("scoutTrooperBoots", ClassPswm));
            _items.Add(4164, new Item("scoutTrooperLegs", ClassPswm));
            _items.Add(4165, new Item("scoutTrooperHelmet", ClassPswm));
            _items.Add(4166, new Item("scoutTrooperChest", ClassPswm));
            _items.Add(4167, new Item("snowtrooperHelmet", ClassPswm));
            _items.Add(4168, new Item("snowtrooperBoots", ClassPswm));
            _items.Add(4169, new Item("snowtrooperLegs", ClassPswm));
            _items.Add(4170, new Item("snowtrooperChest", ClassPswm));
            _items.Add(4171, new Item("debugLootGen", ClassPswm));
            _items.Add(4172, new Item("imperialCredit", ClassPswm));
            _items.Add(4173, new Item("banthaChop", ClassPswm));
            _items.Add(4174, new Item("waterDroplet", ClassPswm));
            _items.Add(4176, new Item("leiasBuns", ClassPswm));
            _items.Add(4177, new Item("atatPilotChest", ClassPswm));
            _items.Add(4178, new Item("atatPilotHelmet", ClassPswm));
            _items.Add(4179, new Item("atatPilotBoots", ClassPswm));
            _items.Add(4180, new Item("atatPilotLegs", ClassPswm));
            _items.Add(4182, new Item("banthaMilk", ClassPswm));
            _items.Add(4183, new Item("spawnHothSpeederBike", ClassPswm));
            _items.Add(4184, new Item("recordTheme", ClassPswm));
            _items.Add(4185, new Item("recordThrone", ClassPswm));
            _items.Add(4186, new Item("recordBinary", ClassPswm));
            _items.Add(4187, new Item("recordImperial", ClassPswm));
            _items.Add(4188, new Item("recordCantina", ClassPswm));
            _items.Add(4189, new Item("spawnSurgical", ClassPswm));
            _items.Add(4190, new Item("banthaChopCooked", ClassPswm));
            _items.Add(4192, new Item("spawnAstromech2", ClassPswm));
            _items.Add(4193, new Item("spawnProbe", ClassPswm));
            _items.Add(4194, new Item("spawnMouse", ClassPswm));
            _items.Add(4195, new Item("spawnProtocol2", ClassPswm));
            _items.Add(4197, new Item("gorrnar", ClassPswm));
            _items.Add(4198, new Item("banthaPlatter", ClassPswm));
            _items.Add(4199, new Item("chasuka", ClassPswm));
            _items.Add(4200, new Item("canron", ClassPswm));
            _items.Add(4201, new Item("dewbackRibs", ClassPswm));
            _items.Add(4202, new Item("acidBeets", ClassPswm));
            _items.Add(4203, new Item("binoculars", ClassPswm));
            _items.Add(4206, new Item("binocularsHoth", ClassPswm));
            _items.Add(4207, new Item("droidHacker", ClassPswm));
            _items.Add(4208, new Item("fleetHelmet", ClassPswm));
            _items.Add(4209, new Item("fleetChest", ClassPswm));
            _items.Add(4210, new Item("fleetBoots", ClassPswm));
            _items.Add(4211, new Item("fleetLegs", ClassPswm));
            _items.Add(4212, new Item("stormtrooperNewBoots", ClassPswm));
            _items.Add(4213, new Item("goldImperialCredit", ClassPswm));
            _items.Add(4214, new Item("stormtrooperNewHelmet", ClassPswm));
            _items.Add(4215, new Item("stormtrooperNewLegs", ClassPswm));
            _items.Add(4217, new Item("silverImperialCredit", ClassPswm));
            _items.Add(4218, new Item("stormtrooperNewChest", ClassPswm));
            _items.Add(4221, new Item("sequelBlasterRifle", ClassPswm));
            _items.Add(4222, new Item("spawnJakkuSpeeder", ClassPswm));
            _items.Add(4224, new Item("spawnTIE", ClassPswm));
            _items.Add(4225, new Item("sequelBlasterPistol", ClassPswm));
            _items.Add(4226, new Item("spawnTIEInterceptor", ClassPswm));
            _items.Add(4228, new Item("spawnAWing", ClassPswm));
            _items.Add(4230, new Item("customItem", ClassPswm));
            _items.Add(4231, new Item("spawnXWing", ClassPswm));
            _items.Add(4232, new Item("spawnAstromechBb8", ClassPswm));
            _items.Add(4233, new Item("spawnAstromechImperial", ClassPswm));
            _items.Add(4234, new Item("spawnAstromechImperial2", ClassPswm));
            _items.Add(4235, new Item("stormtrooperSilverNewBoots", ClassPswm));
            _items.Add(4236, new Item("stormtrooperSilverNewHelmet", ClassPswm));
            _items.Add(4237, new Item("stormtrooperSilverNewLegs", ClassPswm));
            _items.Add(4238, new Item("stormtrooperSilverNewChest", ClassPswm));
            _items.Add(4239, new Item("hyperdriveIlum", ClassPswm));
            _items.Add(4240, new Item("hyperdriveDagobah", ClassPswm));
            _items.Add(4241, new Item("newJediRobes", ClassPswm));
            _items.Add(4353, new Item("spawnDsTurret", ClassPswm));
            _items.Add(4354, new Item("vibroLance", ClassPswm));
            _items.Add(4355, new Item("gamorreanAx3", ClassPswm));
            _items.Add(4356, new Item("gamorreanAx2", ClassPswm));
            _items.Add(4357, new Item("questContainer", ClassPswm));
            _items.Add(4358, new Item("spawnSkyhopper", ClassPswm));
            _items.Add(4359, new Item("spawnSnowspeeder", ClassPswm));
            _items.Add(4360, new Item("spawnAtst", ClassPswm));
            _items.Add(4362, new Item("lightsaberNew9", ClassPswm));
            _items.Add(4363, new Item("lightsaberNew8", ClassPswm));
            _items.Add(4364, new Item("lightsaberNew7", ClassPswm));
            _items.Add(4365, new Item("lightsaberNew6", ClassPswm));
            _items.Add(4366, new Item("lightsaberNew5", ClassPswm));
            _items.Add(4367, new Item("lightsaberNew10", ClassPswm));
            _items.Add(4368, new Item("lightsaberNew4", ClassPswm));
            _items.Add(4369, new Item("lightsaberNew3", ClassPswm));
            _items.Add(4370, new Item("lightsaberNew2", ClassPswm));
            _items.Add(4371, new Item("lightsaberNew1", ClassPswm));
            _items.Add(4372, new Item("lightsaberNew0", ClassPswm));
            _items.Add(4373, new Item("lightsaberNew11", ClassPswm));
            _items.Add(4374, new Item("lightsaberNew12", ClassPswm));
            _items.Add(4375, new Item("lightsaberNew13", ClassPswm));
            _items.Add(4376, new Item("lightsaberNew14", ClassPswm));
            _items.Add(4377, new Item("lightsaberNew15", ClassPswm));
            _items.Add(4378, new Item("hyperdriveMustafar", ClassPswm));
            _items.Add(4379, new Item("idScanner", ClassPswm));
            _items.Add(4380, new Item("ingotCortosis", ClassPswm));
            _items.Add(4381, new Item("ingotBene", ClassPswm));
            _items.Add(4382, new Item("ingotDolomite", ClassPswm));
            _items.Add(4383, new Item("ingotExonium", ClassPswm));
            _items.Add(4384, new Item("ingotIonite", ClassPswm));
            _items.Add(4385, new Item("ingotRubindum", ClassPswm));
            _items.Add(4386, new Item("ingotHelicite", ClassPswm));
            _items.Add(4387, new Item("ingotKelerium", ClassPswm));
        }
