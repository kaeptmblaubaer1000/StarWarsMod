...
public class ChunkProviderGenerateTatooine implements IChunkProvider
{
	...
	public ChunkProviderGenerateTatooine(World p_i2006_1_, long p_i2006_2_, boolean p_i2006_4_)
	{
	...
	public void populate(IChunkProvider p_73153_1_, int p_73153_2_, int p_73153_3_)
	{
		...
		if (TerrainGen.populate(p_73153_1_, this.worldObj, this.rand, p_73153_2_, p_73153_3_, flag, PopulateChunkEvent.Populate.EventType.ANIMALS)) SpawnerAnimals.performWorldGenSpawning(this.worldObj, biomegenbase, k + 8, l + 8, 16, 16, this.rand);
		k += 8;
		l += 8;
		boolean doGen = TerrainGen.populate(p_73153_1_, this.worldObj, this.rand, p_73153_2_, p_73153_3_, flag, PopulateChunkEvent.Populate.EventType.ICE);
		for (int k1 = 0; doGen && k1 < 16; k1++)
			for (int l1 = 0; l1 < 16; l1++)
			{
				int i2 = this.worldObj.getPrecipitationHeight(k + k1, l + l1);
				if (this.worldObj.isBlockFreezable(k1 + k, i2 - 1, l1 + l)) this.worldObj.setBlock(k1 + k, i2 - 1, l1 + l, Blocks.ice, 0, 2);
				if (this.worldObj.func_147478_e(k1 + k, i2, l1 + l, true)) this.worldObj.setBlock(k1 + k, i2, l1 + l, Blocks.snow_layer, 0, 2);
			}
 ...
 * v1.2.0-dev7.jar!\com\
 * parzi\starwarsmod\world\provider\ChunkProviderGenerateTatooine.class Java
