...
public class ChunkProviderGenerateDagobah implements IChunkProvider
{
	...
	public ChunkProviderGenerateDagobah(World p_i2006_1_, long p_i2006_2_, boolean p_i2006_4_)
	{
	  ...
	  public void populate(IChunkProvider p_73153_1_, int p_73153_2_, int p_73153_3_)
	{
		...
		if (this.mapFeaturesEnabled) this.scatteredFeatureGenerator.generateStructuresInChunk(this.worldObj, this.rand, p_73153_2_, p_73153_3_);

		biomegenbase.decorate(this.worldObj, this.rand, k, l);
		if (TerrainGen.populate(p_73153_1_, this.worldObj, this.rand, p_73153_2_, p_73153_3_, flag, ANIMALS)) SpawnerAnimals.performWorldGenSpawning(this.worldObj, biomegenbase, k + 8, l + 8, 16, 16, this.rand);
		k += 8;
		l += 8;
	  ...
	  public Chunk provideChunk(int p_73154_1_, int p_73154_2_)
	{
		...
		if (this.mapFeaturesEnabled) this.scatteredFeatureGenerator.func_151539_a(this, this.worldObj, p_73154_1_, p_73154_2_, ablock);
