...
public class PacketJediRobesSetElementInArmorInv implements IMessage
{
	public static class Handler implements IMessageHandler<PacketJediRobesSetElementInArmorInv, IMessage>
	{
		@Override
		public IMessage onMessage(PacketJediRobesSetElementInArmorInv message, MessageContext ctx)
		{
			try
			{
	...
	public PacketJediRobesSetElementInArmorInv()
	{
	}

	public PacketJediRobesSetElementInArmorInv(String element, int amt, int dim, String player)
	{
