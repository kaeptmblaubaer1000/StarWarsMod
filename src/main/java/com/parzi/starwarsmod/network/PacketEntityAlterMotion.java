...
public class PacketEntityAlterMotion implements IMessage
{
	public static class Handler implements IMessageHandler<PacketEntityAlterMotion, IMessage>
	{
		@Override
		public IMessage onMessage(PacketEntityAlterMotion message, MessageContext ctx)
		{
			try
			{
	...
	public PacketEntityAlterMotion()
	{
	}

	public PacketEntityAlterMotion(int entityId, int dim, String vector)
	{
