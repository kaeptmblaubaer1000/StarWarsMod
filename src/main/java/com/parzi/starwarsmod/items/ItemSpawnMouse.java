...
public class ItemSpawnMouse extends net.minecraft.item.Item
{
	...
	{
		if (player.capabilities.isCreativeMode || player.inventory.consumeInventoryItem(StarWarsMod.spawnMouse)) if (!world.isRemote)
		{
 ...
 * v1.2.0-dev7.jar!\com\parzi\starwarsmod\items\ItemSpawnMouse.class Java
