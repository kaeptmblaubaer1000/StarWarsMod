...
{
	private String name = "spawnAstromech2";
	...
	{
		if (player.capabilities.isCreativeMode || player.inventory.consumeInventoryItem(StarWarsMod.spawnAstromech2)) if (!world.isRemote)
		{
