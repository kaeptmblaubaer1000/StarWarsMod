...
public class VehicFlyingSpeederBike extends VehicleAirBase
{
	public VehicFlyingSpeederBike(World par1World)
	{
		super(par1World);
		this.setSize(1.0F, 1.0F);
		this.vehicYOffset = 0.4F;
		this.moveModifier = 1F;
	...
	{
		this.dropItem(StarWarsMod.spawnFlyingSpeederBike, 1);
	}
