...
public class ModelJediCloak extends ModelBiped
{
	...
	public ModelJediCloak()
	{
		...
		this.Cape.setRotationPoint(0.0F, 0.0F, 0.5F);
		...
		this.HoodBack.addBox(-4.5F, -8.5F, -2.0F, 9, 11, 6, 0.0F);
		...
		this.ArmR.setRotationPoint(4.5F, 1.0F, 0.0F);
		...
		this.ArmL.setRotationPoint(-4.5F, 1.0F, 0.0F);
	...
	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity)
	{
		...
		this.ArmL.rotateAngleX = MathHelper.cos(f * 0.6662F + 3.1415927F) * 1.4F * f1;
