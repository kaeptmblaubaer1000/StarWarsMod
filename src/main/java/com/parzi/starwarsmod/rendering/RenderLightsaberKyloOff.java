...
import com.parzi.starwarsmod.rendering.models.ModelLightsaberKyloOff;

public class RenderLightsaberKyloOff implements IItemRenderer
{
	private ModelLightsaberKyloOff model;

	public RenderLightsaberKyloOff()
	{
		this.model = new ModelLightsaberKyloOff();
	}
