...
public class GuiJediRobes extends GuiScreen
{
	...
	private PowerBase[] spinner = ((com.parzi.starwarsmod.armor.ArmorJediRobes)StarWarsMod.jediRobes).powers;
 ...
 * v1.2.0-dev7.jar!\com\parzi\starwarsmod\rendering\gui\GuiJediRobes.class Java
