...
public class ModelTauntaun extends ModelBase
{
	...
	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity ent)
	{
		...
		this.HornSectionL.rotateAngleY = f3 / 57.295776F;
		this.HornSectionR.rotateAngleY = f3 / 57.295776F;
		this.SmallHornSectionL.rotateAngleY = f3 / 57.295776F;
		this.SmallHornSectionR.rotateAngleY = f3 / 57.295776F;
 ...
 * v1.2.0-dev7.jar!\com\parzi\starwarsmod\rendering\models\ModelTauntaun.class
