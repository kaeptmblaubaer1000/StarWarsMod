...
public class ModelGNK extends ModelBase
{
	...
	public ModelGNK()
	{
		...
		this.FootL.addBox(0.0F, 0.0F, 0.0F, 3, 2, 5);
		this.FootL.setRotationPoint(0.2F, 22.0F, -3.5F);
		this.FootL.setTextureSize(64, 128);
		...
		this.TopBody.setTextureSize(64, 128);
		...
		this.Middle.setTextureSize(64, 128);
		this.Middle.mirror = true;
		this.setRotation(this.Middle, 0.0F, 0.0F, 0.0F);
		this.rightleg = new ModelRenderer(this, 0, 76);
		this.rightleg.addBox(-2.0F, 0.0F, -2.0F, 3, 5, 3);
		this.rightleg.setRotationPoint(-1.2F, 17.0F, 0.5F);
		this.rightleg.setTextureSize(64, 128);
		this.rightleg.mirror = true;
		this.setRotation(this.rightleg, 0.0F, 0.0F, 0.0F);
		this.leftleg = new ModelRenderer(this, 0, 84);
		this.leftleg.addBox(-2.0F, 0.0F, -2.0F, 3, 5, 3);
		this.leftleg.setRotationPoint(2.2F, 17.0F, 0.5F);
		...
		this.TopBodyLower.setTextureSize(64, 128);
		...
		this.BottomBodyLower.setTextureSize(64, 128);
		...
		this.GNKPowerAss.setTextureSize(64, 128);
		this.GNKPowerAss.mirror = true;
		this.setRotation(this.GNKPowerAss, 0.0F, 0.0F, 0.0F);
		this.FootR = new ModelRenderer(this, 0, 99);
		this.FootR.addBox(0.0F, 0.0F, 0.0F, 3, 2, 5);
		this.FootR.setRotationPoint(-3.2F, 22.0F, -3.5F);
		this.FootR.setTextureSize(64, 128);
 ...
 * v1.2.0-dev7.jar!\com\parzi\starwarsmod\rendering\models\ModelGNK.class Java
