...
public class ModelDewback extends ModelBase
{
	...
	public ModelDewback()
	{
		...
		FootFrontR.setRotationPoint(-5.5F, 13F, -4.5F);
		...
		FootBackL.setRotationPoint(3.5F, 13F, 10.5F);
		...
		FootBackR.setRotationPoint(-5.5F, 13F, 10.5F);
		...
		UpperLegFrontL.setRotationPoint(3F, 13F, -4.5F);
		...
		UpperLegBackL.setRotationPoint(3.5F, 13F, 10.5F);
		...
		UpperLegBackR.setRotationPoint(-5.5F, 13F, 10.5F);
		...
		UpperLegFrontR.setRotationPoint(-5.5F, 13F, -4.5F);
		...
		Tail4.setRotationPoint(-3F, 13F, 19F);
		...
		Tail5.setRotationPoint(-2.5F, 14.5F, 20.8F);
		...
		Tail6.setRotationPoint(-2F, 16F, 21.8F);
