...
import com.parzi.starwarsmod.models.ModelLightsaber;
...
public class RenderLightsaber implements IItemRenderer
{
	...
	{
		this.model = new ModelLightsaber();
	}
	...
	{
		GL11.glPushMatrix();
		Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation(Resources.MODID, "textures/models/lightsaber" + item.getItemDamage() + ".png"));
