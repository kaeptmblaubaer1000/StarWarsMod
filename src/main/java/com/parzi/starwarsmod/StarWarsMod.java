...
public class StarWarsMod {
	...
	public static ToolMaterial gaffiMat = EnumHelper.addToolMaterial(
			"gaffiMat", 3, 10240, 10f, 4f, 8);
	public static ToolMaterial plasmaMat = EnumHelper.addToolMaterial(
			"gaffiMat", 3, -1, 10f, 26f, 8);

	/* Armor Materials */
	public static ArmorMaterial jediRobesMat = EnumHelper.addArmorMaterial(
	...
	public void init(FMLInitializationEvent event) {
		...
		EntityUtils.registerMob(this, MobWookiee.class, "wookiee", 80,
				0x974F1A, 0x3C200A);
		EntityUtils.registerMob(this, MobTusken.class, "tusken", 80, 0xFFFDB3,
				0x5E5E4A);
		EntityUtils.registerMob(this, MobJawa.class, "jawa", 80, 0xFF0000,
				0x9B6C00);
		EntityUtils.registerMob(this, MobTauntaun.class, "tauntaun", 80,
				0xFFFFFF, 0x4ADCE8);
		...
		EntityRegistry.addSpawn(MobTauntaun.class, 1, 1, 1,
				EnumCreatureType.ambient, BiomeGenBase.taiga,
				BiomeGenBase.coldBeach, BiomeGenBase.coldTaigaHills,
				BiomeGenBase.coldTaiga, BiomeGenBase.taigaHills);
