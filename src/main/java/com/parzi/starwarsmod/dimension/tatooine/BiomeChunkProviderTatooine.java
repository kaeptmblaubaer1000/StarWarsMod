...
public class BiomeChunkProviderTatooine extends ChunkProviderGenerate
{
	...
	public BiomeChunkProviderTatooine(World world, long seed, boolean features)
	{
		...
		NoiseGenerator[] noiseGens = { noiseGen1, nouseGen2, noiseGen3, noiseGen4, noiseGen5, noiseGen6, mobSpawnerNoise };
