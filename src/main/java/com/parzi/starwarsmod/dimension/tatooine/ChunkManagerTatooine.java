...
public class ChunkManagerTatooine extends WorldChunkManager
{
	public static ArrayList<BiomeGenBase> allowedBiomes = new ArrayList<BiomeGenBase>(Arrays.asList(StarWarsMod.biomeTatooine));
	...
	protected ChunkManagerTatooine()
	{
	...
	public ChunkManagerTatooine(long p_i1975_1_, WorldType p_i1975_3_)
	{
		this();
	...
	public ChunkManagerTatooine(World p_i1976_1_)
	{
	...
	{
		return StarWarsMod.biomeTatooine;
	}
	...
	{
		return new BiomeGenBase[] { StarWarsMod.biomeTatooine };
	}
	...
	public boolean areBiomesViable(int p_76940_1_, int p_76940_2_, int p_76940_3_, List p_76940_4_)
	{
		...
		try
		{
			for (int j2 = 0; j2 < l1 * i2; ++j2)
			{
				...
				if (!p_76940_4_.contains(biomegenbase)) { return false; }
			}
