...
public class MobDewback extends EntityHorse
{
	...
	public void updateRiderPosition()
	{
		...
		float f2 = 0.5F;
		float f3 = 1F;
		this.riddenByEntity.setPosition(this.posX + (double)(f2 * f), this.posY + this.getMountedYOffset() + this.riddenByEntity.getYOffset() + (double)f3 - 0.35F, this.posZ - (double)(f2 * f1));
