...
public class RecipeRegister
{
	public static void registerAll()
	{
		...
		GameRegistry.addShapedRecipe(new ItemStack(StarWarsMod.plasmaEmitter, 1), "HGH", "HNH", "HRH", 'H', StarWarsMod.hiltMetelAlloy, 'N', Items.nether_star, 'R', Blocks.beacon, 'G', Blocks.glass_pane);
