...
public class StarWarsClientProxy extends StarWarsCommonProxy implements
		IGuiHandler {
	@Override
	public void registerRendering() {
		...
		RenderingRegistry.registerEntityRenderingHandler(MobBantha.class,
				new RenderBantha(new ModelBantha(), 0.5F));
		RenderingRegistry.registerEntityRenderingHandler(MobTusken.class,
				new RenderTusken(new ModelBiped(), 0.5F));
		RenderingRegistry.registerEntityRenderingHandler(MobGNK.class,
				new RenderGNK(new ModelGNK(), 0.5F));
		...
		ClientRegistry.bindTileEntitySpecialRenderer(TileEntityMV.class,
				new RenderMV());
