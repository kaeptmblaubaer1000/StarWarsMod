...
public class ArmorHoth extends ItemArmor
{
	...
	{
		if (stack.getItem() == StarWarsMod.hothHelmet || stack.getItem() == StarWarsMod.hothChest || stack.getItem() == StarWarsMod.hothBoots) return StarWarsMod.MODID + ":" + "textures/models/hothArmorLayer1.png";
		if (stack.getItem() == StarWarsMod.hothLegs) return StarWarsMod.MODID + ":" + "textures/models/hothArmorLayer2.png";
		return "";
	}
}
/*
