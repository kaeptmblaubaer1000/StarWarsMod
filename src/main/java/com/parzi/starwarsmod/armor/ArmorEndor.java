...
public class ArmorEndor extends ItemArmor
{
	...
	private ModelEndorHelmet model = new ModelEndorHelmet();
	...
	{
		if (stack.getItem() == StarWarsMod.endorHelmet) return StarWarsMod.MODID + ":" + "textures/models/endorHelmet.png";
		if (stack.getItem() == StarWarsMod.endorChest || stack.getItem() == StarWarsMod.endorBoots) return StarWarsMod.MODID + ":" + "textures/models/endorArmorLayer1.png";
