...
public class Vector3i extends Vector
{
	...
	{
		if (dest == null) return new Vector3i(left.x + right.x, left.y + right.y, left.z + right.z);
		else
		{
	...
	{
		if (dest == null) dest = new Vector3i();
	...
	public Vector3i normalise(Vector3i dest)
	{
		...
		if (dest == null) dest = new Vector3i(x / l, y / l, z / l);
		else dest.set((int)(x / l), (int)(y / l), (int)(z / l));
