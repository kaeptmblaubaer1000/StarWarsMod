...
public class Cone
{
	 ...
	 */
	public static List<Entity> getEntitiesInCone(List<Entity> entities, Vector3f startPos, float radius, float degrees, Vec3d direction)
	{
	...
	public static float getAngleBetween(Entity view, Entity entity)
	{
		...
		return MathUtils.getAngleBetweenVectors(view.getLookVec(), relativePosition);
	}
}