...
public class TileEntitySensorEntityScootemaround extends TileEntitySensor
{
	...
	public TileEntitySensorEntityScootemaround()
	{
		this.needle = VehicScootemaround.class;
		this.rX = 4;
		this.rY = 4;
		this.rZ = 4;
	}
