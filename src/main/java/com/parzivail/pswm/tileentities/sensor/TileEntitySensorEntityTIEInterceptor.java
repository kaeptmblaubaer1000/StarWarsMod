...
public class TileEntitySensorEntityTIEInterceptor extends TileEntitySensor
{
	...
	public TileEntitySensorEntityTIEInterceptor()
	{
		this.needle = VehicTIEInterceptor.class;
		this.rX = 4;
		this.rY = 4;
		this.rZ = 4;
	}
