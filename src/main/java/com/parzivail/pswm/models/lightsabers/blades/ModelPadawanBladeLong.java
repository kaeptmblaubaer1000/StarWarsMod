 ...
 */
public class ModelPadawanBladeLong extends ModelBase implements IHandlesRender
{
	public ModelRenderer blade;

	public ModelPadawanBladeLong()
	{
		this.textureWidth = 512;
		this.textureHeight = 512;
		this.blade = new ModelRenderer(this, 0, 0);
		this.blade.setRotationPoint(-35.0F, 0.0F, 0.0F);
		this.blade.addBox(-139.0F, 1.5F, 1.5F, 175, 3, 3, 0.0F);
	}
