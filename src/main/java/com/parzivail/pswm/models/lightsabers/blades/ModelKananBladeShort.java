 ...
 */
public class ModelKananBladeShort extends ModelBase implements IHandlesRender
{
	public ModelRenderer blade;

	public ModelKananBladeShort()
	{
		this.textureWidth = 512;
		this.textureHeight = 512;
		this.blade = new ModelRenderer(this, 0, 0);
		this.blade.setRotationPoint(20.0F, 0.0F, 0.0F);
		this.blade.addBox(-113.0F, 1.5F, 1.5F, 80, 3, 3, 0.0F);
	}
