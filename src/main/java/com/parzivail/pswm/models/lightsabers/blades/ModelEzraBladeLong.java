 ...
 */
public class ModelEzraBladeLong extends ModelBase implements IHandlesRender
{
	public ModelRenderer blade;

	public ModelEzraBladeLong()
	{
		this.textureWidth = 512;
		this.textureHeight = 512;
		this.blade = new ModelRenderer(this, 0, 0);
		this.blade.setRotationPoint(-162.0F, 1.5F, 1.5F);
		this.blade.addBox(0.0F, 0.0F, 0.0F, 152, 3, 3, 0.0F);
	}
