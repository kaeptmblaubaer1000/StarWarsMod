 ...
 */
public class ModelDarksaberBladeShort extends ModelBase implements IHandlesRender
{
	public ModelRenderer shape1;

	public ModelDarksaberBladeShort()
	{
		this.textureWidth = 256;
		this.textureHeight = 256;
		this.shape1 = new ModelRenderer(this, 0, 0);
		this.shape1.setRotationPoint(17.0F, 0.0F, 0.0F);
		this.shape1.addBox(-108.0F, 1.0F, 1.1F, 100, 4, 2, 0.0F);
	}
