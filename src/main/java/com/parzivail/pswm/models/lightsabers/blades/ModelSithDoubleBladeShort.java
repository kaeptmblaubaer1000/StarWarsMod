 ...
 */
public class ModelSithDoubleBladeShort extends ModelBase implements IHandlesRender
{
	public ModelRenderer blade;
	public ModelRenderer blade2;

	public ModelSithDoubleBladeShort()
	{
		this.textureWidth = 512;
		this.textureHeight = 512;
		this.blade2 = new ModelRenderer(this, 0, 0);
		this.blade2.setRotationPoint(0.0F, 0.0F, 0.0F);
		this.blade2.addBox(-138.0F, 0.5F, 0.5F, 100, 3, 3, 0.0F);
		this.blade = new ModelRenderer(this, 0, 0);
		this.blade.setRotationPoint(0.0F, 0.0F, 0.0F);
		this.blade.addBox(38.0F, 0.5F, 0.5F, 100, 3, 3, 0.0F);
	}
