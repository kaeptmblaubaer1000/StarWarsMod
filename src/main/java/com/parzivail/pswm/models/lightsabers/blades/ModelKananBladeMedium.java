 ...
 */
public class ModelKananBladeMedium extends ModelBase implements IHandlesRender
{
    public ModelRenderer blade;

    public ModelKananBladeMedium() {
        this.textureWidth = 512;
        this.textureHeight = 512;
        this.blade = new ModelRenderer(this, 0, 0);
        this.blade.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.blade.addBox(-133.0F, 1.5F, 1.5F, 120, 3, 3, 0.0F);
    }
