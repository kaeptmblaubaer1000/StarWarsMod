 ...
 */
public class ModelRevan2BladeShort extends ModelBase implements IHandlesRender
{
	public ModelRenderer shape1;

	public ModelRevan2BladeShort()
	{
		this.textureWidth = 256;
		this.textureHeight = 256;
		this.shape1 = new ModelRenderer(this, 0, 0);
		this.shape1.setRotationPoint(11.0F, 0.0F, 0.0F);
		this.shape1.addBox(-118.5F, 0.5F, 0.5F, 120, 4, 4, 0.0F);
	}
