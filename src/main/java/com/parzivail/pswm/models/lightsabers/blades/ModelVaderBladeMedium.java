 ...
 */
public class ModelVaderBladeMedium extends ModelBase implements IHandlesRender
{
    public ModelRenderer blade;

    public ModelVaderBladeMedium() {
        this.textureWidth = 512;
        this.textureHeight = 512;
        this.blade = new ModelRenderer(this, 0, 0);
        this.blade.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.blade.addBox(-109.0F, 1.5F, 1.5F, 120, 3, 3, 0.0F);
    }
