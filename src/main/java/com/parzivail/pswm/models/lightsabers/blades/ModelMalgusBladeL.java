 ...
 */
public class ModelMalgusBladeL extends ModelBase implements IHandlesRender
{
	...
	public ModelMalgusBladeL()
	{
		this.textureWidth = 512;
		this.textureHeight = 512;
		this.blade = new ModelRenderer(this, 0, 0);
		this.blade.setRotationPoint(-81.0F, 0.0F, 0.0F);
		this.blade.addBox(-148.0F, 1.5F, 1.5F, 230, 3, 3, 0.0F);
	}
