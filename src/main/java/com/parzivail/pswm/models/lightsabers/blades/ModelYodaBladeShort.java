 ...
 */
public class ModelYodaBladeShort extends ModelBase implements IHandlesRender
{
	public ModelRenderer shape1;

	public ModelYodaBladeShort()
	{
		this.textureWidth = 512;
		this.textureHeight = 512;
		this.shape1 = new ModelRenderer(this, 0, 0);
		this.shape1.setRotationPoint(7.0F, 0.0F, 0.0F);
		this.shape1.addBox(-106.0F, 1.0F, 1.0F, 100, 3, 3, 0.0F);
	}
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		this.shape1 = new ModelRenderer(this, 0, 0);
		this.shape1.setRotationPoint(7.0F, 0.0F, 0.0F);
		this.shape1.addBox(-100.0F, 1.0F, 1.0F, 120, 3, 3, 0.0F);
