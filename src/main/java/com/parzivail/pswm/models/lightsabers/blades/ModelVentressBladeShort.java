 ...
 */
public class ModelVentressBladeShort extends ModelBase implements IHandlesRender
{
	public ModelRenderer shape1;

	public ModelVentressBladeShort()
	{
		this.textureWidth = 256;
		this.textureHeight = 256;
		this.shape1 = new ModelRenderer(this, 0, 0);
		this.shape1.setRotationPoint(18.0F, 0.0F, 0.0F);
		this.shape1.addBox(-157.0F, 1.0F, 1.0F, 140, 4, 4, 0.0F);
	}
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		this.shape1 = new ModelRenderer(this, 0, 0);
		this.shape1.setRotationPoint(18.0F, 0.0F, 0.0F);
		this.shape1.addBox(-117.0F, 1.0F, 1.0F, 100, 4, 4, 0.0F);
