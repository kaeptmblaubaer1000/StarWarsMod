package com.parzivail.pswm.models.block.hoth;
 ...
 */
public class ModelFloorLight2 extends ModelBase
{
	...
	public ModelFloorLight2()
	{
		...
		this.shape1.setRotationPoint(0.0F, 23.5F, 0.25F);
		...
		this.shape1_11 = new ModelRenderer(this, 66, 41);
		this.shape1_11.setRotationPoint(0.0F, 0.0F, 0.0F);
		this.shape1_11.addBox(-0.5F, -4.3F, -2.0F, 1, 1, 5, 0.0F);
		this.setRotateAngle(shape1_11, 1.0471975511965976F, 0.0F, 0.0F);
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		GL11.glTranslatef(0, 1.172f, 0.01f);
