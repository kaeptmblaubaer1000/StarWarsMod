...
public class WorldGenMosEisleyBig_x112_z96
{
	public static void generate(World w, int i, int j, int k)
	{
		...
		b(w, i, j + 3, k + 11, sandstone_stairs, 0);
		m(w, i, j + 3, k + 11, 4);
		...
		b(w, i, j + 5, k + 11, sandstone_stairs, 0);
		m(w, i, j + 5, k + 11, 2);
	...
	public static void generate_1(World w, int i, int j, int k)
	{
		...
		m(w, i + 1, j + 5, k + 11, 2);
		b(w, i + 1, j + 5, k + 12, sandstone_stairs, 0);
		m(w, i + 1, j + 5, k + 12, 1);
		b(w, i + 1, j + 5, k + 13, sandstone_stairs, 0);
		m(w, i + 1, j + 5, k + 13, 1);
		b(w, i + 1, j + 5, k + 14, sandstone_stairs, 0);
		m(w, i + 1, j + 5, k + 14, 1);
		b(w, i + 1, j + 5, k + 15, sandstone_stairs, 0);
		m(w, i + 1, j + 5, k + 15, 1);
		b(w, i + 1, j + 6, k, air, 0);
		...
		b(w, i + 2, j + 3, k + 14, sandstone_stairs, 0);
		m(w, i + 2, j + 3, k + 14, 1);
	...
	public static void generate_7(World w, int i, int j, int k)
	{
		...
		b(w, i + 8, j + 3, k + 7, sandstone_stairs, 0);
		b(w, i + 8, j + 3, k + 8, air, 0);
		b(w, i + 8, j + 3, k + 9, air, 0);
		b(w, i + 8, j + 3, k + 10, air, 0);
		b(w, i + 8, j + 3, k + 11, sandstone_stairs, 0);
	...
	public static void generate_8(World w, int i, int j, int k)
	{
		...
		b(w, i + 9, j + 1, k + 5, sandstone_stairs, 0);
		...
		b(w, i + 9, j + 11, k + 6, sandstone_stairs, 0);
		b(w, i + 9, j + 11, k + 7, sandstone_stairs, 0);
		b(w, i + 9, j + 11, k + 8, sandstone_stairs, 0);
		b(w, i + 9, j + 11, k + 9, sandstone_stairs, 0);
		b(w, i + 9, j + 11, k + 10, sandstone_stairs, 0);
		b(w, i + 9, j + 11, k + 11, sandstone_stairs, 0);
		b(w, i + 9, j + 11, k + 12, sandstone_stairs, 0);
	...
	public static void generate_9(World w, int i, int j, int k)
	{
		...
		m(w, i + 10, j + 1, k + 5, 1);
		b(w, i + 10, j + 1, k + 6, crafting_table, 0);
		b(w, i + 10, j + 1, k + 7, furnace, 0);
		m(w, i + 10, j + 1, k + 7, 5);
		b(w, i + 10, j + 1, k + 8, air, 0);
		b(w, i + 10, j + 1, k + 9, air, 0);
		b(w, i + 10, j + 1, k + 10, bed, 0);
		b(w, i + 10, j + 1, k + 11, bed, 0);
		m(w, i + 10, j + 1, k + 11, 8);
		...
		m(w, i + 10, j + 4, k + 5, 1);
		b(w, i + 10, j + 4, k + 6, sandstone_stairs, 0);
		m(w, i + 10, j + 4, k + 6, 5);
		...
		b(w, i + 10, j + 5, k + 5, sandstone_stairs, 0);
		b(w, i + 10, j + 5, k + 6, sandstone, 0);
		...
		b(w, i + 10, j + 11, k + 6, sandstone_stairs, 0);
		m(w, i + 10, j + 11, k + 6, 2);
		...
		b(w, i + 10, j + 11, k + 12, sandstone_stairs, 0);
		m(w, i + 10, j + 11, k + 12, 3);
	...
	public static void generate_10(World w, int i, int j, int k)
	{
		...
		b(w, i + 11, j + 6, k + 5, sandstone_stairs, 0);
		...
		b(w, i + 11, j + 11, k + 6, sandstone_stairs, 0);
		m(w, i + 11, j + 11, k + 6, 2);
		...
		b(w, i + 11, j + 13, k + 11, sandstone, 0);
		m(w, i + 11, j + 13, k + 11, 1);
		...
		b(w, i + 11, j + 14, k + 11, sandstone, 0);
		m(w, i + 11, j + 14, k + 11, 1);
		...
		m(w, i + 11, j + 15, k + 7, 1);
		b(w, i + 11, j + 15, k + 8, torch, 0);
		m(w, i + 11, j + 15, k + 8, 1);
		b(w, i + 11, j + 15, k + 9, air, 0);
		b(w, i + 11, j + 15, k + 10, torch, 0);
		m(w, i + 11, j + 15, k + 10, 1);
		b(w, i + 11, j + 15, k + 11, sandstone, 0);
		m(w, i + 11, j + 15, k + 11, 1);
		...
		b(w, i + 11, j + 16, k + 11, sandstone, 0);
		m(w, i + 11, j + 16, k + 11, 1);
	...
	public static void generate_11(World w, int i, int j, int k)
	{
		...
		b(w, i + 12, j + 2, k + 10, sandstone_stairs, 0);
		m(w, i + 12, j + 2, k + 10, 1);
		...
		m(w, i + 12, j + 4, k + 5, 1);
		b(w, i + 12, j + 4, k + 6, stone_slab, 0);
		m(w, i + 12, j + 4, k + 6, 9);
		b(w, i + 12, j + 4, k + 7, air, 0);
		b(w, i + 12, j + 4, k + 8, sandstone_stairs, 0);
		...
		b(w, i + 12, j + 8, k + 8, sandstone_stairs, 0);
		...
		b(w, i + 12, j + 11, k + 6, sandstone_stairs, 0);
		m(w, i + 12, j + 11, k + 6, 2);
		...
		b(w, i + 12, j + 11, k + 12, sandstone_stairs, 0);
		m(w, i + 12, j + 11, k + 12, 3);
		...
		b(w, i + 12, j + 12, k + 7, sandstone, 0);
		m(w, i + 12, j + 12, k + 7, 1);
		b(w, i + 12, j + 12, k + 8, sandstone_stairs, 0);
		b(w, i + 12, j + 12, k + 9, sandstone, 0);
		b(w, i + 12, j + 12, k + 10, air, 0);
		b(w, i + 12, j + 12, k + 11, sandstone, 0);
		m(w, i + 12, j + 12, k + 11, 1);
		...
		b(w, i + 12, j + 13, k + 11, sandstone, 0);
		m(w, i + 12, j + 13, k + 11, 1);
		...
		b(w, i + 12, j + 14, k + 7, sandstone, 0);
		m(w, i + 12, j + 14, k + 7, 1);
		b(w, i + 12, j + 14, k + 8, air, 0);
		b(w, i + 12, j + 14, k + 9, sandstone, 0);
		b(w, i + 12, j + 14, k + 10, air, 0);
		b(w, i + 12, j + 14, k + 11, sandstone, 0);
		m(w, i + 12, j + 14, k + 11, 1);
		...
		b(w, i + 12, j + 15, k + 7, sandstone, 0);
		m(w, i + 12, j + 15, k + 7, 1);
		b(w, i + 12, j + 15, k + 8, air, 0);
		b(w, i + 12, j + 15, k + 9, sandstone, 0);
		b(w, i + 12, j + 15, k + 10, air, 0);
		b(w, i + 12, j + 15, k + 11, sandstone, 0);
		m(w, i + 12, j + 15, k + 11, 1);
		...
		b(w, i + 12, j + 16, k + 7, sandstone, 0);
		m(w, i + 12, j + 16, k + 7, 1);
		b(w, i + 12, j + 16, k + 8, air, 0);
		b(w, i + 12, j + 16, k + 9, sandstone, 0);
		b(w, i + 12, j + 16, k + 10, air, 0);
		b(w, i + 12, j + 16, k + 11, sandstone, 0);
		m(w, i + 12, j + 16, k + 11, 1);
		...
		b(w, i + 12, j + 18, k + 9, sandstone, 0);
		b(w, i + 12, j + 18, k + 10, sandstone, 0);
		b(w, i + 12, j + 18, k + 11, sandstone, 0);
		m(w, i + 12, j + 18, k + 11, 1);
	...
	public static void generate_12(World w, int i, int j, int k)
	{
		...
		b(w, i + 13, j + 3, k + 5, sandstone_stairs, 0);
		m(w, i + 13, j + 3, k + 5, 4);
		...
		b(w, i + 13, j + 5, k + 9, sandstone_stairs, 0);
		m(w, i + 13, j + 5, k + 9, 2);
		...
		b(w, i + 13, j + 6, k + 5, sandstone_stairs, 0);
		m(w, i + 13, j + 6, k + 5, 1);
		...
		b(w, i + 13, j + 11, k + 6, sandstone_stairs, 0);
		m(w, i + 13, j + 11, k + 6, 2);
		...
		m(w, i + 13, j + 15, k + 7, 1);
		b(w, i + 13, j + 15, k + 8, torch, 0);
		m(w, i + 13, j + 15, k + 8, 2);
		b(w, i + 13, j + 15, k + 9, air, 0);
		b(w, i + 13, j + 15, k + 10, torch, 0);
	...
	public static void generate_13(World w, int i, int j, int k)
	{
		...
		b(w, i + 14, j + 1, k + 4, sandstone_stairs, 0);
		m(w, i + 14, j + 1, k + 4, 2);
		b(w, i + 14, j + 1, k + 5, sandstone, 0);
		m(w, i + 14, j + 1, k + 5, 1);
		b(w, i + 14, j + 1, k + 6, chest, 0);
		m(w, i + 14, j + 1, k + 6, 4);
		b(w, i + 14, j + 1, k + 7, chest, 0);
		m(w, i + 14, j + 1, k + 7, 4);
		...
		b(w, i + 14, j + 5, k + 5, sandstone_stairs, 0);
		m(w, i + 14, j + 5, k + 5, 1);
		...
		m(w, i + 14, j + 11, k + 6, 2);
		b(w, i + 14, j + 11, k + 7, sandstone, 0);
		b(w, i + 14, j + 11, k + 8, sandstone, 0);
		b(w, i + 14, j + 11, k + 9, sandstone, 0);
		b(w, i + 14, j + 11, k + 10, sandstone, 0);
		b(w, i + 14, j + 11, k + 11, sandstone, 0);
		b(w, i + 14, j + 11, k + 12, sandstone_stairs, 0);
		m(w, i + 14, j + 11, k + 12, 3);
		...
		m(w, i + 14, j + 12, k + 9, 1);
		b(w, i + 14, j + 12, k + 10, sandstone, 0);
		m(w, i + 14, j + 12, k + 10, 1);
		...
		b(w, i + 14, j + 13, k + 8, sandstone, 0);
		m(w, i + 14, j + 13, k + 8, 1);
		b(w, i + 14, j + 13, k + 9, sandstone, 0);
		m(w, i + 14, j + 13, k + 9, 1);
		b(w, i + 14, j + 13, k + 10, sandstone, 0);
		m(w, i + 14, j + 13, k + 10, 1);
		...
		b(w, i + 14, j + 14, k + 8, sandstone, 0);
		m(w, i + 14, j + 14, k + 8, 1);
		b(w, i + 14, j + 14, k + 9, sandstone, 0);
		m(w, i + 14, j + 14, k + 9, 1);
		b(w, i + 14, j + 14, k + 10, sandstone, 0);
		m(w, i + 14, j + 14, k + 10, 1);
		...
		b(w, i + 14, j + 15, k + 8, sandstone, 0);
		m(w, i + 14, j + 15, k + 8, 1);
		b(w, i + 14, j + 15, k + 9, sandstone, 0);
		m(w, i + 14, j + 15, k + 9, 1);
		b(w, i + 14, j + 15, k + 10, sandstone, 0);
		m(w, i + 14, j + 15, k + 10, 1);
		...
		b(w, i + 14, j + 16, k + 8, sandstone, 0);
		m(w, i + 14, j + 16, k + 8, 1);
		b(w, i + 14, j + 16, k + 9, sandstone, 0);
		m(w, i + 14, j + 16, k + 9, 1);
		b(w, i + 14, j + 16, k + 10, sandstone, 0);
		m(w, i + 14, j + 16, k + 10, 1);
		...
		b(w, i + 14, j + 17, k + 8, sandstone, 0);
		m(w, i + 14, j + 17, k + 8, 1);
		b(w, i + 14, j + 17, k + 9, sandstone, 0);
		m(w, i + 14, j + 17, k + 9, 1);
		b(w, i + 14, j + 17, k + 10, sandstone, 0);
		m(w, i + 14, j + 17, k + 10, 1);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		b(w, i + 15, j + 11, k + 6, sandstone_stairs, 0);
		m(w, i + 15, j + 11, k + 6, 2);
		b(w, i + 15, j + 11, k + 7, sandstone_stairs, 0);
		m(w, i + 15, j + 11, k + 7, 1);
		b(w, i + 15, j + 11, k + 8, sandstone_stairs, 0);
		m(w, i + 15, j + 11, k + 8, 1);
		b(w, i + 15, j + 11, k + 9, sandstone_stairs, 0);
		m(w, i + 15, j + 11, k + 9, 1);
		b(w, i + 15, j + 11, k + 10, sandstone_stairs, 0);
		m(w, i + 15, j + 11, k + 10, 1);
		b(w, i + 15, j + 11, k + 11, sandstone_stairs, 0);
		m(w, i + 15, j + 11, k + 11, 1);
		b(w, i + 15, j + 11, k + 12, sandstone_stairs, 0);
		m(w, i + 15, j + 11, k + 12, 3);
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 126, j + 1, k + 102);
		TileEntityChest chest1 = (TileEntityChest)w.getTileEntity(i + 126, j + 1, k + 103);
	}
