 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x48_z112
{
	...
	public static void generate_5(World w, int i, int j, int k)
	{
		...
		b(w, i + 6, j + 3, k + 13, sandstone_stairs, 0);
		m(w, i + 6, j + 3, k + 13, 2);
	...
	public static void generate_6(World w, int i, int j, int k)
	{
		...
		b(w, i + 7, j + 8, k + 15, sandstone_stairs, 0);
		m(w, i + 7, j + 8, k + 15, 2);
		b(w, i + 7, j + 9, k, air, 0);
	...
	public static void generate_7(World w, int i, int j, int k)
	{
		...
		b(w, i + 8, j + 3, k + 4, sandstone_stairs, 0);
		...
		b(w, i + 8, j + 8, k + 15, sandstone_stairs, 0);
		m(w, i + 8, j + 8, k + 15, 2);
		b(w, i + 8, j + 9, k, air, 0);
	...
	public static void generate_9(World w, int i, int j, int k)
	{
		...
		b(w, i + 10, j + 1, k, furnace, 0);
		m(w, i + 10, j + 1, k, 5);
		b(w, i + 10, j + 1, k + 1, air, 0);
		b(w, i + 10, j + 1, k + 2, air, 0);
		b(w, i + 10, j + 1, k + 3, bed, 0);
		b(w, i + 10, j + 1, k + 4, bed, 0);
		m(w, i + 10, j + 1, k + 4, 8);
		...
		b(w, i + 10, j + 11, k + 2, sandstone, 0);
		b(w, i + 10, j + 11, k + 3, sandstone, 0);
		b(w, i + 10, j + 11, k + 4, sandstone, 0);
		b(w, i + 10, j + 11, k + 5, sandstone_stairs, 0);
		m(w, i + 10, j + 11, k + 5, 3);
		...
		b(w, i + 10, j + 14, k + 1, sandstone, 0);
		m(w, i + 10, j + 14, k + 1, 1);
		b(w, i + 10, j + 14, k + 2, sandstone, 0);
		m(w, i + 10, j + 14, k + 2, 1);
		...
		b(w, i + 10, j + 15, k + 1, sandstone, 0);
		m(w, i + 10, j + 15, k + 1, 1);
		b(w, i + 10, j + 15, k + 2, sandstone, 0);
		m(w, i + 10, j + 15, k + 2, 1);
		...
		b(w, i + 10, j + 16, k + 1, sandstone, 0);
		m(w, i + 10, j + 16, k + 1, 1);
		b(w, i + 10, j + 16, k + 2, sandstone, 0);
		m(w, i + 10, j + 16, k + 2, 1);
		...
		b(w, i + 10, j + 17, k + 1, sandstone, 0);
		m(w, i + 10, j + 17, k + 1, 1);
		b(w, i + 10, j + 17, k + 2, sandstone, 0);
		m(w, i + 10, j + 17, k + 2, 1);
	...
	public static void generate_10(World w, int i, int j, int k)
	{
		...
		b(w, i + 11, j + 3, k + 2, sandstone_stairs, 0);
		m(w, i + 11, j + 3, k + 2, 3);
		...
		b(w, i + 11, j + 11, k + 2, sandstone_stairs, 0);
		m(w, i + 11, j + 11, k + 2, 3);
		b(w, i + 11, j + 11, k + 3, air, 0);
		b(w, i + 11, j + 11, k + 4, sandstone, 0);
		b(w, i + 11, j + 11, k + 5, sandstone_stairs, 0);
		m(w, i + 11, j + 11, k + 5, 3);
		...
		b(w, i + 11, j + 15, k, sandstone, 0);
		m(w, i + 11, j + 15, k, 1);
		b(w, i + 11, j + 15, k + 1, torch, 0);
		m(w, i + 11, j + 15, k + 1, 1);
		b(w, i + 11, j + 15, k + 2, air, 0);
		b(w, i + 11, j + 15, k + 3, torch, 0);
		m(w, i + 11, j + 15, k + 3, 1);
		b(w, i + 11, j + 15, k + 4, sandstone, 0);
		m(w, i + 11, j + 15, k + 4, 1);
		...
		b(w, i + 11, j + 17, k, sandstone, 0);
		m(w, i + 11, j + 17, k, 1);
		b(w, i + 11, j + 17, k + 1, sandstone, 0);
		b(w, i + 11, j + 17, k + 2, sandstone, 0);
		b(w, i + 11, j + 17, k + 3, sandstone, 0);
		b(w, i + 11, j + 17, k + 4, sandstone, 0);
		m(w, i + 11, j + 17, k + 4, 1);
		...
		b(w, i + 11, j + 18, k + 1, sandstone, 0);
		b(w, i + 11, j + 18, k + 2, sandstone, 0);
	...
	public static void generate_11(World w, int i, int j, int k)
	{
		...
		b(w, i + 12, j + 2, k + 3, sandstone_stairs, 0);
		m(w, i + 12, j + 2, k + 3, 1);
		...
		b(w, i + 12, j + 4, k + 1, sandstone_stairs, 0);
		...
		b(w, i + 12, j + 10, k + 3, sandstone_stairs, 0);
		m(w, i + 12, j + 10, k + 3, 1);
		...
		b(w, i + 12, j + 11, k + 2, sandstone, 0);
		b(w, i + 12, j + 11, k + 3, air, 0);
		b(w, i + 12, j + 11, k + 4, sandstone, 0);
		b(w, i + 12, j + 11, k + 5, sandstone_stairs, 0);
		m(w, i + 12, j + 11, k + 5, 3);
		...
		b(w, i + 12, j + 12, k, sandstone, 0);
		m(w, i + 12, j + 12, k, 1);
		b(w, i + 12, j + 12, k + 1, sandstone_stairs, 0);
		b(w, i + 12, j + 12, k + 2, sandstone, 0);
		b(w, i + 12, j + 12, k + 3, air, 0);
		b(w, i + 12, j + 12, k + 4, sandstone, 0);
		m(w, i + 12, j + 12, k + 4, 1);
		...
		b(w, i + 12, j + 14, k, sandstone, 0);
		m(w, i + 12, j + 14, k, 1);
		b(w, i + 12, j + 14, k + 1, air, 0);
		b(w, i + 12, j + 14, k + 2, sandstone, 0);
		b(w, i + 12, j + 14, k + 3, air, 0);
		b(w, i + 12, j + 14, k + 4, sandstone, 0);
		m(w, i + 12, j + 14, k + 4, 1);
		...
		b(w, i + 12, j + 15, k, sandstone, 0);
		m(w, i + 12, j + 15, k, 1);
		b(w, i + 12, j + 15, k + 1, air, 0);
		b(w, i + 12, j + 15, k + 2, sandstone, 0);
		b(w, i + 12, j + 15, k + 3, air, 0);
		b(w, i + 12, j + 15, k + 4, sandstone, 0);
		m(w, i + 12, j + 15, k + 4, 1);
		...
		b(w, i + 12, j + 16, k, sandstone, 0);
		m(w, i + 12, j + 16, k, 1);
		b(w, i + 12, j + 16, k + 1, air, 0);
		b(w, i + 12, j + 16, k + 2, sandstone, 0);
		b(w, i + 12, j + 16, k + 3, air, 0);
		b(w, i + 12, j + 16, k + 4, sandstone, 0);
		m(w, i + 12, j + 16, k + 4, 1);
		...
		b(w, i + 12, j + 17, k, sandstone, 0);
		m(w, i + 12, j + 17, k, 1);
		b(w, i + 12, j + 17, k + 1, sandstone, 0);
		b(w, i + 12, j + 17, k + 2, sandstone, 0);
		b(w, i + 12, j + 17, k + 3, sandstone, 0);
		b(w, i + 12, j + 17, k + 4, sandstone, 0);
		m(w, i + 12, j + 17, k + 4, 1);
		...
		b(w, i + 12, j + 18, k, sandstone, 0);
		m(w, i + 12, j + 18, k, 1);
		b(w, i + 12, j + 18, k + 1, sandstone, 0);
		b(w, i + 12, j + 18, k + 2, sandstone, 0);
		b(w, i + 12, j + 18, k + 3, sandstone, 0);
		b(w, i + 12, j + 18, k + 4, sandstone, 0);
		m(w, i + 12, j + 18, k + 4, 1);
		...
		b(w, i + 12, j + 19, k + 1, sandstone, 0);
		b(w, i + 12, j + 19, k + 2, sandstone, 0);
	...
	public static void generate_12(World w, int i, int j, int k)
	{
		...
		b(w, i + 13, j + 5, k + 2, sandstone_stairs, 0);
		m(w, i + 13, j + 5, k + 2, 2);
		...
		b(w, i + 13, j + 9, k + 2, sandstone_stairs, 0);
		m(w, i + 13, j + 9, k + 2, 2);
		...
		b(w, i + 13, j + 11, k + 4, sandstone, 0);
		b(w, i + 13, j + 11, k + 5, sandstone_stairs, 0);
		m(w, i + 13, j + 11, k + 5, 3);
		...
		m(w, i + 13, j + 15, k, 1);
		b(w, i + 13, j + 15, k + 1, torch, 0);
		m(w, i + 13, j + 15, k + 1, 2);
		b(w, i + 13, j + 15, k + 2, air, 0);
		b(w, i + 13, j + 15, k + 3, torch, 0);
		m(w, i + 13, j + 15, k + 3, 2);
		...
		m(w, i + 13, j + 17, k, 1);
		b(w, i + 13, j + 17, k + 1, sandstone, 0);
		b(w, i + 13, j + 17, k + 2, sandstone, 0);
		...
		b(w, i + 13, j + 18, k + 1, sandstone, 0);
		b(w, i + 13, j + 18, k + 2, sandstone, 0);
	...
	public static void generate_13(World w, int i, int j, int k)
	{
		...
		b(w, i + 14, j + 11, k + 2, sandstone, 0);
		b(w, i + 14, j + 11, k + 3, sandstone, 0);
		b(w, i + 14, j + 11, k + 4, sandstone, 0);
		...
		b(w, i + 14, j + 13, k + 1, sandstone, 0);
		m(w, i + 14, j + 13, k + 1, 1);
		b(w, i + 14, j + 13, k + 2, sandstone, 0);
		m(w, i + 14, j + 13, k + 2, 1);
		...
		b(w, i + 14, j + 14, k + 1, sandstone, 0);
		m(w, i + 14, j + 14, k + 1, 1);
		b(w, i + 14, j + 14, k + 2, sandstone, 0);
		m(w, i + 14, j + 14, k + 2, 1);
		b(w, i + 14, j + 14, k + 3, sandstone, 0);
		m(w, i + 14, j + 14, k + 3, 1);
		...
		b(w, i + 14, j + 15, k + 1, sandstone, 0);
		m(w, i + 14, j + 15, k + 1, 1);
		b(w, i + 14, j + 15, k + 2, sandstone, 0);
		m(w, i + 14, j + 15, k + 2, 1);
		b(w, i + 14, j + 15, k + 3, sandstone, 0);
		m(w, i + 14, j + 15, k + 3, 1);
		...
		b(w, i + 14, j + 16, k + 1, sandstone, 0);
		m(w, i + 14, j + 16, k + 1, 1);
		b(w, i + 14, j + 16, k + 2, sandstone, 0);
		m(w, i + 14, j + 16, k + 2, 1);
		b(w, i + 14, j + 16, k + 3, sandstone, 0);
		m(w, i + 14, j + 16, k + 3, 1);
		...
		b(w, i + 14, j + 17, k + 1, sandstone, 0);
		m(w, i + 14, j + 17, k + 1, 1);
		b(w, i + 14, j + 17, k + 2, sandstone, 0);
		m(w, i + 14, j + 17, k + 2, 1);
		b(w, i + 14, j + 17, k + 3, sandstone, 0);
		m(w, i + 14, j + 17, k + 3, 1);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		b(w, i + 15, j + 11, k, sandstone_stairs, 0);
		m(w, i + 15, j + 11, k, 1);
		b(w, i + 15, j + 11, k + 1, sandstone_stairs, 0);
		m(w, i + 15, j + 11, k + 1, 1);
		b(w, i + 15, j + 11, k + 2, sandstone_stairs, 0);
		m(w, i + 15, j + 11, k + 2, 1);
		b(w, i + 15, j + 11, k + 3, sandstone_stairs, 0);
		m(w, i + 15, j + 11, k + 3, 1);
		b(w, i + 15, j + 11, k + 4, sandstone_stairs, 0);
		m(w, i + 15, j + 11, k + 4, 1);
		b(w, i + 15, j + 11, k + 5, sandstone_stairs, 0);
		m(w, i + 15, j + 11, k + 5, 3);
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 62, j + 1, k + 112);
		TileEntityChest chest1 = (TileEntityChest)w.getTileEntity(i + 59, j + 1, k + 127);
	}
