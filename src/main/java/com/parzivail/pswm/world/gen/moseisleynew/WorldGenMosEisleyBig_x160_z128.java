...
public class WorldGenMosEisleyBig_x160_z128
{
	public static void generate(World w, int i, int j, int k)
	{
		...
		b(w, i, j + 3, k + 12, sandstone_stairs, 0);
	...
	public static void generate_1(World w, int i, int j, int k)
	{
		...
		b(w, i + 2, j + 1, k + 10, blockTable, 0);
		m(w, i + 2, j + 1, k + 10, 2);
		b(w, i + 2, j + 1, k + 11, bed, 0);
		m(w, i + 2, j + 1, k + 11, 9);
		b(w, i + 2, j + 1, k + 12, bed, 0);
		m(w, i + 2, j + 1, k + 12, 9);
		b(w, i + 2, j + 1, k + 13, chest, 0);
		m(w, i + 2, j + 1, k + 13, 5);
		b(w, i + 2, j + 1, k + 14, crafting_table, 0);
		b(w, i + 2, j + 1, k + 15, bed, 0);
		m(w, i + 2, j + 1, k + 15, 9);
		b(w, i + 2, j + 2, k, air, 0);
	...
	public static void generate_4(World w, int i, int j, int k)
	{
		...
		b(w, i + 5, j + 10, k + 13, stone_slab, 0);
		m(w, i + 5, j + 10, k + 13, 1);
	...
	public static void generate_5(World w, int i, int j, int k)
	{
		...
		b(w, i + 6, j + 9, k + 11, sandstone_stairs, 0);
		m(w, i + 6, j + 9, k + 11, 2);
		...
		b(w, i + 6, j + 10, k + 13, stone_slab, 0);
		m(w, i + 6, j + 10, k + 13, 1);
	...
	public static void generate_7(World w, int i, int j, int k)
	{
		...
		b(w, i + 8, j + 1, k + 10, jukebox, 0);
		b(w, i + 8, j + 1, k + 11, air, 0);
		b(w, i + 8, j + 1, k + 12, air, 0);
		b(w, i + 8, j + 1, k + 13, carpet, 0);
		m(w, i + 8, j + 1, k + 13, 8);
	...
	public static void generate_10(World w, int i, int j, int k)
	{
		...
		b(w, i + 11, j + 3, k + 15, sandstone_stairs, 0);
		m(w, i + 11, j + 3, k + 15, 6);
	...
	public static void generate_11(World w, int i, int j, int k)
	{
		...
		m(w, i + 12, j + 4, k + 12, 1);
		b(w, i + 12, j + 4, k + 13, sandstone_stairs, 0);
		m(w, i + 12, j + 4, k + 13, 1);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 162, j + 1, k + 141);
		TileEntityChest chest1 = (TileEntityChest)w.getTileEntity(i + 169, j + 1, k + 138);
	}
