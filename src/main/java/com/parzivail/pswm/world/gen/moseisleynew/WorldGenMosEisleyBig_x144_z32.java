...
public class WorldGenMosEisleyBig_x144_z32
{
	...
	public static void generate_13(World w, int i, int j, int k)
	{
		...
		b(w, i + 14, j + 1, k + 12, jukebox, 0);
		b(w, i + 14, j + 1, k + 13, chest, 0);
		m(w, i + 14, j + 1, k + 13, 5);
		...
		b(w, i + 14, j + 8, k + 10, sandstone_stairs, 0);
		...
		b(w, i + 15, j + 1, k + 6, bed, 0);
		m(w, i + 15, j + 1, k + 6, 10);
		b(w, i + 15, j + 1, k + 7, bed, 0);
		m(w, i + 15, j + 1, k + 7, 2);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		b(w, i + 15, j + 9, k + 9, sandstone_stairs, 0);
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 158, j + 1, k + 45);
	}
