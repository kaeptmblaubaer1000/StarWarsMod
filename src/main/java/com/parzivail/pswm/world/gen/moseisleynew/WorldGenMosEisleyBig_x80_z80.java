...
public class WorldGenMosEisleyBig_x80_z80
{
	...
	public static void generate_1(World w, int i, int j, int k)
	{
		...
		b(w, i + 2, j + 4, k + 2, sandstone_stairs, 0);
		m(w, i + 2, j + 4, k + 2, 3);
	...
	public static void generate_3(World w, int i, int j, int k)
	{
		...
		b(w, i + 4, j + 4, k + 4, sandstone_stairs, 0);
		m(w, i + 4, j + 4, k + 4, 3);
		...
		b(w, i + 4, j + 5, k, sandstone_stairs, 0);
		m(w, i + 4, j + 5, k, 6);
	...
	public static void generate_10(World w, int i, int j, int k)
	{
		...
		b(w, i + 11, j + 5, k + 6, sandstone_stairs, 0);
		m(w, i + 11, j + 5, k + 6, 5);
	...
	public static void generate_11(World w, int i, int j, int k)
	{
		...
		b(w, i + 12, j + 4, k + 7, sandstone_stairs, 0);
		m(w, i + 12, j + 4, k + 7, 5);
