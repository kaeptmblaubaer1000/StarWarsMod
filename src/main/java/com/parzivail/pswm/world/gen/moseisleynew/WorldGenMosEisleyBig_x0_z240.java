 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x0_z240
{
	...
	public static void generate_4(World w, int i, int j, int k)
	{
		...
		m(w, i + 5, j + 6, k + 11, 4);
		b(w, i + 5, j + 6, k + 12, sandstone_stairs, 0);
		m(w, i + 5, j + 6, k + 12, 4);
	...
	public static void generate_5(World w, int i, int j, int k)
	{
		...
		m(w, i + 6, j + 2, k + 12, 1);
		b(w, i + 6, j + 2, k + 13, glass_pane, 0);
		b(w, i + 6, j + 2, k + 14, glass_pane, 0);
		b(w, i + 6, j + 2, k + 15, glass_pane, 0);
		...
		m(w, i + 6, j + 3, k + 12, 1);
		b(w, i + 6, j + 3, k + 13, glass_pane, 0);
		b(w, i + 6, j + 3, k + 14, glass_pane, 0);
		b(w, i + 6, j + 3, k + 15, glass_pane, 0);
		...
		m(w, i + 6, j + 4, k + 12, 1);
		b(w, i + 6, j + 4, k + 13, glass_pane, 0);
		b(w, i + 6, j + 4, k + 14, glass_pane, 0);
		b(w, i + 6, j + 4, k + 15, glass_pane, 0);
	...
	public static void generate_6(World w, int i, int j, int k)
	{
		...
		b(w, i + 7, j + 9, k + 4, torch, 0);
		m(w, i + 7, j + 9, k + 4, 1);
		b(w, i + 7, j + 9, k + 5, air, 0);
		b(w, i + 7, j + 9, k + 6, air, 0);
		b(w, i + 7, j + 9, k + 7, torch, 0);
		m(w, i + 7, j + 9, k + 7, 1);
	...
	public static void generate_9(World w, int i, int j, int k)
	{
		...
		b(w, i + 10, j + 1, k + 12, stone_slab, 0);
		m(w, i + 10, j + 1, k + 12, 1);
	...
	public static void generate_10(World w, int i, int j, int k)
	{
		...
		b(w, i + 11, j + 1, k + 13, stone_slab, 0);
		m(w, i + 11, j + 1, k + 13, 1);
	...
	public static void generate_12(World w, int i, int j, int k)
	{
		...
		b(w, i + 13, j + 13, k + 3, glass, 0);
		b(w, i + 13, j + 13, k + 4, glass, 0);
	...
	public static void generate_13(World w, int i, int j, int k)
	{
		...
		b(w, i + 14, j + 8, k + 15, glass_pane, 0);
		...
		m(w, i + 14, j + 9, k + 14, 5);
		b(w, i + 14, j + 9, k + 15, sandstone_stairs, 0);
		...
		b(w, i + 14, j + 13, k + 3, glass, 0);
		b(w, i + 14, j + 13, k + 4, glass, 0);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		b(w, i + 15, j + 8, k + 15, glass_pane, 0);
		...
		b(w, i + 15, j + 9, k + 15, glass_pane, 0);
		...
		b(w, i + 15, j + 10, k + 15, sandstone_stairs, 0);
		...
		b(w, i + 15, j + 11, k + 13, sandstone, 0);
		...
		b(w, i + 15, j + 13, k + 1, sandstone, 0);
		b(w, i + 15, j + 13, k + 2, glass, 0);
		b(w, i + 15, j + 13, k + 3, glass, 0);
		b(w, i + 15, j + 13, k + 4, glass, 0);
		b(w, i + 15, j + 13, k + 5, glass, 0);
		b(w, i + 15, j + 13, k + 6, glass, 0);
		b(w, i + 15, j + 13, k + 7, glass, 0);
		b(w, i + 15, j + 13, k + 8, glass, 0);
		b(w, i + 15, j + 13, k + 9, glass, 0);
		b(w, i + 15, j + 13, k + 10, sandstone, 0);
