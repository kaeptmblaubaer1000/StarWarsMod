 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x0_z16
{
	...
	public static void generate_10(World w, int i, int j, int k)
	{
		...
		b(w, i + 11, j + 1, k + 13, bed, 0);
		m(w, i + 11, j + 1, k + 13, 10);
		b(w, i + 11, j + 1, k + 14, bed, 0);
		m(w, i + 11, j + 1, k + 14, 2);
	...
	public static void generate_12(World w, int i, int j, int k)
	{
		...
		b(w, i + 13, j + 1, k + 13, crafting_table, 0);
	...
	public static void generate_13(World w, int i, int j, int k)
	{
		...
		b(w, i + 14, j + 8, k + 13, sandstone_stairs, 0);
		m(w, i + 14, j + 8, k + 13, 2);
		...
		b(w, i + 15, j + 1, k + 13, bed, 0);
		m(w, i + 15, j + 1, k + 13, 10);
		b(w, i + 15, j + 1, k + 14, bed, 0);
		m(w, i + 15, j + 1, k + 14, 2);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		b(w, i + 15, j + 9, k + 15, stone_slab, 0);
		m(w, i + 15, j + 9, k + 15, 1);
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 14, j + 1, k + 29);
	}
