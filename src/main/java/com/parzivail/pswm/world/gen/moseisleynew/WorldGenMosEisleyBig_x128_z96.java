 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x128_z96
{
	...
	public static void generate_6(World w, int i, int j, int k)
	{
		...
		b(w, i + 7, j + 1, k + 3, crafting_table, 0);
		...
		b(w, i + 7, j + 8, k + 3, stone_slab, 0);
		m(w, i + 7, j + 8, k + 3, 1);
		b(w, i + 7, j + 8, k + 4, sandstone_stairs, 0);
		b(w, i + 7, j + 8, k + 5, sandstone_stairs, 0);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 138, j + 1, k + 101);
	}
