 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x32_z192
{
	...
	public static void generate_11(World w, int i, int j, int k)
	{
		...
		b(w, i + 12, j + 6, k, sandstone_stairs, 0);
		m(w, i + 12, j + 6, k, 2);
	...
	public static void generate_12(World w, int i, int j, int k)
	{
		...
		b(w, i + 13, j + 1, k + 3, crafting_table, 0);
		...
		m(w, i + 13, j + 3, k + 15, 2);
		b(w, i + 13, j + 4, k, stone_slab, 0);
		m(w, i + 13, j + 4, k, 9);
		b(w, i + 13, j + 4, k + 1, stone_slab, 0);
		m(w, i + 13, j + 4, k + 1, 9);
		b(w, i + 13, j + 4, k + 2, stone_slab, 0);
		m(w, i + 13, j + 4, k + 2, 9);
	...
	public static void generate_13(World w, int i, int j, int k)
	{
		...
		m(w, i + 14, j + 9, k + 14, 1);
		b(w, i + 14, j + 9, k + 15, stone_slab, 0);
		m(w, i + 14, j + 9, k + 15, 1);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		b(w, i + 15, j + 8, k + 1, sandstone_stairs, 0);
		m(w, i + 15, j + 8, k + 1, 3);
		...
		b(w, i + 15, j + 12, k + 1, sandstone_stairs, 0);
		m(w, i + 15, j + 12, k + 1, 3);
		...
		b(w, i + 15, j + 15, k, torch, 0);
		m(w, i + 15, j + 15, k, 3);
		b(w, i + 15, j + 15, k + 1, air, 0);
		b(w, i + 15, j + 15, k + 2, torch, 0);
		m(w, i + 15, j + 15, k + 2, 4);
