...
public class WorldGenMosEisleyBig_x160_z208
{
	...
	public static void generate_1(World w, int i, int j, int k)
	{
		...
		b(w, i + 1, j + 8, k + 8, sandstone_stairs, 0);
		m(w, i + 1, j + 8, k + 8, 2);
		...
		b(w, i + 2, j + 4, k + 4, sandstone_stairs, 0);
		m(w, i + 2, j + 4, k + 4, 2);
		b(w, i + 2, j + 4, k + 5, sandstone, 0);
		b(w, i + 2, j + 4, k + 6, stone_slab, 0);
		m(w, i + 2, j + 4, k + 6, 9);
	...
	public static void generate_2(World w, int i, int j, int k)
	{
		...
		m(w, i + 2, j + 10, k + 10, 1);
		b(w, i + 2, j + 10, k + 11, stone_slab, 0);
		m(w, i + 2, j + 10, k + 11, 1);
		...
		b(w, i + 3, j + 1, k + 8, carpet, 0);
		m(w, i + 3, j + 1, k + 8, 8);
		b(w, i + 3, j + 1, k + 9, carpet, 0);
		m(w, i + 3, j + 1, k + 9, 8);
		...
		b(w, i + 3, j + 1, k + 14, crafting_table, 0);
	...
	public static void generate_3(World w, int i, int j, int k)
	{
		...
		b(w, i + 3, j + 8, k + 14, sandstone_stairs, 0);
		m(w, i + 3, j + 8, k + 14, 3);
		...
		b(w, i + 3, j + 9, k + 8, sandstone_stairs, 0);
		m(w, i + 3, j + 9, k + 8, 2);
		...
		b(w, i + 3, j + 10, k + 10, stone_slab, 0);
		m(w, i + 3, j + 10, k + 10, 1);
		b(w, i + 3, j + 10, k + 11, stone_slab, 0);
		m(w, i + 3, j + 10, k + 11, 1);
		...
		m(w, i + 4, j + 3, k + 4, 1);
		b(w, i + 4, j + 3, k + 5, sandstone_stairs, 0);
		m(w, i + 4, j + 3, k + 5, 4);
	...
	public static void generate_4(World w, int i, int j, int k)
	{
		...
		b(w, i + 5, j + 4, k + 6, sandstone_stairs, 0);
		m(w, i + 5, j + 4, k + 6, 4);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 162, j + 1, k + 222);
	}
