 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x0_z128
{
	...
	public static void generate_3(World w, int i, int j, int k)
	{
		...
		b(w, i + 4, j + 7, k + 9, sandstone_stairs, 0);
	...
	public static void generate_11(World w, int i, int j, int k)
	{
		...
		b(w, i + 12, j + 1, k + 7, crafting_table, 0);
	...
	public static void generate_12(World w, int i, int j, int k)
	{
		...
		b(w, i + 13, j + 7, k + 7, sandstone_stairs, 0);
		m(w, i + 13, j + 7, k + 7, 1);
		b(w, i + 13, j + 7, k + 8, sandstone_stairs, 0);
		m(w, i + 13, j + 7, k + 8, 1);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 10, j + 1, k + 138);
	}
