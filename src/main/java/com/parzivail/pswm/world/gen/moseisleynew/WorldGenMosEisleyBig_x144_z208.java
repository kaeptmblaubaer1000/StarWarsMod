...
public class WorldGenMosEisleyBig_x144_z208
{
	public static void generate(World w, int i, int j, int k)
	{
		...
		m(w, i, j + 1, k + 3, 1);
		b(w, i, j + 1, k + 4, stone_slab, 0);
		m(w, i, j + 1, k + 4, 1);
		b(w, i, j + 1, k + 5, stone_slab, 0);
		m(w, i, j + 1, k + 5, 1);
		b(w, i, j + 1, k + 6, stone_slab, 0);
		m(w, i, j + 1, k + 6, 1);
		...
		b(w, i, j + 5, k + 1, sandstone_stairs, 0);
		m(w, i, j + 5, k + 1, 7);
		b(w, i, j + 5, k + 2, air, 0);
		b(w, i, j + 5, k + 3, air, 0);
		b(w, i, j + 5, k + 4, air, 0);
		b(w, i, j + 5, k + 5, air, 0);
		b(w, i, j + 5, k + 6, sandstone_stairs, 0);
		m(w, i, j + 5, k + 6, 6);
	...
	public static void generate_1(World w, int i, int j, int k)
	{
		...
		m(w, i + 1, j + 3, k + 1, 1);
		b(w, i + 1, j + 3, k + 2, glass_pane, 0);
		b(w, i + 1, j + 3, k + 3, glass_pane, 0);
		b(w, i + 1, j + 3, k + 4, glass_pane, 0);
		b(w, i + 1, j + 3, k + 5, glass_pane, 0);
		...
		b(w, i + 1, j + 5, k, sandstone_stairs, 0);
		m(w, i + 1, j + 5, k, 2);
		...
		b(w, i + 1, j + 6, k + 6, sandstone_stairs, 0);
		m(w, i + 1, j + 6, k + 6, 3);
	...
	public static void generate_3(World w, int i, int j, int k)
	{
		...
		b(w, i + 4, j + 3, k + 2, sandstone_stairs, 0);
	...
	public static void generate_5(World w, int i, int j, int k)
	{
		...
		b(w, i + 6, j + 1, k + 2, furnace, 0);
		m(w, i + 6, j + 1, k + 2, 5);
		b(w, i + 6, j + 1, k + 3, crafting_table, 0);
		...
		b(w, i + 6, j + 4, k + 3, sandstone_stairs, 0);
		m(w, i + 6, j + 4, k + 3, 5);
		...
		b(w, i + 6, j + 5, k + 4, sandstone_stairs, 0);
	...
	public static void generate_6(World w, int i, int j, int k)
	{
		...
		b(w, i + 7, j + 6, k + 4, sandstone_stairs, 0);
	...
	public static void generate_7(World w, int i, int j, int k)
	{
		...
		b(w, i + 8, j + 4, k + 1, sandstone_stairs, 0);
		b(w, i + 8, j + 4, k + 2, air, 0);
		b(w, i + 8, j + 4, k + 3, stone_slab, 0);
		m(w, i + 8, j + 4, k + 3, 9);
		...
		b(w, i + 8, j + 8, k + 1, sandstone_stairs, 0);
		...
		b(w, i + 8, j + 12, k, sandstone, 0);
		b(w, i + 8, j + 12, k + 1, sandstone_stairs, 0);
		...
		b(w, i + 8, j + 17, k, sandstone, 0);
		b(w, i + 8, j + 17, k + 1, sandstone, 0);
		...
		b(w, i + 8, j + 18, k, sandstone, 0);
		b(w, i + 8, j + 18, k + 1, sandstone, 0);
		b(w, i + 8, j + 18, k + 2, sandstone, 0);
		m(w, i + 8, j + 18, k + 2, 1);
	...
	public static void generate_8(World w, int i, int j, int k)
	{
		...
		b(w, i + 8, j + 19, k, sandstone, 0);
		b(w, i + 8, j + 19, k + 1, sandstone, 0);
		...
		b(w, i + 9, j + 3, k + 4, sandstone_stairs, 0);
		m(w, i + 9, j + 3, k + 4, 4);
		...
		b(w, i + 9, j + 5, k, sandstone_stairs, 0);
		m(w, i + 9, j + 5, k, 3);
		...
		b(w, i + 9, j + 6, k + 4, sandstone_stairs, 0);
		m(w, i + 9, j + 6, k + 4, 1);
		...
		b(w, i + 9, j + 12, k, sandstone, 0);
		b(w, i + 9, j + 12, k + 1, sandstone, 0);
		b(w, i + 9, j + 12, k + 2, sandstone, 0);
		m(w, i + 9, j + 12, k + 2, 1);
		...
		b(w, i + 9, j + 15, k + 1, torch, 0);
		m(w, i + 9, j + 15, k + 1, 2);
		b(w, i + 9, j + 15, k + 2, sandstone, 0);
		m(w, i + 9, j + 15, k + 2, 1);
		...
		b(w, i + 9, j + 17, k, sandstone, 0);
		b(w, i + 9, j + 17, k + 1, sandstone, 0);
		b(w, i + 9, j + 17, k + 2, sandstone, 0);
		m(w, i + 9, j + 17, k + 2, 1);
		...
		b(w, i + 9, j + 18, k, sandstone, 0);
		b(w, i + 9, j + 18, k + 1, sandstone, 0);
	...
	public static void generate_9(World w, int i, int j, int k)
	{
		...
		b(w, i + 10, j + 1, k + 2, chest, 0);
		m(w, i + 10, j + 1, k + 2, 4);
		b(w, i + 10, j + 1, k + 3, chest, 0);
		m(w, i + 10, j + 1, k + 3, 4);
		...
		b(w, i + 10, j + 4, k + 3, sandstone_stairs, 0);
		m(w, i + 10, j + 4, k + 3, 4);
		...
		b(w, i + 10, j + 5, k + 4, sandstone_stairs, 0);
		m(w, i + 10, j + 5, k + 4, 1);
		...
		b(w, i + 10, j + 11, k + 3, sandstone_stairs, 0);
		m(w, i + 10, j + 11, k + 3, 3);
	...
	public static void generate_11(World w, int i, int j, int k)
	{
		...
		b(w, i + 12, j + 1, k + 12, sandstone_stairs, 0);
	...
	public static void generate_12(World w, int i, int j, int k)
	{
		...
		b(w, i + 13, j + 3, k + 12, sandstone_stairs, 0);
	...
	public static void generate_13(World w, int i, int j, int k)
	{
		...
		m(w, i + 15, j + 1, k + 6, 1);
		b(w, i + 15, j + 1, k + 7, chest, 0);
		m(w, i + 15, j + 1, k + 7, 5);
		b(w, i + 15, j + 1, k + 8, jukebox, 0);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 159, j + 1, k + 215);
		TileEntityChest chest1 = (TileEntityChest)w.getTileEntity(i + 154, j + 1, k + 210);
		TileEntityChest chest2 = (TileEntityChest)w.getTileEntity(i + 154, j + 1, k + 211);
	}
