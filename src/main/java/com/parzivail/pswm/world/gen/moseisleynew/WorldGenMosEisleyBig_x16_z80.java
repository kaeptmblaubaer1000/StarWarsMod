 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x16_z80
{
	public static void generate(World w, int i, int j, int k)
	{
		...
		b(w, i, j + 5, k + 15, sandstone_stairs, 0);
		m(w, i, j + 5, k + 15, 2);
		b(w, i, j + 6, k, air, 0);
		b(w, i, j + 6, k + 1, air, 0);
		b(w, i, j + 6, k + 2, air, 0);
	...
	public static void generate_2(World w, int i, int j, int k)
	{
		...
		b(w, i + 3, j + 5, k + 15, sandstone_stairs, 0);
		m(w, i + 3, j + 5, k + 15, 2);
		b(w, i + 3, j + 6, k, air, 0);
	...
	public static void generate_3(World w, int i, int j, int k)
	{
		...
		b(w, i + 4, j + 5, k + 15, sandstone_stairs, 0);
		m(w, i + 4, j + 5, k + 15, 2);
		b(w, i + 4, j + 6, k, air, 0);
	...
	public static void generate_13(World w, int i, int j, int k)
	{
		...
		m(w, i + 14, j + 3, k + 3, 1);
		b(w, i + 14, j + 3, k + 4, glass_pane, 0);
		b(w, i + 14, j + 3, k + 5, glass_pane, 0);
		b(w, i + 14, j + 3, k + 6, glass_pane, 0);
		b(w, i + 14, j + 3, k + 7, glass_pane, 0);
