 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x128_z16
{
	...
	public static void generate_10(World w, int i, int j, int k)
	{
		...
		b(w, i + 11, j + 9, k + 2, sandstone_stairs, 0);
		m(w, i + 11, j + 9, k + 2, 3);
	...
	public static void generate_12(World w, int i, int j, int k)
	{
		...
		b(w, i + 13, j + 9, k, sandstone_stairs, 0);
		m(w, i + 13, j + 9, k, 1);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 135, j + 1, k + 19);
		TileEntityChest chest1 = (TileEntityChest)w.getTileEntity(i + 142, j + 1, k + 16);
	}
