 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x32_z96
{
	...
	public static void generate_4(World w, int i, int j, int k)
	{
		...
		m(w, i + 5, j + 4, k + 12, 1);
		b(w, i + 5, j + 4, k + 13, sandstone_stairs, 0);
		m(w, i + 5, j + 4, k + 13, 7);
		b(w, i + 5, j + 4, k + 14, stone_slab, 0);
		m(w, i + 5, j + 4, k + 14, 9);
		b(w, i + 5, j + 4, k + 15, stone_slab, 0);
		m(w, i + 5, j + 4, k + 15, 9);
		b(w, i + 5, j + 5, k, air, 0);
	...
	public static void generate_5(World w, int i, int j, int k)
	{
		...
		b(w, i + 6, j + 8, k + 15, sandstone_stairs, 0);
	...
	public static void generate_6(World w, int i, int j, int k)
	{
		...
		b(w, i + 7, j + 9, k + 15, sandstone_stairs, 0);
	...
	public static void generate_7(World w, int i, int j, int k)
	{
		...
		b(w, i + 8, j + 1, k + 12, blockTable, 0);
		m(w, i + 8, j + 1, k + 12, 3);
		b(w, i + 8, j + 1, k + 13, air, 0);
		b(w, i + 8, j + 1, k + 14, carpet, 0);
		m(w, i + 8, j + 1, k + 14, 8);
		b(w, i + 8, j + 1, k + 15, carpet, 0);
		m(w, i + 8, j + 1, k + 15, 8);
		b(w, i + 8, j + 2, k, air, 0);
		...
		b(w, i + 8, j + 8, k + 13, sandstone_stairs, 0);
		m(w, i + 8, j + 8, k + 13, 2);
	...
	public static void generate_8(World w, int i, int j, int k)
	{
		...
		b(w, i + 9, j + 1, k + 14, carpet, 0);
		m(w, i + 9, j + 1, k + 14, 8);
		b(w, i + 9, j + 1, k + 15, carpet, 0);
		m(w, i + 9, j + 1, k + 15, 8);
		b(w, i + 9, j + 2, k, air, 0);
		...
		b(w, i + 9, j + 8, k + 12, sandstone_stairs, 0);
		m(w, i + 9, j + 8, k + 12, 2);
		...
		b(w, i + 9, j + 10, k + 15, stone_slab, 0);
		m(w, i + 9, j + 10, k + 15, 1);
		b(w, i + 9, j + 11, k, stone_slab, 0);
		m(w, i + 9, j + 11, k, 1);
		b(w, i + 9, j + 11, k + 1, stone_slab, 0);
		m(w, i + 9, j + 11, k + 1, 1);
	...
	public static void generate_9(World w, int i, int j, int k)
	{
		...
		b(w, i + 10, j + 9, k + 3, sandstone, 0);
		b(w, i + 10, j + 9, k + 4, sandstone, 0);
		b(w, i + 10, j + 9, k + 5, sandstone, 0);
		...
		b(w, i + 10, j + 9, k + 13, sandstone_stairs, 0);
		m(w, i + 10, j + 9, k + 13, 2);
		...
		b(w, i + 10, j + 10, k + 15, stone_slab, 0);
		m(w, i + 10, j + 10, k + 15, 1);
		b(w, i + 10, j + 11, k, stone_slab, 0);
		m(w, i + 10, j + 11, k, 1);
	...
	public static void generate_10(World w, int i, int j, int k)
	{
		...
		b(w, i + 11, j + 8, k + 13, sandstone_stairs, 0);
		m(w, i + 11, j + 8, k + 13, 2);
		...
		b(w, i + 11, j + 9, k + 3, sandstone, 0);
		b(w, i + 11, j + 9, k + 4, sandstone, 0);
		b(w, i + 11, j + 9, k + 5, sandstone, 0);
		b(w, i + 11, j + 9, k + 6, sandstone, 0);
		...
		b(w, i + 11, j + 10, k + 5, sandstone, 0);
		b(w, i + 11, j + 10, k + 6, sandstone, 0);
	...
	public static void generate_11(World w, int i, int j, int k)
	{
		...
		b(w, i + 12, j + 1, k + 13, bed, 0);
		m(w, i + 12, j + 1, k + 13, 3);
		b(w, i + 12, j + 1, k + 14, bed, 0);
		m(w, i + 12, j + 1, k + 14, 3);
		...
		b(w, i + 12, j + 9, k + 15, sandstone_stairs, 0);
		m(w, i + 12, j + 9, k + 15, 1);
		...
		b(w, i + 12, j + 10, k + 5, sandstone, 0);
		b(w, i + 12, j + 10, k + 6, sandstone, 0);
		...
		m(w, i + 12, j + 11, k + 2, 1);
		b(w, i + 12, j + 11, k + 3, stone_slab, 0);
		m(w, i + 12, j + 11, k + 3, 1);
		b(w, i + 12, j + 11, k + 4, stone_slab, 0);
		m(w, i + 12, j + 11, k + 4, 1);
	...
	public static void generate_12(World w, int i, int j, int k)
	{
		...
		b(w, i + 13, j + 1, k + 12, blockTable, 0);
		m(w, i + 13, j + 1, k + 12, 3);
		b(w, i + 13, j + 1, k + 13, bed, 0);
		m(w, i + 13, j + 1, k + 13, 11);
		b(w, i + 13, j + 1, k + 14, bed, 0);
		m(w, i + 13, j + 1, k + 14, 11);
		b(w, i + 13, j + 1, k + 15, crafting_table, 0);
		...
		b(w, i + 13, j + 8, k + 15, sandstone_stairs, 0);
		m(w, i + 13, j + 8, k + 15, 1);
		b(w, i + 13, j + 9, k, air, 0);
		b(w, i + 13, j + 9, k + 1, air, 0);
		b(w, i + 13, j + 9, k + 2, air, 0);
		b(w, i + 13, j + 9, k + 3, sandstone, 0);
		m(w, i + 13, j + 9, k + 3, 2);
		b(w, i + 13, j + 9, k + 4, sandstone, 0);
		b(w, i + 13, j + 9, k + 5, sandstone, 0);
		b(w, i + 13, j + 9, k + 6, sandstone, 0);
		...
		m(w, i + 13, j + 11, k + 1, 1);
		b(w, i + 13, j + 11, k + 2, stone_slab, 0);
		m(w, i + 13, j + 11, k + 2, 1);
		b(w, i + 13, j + 11, k + 3, stone_slab, 0);
		m(w, i + 13, j + 11, k + 3, 1);
		b(w, i + 13, j + 11, k + 4, stone_slab, 0);
		m(w, i + 13, j + 11, k + 4, 1);
	...
	public static void generate_13(World w, int i, int j, int k)
	{
		...
		b(w, i + 14, j + 11, k + 1, stone_slab, 0);
		m(w, i + 14, j + 11, k + 1, 1);
		b(w, i + 14, j + 11, k + 2, stone_slab, 0);
		m(w, i + 14, j + 11, k + 2, 1);
		b(w, i + 14, j + 11, k + 3, stone_slab, 0);
		m(w, i + 14, j + 11, k + 3, 1);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		b(w, i + 15, j + 9, k + 3, sandstone, 0);
		m(w, i + 15, j + 9, k + 3, 2);
		b(w, i + 15, j + 9, k + 4, sandstone, 0);
		...
		b(w, i + 15, j + 10, k + 3, sandstone, 0);
		b(w, i + 15, j + 10, k + 4, sandstone, 0);
		...
		b(w, i + 15, j + 11, k + 1, stone_slab, 0);
		m(w, i + 15, j + 11, k + 1, 1);
		b(w, i + 15, j + 11, k + 2, stone_slab, 0);
		m(w, i + 15, j + 11, k + 2, 1);
