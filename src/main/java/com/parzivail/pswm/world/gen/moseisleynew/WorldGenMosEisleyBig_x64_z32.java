 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x64_z32
{
	public static void generate(World w, int i, int j, int k)
	{
		...
		m(w, i, j + 1, k + 11, 8);
		b(w, i, j + 1, k + 12, carpet, 0);
		m(w, i, j + 1, k + 12, 8);
		b(w, i, j + 1, k + 13, air, 0);
		b(w, i, j + 1, k + 14, air, 0);
		b(w, i, j + 1, k + 15, bed, 0);
		b(w, i, j + 2, k, air, 0);
		b(w, i, j + 2, k + 1, air, 0);
		b(w, i, j + 2, k + 2, air, 0);
		b(w, i, j + 2, k + 3, air, 0);
		...
		b(w, i, j + 8, k + 8, air, 0);
		b(w, i, j + 8, k + 9, air, 0);
		b(w, i, j + 8, k + 10, sandstone_stairs, 0);
		m(w, i, j + 8, k + 10, 2);
	...
	public static void generate_1(World w, int i, int j, int k)
	{
		...
		b(w, i + 1, j + 10, k + 12, stone_slab, 0);
		m(w, i + 1, j + 10, k + 12, 1);
		b(w, i + 1, j + 10, k + 13, stone_slab, 0);
		m(w, i + 1, j + 10, k + 13, 1);
		...
		b(w, i + 2, j + 4, k + 6, sandstone_stairs, 0);
		m(w, i + 2, j + 4, k + 6, 2);
	...
	public static void generate_2(World w, int i, int j, int k)
	{
		...
		b(w, i + 2, j + 10, k + 12, stone_slab, 0);
		m(w, i + 2, j + 10, k + 12, 1);
		b(w, i + 2, j + 10, k + 13, stone_slab, 0);
		m(w, i + 2, j + 10, k + 13, 1);
