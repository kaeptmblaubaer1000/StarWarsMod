 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x112_z144
{
	...
	public static void generate_7(World w, int i, int j, int k)
	{
		...
		m(w, i + 8, j + 1, k + 13, 2);
		b(w, i + 8, j + 1, k + 14, crafting_table, 0);
	...
	public static void generate_8(World w, int i, int j, int k)
	{
		...
		b(w, i + 9, j + 5, k + 14, sandstone_stairs, 0);
		m(w, i + 9, j + 5, k + 14, 2);
