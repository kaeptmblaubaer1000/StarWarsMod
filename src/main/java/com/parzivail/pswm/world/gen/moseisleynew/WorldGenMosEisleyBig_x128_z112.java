 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x128_z112
{
	public static void generate(World w, int i, int j, int k)
	{
		...
		b(w, i, j + 6, k + 3, air, 0);
		b(w, i, j + 6, k + 4, air, 0);
		b(w, i, j + 6, k + 5, sandstone_stairs, 0);
		m(w, i, j + 6, k + 5, 1);
		...
		b(w, i, j + 9, k + 7, air, 0);
		b(w, i, j + 9, k + 8, air, 0);
		b(w, i, j + 9, k + 9, sandstone_stairs, 0);
		m(w, i, j + 9, k + 9, 2);
		...
		b(w, i, j + 11, k + 12, sandstone_stairs, 0);
		m(w, i, j + 11, k + 12, 3);
		...
		m(w, i, j + 15, k + 7, 1);
		b(w, i, j + 15, k + 8, torch, 0);
		m(w, i, j + 15, k + 8, 2);
		b(w, i, j + 15, k + 9, air, 0);
		b(w, i, j + 15, k + 10, torch, 0);
		m(w, i, j + 15, k + 10, 2);
		b(w, i, j + 15, k + 11, sandstone, 0);
		m(w, i, j + 15, k + 11, 1);
		...
		b(w, i, j + 17, k + 10, sandstone, 0);
		b(w, i, j + 17, k + 11, sandstone, 0);
		m(w, i, j + 17, k + 11, 1);
	...
	public static void generate_1(World w, int i, int j, int k)
	{
		...
		b(w, i + 1, j + 11, k + 10, sandstone, 0);
		b(w, i + 1, j + 11, k + 11, sandstone, 0);
		...
		b(w, i + 1, j + 14, k + 8, sandstone, 0);
		m(w, i + 1, j + 14, k + 8, 1);
		b(w, i + 1, j + 14, k + 9, sandstone, 0);
		m(w, i + 1, j + 14, k + 9, 1);
		b(w, i + 1, j + 14, k + 10, sandstone, 0);
		m(w, i + 1, j + 14, k + 10, 1);
		...
		b(w, i + 1, j + 15, k + 8, sandstone, 0);
		m(w, i + 1, j + 15, k + 8, 1);
		b(w, i + 1, j + 15, k + 9, sandstone, 0);
		m(w, i + 1, j + 15, k + 9, 1);
		b(w, i + 1, j + 15, k + 10, sandstone, 0);
		m(w, i + 1, j + 15, k + 10, 1);
		...
		b(w, i + 1, j + 16, k + 8, sandstone, 0);
		m(w, i + 1, j + 16, k + 8, 1);
		b(w, i + 1, j + 16, k + 9, sandstone, 0);
		m(w, i + 1, j + 16, k + 9, 1);
		b(w, i + 1, j + 16, k + 10, sandstone, 0);
		m(w, i + 1, j + 16, k + 10, 1);
	...
	public static void generate_13(World w, int i, int j, int k)
	{
		...
		m(w, i + 15, j + 1, k, 9);
		b(w, i + 15, j + 1, k + 1, bed, 0);
		m(w, i + 15, j + 1, k + 1, 9);
		b(w, i + 15, j + 1, k + 2, chest, 0);
		m(w, i + 15, j + 1, k + 2, 5);
		b(w, i + 15, j + 1, k + 3, crafting_table, 0);
		b(w, i + 15, j + 1, k + 4, bed, 0);
		m(w, i + 15, j + 1, k + 4, 9);
		b(w, i + 15, j + 1, k + 5, bed, 0);
		m(w, i + 15, j + 1, k + 5, 9);
		b(w, i + 15, j + 1, k + 6, blockTable, 0);
		m(w, i + 15, j + 1, k + 6, 2);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 129, j + 1, k + 119);
		TileEntityChest chest1 = (TileEntityChest)w.getTileEntity(i + 129, j + 1, k + 118);
		TileEntityChest chest2 = (TileEntityChest)w.getTileEntity(i + 143, j + 1, k + 114);
	}
