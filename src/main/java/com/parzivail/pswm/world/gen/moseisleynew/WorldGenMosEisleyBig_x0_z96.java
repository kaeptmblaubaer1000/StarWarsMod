 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x0_z96
{
	...
	public static void generate_8(World w, int i, int j, int k)
	{
		...
		m(w, i + 9, j + 1, k + 5, 1);
		b(w, i + 9, j + 1, k + 6, stone_slab, 0);
		m(w, i + 9, j + 1, k + 6, 1);
		b(w, i + 9, j + 1, k + 7, stone_slab, 0);
		m(w, i + 9, j + 1, k + 7, 1);
		b(w, i + 9, j + 1, k + 8, stone_slab, 0);
		m(w, i + 9, j + 1, k + 8, 1);
		b(w, i + 9, j + 1, k + 9, stone_slab, 0);
		m(w, i + 9, j + 1, k + 9, 1);
		b(w, i + 9, j + 1, k + 10, stone_slab, 0);
		m(w, i + 9, j + 1, k + 10, 1);
		b(w, i + 9, j + 1, k + 11, stone_slab, 0);
		m(w, i + 9, j + 1, k + 11, 1);
	...
	public static void generate_9(World w, int i, int j, int k)
	{
		...
		m(w, i + 10, j + 1, k + 5, 1);
		b(w, i + 10, j + 1, k + 6, stone_slab, 0);
		m(w, i + 10, j + 1, k + 6, 1);
		b(w, i + 10, j + 1, k + 7, stone_slab, 0);
		m(w, i + 10, j + 1, k + 7, 1);
		b(w, i + 10, j + 1, k + 8, stone_slab, 0);
		m(w, i + 10, j + 1, k + 8, 1);
		b(w, i + 10, j + 1, k + 9, stone_slab, 0);
		m(w, i + 10, j + 1, k + 9, 1);
		b(w, i + 10, j + 1, k + 10, stone_slab, 0);
		m(w, i + 10, j + 1, k + 10, 1);
		b(w, i + 10, j + 1, k + 11, stone_slab, 0);
		m(w, i + 10, j + 1, k + 11, 1);
		...
		b(w, i + 10, j + 2, k + 12, stone_slab, 0);
		m(w, i + 10, j + 2, k + 12, 1);
		...
		b(w, i + 10, j + 3, k + 14, sandstone_stairs, 0);
		m(w, i + 10, j + 3, k + 14, 3);
	...
	public static void generate_10(World w, int i, int j, int k)
	{
		...
		b(w, i + 11, j + 2, k + 4, glass_pane, 0);
		b(w, i + 11, j + 2, k + 5, air, 0);
		b(w, i + 11, j + 2, k + 6, air, 0);
		b(w, i + 11, j + 2, k + 7, stone_slab, 0);
		m(w, i + 11, j + 2, k + 7, 1);
		b(w, i + 11, j + 2, k + 8, stone_slab, 0);
		m(w, i + 11, j + 2, k + 8, 1);
		b(w, i + 11, j + 2, k + 9, stone_slab, 0);
		m(w, i + 11, j + 2, k + 9, 1);
		b(w, i + 11, j + 2, k + 10, stone_slab, 0);
		m(w, i + 11, j + 2, k + 10, 1);
		b(w, i + 11, j + 2, k + 11, stone_slab, 0);
		m(w, i + 11, j + 2, k + 11, 1);
		b(w, i + 11, j + 2, k + 12, stone_slab, 0);
		m(w, i + 11, j + 2, k + 12, 1);
		...
		b(w, i + 11, j + 9, k + 8, sandstone_stairs, 0);
	...
	public static void generate_11(World w, int i, int j, int k)
	{
		...
		b(w, i + 12, j + 9, k + 10, sandstone_stairs, 0);
		m(w, i + 12, j + 9, k + 10, 3);
	...
	public static void generate_12(World w, int i, int j, int k)
	{
		...
		b(w, i + 13, j + 5, k, sandstone_stairs, 0);
		...
		b(w, i + 13, j + 8, k + 12, sandstone_stairs, 0);
		m(w, i + 13, j + 8, k + 12, 3);
		...
		b(w, i + 13, j + 10, k + 7, sandstone_stairs, 0);
		m(w, i + 13, j + 10, k + 7, 2);
		b(w, i + 13, j + 10, k + 8, sandstone, 0);
		b(w, i + 13, j + 10, k + 9, sandstone, 0);
		b(w, i + 13, j + 10, k + 10, sandstone_stairs, 0);
		m(w, i + 13, j + 10, k + 10, 3);
	...
	public static void generate_13(World w, int i, int j, int k)
	{
		...
		b(w, i + 14, j + 7, k + 13, sandstone_stairs, 0);
		m(w, i + 14, j + 7, k + 13, 3);
		...
		b(w, i + 14, j + 8, k + 5, sandstone_stairs, 0);
		m(w, i + 14, j + 8, k + 5, 2);
		...
		b(w, i + 14, j + 8, k + 12, sandstone_stairs, 0);
		m(w, i + 14, j + 8, k + 12, 3);
		...
		b(w, i + 14, j + 10, k + 7, sandstone_stairs, 0);
		m(w, i + 14, j + 10, k + 7, 2);
		b(w, i + 14, j + 10, k + 8, sandstone, 0);
		b(w, i + 14, j + 10, k + 9, sandstone, 0);
		b(w, i + 14, j + 10, k + 10, sandstone_stairs, 0);
		m(w, i + 14, j + 10, k + 10, 3);
		...
		m(w, i + 15, j + 1, k + 9, 3);
		b(w, i + 15, j + 1, k + 10, blockTable, 0);
		...
		b(w, i + 15, j + 3, k + 3, sandstone_stairs, 0);
		m(w, i + 15, j + 3, k + 3, 5);
		b(w, i + 15, j + 3, k + 4, sandstone_stairs, 0);
		m(w, i + 15, j + 3, k + 4, 5);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		b(w, i + 15, j + 7, k + 13, sandstone_stairs, 0);
		m(w, i + 15, j + 7, k + 13, 3);
		...
		b(w, i + 15, j + 9, k + 11, sandstone_stairs, 0);
		m(w, i + 15, j + 9, k + 11, 3);
