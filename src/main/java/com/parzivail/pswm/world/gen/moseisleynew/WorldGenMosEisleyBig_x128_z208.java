 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x128_z208
{
	public static void generate(World w, int i, int j, int k)
	{
		...
		b(w, i, j + 4, k + 1, sandstone_stairs, 0);
		m(w, i, j + 4, k + 1, 7);
		b(w, i, j + 4, k + 2, air, 0);
		b(w, i, j + 4, k + 3, air, 0);
		b(w, i, j + 4, k + 4, air, 0);
		...
		b(w, i, j + 5, k + 2, sandstone_stairs, 0);
		m(w, i, j + 5, k + 2, 7);
		b(w, i, j + 5, k + 3, stone_slab, 0);
		m(w, i, j + 5, k + 3, 9);
		b(w, i, j + 5, k + 4, stone_slab, 0);
		m(w, i, j + 5, k + 4, 9);
		b(w, i, j + 5, k + 5, sandstone_stairs, 0);
		m(w, i, j + 5, k + 5, 6);
	...
	public static void generate_2(World w, int i, int j, int k)
	{
		...
		b(w, i + 3, j + 1, k + 8, sandstone_stairs, 0);
		m(w, i + 3, j + 1, k + 8, 1);
	...
	public static void generate_3(World w, int i, int j, int k)
	{
		...
		b(w, i + 4, j + 4, k + 13, sandstone_stairs, 0);
	...
	public static void generate_4(World w, int i, int j, int k)
	{
		...
		b(w, i + 5, j + 4, k + 12, sandstone_stairs, 0);
		m(w, i + 5, j + 4, k + 12, 5);
	...
	public static void generate_5(World w, int i, int j, int k)
	{
		...
		b(w, i + 6, j + 4, k + 13, sandstone_stairs, 0);
		m(w, i + 6, j + 4, k + 13, 5);
		...
		b(w, i + 6, j + 5, k + 12, sandstone_stairs, 0);
		m(w, i + 6, j + 5, k + 12, 5);
	...
	public static void generate_7(World w, int i, int j, int k)
	{
		...
		b(w, i + 8, j + 1, k + 2, blockTable, 0);
		m(w, i + 8, j + 1, k + 2, 3);
		b(w, i + 8, j + 1, k + 3, air, 0);
		b(w, i + 8, j + 1, k + 4, air, 0);
		b(w, i + 8, j + 1, k + 5, blockTable, 0);
		m(w, i + 8, j + 1, k + 5, 3);
		b(w, i + 8, j + 1, k + 6, air, 0);
		b(w, i + 8, j + 1, k + 7, air, 0);
		b(w, i + 8, j + 1, k + 8, blockTable, 0);
		m(w, i + 8, j + 1, k + 8, 3);
	...
	public static void generate_8(World w, int i, int j, int k)
	{
		...
		b(w, i + 9, j + 4, k + 13, sandstone_stairs, 0);
		m(w, i + 9, j + 4, k + 13, 4);
	...
	public static void generate_9(World w, int i, int j, int k)
	{
		...
		b(w, i + 10, j + 1, k + 15, stone_slab, 0);
		m(w, i + 10, j + 1, k + 15, 1);
	...
	public static void generate_10(World w, int i, int j, int k)
	{
		...
		b(w, i + 11, j + 4, k + 13, sandstone_stairs, 0);
		m(w, i + 11, j + 4, k + 13, 1);
		b(w, i + 11, j + 4, k + 14, sandstone_stairs, 0);
		m(w, i + 11, j + 4, k + 14, 1);
	...
	public static void generate_11(World w, int i, int j, int k)
	{
		...
		b(w, i + 12, j + 2, k, stone_slab, 0);
		m(w, i + 12, j + 2, k, 1);
		b(w, i + 12, j + 2, k + 1, stone_slab, 0);
		m(w, i + 12, j + 2, k + 1, 1);
		b(w, i + 12, j + 2, k + 2, stone_slab, 0);
		m(w, i + 12, j + 2, k + 2, 1);
		b(w, i + 12, j + 2, k + 3, stone_slab, 0);
		m(w, i + 12, j + 2, k + 3, 1);
		b(w, i + 12, j + 2, k + 4, stone_slab, 0);
		m(w, i + 12, j + 2, k + 4, 1);
		b(w, i + 12, j + 2, k + 5, stone_slab, 0);
		m(w, i + 12, j + 2, k + 5, 1);
		b(w, i + 12, j + 2, k + 6, stone_slab, 0);
		m(w, i + 12, j + 2, k + 6, 1);
		b(w, i + 12, j + 2, k + 7, stone_slab, 0);
		m(w, i + 12, j + 2, k + 7, 1);
		b(w, i + 12, j + 2, k + 8, stone_slab, 0);
		m(w, i + 12, j + 2, k + 8, 1);
	...
	public static void generate_12(World w, int i, int j, int k)
	{
		...
		b(w, i + 13, j + 1, k, stone_slab, 0);
		m(w, i + 13, j + 1, k, 1);
		b(w, i + 13, j + 1, k + 1, stone_slab, 0);
		m(w, i + 13, j + 1, k + 1, 1);
		b(w, i + 13, j + 1, k + 2, stone_slab, 0);
		m(w, i + 13, j + 1, k + 2, 1);
		b(w, i + 13, j + 1, k + 3, stone_slab, 0);
		m(w, i + 13, j + 1, k + 3, 1);
		b(w, i + 13, j + 1, k + 4, stone_slab, 0);
		m(w, i + 13, j + 1, k + 4, 1);
		b(w, i + 13, j + 1, k + 5, stone_slab, 0);
		m(w, i + 13, j + 1, k + 5, 1);
		b(w, i + 13, j + 1, k + 6, stone_slab, 0);
		m(w, i + 13, j + 1, k + 6, 1);
		b(w, i + 13, j + 1, k + 7, stone_slab, 0);
		m(w, i + 13, j + 1, k + 7, 1);
		b(w, i + 13, j + 1, k + 8, stone_slab, 0);
		m(w, i + 13, j + 1, k + 8, 1);
		b(w, i + 13, j + 1, k + 9, stone_slab, 0);
		m(w, i + 13, j + 1, k + 9, 1);
		b(w, i + 13, j + 1, k + 10, stone_slab, 0);
		m(w, i + 13, j + 1, k + 10, 1);
	...
	{
		b(w, i + 14, j + 1, k + 1, stone_slab, 0);
		m(w, i + 14, j + 1, k + 1, 1);
		b(w, i + 14, j + 1, k + 2, stone_slab, 0);
		m(w, i + 14, j + 1, k + 2, 1);
		b(w, i + 14, j + 1, k + 3, stone_slab, 0);
		m(w, i + 14, j + 1, k + 3, 1);
		b(w, i + 14, j + 1, k + 4, stone_slab, 0);
		m(w, i + 14, j + 1, k + 4, 1);
		b(w, i + 14, j + 1, k + 5, stone_slab, 0);
		m(w, i + 14, j + 1, k + 5, 1);
		b(w, i + 14, j + 1, k + 6, stone_slab, 0);
		m(w, i + 14, j + 1, k + 6, 1);
		b(w, i + 14, j + 1, k + 7, stone_slab, 0);
		m(w, i + 14, j + 1, k + 7, 1);
		b(w, i + 14, j + 1, k + 8, stone_slab, 0);
		m(w, i + 14, j + 1, k + 8, 1);
		...
		b(w, i + 15, j + 1, k + 1, stone_slab, 0);
		m(w, i + 15, j + 1, k + 1, 1);
		b(w, i + 15, j + 1, k + 2, stone_slab, 0);
		m(w, i + 15, j + 1, k + 2, 1);
		b(w, i + 15, j + 1, k + 3, stone_slab, 0);
		m(w, i + 15, j + 1, k + 3, 1);
		b(w, i + 15, j + 1, k + 4, stone_slab, 0);
		m(w, i + 15, j + 1, k + 4, 1);
		b(w, i + 15, j + 1, k + 5, stone_slab, 0);
		m(w, i + 15, j + 1, k + 5, 1);
		b(w, i + 15, j + 1, k + 6, stone_slab, 0);
		m(w, i + 15, j + 1, k + 6, 1);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		b(w, i + 15, j + 4, k + 9, sandstone_stairs, 0);
		m(w, i + 15, j + 4, k + 9, 3);
