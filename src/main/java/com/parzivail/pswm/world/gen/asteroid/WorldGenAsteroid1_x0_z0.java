 ...
 */
//@formatter:off
public class WorldGenAsteroid1_x0_z0
{
	public static void generate(World w, int i, int j, int k)
	{
		...
		b(w, i, j + 12, k + 6, stone, 0);
		b(w, i, j + 12, k + 7, stone, 0);
		b(w, i, j + 12, k + 8, stone, 0);
		b(w, i, j + 12, k + 9, stone, 0);
		b(w, i, j + 12, k + 10, stone, 0);
		...
		b(w, i + 1, j + 13, k + 5, stone, 0);
		b(w, i + 1, j + 13, k + 6, stone, 0);
	...
	public static void generate_1(World w, int i, int j, int k)
	{
		...
		b(w, i + 3, j + 1, k + 9, stone, 0);
		b(w, i + 3, j + 1, k + 10, stone, 0);
		...
		b(w, i + 4, j + 1, k + 10, stone, 0);
		b(w, i + 4, j + 1, k + 11, stone, 0);
	...
	public static void generate_2(World w, int i, int j, int k)
	{
		...
		b(w, i + 5, j, k + 8, stone, 0);
		b(w, i + 5, j, k + 9, stone, 0);
		b(w, i + 5, j, k + 10, stone, 0);
	...
	public static void generate_4(World w, int i, int j, int k)
	{
		...
		b(w, i + 9, j + 12, k + 1, stone, 0);
		b(w, i + 9, j + 12, k + 2, stone, 0);
	...
	public static void generate_7(World w, int i, int j, int k)
	{
		...
		b(w, i + 14, j + 10, k + 11, stone, 0);
		b(w, i + 14, j + 10, k + 12, stone, 0);
