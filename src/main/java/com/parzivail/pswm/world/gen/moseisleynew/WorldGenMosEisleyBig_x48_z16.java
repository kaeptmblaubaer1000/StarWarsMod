 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x48_z16
{
	...
	public static void generate_5(World w, int i, int j, int k)
	{
		...
		b(w, i + 6, j + 1, k + 8, chest, 0);
		m(w, i + 6, j + 1, k + 8, 5);
		b(w, i + 6, j + 1, k + 9, chest, 0);
		m(w, i + 6, j + 1, k + 9, 5);
	...
	public static void generate_6(World w, int i, int j, int k)
	{
		...
		b(w, i + 7, j + 5, k + 6, sandstone_stairs, 0);
		m(w, i + 7, j + 5, k + 6, 3);
		...
		b(w, i + 7, j + 9, k + 6, sandstone_stairs, 0);
		m(w, i + 7, j + 9, k + 6, 3);
	...
	public static void generate_7(World w, int i, int j, int k)
	{
		...
		b(w, i + 8, j + 2, k + 5, sandstone_stairs, 0);
		...
		b(w, i + 8, j + 8, k + 7, sandstone_stairs, 0);
		m(w, i + 8, j + 8, k + 7, 1);
		...
		b(w, i + 8, j + 12, k + 7, sandstone_stairs, 0);
		m(w, i + 8, j + 12, k + 7, 1);
	...
	public static void generate_8(World w, int i, int j, int k)
	{
		...
		b(w, i + 8, j + 19, k + 5, sandstone, 0);
		b(w, i + 8, j + 19, k + 6, sandstone, 0);
		b(w, i + 8, j + 19, k + 7, sandstone, 0);
		...
		m(w, i + 9, j + 15, k + 4, 1);
		b(w, i + 9, j + 15, k + 5, torch, 0);
		m(w, i + 9, j + 15, k + 5, 2);
		b(w, i + 9, j + 15, k + 6, air, 0);
		b(w, i + 9, j + 15, k + 7, torch, 0);
		m(w, i + 9, j + 15, k + 7, 2);
	...
	public static void generate_9(World w, int i, int j, int k)
	{
		...
		m(w, i + 10, j + 1, k + 4, 10);
		b(w, i + 10, j + 1, k + 5, bed, 0);
		m(w, i + 10, j + 1, k + 5, 2);
		b(w, i + 10, j + 1, k + 6, air, 0);
		b(w, i + 10, j + 1, k + 7, air, 0);
		b(w, i + 10, j + 1, k + 8, furnace, 0);
		m(w, i + 10, j + 1, k + 8, 4);
		b(w, i + 10, j + 1, k + 9, crafting_table, 0);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 54, j + 1, k + 24);
		TileEntityChest chest1 = (TileEntityChest)w.getTileEntity(i + 54, j + 1, k + 25);
	}
