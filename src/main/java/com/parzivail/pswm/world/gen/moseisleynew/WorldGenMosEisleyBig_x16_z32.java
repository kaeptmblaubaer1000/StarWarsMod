 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x16_z32
{
	...
	public static void generate_9(World w, int i, int j, int k)
	{
		...
		b(w, i + 10, j + 2, k + 13, glass_pane, 0);
		...
		b(w, i + 10, j + 3, k + 13, glass_pane, 0);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 17, j + 1, k + 36);
	}
