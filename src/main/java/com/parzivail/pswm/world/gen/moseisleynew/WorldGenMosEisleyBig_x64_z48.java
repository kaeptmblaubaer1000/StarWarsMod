 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x64_z48
{
	...
	public static void generate_1(World w, int i, int j, int k)
	{
		...
		b(w, i + 2, j + 1, k, crafting_table, 0);
	...
	public static void generate_2(World w, int i, int j, int k)
	{
		...
		b(w, i + 3, j + 3, k + 2, sandstone_stairs, 0);
		m(w, i + 3, j + 3, k + 2, 3);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 65, j + 1, k + 48);
		TileEntityChest chest1 = (TileEntityChest)w.getTileEntity(i + 70, j + 1, k + 62);
		TileEntityChest chest2 = (TileEntityChest)w.getTileEntity(i + 69, j + 1, k + 62);
	}
