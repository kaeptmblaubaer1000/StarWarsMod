 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x128_z240
{
	...
	public static void generate_2(World w, int i, int j, int k)
	{
		...
		b(w, i + 3, j + 3, k + 5, torch, 0);
		m(w, i + 3, j + 3, k + 5, 1);
		b(w, i + 3, j + 3, k + 6, air, 0);
		b(w, i + 3, j + 3, k + 7, air, 0);
		b(w, i + 3, j + 3, k + 8, torch, 0);
		m(w, i + 3, j + 3, k + 8, 1);
	...
	public static void generate_4(World w, int i, int j, int k)
	{
		...
		b(w, i + 5, j + 1, k, blockTatooineSand, 0);
	...
	public static void generate_5(World w, int i, int j, int k)
	{
		...
		b(w, i + 6, j + 1, k, blockTatooineSand, 0);
		...
		b(w, i + 6, j + 1, k + 6, blockTable, 0);
		b(w, i + 6, j + 1, k + 7, blockTable, 0);
	...
	public static void generate_6(World w, int i, int j, int k)
	{
		...
		b(w, i + 7, j + 1, k, blockTatooineSand, 0);
		...
		b(w, i + 7, j + 1, k + 6, blockTable, 0);
		b(w, i + 7, j + 1, k + 7, blockTable, 0);
	...
	public static void generate_7(World w, int i, int j, int k)
	{
		...
		b(w, i + 8, j + 1, k, blockTatooineSand, 0);
	...
	public static void generate_12(World w, int i, int j, int k)
	{
		...
		b(w, i + 13, j + 2, k + 13, stone_slab, 0);
		m(w, i + 13, j + 2, k + 13, 1);
		b(w, i + 13, j + 2, k + 14, stone_slab, 0);
		m(w, i + 13, j + 2, k + 14, 1);
		b(w, i + 13, j + 2, k + 15, stone_slab, 0);
		m(w, i + 13, j + 2, k + 15, 1);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		b(w, i + 15, j + 4, k + 11, sandstone_stairs, 0);
		m(w, i + 15, j + 4, k + 11, 5);
