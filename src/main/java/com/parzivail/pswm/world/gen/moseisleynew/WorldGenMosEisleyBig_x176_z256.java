...
public class WorldGenMosEisleyBig_x176_z256
{
	...
	public static void generate_4(World w, int i, int j, int k)
	{
		...
		b(w, i + 5, j + 4, k + 9, sandstone_stairs, 0);
		m(w, i + 5, j + 4, k + 9, 5);
		...
		b(w, i + 5, j + 8, k + 3, sandstone_stairs, 0);
		...
		b(w, i + 5, j + 9, k + 4, sandstone_stairs, 0);
	...
	public static void generate_5(World w, int i, int j, int k)
	{
		...
		b(w, i + 6, j + 4, k + 9, stone_slab, 0);
		m(w, i + 6, j + 4, k + 9, 9);
		b(w, i + 6, j + 4, k + 10, sandstone, 0);
		b(w, i + 6, j + 4, k + 11, stone_slab, 0);
		m(w, i + 6, j + 4, k + 11, 1);
		...
		b(w, i + 6, j + 8, k + 7, sandstone_stairs, 0);
		m(w, i + 6, j + 8, k + 7, 3);
	...
	public static void generate_6(World w, int i, int j, int k)
	{
		...
		b(w, i + 7, j + 1, k + 1, crafting_table, 0);
	...
	public static void generate_8(World w, int i, int j, int k)
	{
		...
		b(w, i + 9, j + 1, k + 1, bed, 0);
		m(w, i + 9, j + 1, k + 1, 10);
		b(w, i + 9, j + 1, k + 2, bed, 0);
		m(w, i + 9, j + 1, k + 2, 2);
		...
		b(w, i + 9, j + 8, k + 7, sandstone_stairs, 0);
		m(w, i + 9, j + 8, k + 7, 3);
	...
	public static void generate_9(World w, int i, int j, int k)
	{
		...
		b(w, i + 10, j + 9, k + 4, sandstone_stairs, 0);
		m(w, i + 10, j + 9, k + 4, 1);
	...
	public static void generate_10(World w, int i, int j, int k)
	{
		...
		b(w, i + 11, j + 1, k + 7, jukebox, 0);
		b(w, i + 11, j + 1, k + 8, chest, 0);
		m(w, i + 11, j + 1, k + 8, 4);
	...
	public static void generate_12(World w, int i, int j, int k)
	{
		...
		b(w, i + 13, j + 3, k + 3, sandstone_stairs, 0);
		m(w, i + 13, j + 3, k + 3, 1);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 184, j + 1, k + 257);
		TileEntityChest chest1 = (TileEntityChest)w.getTileEntity(i + 187, j + 1, k + 264);
	}
