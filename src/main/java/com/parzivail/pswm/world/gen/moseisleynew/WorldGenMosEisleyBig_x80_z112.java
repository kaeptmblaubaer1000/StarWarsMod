...
public class WorldGenMosEisleyBig_x80_z112
{
	...
	public static void generate_1(World w, int i, int j, int k)
	{
		...
		b(w, i + 1, j + 13, k + 6, sandstone, 0);
		b(w, i + 1, j + 13, k + 7, sandstone, 0);
	...
	public static void generate_3(World w, int i, int j, int k)
	{
		...
		b(w, i + 3, j + 12, k + 5, sandstone, 0);
		b(w, i + 3, j + 12, k + 6, sandstone, 0);
	...
	public static void generate_5(World w, int i, int j, int k)
	{
		...
		b(w, i + 6, j + 9, k + 7, torch, 0);
		m(w, i + 6, j + 9, k + 7, 2);
		b(w, i + 6, j + 9, k + 8, air, 0);
		b(w, i + 6, j + 9, k + 9, air, 0);
		b(w, i + 6, j + 9, k + 10, torch, 0);
		m(w, i + 6, j + 9, k + 10, 2);
	...
	public static void generate_7(World w, int i, int j, int k)
	{
		...
		m(w, i + 8, j + 6, k + 13, 5);
		b(w, i + 8, j + 6, k + 14, sandstone_stairs, 0);
		m(w, i + 8, j + 6, k + 14, 5);
