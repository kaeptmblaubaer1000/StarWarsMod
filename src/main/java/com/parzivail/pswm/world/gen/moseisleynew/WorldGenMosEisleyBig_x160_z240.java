...
public class WorldGenMosEisleyBig_x160_z240
{
	public static void generate(World w, int i, int j, int k)
	{
		...
		m(w, i, j + 4, k + 13, 2);
		b(w, i, j + 4, k + 14, sandstone_stairs, 0);
		m(w, i, j + 4, k + 14, 7);
		b(w, i, j + 4, k + 15, stone_slab, 0);
		m(w, i, j + 4, k + 15, 9);
	...
	public static void generate_1(World w, int i, int j, int k)
	{
		...
		b(w, i + 1, j + 4, k + 13, sandstone_stairs, 0);
		m(w, i + 1, j + 4, k + 13, 7);
	...
	public static void generate_5(World w, int i, int j, int k)
	{
		...
		b(w, i + 6, j + 1, k + 10, crafting_table, 0);
	...
	public static void generate_6(World w, int i, int j, int k)
	{
		...
		b(w, i + 7, j + 1, k + 10, furnace, 0);
		m(w, i + 7, j + 1, k + 10, 3);
		b(w, i + 7, j + 1, k + 11, air, 0);
		b(w, i + 7, j + 1, k + 12, sandstone_stairs, 0);
		m(w, i + 7, j + 1, k + 12, 3);
		b(w, i + 7, j + 1, k + 13, air, 0);
		b(w, i + 7, j + 1, k + 14, blockTable, 0);
		m(w, i + 7, j + 1, k + 14, 3);
		b(w, i + 7, j + 1, k + 15, blockTable, 0);
		m(w, i + 7, j + 1, k + 15, 3);
	...
	public static void generate_7(World w, int i, int j, int k)
	{
		...
		b(w, i + 8, j + 1, k + 14, blockTable, 0);
		m(w, i + 8, j + 1, k + 14, 3);
		b(w, i + 8, j + 1, k + 15, blockTable, 0);
		m(w, i + 8, j + 1, k + 15, 3);
	...
	public static void generate_10(World w, int i, int j, int k)
	{
		...
		b(w, i + 11, j + 3, k + 1, sandstone_stairs, 0);
		m(w, i + 11, j + 3, k + 1, 7);
		b(w, i + 11, j + 3, k + 2, air, 0);
		b(w, i + 11, j + 3, k + 3, air, 0);
		b(w, i + 11, j + 3, k + 4, sandstone_stairs, 0);
		m(w, i + 11, j + 3, k + 4, 6);
	...
	public static void generate_12(World w, int i, int j, int k)
	{
		...
		b(w, i + 13, j + 8, k + 2, sandstone_stairs, 0);
		b(w, i + 13, j + 8, k + 3, sandstone_stairs, 0);
	...
	public static void generate_13(World w, int i, int j, int k)
	{
		...
		b(w, i + 14, j + 1, k + 2, carpet, 0);
		m(w, i + 14, j + 1, k + 2, 8);
		b(w, i + 14, j + 1, k + 3, carpet, 0);
		m(w, i + 14, j + 1, k + 3, 8);
		b(w, i + 14, j + 1, k + 4, air, 0);
		b(w, i + 14, j + 1, k + 5, air, 0);
		b(w, i + 14, j + 1, k + 6, jukebox, 0);
		...
		b(w, i + 14, j + 9, k + 2, sandstone_stairs, 0);
		b(w, i + 14, j + 9, k + 3, sandstone_stairs, 0);
		...
		b(w, i + 15, j + 1, k + 1, carpet, 0);
		m(w, i + 15, j + 1, k + 1, 8);
		b(w, i + 15, j + 1, k + 2, carpet, 0);
		m(w, i + 15, j + 1, k + 2, 8);
		b(w, i + 15, j + 1, k + 3, carpet, 0);
		m(w, i + 15, j + 1, k + 3, 8);
		b(w, i + 15, j + 1, k + 4, carpet, 0);
		m(w, i + 15, j + 1, k + 4, 8);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		b(w, i + 15, j + 3, k + 8, sandstone_stairs, 0);
		m(w, i + 15, j + 3, k + 8, 3);
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 173, j + 1, k + 246);
	}
