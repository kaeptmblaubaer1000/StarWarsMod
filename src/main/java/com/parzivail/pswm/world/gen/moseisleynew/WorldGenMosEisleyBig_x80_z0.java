...
public class WorldGenMosEisleyBig_x80_z0
{
	...
	public static void generate_5(World w, int i, int j, int k)
	{
		...
		b(w, i + 6, j + 9, k + 13, sandstone_stairs, 0);
	...
	public static void generate_7(World w, int i, int j, int k)
	{
		...
		b(w, i + 8, j + 1, k + 9, crafting_table, 0);
		b(w, i + 8, j + 1, k + 10, air, 0);
		b(w, i + 8, j + 1, k + 11, air, 0);
		b(w, i + 8, j + 1, k + 12, carpet, 0);
		m(w, i + 8, j + 1, k + 12, 8);
		...
		b(w, i + 8, j + 10, k + 12, stone_slab, 0);
		m(w, i + 8, j + 10, k + 12, 1);
		b(w, i + 8, j + 10, k + 13, stone_slab, 0);
		m(w, i + 8, j + 10, k + 13, 1);
	...
	public static void generate_8(World w, int i, int j, int k)
	{
		...
		b(w, i + 9, j + 1, k + 12, carpet, 0);
		m(w, i + 9, j + 1, k + 12, 8);
		b(w, i + 9, j + 1, k + 13, carpet, 0);
		m(w, i + 9, j + 1, k + 13, 8);
		...
		b(w, i + 9, j + 10, k + 12, stone_slab, 0);
		m(w, i + 9, j + 10, k + 12, 1);
		b(w, i + 9, j + 10, k + 13, stone_slab, 0);
		m(w, i + 9, j + 10, k + 13, 1);
	...
	public static void generate_9(World w, int i, int j, int k)
	{
		...
		b(w, i + 10, j + 1, k + 13, carpet, 0);
		m(w, i + 10, j + 1, k + 13, 8);
		b(w, i + 10, j + 1, k + 14, carpet, 0);
		m(w, i + 10, j + 1, k + 14, 8);
	...
	public static void generate_10(World w, int i, int j, int k)
	{
		...
		b(w, i + 11, j + 9, k + 12, sandstone_stairs, 0);
		m(w, i + 11, j + 9, k + 12, 1);
	...
	public static void generate_13(World w, int i, int j, int k)
	{
		...
		b(w, i + 14, j + 3, k + 14, sandstone_stairs, 0);
		m(w, i + 14, j + 3, k + 14, 1);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 89, j + 1, k + 9);
	}
