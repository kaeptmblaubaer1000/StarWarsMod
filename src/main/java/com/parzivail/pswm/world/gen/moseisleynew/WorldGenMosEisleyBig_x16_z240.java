 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x16_z240
{
	public static void generate(World w, int i, int j, int k)
	{
		...
		b(w, i, j + 10, k + 15, sandstone_stairs, 0);
		m(w, i, j + 10, k + 15, 1);
		b(w, i, j + 11, k, air, 0);
	...
	public static void generate_1(World w, int i, int j, int k)
	{
		...
		b(w, i + 1, j + 9, k + 14, sandstone_stairs, 0);
		m(w, i + 1, j + 9, k + 14, 4);
		b(w, i + 1, j + 9, k + 15, sandstone_stairs, 0);
		m(w, i + 1, j + 9, k + 15, 1);
		...
		b(w, i + 1, j + 13, k + 2, sandstone, 0);
		b(w, i + 1, j + 13, k + 3, glass, 0);
		b(w, i + 1, j + 13, k + 4, glass, 0);
		b(w, i + 1, j + 13, k + 5, glass, 0);
		b(w, i + 1, j + 13, k + 6, glass, 0);
		b(w, i + 1, j + 13, k + 7, glass, 0);
		b(w, i + 1, j + 13, k + 8, glass, 0);
		b(w, i + 1, j + 13, k + 9, sandstone, 0);
		b(w, i + 1, j + 13, k + 10, sandstone, 0);
		b(w, i + 1, j + 13, k + 11, sandstone, 0);
	...
	public static void generate_2(World w, int i, int j, int k)
	{
		...
		b(w, i + 2, j + 8, k + 14, sandstone_stairs, 0);
		m(w, i + 2, j + 8, k + 14, 4);
		b(w, i + 2, j + 8, k + 15, sandstone_stairs, 0);
		m(w, i + 2, j + 8, k + 15, 1);
		b(w, i + 2, j + 9, k, air, 0);
		...
		b(w, i + 2, j + 10, k + 13, sandstone_stairs, 0);
		m(w, i + 2, j + 10, k + 13, 4);
		...
		b(w, i + 2, j + 13, k + 3, glass, 0);
		b(w, i + 2, j + 13, k + 4, glass, 0);
		b(w, i + 2, j + 13, k + 5, glass, 0);
	...
	public static void generate_3(World w, int i, int j, int k)
	{
		...
		b(w, i + 3, j + 12, k + 11, sandstone, 0);
		b(w, i + 3, j + 12, k + 12, sandstone, 0);
		...
		b(w, i + 3, j + 13, k + 5, glass, 0);
		b(w, i + 3, j + 13, k + 6, glass, 0);
		b(w, i + 3, j + 13, k + 7, sandstone, 0);
	...
	public static void generate_4(World w, int i, int j, int k)
	{
		...
		b(w, i + 5, j + 7, k + 14, sandstone_stairs, 0);
		m(w, i + 5, j + 7, k + 14, 1);
		...
		b(w, i + 5, j + 8, k + 14, stone_slab, 0);
		m(w, i + 5, j + 8, k + 14, 1);
		b(w, i + 5, j + 8, k + 15, stone_slab, 0);
		m(w, i + 5, j + 8, k + 15, 1);
		b(w, i + 5, j + 9, k, air, 0);
	...
	public static void generate_6(World w, int i, int j, int k)
	{
		...
		b(w, i + 7, j + 7, k + 14, sandstone_stairs, 0);
		m(w, i + 7, j + 7, k + 14, 3);
		b(w, i + 7, j + 7, k + 15, blockTable, 0);
	...
	public static void generate_7(World w, int i, int j, int k)
	{
		...
		b(w, i + 8, j + 9, k + 4, torch, 0);
		m(w, i + 8, j + 9, k + 4, 2);
		b(w, i + 8, j + 9, k + 5, air, 0);
		b(w, i + 8, j + 9, k + 6, air, 0);
		b(w, i + 8, j + 9, k + 7, torch, 0);
		m(w, i + 8, j + 9, k + 7, 2);
	...
	public static void generate_9(World w, int i, int j, int k)
	{
		...
		b(w, i + 10, j + 4, k + 4, sandstone_stairs, 0);
		m(w, i + 10, j + 4, k + 4, 1);
		...
		b(w, i + 10, j + 4, k + 11, sandstone_stairs, 0);
		m(w, i + 10, j + 4, k + 11, 1);
		...
		b(w, i + 10, j + 6, k + 9, sandstone_stairs, 0);
		m(w, i + 10, j + 6, k + 9, 5);
		b(w, i + 10, j + 6, k + 10, sandstone_stairs, 0);
		m(w, i + 10, j + 6, k + 10, 5);
		b(w, i + 10, j + 6, k + 11, sandstone_stairs, 0);
		m(w, i + 10, j + 6, k + 11, 5);
		b(w, i + 10, j + 6, k + 12, sandstone_stairs, 0);
		m(w, i + 10, j + 6, k + 12, 5);
		b(w, i + 10, j + 6, k + 13, sandstone_stairs, 0);
		m(w, i + 10, j + 6, k + 13, 5);
		b(w, i + 10, j + 6, k + 14, sandstone_stairs, 0);
		m(w, i + 10, j + 6, k + 14, 5);
		b(w, i + 10, j + 6, k + 15, sandstone_stairs, 0);
		m(w, i + 10, j + 6, k + 15, 5);
		...
		m(w, i + 10, j + 7, k + 10, 1);
		b(w, i + 10, j + 7, k + 11, stone_slab, 0);
		m(w, i + 10, j + 7, k + 11, 1);
		b(w, i + 10, j + 7, k + 12, stone_slab, 0);
		m(w, i + 10, j + 7, k + 12, 1);
		b(w, i + 10, j + 7, k + 13, stone_slab, 0);
		m(w, i + 10, j + 7, k + 13, 1);
		b(w, i + 10, j + 7, k + 14, stone_slab, 0);
		m(w, i + 10, j + 7, k + 14, 1);
		b(w, i + 10, j + 7, k + 15, stone_slab, 0);
		m(w, i + 10, j + 7, k + 15, 1);
