...
public class WorldGenMosEisleyBig_x160_z16
{
	public static void generate(World w, int i, int j, int k)
	{
		...
		b(w, i, j + 7, k + 8, sandstone_stairs, 0);
		m(w, i, j + 7, k + 8, 3);
		b(w, i, j + 7, k + 9, air, 0);
		...
		b(w, i, j + 9, k, air, 0);
		b(w, i, j + 9, k + 1, sandstone_stairs, 0);
		m(w, i, j + 9, k + 1, 2);
	...
	public static void generate_1(World w, int i, int j, int k)
	{
		...
		b(w, i + 1, j + 7, k + 8, sandstone_stairs, 0);
		m(w, i + 1, j + 7, k + 8, 3);
	...
	public static void generate_2(World w, int i, int j, int k)
	{
		...
		m(w, i + 2, j + 7, k, 1);
		b(w, i + 2, j + 7, k + 1, sandstone_stairs, 0);
		m(w, i + 2, j + 7, k + 1, 1);
		b(w, i + 2, j + 7, k + 2, sandstone_stairs, 0);
		m(w, i + 2, j + 7, k + 2, 1);
		b(w, i + 2, j + 7, k + 3, sandstone_stairs, 0);
		m(w, i + 2, j + 7, k + 3, 1);
		b(w, i + 2, j + 7, k + 4, sandstone_stairs, 0);
		m(w, i + 2, j + 7, k + 4, 1);
		b(w, i + 2, j + 7, k + 5, sandstone_stairs, 0);
		m(w, i + 2, j + 7, k + 5, 1);
		b(w, i + 2, j + 7, k + 6, sandstone_stairs, 0);
		m(w, i + 2, j + 7, k + 6, 1);
		b(w, i + 2, j + 7, k + 7, sandstone_stairs, 0);
		m(w, i + 2, j + 7, k + 7, 1);
	...
	public static void generate_12(World w, int i, int j, int k)
	{
		...
		m(w, i + 13, j + 15, k + 14, 1);
		b(w, i + 13, j + 15, k + 15, torch, 0);
		m(w, i + 13, j + 15, k + 15, 3);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		b(w, i + 15, j + 11, k + 13, sandstone_stairs, 0);
		m(w, i + 15, j + 11, k + 13, 2);
		...
		b(w, i + 15, j + 14, k + 14, sandstone, 0);
		m(w, i + 15, j + 14, k + 14, 1);
		...
		b(w, i + 15, j + 15, k + 14, sandstone, 0);
		m(w, i + 15, j + 15, k + 14, 1);
		b(w, i + 15, j + 15, k + 15, torch, 0);
		m(w, i + 15, j + 15, k + 15, 3);
		...
		b(w, i + 15, j + 16, k + 14, sandstone, 0);
		m(w, i + 15, j + 16, k + 14, 1);
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 161, j + 1, k + 18);
	}
