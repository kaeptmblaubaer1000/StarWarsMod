 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x112_z192
{
	...
	public static void generate_1(World w, int i, int j, int k)
	{
		...
		m(w, i + 1, j + 9, k + 7, 1);
		b(w, i + 1, j + 9, k + 8, sandstone_stairs, 0);
		m(w, i + 1, j + 9, k + 8, 1);
	...
	public static void generate_4(World w, int i, int j, int k)
	{
		...
		m(w, i + 5, j + 3, k + 7, 7);
		b(w, i + 5, j + 3, k + 8, sandstone_stairs, 0);
		m(w, i + 5, j + 3, k + 8, 6);
	...
	public static void generate_13(World w, int i, int j, int k)
	{
		...
		b(w, i + 14, j + 2, k + 14, sandstone_stairs, 0);
		m(w, i + 14, j + 2, k + 14, 3);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 114, j + 1, k + 196);
	}
