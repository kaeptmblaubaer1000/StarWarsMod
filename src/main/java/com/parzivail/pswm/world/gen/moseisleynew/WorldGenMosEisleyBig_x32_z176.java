 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x32_z176
{
	...
	public static void generate_11(World w, int i, int j, int k)
	{
		...
		b(w, i + 12, j + 5, k + 15, sandstone_stairs, 0);
		m(w, i + 12, j + 5, k + 15, 2);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		b(w, i + 15, j + 11, k + 14, sandstone_stairs, 0);
		m(w, i + 15, j + 11, k + 14, 2);
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 45, j + 1, k + 191);
		TileEntityChest chest1 = (TileEntityChest)w.getTileEntity(i + 46, j + 1, k + 191);
	}
