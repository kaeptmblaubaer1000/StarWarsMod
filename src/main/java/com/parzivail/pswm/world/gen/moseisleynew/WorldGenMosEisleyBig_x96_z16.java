...
public class WorldGenMosEisleyBig_x96_z16
{
	...
	public static void generate_2(World w, int i, int j, int k)
	{
		...
		b(w, i + 3, j + 3, k + 3, sandstone_stairs, 0);
	...
	public static void generate_5(World w, int i, int j, int k)
	{
		...
		b(w, i + 6, j + 1, k + 1, bed, 0);
		m(w, i + 6, j + 1, k + 1, 10);
		b(w, i + 6, j + 1, k + 2, bed, 0);
		m(w, i + 6, j + 1, k + 2, 2);
		...
		b(w, i + 6, j + 8, k + 3, sandstone_stairs, 0);
		b(w, i + 6, j + 8, k + 4, sandstone, 0);
		b(w, i + 6, j + 8, k + 5, sandstone, 0);
		b(w, i + 6, j + 8, k + 6, sandstone_stairs, 0);
		...
		b(w, i + 6, j + 9, k + 4, sandstone_stairs, 0);
	...
	public static void generate_6(World w, int i, int j, int k)
	{
		...
		b(w, i + 7, j + 1, k + 1, bed, 0);
		m(w, i + 7, j + 1, k + 1, 10);
		b(w, i + 7, j + 1, k + 2, bed, 0);
		m(w, i + 7, j + 1, k + 2, 2);
		b(w, i + 7, j + 1, k + 3, air, 0);
		b(w, i + 7, j + 1, k + 4, air, 0);
		b(w, i + 7, j + 1, k + 5, carpet, 0);
		m(w, i + 7, j + 1, k + 5, 8);
		b(w, i + 7, j + 1, k + 6, carpet, 0);
		m(w, i + 7, j + 1, k + 6, 8);
		...
		b(w, i + 7, j + 4, k + 9, stone_slab, 0);
		m(w, i + 7, j + 4, k + 9, 9);
		b(w, i + 7, j + 4, k + 10, sandstone, 0);
		b(w, i + 7, j + 4, k + 11, stone_slab, 0);
		m(w, i + 7, j + 4, k + 11, 1);
		...
		b(w, i + 7, j + 8, k + 2, sandstone_stairs, 0);
		m(w, i + 7, j + 8, k + 2, 2);
	...
	public static void generate_7(World w, int i, int j, int k)
	{
		...
		b(w, i + 8, j + 1, k + 1, crafting_table, 0);
		b(w, i + 8, j + 1, k + 2, air, 0);
		b(w, i + 8, j + 1, k + 3, air, 0);
		b(w, i + 8, j + 1, k + 4, carpet, 0);
		m(w, i + 8, j + 1, k + 4, 8);
		b(w, i + 8, j + 1, k + 5, carpet, 0);
		m(w, i + 8, j + 1, k + 5, 8);
		b(w, i + 8, j + 1, k + 6, carpet, 0);
		m(w, i + 8, j + 1, k + 6, 8);
		b(w, i + 8, j + 1, k + 7, carpet, 0);
		m(w, i + 8, j + 1, k + 7, 8);
		...
		b(w, i + 8, j + 9, k + 2, sandstone_stairs, 0);
		m(w, i + 8, j + 9, k + 2, 2);
		...
		b(w, i + 8, j + 10, k + 4, stone_slab, 0);
		m(w, i + 8, j + 10, k + 4, 1);
		b(w, i + 8, j + 10, k + 5, stone_slab, 0);
		m(w, i + 8, j + 10, k + 5, 1);
	...
	public static void generate_8(World w, int i, int j, int k)
	{
		...
		b(w, i + 9, j + 1, k + 1, chest, 0);
		m(w, i + 9, j + 1, k + 1, 3);
		b(w, i + 9, j + 1, k + 2, air, 0);
		b(w, i + 9, j + 1, k + 3, air, 0);
		b(w, i + 9, j + 1, k + 4, carpet, 0);
		m(w, i + 9, j + 1, k + 4, 8);
		b(w, i + 9, j + 1, k + 5, carpet, 0);
		m(w, i + 9, j + 1, k + 5, 8);
		b(w, i + 9, j + 1, k + 6, carpet, 0);
		m(w, i + 9, j + 1, k + 6, 8);
		b(w, i + 9, j + 1, k + 7, carpet, 0);
		m(w, i + 9, j + 1, k + 7, 8);
		...
		b(w, i + 9, j + 4, k + 9, stone_slab, 0);
		m(w, i + 9, j + 4, k + 9, 9);
		b(w, i + 9, j + 4, k + 10, sandstone, 0);
		b(w, i + 9, j + 4, k + 11, sandstone_stairs, 0);
		m(w, i + 9, j + 4, k + 11, 3);
		...
		b(w, i + 9, j + 8, k + 8, sandstone_stairs, 0);
		m(w, i + 9, j + 8, k + 8, 3);
		...
		b(w, i + 9, j + 9, k + 7, sandstone_stairs, 0);
		m(w, i + 9, j + 9, k + 7, 3);
		...
		b(w, i + 9, j + 10, k + 4, stone_slab, 0);
		m(w, i + 9, j + 10, k + 4, 1);
		b(w, i + 9, j + 10, k + 5, stone_slab, 0);
		m(w, i + 9, j + 10, k + 5, 1);
	...
	public static void generate_9(World w, int i, int j, int k)
	{
		...
		b(w, i + 10, j + 1, k + 1, bed, 0);
		m(w, i + 10, j + 1, k + 1, 10);
		b(w, i + 10, j + 1, k + 2, bed, 0);
		m(w, i + 10, j + 1, k + 2, 2);
		b(w, i + 10, j + 1, k + 3, air, 0);
		b(w, i + 10, j + 1, k + 4, air, 0);
		b(w, i + 10, j + 1, k + 5, carpet, 0);
		m(w, i + 10, j + 1, k + 5, 8);
		b(w, i + 10, j + 1, k + 6, carpet, 0);
		m(w, i + 10, j + 1, k + 6, 8);
		...
		b(w, i + 10, j + 3, k + 10, sandstone_stairs, 0);
		m(w, i + 10, j + 3, k + 10, 4);
		...
		b(w, i + 10, j + 4, k + 9, stone_slab, 0);
		m(w, i + 10, j + 4, k + 9, 9);
		b(w, i + 10, j + 4, k + 10, sandstone, 0);
		b(w, i + 10, j + 4, k + 11, stone_slab, 0);
		m(w, i + 10, j + 4, k + 11, 1);
	...
	public static void generate_10(World w, int i, int j, int k)
	{
		...
		b(w, i + 11, j + 1, k + 1, bed, 0);
		m(w, i + 11, j + 1, k + 1, 10);
		b(w, i + 11, j + 1, k + 2, bed, 0);
		m(w, i + 11, j + 1, k + 2, 2);
		...
		b(w, i + 11, j + 9, k + 4, sandstone_stairs, 0);
		m(w, i + 11, j + 9, k + 4, 1);
		b(w, i + 11, j + 9, k + 5, sandstone_stairs, 0);
		m(w, i + 11, j + 9, k + 5, 1);
	...
	public static void generate_11(World w, int i, int j, int k)
	{
		...
		b(w, i + 12, j + 8, k + 4, sandstone_stairs, 0);
		m(w, i + 12, j + 8, k + 4, 1);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 108, j + 1, k + 24);
		TileEntityChest chest1 = (TileEntityChest)w.getTileEntity(i + 105, j + 1, k + 17);
	}
