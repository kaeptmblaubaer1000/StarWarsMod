 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x0_z256
{
	...
	public static void generate_4(World w, int i, int j, int k)
	{
		...
		b(w, i + 5, j + 6, k, sandstone_stairs, 0);
		m(w, i + 5, j + 6, k, 4);
		...
		m(w, i + 5, j + 6, k + 3, 4);
		b(w, i + 5, j + 6, k + 4, sandstone_stairs, 0);
		m(w, i + 5, j + 6, k + 4, 4);
		b(w, i + 5, j + 6, k + 5, sandstone_stairs, 0);
		m(w, i + 5, j + 6, k + 5, 4);
		b(w, i + 5, j + 6, k + 6, sandstone_stairs, 0);
		m(w, i + 5, j + 6, k + 6, 4);
		b(w, i + 5, j + 6, k + 7, sandstone_stairs, 0);
		m(w, i + 5, j + 6, k + 7, 4);
		b(w, i + 5, j + 6, k + 8, sandstone_stairs, 0);
		m(w, i + 5, j + 6, k + 8, 4);
	...
	public static void generate_5(World w, int i, int j, int k)
	{
		...
		b(w, i + 6, j + 2, k, glass_pane, 0);
		b(w, i + 6, j + 2, k + 1, glass_pane, 0);
		b(w, i + 6, j + 2, k + 2, glass_pane, 0);
		...
		b(w, i + 6, j + 3, k, glass_pane, 0);
		b(w, i + 6, j + 3, k + 1, glass_pane, 0);
		b(w, i + 6, j + 3, k + 2, glass_pane, 0);
		...
		b(w, i + 6, j + 4, k, glass_pane, 0);
		b(w, i + 6, j + 4, k + 1, glass_pane, 0);
		b(w, i + 6, j + 4, k + 2, glass_pane, 0);
	...
	public static void generate_6(World w, int i, int j, int k)
	{
		...
		m(w, i + 7, j + 6, k + 7, 1);
		b(w, i + 7, j + 6, k + 8, sandstone_stairs, 0);
		m(w, i + 7, j + 6, k + 8, 1);
	...
	public static void generate_7(World w, int i, int j, int k)
	{
		...
		m(w, i + 8, j + 5, k + 5, 2);
		b(w, i + 8, j + 5, k + 6, sandstone_stairs, 0);
		m(w, i + 8, j + 5, k + 6, 1);
	...
	public static void generate_8(World w, int i, int j, int k)
	{
		...
		b(w, i + 9, j + 1, k, blockTable, 0);
		b(w, i + 9, j + 1, k + 1, blockTable, 0);
	...
	public static void generate_10(World w, int i, int j, int k)
	{
		...
		b(w, i + 11, j + 2, k + 6, sandstone_stairs, 0);
		m(w, i + 11, j + 2, k + 6, 1);
		b(w, i + 11, j + 2, k + 7, sandstone_stairs, 0);
		m(w, i + 11, j + 2, k + 7, 1);
		...
		b(w, i + 11, j + 6, k, double_stone_slab, 0);
		m(w, i + 11, j + 6, k, 1);
	...
	public static void generate_12(World w, int i, int j, int k)
	{
		...
		m(w, i + 13, j + 7, k + 10, 1);
		b(w, i + 13, j + 7, k + 11, stone_slab, 0);
		m(w, i + 13, j + 7, k + 11, 1);
	...
	public static void generate_13(World w, int i, int j, int k)
	{
		...
		m(w, i + 14, j + 7, k + 10, 1);
		b(w, i + 14, j + 7, k + 11, stone_slab, 0);
		m(w, i + 14, j + 7, k + 11, 1);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		m(w, i + 15, j + 7, k, 1);
		b(w, i + 15, j + 7, k + 1, stone_slab, 0);
		m(w, i + 15, j + 7, k + 1, 1);
		b(w, i + 15, j + 7, k + 2, sandstone_stairs, 0);
		m(w, i + 15, j + 7, k + 2, 3);
		...
		m(w, i + 15, j + 7, k + 10, 1);
		b(w, i + 15, j + 7, k + 11, stone_slab, 0);
		m(w, i + 15, j + 7, k + 11, 1);
