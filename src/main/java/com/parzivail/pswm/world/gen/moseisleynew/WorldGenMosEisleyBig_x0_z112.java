 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x0_z112
{
	...
	public static void generate_1(World w, int i, int j, int k)
	{
		...
		b(w, i + 2, j + 4, k + 8, stone_slab, 0);
		m(w, i + 2, j + 4, k + 8, 1);
		b(w, i + 2, j + 4, k + 9, sandstone_stairs, 0);
		generate_2(w, i, j, k);
	}

	public static void generate_2(World w, int i, int j, int k)
	{
		b(w, i + 2, j + 4, k + 10, sandstone_stairs, 0);
	...
	public static void generate_3(World w, int i, int j, int k)
	{
		...
		m(w, i + 4, j + 4, k + 7, 7);
		b(w, i + 4, j + 4, k + 8, stone_slab, 0);
		m(w, i + 4, j + 4, k + 8, 9);
		b(w, i + 4, j + 4, k + 9, stone_slab, 0);
		m(w, i + 4, j + 4, k + 9, 9);
		b(w, i + 4, j + 4, k + 10, stone_slab, 0);
		m(w, i + 4, j + 4, k + 10, 9);
		b(w, i + 4, j + 4, k + 11, stone_slab, 0);
		m(w, i + 4, j + 4, k + 11, 9);
	...
	public static void generate_7(World w, int i, int j, int k)
	{
		...
		b(w, i + 8, j + 9, k + 12, sandstone_stairs, 0);
		m(w, i + 8, j + 9, k + 12, 3);
		...
		m(w, i + 8, j + 10, k + 9, 1);
		b(w, i + 8, j + 10, k + 10, stone_slab, 0);
		m(w, i + 8, j + 10, k + 10, 1);
	...
	public static void generate_8(World w, int i, int j, int k)
	{
		...
		b(w, i + 9, j + 8, k + 6, sandstone_stairs, 0);
		m(w, i + 9, j + 8, k + 6, 2);
		...
		m(w, i + 9, j + 10, k + 9, 1);
		b(w, i + 9, j + 10, k + 10, stone_slab, 0);
		m(w, i + 9, j + 10, k + 10, 1);
	...
	public static void generate_9(World w, int i, int j, int k)
	{
		...
		b(w, i + 10, j + 9, k + 11, stone_slab, 0);
		m(w, i + 10, j + 9, k + 11, 1);
	...
	public static void generate_10(World w, int i, int j, int k)
	{
		...
		b(w, i + 11, j + 1, k + 11, bed, 0);
		m(w, i + 11, j + 1, k + 11, 3);
		b(w, i + 11, j + 1, k + 12, bed, 0);
		m(w, i + 11, j + 1, k + 12, 3);
		...
		m(w, i + 11, j + 9, k + 9, 1);
		b(w, i + 11, j + 9, k + 10, sandstone_stairs, 0);
		m(w, i + 11, j + 9, k + 10, 1);
	...
	public static void generate_11(World w, int i, int j, int k)
	{
		...
		m(w, i + 12, j + 1, k + 8, 11);
		b(w, i + 12, j + 1, k + 9, crafting_table, 0);
		b(w, i + 12, j + 1, k + 10, chest, 0);
		m(w, i + 12, j + 1, k + 10, 4);
		b(w, i + 12, j + 1, k + 11, bed, 0);
		m(w, i + 12, j + 1, k + 11, 11);
		b(w, i + 12, j + 1, k + 12, bed, 0);
		m(w, i + 12, j + 1, k + 12, 11);
		b(w, i + 12, j + 1, k + 13, blockTable, 0);
		m(w, i + 12, j + 1, k + 13, 3);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 5, j + 1, k + 125);
		TileEntityChest chest1 = (TileEntityChest)w.getTileEntity(i + 12, j + 1, k + 122);
	}
