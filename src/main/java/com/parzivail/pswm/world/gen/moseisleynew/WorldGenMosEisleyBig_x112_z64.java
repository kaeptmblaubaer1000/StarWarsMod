...
public class WorldGenMosEisleyBig_x112_z64
{
	...
	public static void generate_3(World w, int i, int j, int k)
	{
		...
		b(w, i + 4, j + 1, k + 12, crafting_table, 0);
	...
	public static void generate_9(World w, int i, int j, int k)
	{
		...
		b(w, i + 10, j + 5, k + 14, stone_slab, 0);
		m(w, i + 10, j + 5, k + 14, 1);
		...
		b(w, i + 10, j + 7, k + 8, sandstone_stairs, 0);
		m(w, i + 10, j + 7, k + 8, 2);
	...
	public static void generate_11(World w, int i, int j, int k)
	{
		...
		b(w, i + 12, j + 5, k, sandstone_stairs, 0);
		m(w, i + 12, j + 5, k, 3);
	...
	public static void generate_12(World w, int i, int j, int k)
	{
		...
		m(w, i + 13, j, k + 15, 1);
		b(w, i + 13, j + 1, k, crafting_table, 0);
		...
		b(w, i + 13, j + 3, k + 10, sandstone_stairs, 0);
		m(w, i + 13, j + 3, k + 10, 1);
		...
		b(w, i + 13, j + 4, k, sandstone_stairs, 0);
		m(w, i + 13, j + 4, k, 6);
		...
		b(w, i + 13, j + 11, k, sandstone_stairs, 0);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 118, j + 1, k + 73);
	}
