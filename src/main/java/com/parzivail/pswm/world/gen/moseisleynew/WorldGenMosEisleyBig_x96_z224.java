...
import static com.parzivail.pswm.StarWarsMod.blockMV;
...
public class WorldGenMosEisleyBig_x96_z224
{
	...
	public static void generate_2(World w, int i, int j, int k)
	{
		...
		b(w, i + 2, j + 11, k, stone_slab, 0);
		m(w, i + 2, j + 11, k, 1);
		b(w, i + 2, j + 11, k + 1, stone_slab, 0);
		m(w, i + 2, j + 11, k + 1, 1);
	...
	public static void generate_9(World w, int i, int j, int k)
	{
		...
		b(w, i + 10, j + 4, k + 14, sandstone_stairs, 0);
		m(w, i + 10, j + 4, k + 14, 2);
