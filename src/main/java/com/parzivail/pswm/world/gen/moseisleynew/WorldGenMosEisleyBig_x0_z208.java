 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x0_z208
{
	...
	public static void generate_3(World w, int i, int j, int k)
	{
		...
		b(w, i + 4, j + 7, k + 7, sandstone_stairs, 0);
		m(w, i + 4, j + 7, k + 7, 2);
	...
	public static void generate_4(World w, int i, int j, int k)
	{
		...
		b(w, i + 5, j + 7, k + 7, sandstone_stairs, 0);
		m(w, i + 5, j + 7, k + 7, 2);
	...
	public static void generate_5(World w, int i, int j, int k)
	{
		...
		b(w, i + 6, j + 9, k + 9, sandstone_stairs, 0);
		m(w, i + 6, j + 9, k + 9, 2);
	...
	public static void generate_6(World w, int i, int j, int k)
	{
		...
		b(w, i + 7, j + 8, k + 8, stone_slab, 0);
		m(w, i + 7, j + 8, k + 8, 1);
		b(w, i + 7, j + 8, k + 9, sandstone_stairs, 0);
		m(w, i + 7, j + 8, k + 9, 1);
		b(w, i + 7, j + 8, k + 10, sandstone_stairs, 0);
		m(w, i + 7, j + 8, k + 10, 1);
		b(w, i + 7, j + 8, k + 11, sandstone_stairs, 0);
		m(w, i + 7, j + 8, k + 11, 1);
		b(w, i + 7, j + 8, k + 12, sandstone_stairs, 0);
		m(w, i + 7, j + 8, k + 12, 1);
		b(w, i + 7, j + 8, k + 13, sandstone_stairs, 0);
		m(w, i + 7, j + 8, k + 13, 1);
		b(w, i + 7, j + 8, k + 14, sandstone_stairs, 0);
		m(w, i + 7, j + 8, k + 14, 1);
		b(w, i + 7, j + 8, k + 15, stone_slab, 0);
		m(w, i + 7, j + 8, k + 15, 1);
		b(w, i + 7, j + 9, k, air, 0);
	...
	public static void generate_10(World w, int i, int j, int k)
	{
		...
		b(w, i + 11, j + 7, k + 3, sandstone_stairs, 0);
	...
	public static void generate_11(World w, int i, int j, int k)
	{
		...
		b(w, i + 12, j + 1, k, crafting_table, 0);
	...
	public static void generate_12(World w, int i, int j, int k)
	{
		...
		b(w, i + 13, j + 9, k + 1, sandstone_stairs, 0);
	...
	public static void generate_13(World w, int i, int j, int k)
	{
		...
		b(w, i + 14, j + 8, k, sandstone_stairs, 0);
		m(w, i + 14, j + 8, k, 2);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		b(w, i + 15, j + 8, k + 3, sandstone_stairs, 0);
		m(w, i + 15, j + 8, k + 3, 3);
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 7, j + 1, k + 218);
		TileEntityChest chest1 = (TileEntityChest)w.getTileEntity(i + 14, j + 1, k + 211);
	}
