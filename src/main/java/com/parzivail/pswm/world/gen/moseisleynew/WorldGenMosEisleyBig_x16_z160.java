 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x16_z160
{
	...
	public static void generate_2(World w, int i, int j, int k)
	{
		...
		b(w, i + 3, j + 2, k + 4, sandstone_stairs, 0);
		m(w, i + 3, j + 2, k + 4, 1);
		...
		b(w, i + 3, j + 4, k + 2, sandstone_stairs, 0);
	...
	public static void generate_10(World w, int i, int j, int k)
	{
		...
		b(w, i + 11, j + 5, k + 3, sandstone_stairs, 0);
		m(w, i + 11, j + 5, k + 3, 1);
	...
	public static void generate_11(World w, int i, int j, int k)
	{
		...
		b(w, i + 12, j + 4, k + 3, sandstone_stairs, 0);
		m(w, i + 12, j + 4, k + 3, 1);
	...
	public static void generate_13(World w, int i, int j, int k)
	{
		...
		b(w, i + 14, j + 2, k + 4, sandstone_stairs, 0);
