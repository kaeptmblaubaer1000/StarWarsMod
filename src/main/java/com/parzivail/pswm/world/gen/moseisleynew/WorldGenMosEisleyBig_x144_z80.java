...
public class WorldGenMosEisleyBig_x144_z80
{
	...
	public static void generate_9(World w, int i, int j, int k)
	{
		...
		b(w, i + 10, j + 8, k + 15, sandstone_stairs, 0);
		m(w, i + 10, j + 8, k + 15, 2);
	...
	public static void generate_13(World w, int i, int j, int k)
	{
		...
		b(w, i + 14, j + 1, k + 15, blockTable, 0);
		m(w, i + 14, j + 1, k + 15, 2);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 151, j + 1, k + 95);
	}
