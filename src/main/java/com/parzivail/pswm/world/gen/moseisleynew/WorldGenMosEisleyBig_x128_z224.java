 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x128_z224
{
	...
	public static void generate_3(World w, int i, int j, int k)
	{
		...
		b(w, i + 4, j + 1, k, stone_slab, 0);
		m(w, i + 4, j + 1, k, 1);
		b(w, i + 4, j + 1, k + 1, air, 0);
		b(w, i + 4, j + 1, k + 2, stone_slab, 0);
		m(w, i + 4, j + 1, k + 2, 1);
	...
	public static void generate_4(World w, int i, int j, int k)
	{
		...
		m(w, i + 5, j + 1, k + 8, 2);
		b(w, i + 5, j + 1, k + 9, blockTatooineSand, 0);
		b(w, i + 5, j + 1, k + 10, blockTatooineSand, 0);
		b(w, i + 5, j + 1, k + 11, blockTatooineSand, 0);
		b(w, i + 5, j + 1, k + 12, blockTatooineSand, 0);
		b(w, i + 5, j + 1, k + 13, blockTatooineSand, 0);
		b(w, i + 5, j + 1, k + 14, blockTatooineSand, 0);
		b(w, i + 5, j + 1, k + 15, blockTatooineSand, 0);
		b(w, i + 5, j + 2, k, air, 0);
	...
	public static void generate_5(World w, int i, int j, int k)
	{
		...
		m(w, i + 6, j + 1, k + 8, 2);
		b(w, i + 6, j + 1, k + 9, blockTatooineSand, 0);
		b(w, i + 6, j + 1, k + 10, blockTatooineSand, 0);
		b(w, i + 6, j + 1, k + 11, blockTatooineSand, 0);
		b(w, i + 6, j + 1, k + 12, blockTatooineSand, 0);
		b(w, i + 6, j + 1, k + 13, blockTatooineSand, 0);
		b(w, i + 6, j + 1, k + 14, blockTatooineSand, 0);
		b(w, i + 6, j + 1, k + 15, blockTatooineSand, 0);
		b(w, i + 6, j + 2, k, air, 0);
		b(w, i + 6, j + 2, k + 1, air, 0);
		b(w, i + 6, j + 2, k + 2, air, 0);
		b(w, i + 6, j + 2, k + 3, air, 0);
		b(w, i + 6, j + 2, k + 4, glass_pane, 0);
	...
	public static void generate_6(World w, int i, int j, int k)
	{
		...
		m(w, i + 7, j + 1, k + 8, 2);
		b(w, i + 7, j + 1, k + 9, blockTatooineSand, 0);
		b(w, i + 7, j + 1, k + 10, sand, 0);
		b(w, i + 7, j + 1, k + 11, blockTatooineSand, 0);
		b(w, i + 7, j + 1, k + 12, blockTatooineSand, 0);
		b(w, i + 7, j + 1, k + 13, blockTatooineSand, 0);
		b(w, i + 7, j + 1, k + 14, blockTatooineSand, 0);
		b(w, i + 7, j + 1, k + 15, blockTatooineSand, 0);
		b(w, i + 7, j + 2, k, air, 0);
	...
	public static void generate_7(World w, int i, int j, int k)
	{
		...
		b(w, i + 8, j + 1, k + 15, blockTatooineSand, 0);
		b(w, i + 8, j + 2, k, air, 0);
		b(w, i + 8, j + 2, k + 1, air, 0);
		b(w, i + 8, j + 2, k + 2, air, 0);
		b(w, i + 8, j + 2, k + 3, air, 0);
		b(w, i + 8, j + 2, k + 4, glass_pane, 0);
	...
	public static void generate_9(World w, int i, int j, int k)
	{
		...
		b(w, i + 10, j + 1, k + 12, blockTable, 0);
