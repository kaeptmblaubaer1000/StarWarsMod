...
public class WorldGenMosEisleyBig_x96_z192
{
	...
	public static void generate_8(World w, int i, int j, int k)
	{
		...
		b(w, i + 9, j + 3, k + 6, sandstone_stairs, 0);
	...
	public static void generate_10(World w, int i, int j, int k)
	{
		...
		m(w, i + 11, j + 1, k + 4, 2);
		b(w, i + 11, j + 1, k + 5, bed, 0);
		m(w, i + 11, j + 1, k + 5, 9);
		b(w, i + 11, j + 1, k + 6, bed, 0);
		m(w, i + 11, j + 1, k + 6, 9);
		b(w, i + 11, j + 1, k + 7, chest, 0);
		m(w, i + 11, j + 1, k + 7, 5);
		b(w, i + 11, j + 1, k + 8, crafting_table, 0);
		b(w, i + 11, j + 1, k + 9, bed, 0);
		m(w, i + 11, j + 1, k + 9, 9);
		b(w, i + 11, j + 1, k + 10, bed, 0);
		m(w, i + 11, j + 1, k + 10, 9);
		b(w, i + 11, j + 1, k + 11, blockTable, 0);
		m(w, i + 11, j + 1, k + 11, 2);
	...
	public static void generate_11(World w, int i, int j, int k)
	{
		...
		b(w, i + 12, j + 1, k + 5, bed, 0);
		m(w, i + 12, j + 1, k + 5, 1);
		b(w, i + 12, j + 1, k + 6, bed, 0);
		m(w, i + 12, j + 1, k + 6, 1);
		b(w, i + 12, j + 1, k + 7, air, 0);
		b(w, i + 12, j + 1, k + 8, air, 0);
		b(w, i + 12, j + 1, k + 9, bed, 0);
		m(w, i + 12, j + 1, k + 9, 1);
		...
		b(w, i + 12, j + 8, k + 6, sandstone_stairs, 0);
		...
		b(w, i + 12, j + 9, k + 7, sandstone_stairs, 0);
		b(w, i + 12, j + 9, k + 8, sandstone_stairs, 0);
	...
	public static void generate_12(World w, int i, int j, int k)
	{
		...
		b(w, i + 13, j + 3, k + 2, sandstone_stairs, 0);
		m(w, i + 13, j + 3, k + 2, 2);
		...
		b(w, i + 13, j + 8, k + 5, sandstone_stairs, 0);
		m(w, i + 13, j + 8, k + 5, 2);
	...
	public static void generate_13(World w, int i, int j, int k)
	{
		...
		b(w, i + 14, j + 1, k + 7, carpet, 0);
		m(w, i + 14, j + 1, k + 7, 8);
		b(w, i + 14, j + 1, k + 8, carpet, 0);
		m(w, i + 14, j + 1, k + 8, 8);
		...
		b(w, i + 14, j + 8, k + 4, sandstone_stairs, 0);
		m(w, i + 14, j + 8, k + 4, 2);
		...
		b(w, i + 14, j + 8, k + 11, sandstone_stairs, 0);
		m(w, i + 14, j + 8, k + 11, 3);
		...
		b(w, i + 14, j + 10, k + 7, stone_slab, 0);
		m(w, i + 14, j + 10, k + 7, 1);
		b(w, i + 14, j + 10, k + 8, stone_slab, 0);
		m(w, i + 14, j + 10, k + 8, 1);
		...
		b(w, i + 15, j + 1, k + 6, carpet, 0);
		m(w, i + 15, j + 1, k + 6, 8);
		b(w, i + 15, j + 1, k + 7, carpet, 0);
		m(w, i + 15, j + 1, k + 7, 8);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		b(w, i + 15, j + 8, k + 4, sandstone_stairs, 0);
		m(w, i + 15, j + 8, k + 4, 2);
		...
		b(w, i + 15, j + 10, k + 7, stone_slab, 0);
		m(w, i + 15, j + 10, k + 7, 1);
		b(w, i + 15, j + 10, k + 8, stone_slab, 0);
		m(w, i + 15, j + 10, k + 8, 1);
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 107, j + 1, k + 199);
	}
