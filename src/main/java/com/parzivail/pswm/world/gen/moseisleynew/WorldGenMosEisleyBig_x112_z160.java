 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x112_z160
{
	...
	public static void generate_5(World w, int i, int j, int k)
	{
		...
		b(w, i + 6, j + 12, k, sandstone_stairs, 0);
		m(w, i + 6, j + 12, k, 2);
	...
	public static void generate_6(World w, int i, int j, int k)
	{
		...
		b(w, i + 6, j + 15, k + 1, torch, 0);
		m(w, i + 6, j + 15, k + 1, 4);
		b(w, i + 6, j + 15, k + 2, sandstone, 0);
		m(w, i + 6, j + 15, k + 2, 1);
	...
	public static void generate_7(World w, int i, int j, int k)
	{
		...
		b(w, i + 8, j + 4, k, stone_slab, 0);
		m(w, i + 8, j + 4, k, 9);
		b(w, i + 8, j + 4, k + 1, stone_slab, 0);
		m(w, i + 8, j + 4, k + 1, 9);
		b(w, i + 8, j + 4, k + 2, sandstone_stairs, 0);
		m(w, i + 8, j + 4, k + 2, 6);
	...
	public static void generate_8(World w, int i, int j, int k)
	{
		...
		b(w, i + 9, j + 3, k, air, 0);
		b(w, i + 9, j + 3, k + 1, sandstone_stairs, 0);
		m(w, i + 9, j + 3, k + 1, 6);
	...
	public static void generate_13(World w, int i, int j, int k)
	{
		...
		m(w, i + 14, j + 6, k + 11, 9);
		b(w, i + 14, j + 6, k + 12, stone_slab, 0);
		m(w, i + 14, j + 6, k + 12, 9);
		b(w, i + 14, j + 6, k + 13, stone_slab, 0);
		m(w, i + 14, j + 6, k + 13, 9);
		b(w, i + 14, j + 6, k + 14, stone_slab, 0);
		m(w, i + 14, j + 6, k + 14, 9);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 119, j + 1, k + 162);
		TileEntityChest chest1 = (TileEntityChest)w.getTileEntity(i + 120, j + 1, k + 162);
	}
