...
public class WorldGenMosEisleyBig_x160_z176
{
	...
	public static void generate_2(World w, int i, int j, int k)
	{
		...
		m(w, i + 2, j + 4, k + 14, 2);
		b(w, i + 2, j + 4, k + 15, sandstone_stairs, 0);
		m(w, i + 2, j + 4, k + 15, 7);
		b(w, i + 2, j + 5, k, air, 0);
		...
		b(w, i + 3, j + 1, k, blockTable, 0);
		m(w, i + 3, j + 1, k, 3);
		b(w, i + 3, j + 1, k + 1, blockTable, 0);
		m(w, i + 3, j + 1, k + 1, 3);
		b(w, i + 3, j + 1, k + 2, blockTable, 0);
		m(w, i + 3, j + 1, k + 2, 3);
		b(w, i + 3, j + 1, k + 3, air, 0);
		b(w, i + 3, j + 1, k + 4, sandstone_stairs, 0);
		m(w, i + 3, j + 1, k + 4, 2);
		b(w, i + 3, j + 1, k + 5, air, 0);
		b(w, i + 3, j + 1, k + 6, chest, 0);
		m(w, i + 3, j + 1, k + 6, 3);
	...
	public static void generate_3(World w, int i, int j, int k)
	{
		...
		b(w, i + 4, j + 1, k, blockTable, 0);
		m(w, i + 4, j + 1, k, 3);
		b(w, i + 4, j + 1, k + 1, blockTable, 0);
		m(w, i + 4, j + 1, k + 1, 3);
		b(w, i + 4, j + 1, k + 2, blockTable, 0);
		m(w, i + 4, j + 1, k + 2, 3);
	...
	public static void generate_8(World w, int i, int j, int k)
	{
		...
		b(w, i + 9, j + 3, k + 15, sandstone_stairs, 0);
		m(w, i + 9, j + 3, k + 15, 1);
		b(w, i + 9, j + 4, k, air, 0);
	...
	public static void generate_13(World w, int i, int j, int k)
	{
		...
		b(w, i + 14, j + 3, k + 4, sandstone_stairs, 0);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 162, j + 1, k + 182);
		TileEntityChest chest1 = (TileEntityChest)w.getTileEntity(i + 163, j + 1, k + 182);
		TileEntityChest chest2 = (TileEntityChest)w.getTileEntity(i + 162, j + 1, k + 191);
		TileEntityChest chest3 = (TileEntityChest)w.getTileEntity(i + 163, j + 1, k + 191);
	}
