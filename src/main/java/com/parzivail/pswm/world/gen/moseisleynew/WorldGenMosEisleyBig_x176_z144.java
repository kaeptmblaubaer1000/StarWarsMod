...
public class WorldGenMosEisleyBig_x176_z144
{
	...
	public static void generate_1(World w, int i, int j, int k)
	{
		...
		b(w, i + 1, j + 11, k + 10, sandstone_stairs, 0);
		m(w, i + 1, j + 11, k + 10, 2);
		b(w, i + 1, j + 11, k + 11, sandstone_stairs, 0);
	...
	public static void generate_2(World w, int i, int j, int k)
	{
		...
		m(w, i + 2, j + 11, k + 10, 2);
		b(w, i + 2, j + 11, k + 11, sandstone, 0);
		b(w, i + 2, j + 11, k + 12, sandstone, 0);
		...
		b(w, i + 3, j + 5, k + 13, sandstone_stairs, 0);
		m(w, i + 3, j + 5, k + 13, 3);
	...
	public static void generate_3(World w, int i, int j, int k)
	{
		...
		b(w, i + 3, j + 9, k + 13, sandstone_stairs, 0);
		m(w, i + 3, j + 9, k + 13, 3);
		...
		b(w, i + 3, j + 15, k + 11, sandstone, 0);
		m(w, i + 3, j + 15, k + 11, 1);
		b(w, i + 3, j + 15, k + 12, torch, 0);
		m(w, i + 3, j + 15, k + 12, 1);
		...
		b(w, i + 3, j + 17, k + 11, sandstone, 0);
		m(w, i + 3, j + 17, k + 11, 1);
		b(w, i + 3, j + 17, k + 12, sandstone, 0);
		...
		b(w, i + 3, j + 18, k + 12, sandstone, 0);
		b(w, i + 3, j + 18, k + 13, sandstone, 0);
		...
		b(w, i + 4, j + 2, k + 12, sandstone_stairs, 0);
	...
	public static void generate_4(World w, int i, int j, int k)
	{
		...
		b(w, i + 4, j + 10, k + 12, sandstone_stairs, 0);
		...
		b(w, i + 5, j + 3, k + 13, sandstone_stairs, 0);
		m(w, i + 5, j + 3, k + 13, 2);
	...
	public static void generate_5(World w, int i, int j, int k)
	{
		...
		b(w, i + 6, j + 1, k + 11, bed, 0);
		m(w, i + 6, j + 1, k + 11, 10);
		b(w, i + 6, j + 1, k + 12, bed, 0);
		m(w, i + 6, j + 1, k + 12, 2);
		b(w, i + 6, j + 1, k + 13, air, 0);
		b(w, i + 6, j + 1, k + 14, air, 0);
		b(w, i + 6, j + 1, k + 15, furnace, 0);
		m(w, i + 6, j + 1, k + 15, 4);
		b(w, i + 6, j + 2, k, air, 0);
		...
		b(w, i + 6, j + 3, k + 9, sandstone_stairs, 0);
		m(w, i + 6, j + 3, k + 9, 2);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 178, j + 1, k + 159);
	}
