 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x32_z16
{
	...
	public static void generate_1(World w, int i, int j, int k)
	{
		...
		b(w, i + 1, j + 8, k + 9, sandstone_stairs, 0);
		...
		b(w, i + 2, j + 1, k + 6, bed, 0);
		m(w, i + 2, j + 1, k + 6, 10);
		b(w, i + 2, j + 1, k + 7, bed, 0);
		m(w, i + 2, j + 1, k + 7, 2);
	...
	public static void generate_2(World w, int i, int j, int k)
	{
		...
		b(w, i + 2, j + 4, k + 14, sandstone_stairs, 0);
		m(w, i + 2, j + 4, k + 14, 5);
		...
		b(w, i + 2, j + 8, k + 8, sandstone_stairs, 0);
		b(w, i + 2, j + 8, k + 9, sandstone, 0);
		b(w, i + 2, j + 8, k + 10, sandstone, 0);
		b(w, i + 2, j + 8, k + 11, sandstone_stairs, 0);
	...
	public static void generate_3(World w, int i, int j, int k)
	{
		...
		b(w, i + 4, j + 1, k + 6, crafting_table, 0);
		b(w, i + 4, j + 1, k + 7, air, 0);
		b(w, i + 4, j + 1, k + 8, air, 0);
		b(w, i + 4, j + 1, k + 9, carpet, 0);
		m(w, i + 4, j + 1, k + 9, 8);
		b(w, i + 4, j + 1, k + 10, carpet, 0);
		m(w, i + 4, j + 1, k + 10, 8);
		b(w, i + 4, j + 1, k + 11, carpet, 0);
		m(w, i + 4, j + 1, k + 11, 8);
		b(w, i + 4, j + 1, k + 12, carpet, 0);
		m(w, i + 4, j + 1, k + 12, 8);
	...
	public static void generate_4(World w, int i, int j, int k)
	{
		...
		b(w, i + 4, j + 9, k + 7, sandstone_stairs, 0);
		m(w, i + 4, j + 9, k + 7, 2);
		...
		b(w, i + 4, j + 10, k + 9, stone_slab, 0);
		m(w, i + 4, j + 10, k + 9, 1);
		b(w, i + 4, j + 10, k + 10, stone_slab, 0);
		m(w, i + 4, j + 10, k + 10, 1);
		...
		b(w, i + 5, j + 1, k + 6, chest, 0);
		m(w, i + 5, j + 1, k + 6, 3);
		b(w, i + 5, j + 1, k + 7, air, 0);
		b(w, i + 5, j + 1, k + 8, air, 0);
		b(w, i + 5, j + 1, k + 9, carpet, 0);
		m(w, i + 5, j + 1, k + 9, 8);
		b(w, i + 5, j + 1, k + 10, carpet, 0);
		m(w, i + 5, j + 1, k + 10, 8);
		b(w, i + 5, j + 1, k + 11, carpet, 0);
		m(w, i + 5, j + 1, k + 11, 8);
		b(w, i + 5, j + 1, k + 12, carpet, 0);
		m(w, i + 5, j + 1, k + 12, 8);
		...
		b(w, i + 5, j + 10, k + 9, stone_slab, 0);
		m(w, i + 5, j + 10, k + 9, 1);
		b(w, i + 5, j + 10, k + 10, stone_slab, 0);
		m(w, i + 5, j + 10, k + 10, 1);
	...
	public static void generate_5(World w, int i, int j, int k)
	{
		...
		b(w, i + 6, j + 1, k + 6, bed, 0);
		m(w, i + 6, j + 1, k + 6, 10);
		b(w, i + 6, j + 1, k + 7, bed, 0);
		m(w, i + 6, j + 1, k + 7, 2);
		b(w, i + 6, j + 1, k + 8, air, 0);
		b(w, i + 6, j + 1, k + 9, air, 0);
		b(w, i + 6, j + 1, k + 10, carpet, 0);
		m(w, i + 6, j + 1, k + 10, 8);
		b(w, i + 6, j + 1, k + 11, carpet, 0);
		m(w, i + 6, j + 1, k + 11, 8);
		...
		b(w, i + 6, j + 8, k + 12, sandstone_stairs, 0);
		m(w, i + 6, j + 8, k + 12, 3);
	...
	public static void generate_6(World w, int i, int j, int k)
	{
		...
		b(w, i + 7, j + 1, k + 6, bed, 0);
		m(w, i + 7, j + 1, k + 6, 10);
		b(w, i + 7, j + 1, k + 7, bed, 0);
		m(w, i + 7, j + 1, k + 7, 2);
		...
		m(w, i + 7, j + 9, k + 9, 1);
		b(w, i + 7, j + 9, k + 10, sandstone_stairs, 0);
		m(w, i + 7, j + 9, k + 10, 1);
	...
	public static void generate_7(World w, int i, int j, int k)
	{
		...
		b(w, i + 8, j + 1, k + 12, jukebox, 0);
		b(w, i + 8, j + 1, k + 13, chest, 0);
		m(w, i + 8, j + 1, k + 13, 4);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 37, j + 1, k + 22);
		TileEntityChest chest1 = (TileEntityChest)w.getTileEntity(i + 40, j + 1, k + 29);
	}
