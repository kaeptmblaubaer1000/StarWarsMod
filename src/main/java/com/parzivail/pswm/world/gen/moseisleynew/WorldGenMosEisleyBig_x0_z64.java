 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x0_z64
{
	...
	public static void generate_2(World w, int i, int j, int k)
	{
		...
		b(w, i + 3, j + 3, k + 6, sandstone_stairs, 0);
	...
	public static void generate_4(World w, int i, int j, int k)
	{
		...
		b(w, i + 4, j + 11, k + 7, sandstone_stairs, 0);
		b(w, i + 4, j + 11, k + 8, sandstone_stairs, 0);
		b(w, i + 4, j + 11, k + 9, sandstone_stairs, 0);
		b(w, i + 4, j + 11, k + 10, sandstone_stairs, 0);
		...
		m(w, i + 5, j + 1, k + 4, 1);
		b(w, i + 5, j + 1, k + 5, crafting_table, 0);
		b(w, i + 5, j + 1, k + 6, furnace, 0);
		m(w, i + 5, j + 1, k + 6, 5);
		b(w, i + 5, j + 1, k + 7, air, 0);
		b(w, i + 5, j + 1, k + 8, air, 0);
		b(w, i + 5, j + 1, k + 9, bed, 0);
		b(w, i + 5, j + 1, k + 10, bed, 0);
		m(w, i + 5, j + 1, k + 10, 8);
		...
		m(w, i + 5, j + 4, k + 4, 1);
		b(w, i + 5, j + 4, k + 5, sandstone_stairs, 0);
		m(w, i + 5, j + 4, k + 5, 5);
	...
	public static void generate_5(World w, int i, int j, int k)
	{
		...
		b(w, i + 6, j + 11, k + 5, sandstone_stairs, 0);
		m(w, i + 6, j + 11, k + 5, 2);
	...
	public static void generate_6(World w, int i, int j, int k)
	{
		...
		m(w, i + 6, j + 15, k + 6, 1);
		b(w, i + 6, j + 15, k + 7, torch, 0);
		m(w, i + 6, j + 15, k + 7, 1);
		b(w, i + 6, j + 15, k + 8, air, 0);
		b(w, i + 6, j + 15, k + 9, torch, 0);
		m(w, i + 6, j + 15, k + 9, 1);
		b(w, i + 6, j + 15, k + 10, sandstone, 0);
		m(w, i + 6, j + 15, k + 10, 1);
		...
		b(w, i + 7, j + 2, k + 9, sandstone_stairs, 0);
		m(w, i + 7, j + 2, k + 9, 1);
		...
		m(w, i + 7, j + 4, k + 4, 1);
		b(w, i + 7, j + 4, k + 5, stone_slab, 0);
		m(w, i + 7, j + 4, k + 5, 9);
		b(w, i + 7, j + 4, k + 6, air, 0);
		b(w, i + 7, j + 4, k + 7, sandstone_stairs, 0);
		...
		b(w, i + 7, j + 6, k + 9, sandstone_stairs, 0);
		m(w, i + 7, j + 6, k + 9, 1);
		...
		b(w, i + 7, j + 10, k + 9, sandstone_stairs, 0);
		m(w, i + 7, j + 10, k + 9, 1);
		...
		b(w, i + 7, j + 11, k + 5, sandstone_stairs, 0);
		m(w, i + 7, j + 11, k + 5, 2);
		...
		m(w, i + 7, j + 12, k + 6, 1);
		b(w, i + 7, j + 12, k + 7, sandstone_stairs, 0);
	...
	public static void generate_7(World w, int i, int j, int k)
	{
		...
		b(w, i + 8, j + 5, k + 8, sandstone_stairs, 0);
		m(w, i + 8, j + 5, k + 8, 2);
		...
		b(w, i + 8, j + 9, k + 8, sandstone_stairs, 0);
		m(w, i + 8, j + 9, k + 8, 2);
		...
		m(w, i + 8, j + 15, k + 6, 1);
		b(w, i + 8, j + 15, k + 7, torch, 0);
		m(w, i + 8, j + 15, k + 7, 2);
		b(w, i + 8, j + 15, k + 8, air, 0);
		b(w, i + 8, j + 15, k + 9, torch, 0);
		m(w, i + 8, j + 15, k + 9, 2);
	...
	public static void generate_8(World w, int i, int j, int k)
	{
		...
		b(w, i + 9, j + 3, k + 6, torch, 0);
		m(w, i + 9, j + 3, k + 6, 2);
		b(w, i + 9, j + 3, k + 7, air, 0);
		b(w, i + 9, j + 3, k + 8, air, 0);
		b(w, i + 9, j + 3, k + 9, torch, 0);
		m(w, i + 9, j + 3, k + 9, 2);
		...
		m(w, i + 9, j + 4, k + 4, 1);
		b(w, i + 9, j + 4, k + 5, sandstone_stairs, 0);
		m(w, i + 9, j + 4, k + 5, 4);
		...
		b(w, i + 9, j + 5, k + 4, sandstone_stairs, 0);
		m(w, i + 9, j + 5, k + 4, 1);
	...
	public static void generate_9(World w, int i, int j, int k)
	{
		...
		m(w, i + 10, j + 11, k + 7, 1);
		b(w, i + 10, j + 11, k + 8, sandstone_stairs, 0);
		m(w, i + 10, j + 11, k + 8, 1);
	...
	public static void generate_10(World w, int i, int j, int k)
	{
		...
		b(w, i + 11, j + 3, k + 10, sandstone_stairs, 0);
		m(w, i + 11, j + 3, k + 10, 1);
	...
	public static void generate_11(World w, int i, int j, int k)
	{
		...
		b(w, i + 12, j + 1, k + 10, sandstone_stairs, 0);
		m(w, i + 12, j + 1, k + 10, 1);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 9, j + 1, k + 70);
		TileEntityChest chest1 = (TileEntityChest)w.getTileEntity(i + 9, j + 1, k + 69);
	}
