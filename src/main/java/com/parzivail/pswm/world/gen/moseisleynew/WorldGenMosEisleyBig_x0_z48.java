 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x0_z48
{
	...
	public static void generate_3(World w, int i, int j, int k)
	{
		...
		b(w, i + 4, j + 1, k, crafting_table, 0);
		b(w, i + 4, j + 1, k + 1, furnace, 0);
		m(w, i + 4, j + 1, k + 1, 5);
		b(w, i + 4, j + 1, k + 2, air, 0);
		b(w, i + 4, j + 1, k + 3, air, 0);
		b(w, i + 4, j + 1, k + 4, bed, 0);
		b(w, i + 4, j + 1, k + 5, bed, 0);
		m(w, i + 4, j + 1, k + 5, 8);
		...
		b(w, i + 4, j + 3, k + 7, sandstone_stairs, 0);
		m(w, i + 4, j + 3, k + 7, 3);
		...
		b(w, i + 4, j + 4, k, sandstone_stairs, 0);
		m(w, i + 4, j + 4, k, 5);
	...
	public static void generate_4(World w, int i, int j, int k)
	{
		...
		b(w, i + 5, j + 3, k + 3, sandstone_stairs, 0);
		m(w, i + 5, j + 3, k + 3, 3);
		...
		b(w, i + 5, j + 7, k + 3, sandstone_stairs, 0);
		m(w, i + 5, j + 7, k + 3, 3);
		...
		b(w, i + 5, j + 11, k + 6, sandstone_stairs, 0);
		m(w, i + 5, j + 11, k + 6, 3);
	...
	public static void generate_5(World w, int i, int j, int k)
	{
		...
		m(w, i + 5, j + 15, k + 1, 1);
		b(w, i + 5, j + 15, k + 2, torch, 0);
		m(w, i + 5, j + 15, k + 2, 1);
		b(w, i + 5, j + 15, k + 3, air, 0);
		b(w, i + 5, j + 15, k + 4, torch, 0);
		m(w, i + 5, j + 15, k + 4, 1);
		b(w, i + 5, j + 15, k + 5, sandstone, 0);
		m(w, i + 5, j + 15, k + 5, 1);
		...
		b(w, i + 5, j + 17, k + 4, sandstone, 0);
		b(w, i + 5, j + 17, k + 5, sandstone, 0);
		m(w, i + 5, j + 17, k + 5, 1);
		...
		b(w, i + 6, j + 2, k + 4, sandstone_stairs, 0);
		m(w, i + 6, j + 2, k + 4, 1);
		...
		b(w, i + 6, j + 6, k + 4, sandstone_stairs, 0);
		m(w, i + 6, j + 6, k + 4, 1);
		...
		b(w, i + 6, j + 8, k + 2, sandstone_stairs, 0);
		...
		b(w, i + 6, j + 11, k + 6, sandstone_stairs, 0);
		m(w, i + 6, j + 11, k + 6, 3);
		...
		b(w, i + 6, j + 12, k + 1, sandstone, 0);
		m(w, i + 6, j + 12, k + 1, 1);
		b(w, i + 6, j + 12, k + 2, sandstone_stairs, 0);
	...
	public static void generate_6(World w, int i, int j, int k)
	{
		...
		b(w, i + 6, j + 17, k + 4, sandstone, 0);
		b(w, i + 6, j + 17, k + 5, sandstone, 0);
		m(w, i + 6, j + 17, k + 5, 1);
		...
		b(w, i + 6, j + 18, k + 4, sandstone, 0);
		b(w, i + 6, j + 18, k + 5, sandstone, 0);
		m(w, i + 6, j + 18, k + 5, 1);
		...
		b(w, i + 7, j + 5, k + 3, sandstone_stairs, 0);
		m(w, i + 7, j + 5, k + 3, 2);
		...
		m(w, i + 7, j + 15, k + 1, 1);
		b(w, i + 7, j + 15, k + 2, torch, 0);
		m(w, i + 7, j + 15, k + 2, 2);
		b(w, i + 7, j + 15, k + 3, air, 0);
		b(w, i + 7, j + 15, k + 4, torch, 0);
		m(w, i + 7, j + 15, k + 4, 2);
		b(w, i + 7, j + 15, k + 5, sandstone, 0);
		m(w, i + 7, j + 15, k + 5, 1);
	...
	public static void generate_7(World w, int i, int j, int k)
	{
		...
		b(w, i + 7, j + 17, k + 4, sandstone, 0);
		b(w, i + 7, j + 17, k + 5, sandstone, 0);
		m(w, i + 7, j + 17, k + 5, 1);
		...
		b(w, i + 7, j + 18, k + 2, sandstone, 0);
		b(w, i + 7, j + 18, k + 3, sandstone, 0);
		b(w, i + 7, j + 18, k + 4, sandstone, 0);
		...
		b(w, i + 8, j + 1, k, chest, 0);
		m(w, i + 8, j + 1, k, 4);
		b(w, i + 8, j + 1, k + 1, chest, 0);
		m(w, i + 8, j + 1, k + 1, 4);
		...
		b(w, i + 8, j + 3, k, air, 0);
		b(w, i + 8, j + 3, k + 1, torch, 0);
		m(w, i + 8, j + 3, k + 1, 2);
		b(w, i + 8, j + 3, k + 2, air, 0);
		b(w, i + 8, j + 3, k + 3, air, 0);
		b(w, i + 8, j + 3, k + 4, torch, 0);
		m(w, i + 8, j + 3, k + 4, 2);
		...
		b(w, i + 8, j + 4, k, sandstone_stairs, 0);
		m(w, i + 8, j + 4, k, 4);
		...
		m(w, i + 8, j + 11, k, 2);
		b(w, i + 8, j + 11, k + 1, sandstone, 0);
		b(w, i + 8, j + 11, k + 2, sandstone, 0);
		...
		b(w, i + 8, j + 13, k + 2, sandstone, 0);
		m(w, i + 8, j + 13, k + 2, 1);
		b(w, i + 8, j + 13, k + 3, sandstone, 0);
		m(w, i + 8, j + 13, k + 3, 1);
		b(w, i + 8, j + 13, k + 4, sandstone, 0);
		m(w, i + 8, j + 13, k + 4, 1);
		...
		b(w, i + 8, j + 14, k + 2, sandstone, 0);
		m(w, i + 8, j + 14, k + 2, 1);
		b(w, i + 8, j + 14, k + 3, sandstone, 0);
		m(w, i + 8, j + 14, k + 3, 1);
		b(w, i + 8, j + 14, k + 4, sandstone, 0);
		m(w, i + 8, j + 14, k + 4, 1);
		...
		b(w, i + 8, j + 15, k + 2, sandstone, 0);
		m(w, i + 8, j + 15, k + 2, 1);
		b(w, i + 8, j + 15, k + 3, sandstone, 0);
		m(w, i + 8, j + 15, k + 3, 1);
		b(w, i + 8, j + 15, k + 4, sandstone, 0);
		m(w, i + 8, j + 15, k + 4, 1);
		...
		b(w, i + 8, j + 16, k + 2, sandstone, 0);
		m(w, i + 8, j + 16, k + 2, 1);
		b(w, i + 8, j + 16, k + 3, sandstone, 0);
		m(w, i + 8, j + 16, k + 3, 1);
		b(w, i + 8, j + 16, k + 4, sandstone, 0);
		m(w, i + 8, j + 16, k + 4, 1);
		...
		b(w, i + 8, j + 17, k + 2, sandstone, 0);
		m(w, i + 8, j + 17, k + 2, 1);
		b(w, i + 8, j + 17, k + 3, sandstone, 0);
		m(w, i + 8, j + 17, k + 3, 1);
		b(w, i + 8, j + 17, k + 4, sandstone, 0);
		m(w, i + 8, j + 17, k + 4, 1);
	...
	public static void generate_8(World w, int i, int j, int k)
	{
		...
		b(w, i + 9, j + 11, k, sandstone_stairs, 0);
		m(w, i + 9, j + 11, k, 2);
		b(w, i + 9, j + 11, k + 1, sandstone_stairs, 0);
		m(w, i + 9, j + 11, k + 1, 1);
		b(w, i + 9, j + 11, k + 2, sandstone_stairs, 0);
		m(w, i + 9, j + 11, k + 2, 1);
		b(w, i + 9, j + 11, k + 3, sandstone_stairs, 0);
		m(w, i + 9, j + 11, k + 3, 1);
		b(w, i + 9, j + 11, k + 4, sandstone_stairs, 0);
		m(w, i + 9, j + 11, k + 4, 1);
		b(w, i + 9, j + 11, k + 5, sandstone_stairs, 0);
		m(w, i + 9, j + 11, k + 5, 1);
	...
	public static void generate_9(World w, int i, int j, int k)
	{
		...
		b(w, i + 10, j + 3, k + 1, sandstone_stairs, 0);
		m(w, i + 10, j + 3, k + 1, 1);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		m(w, i + 15, j + 4, k + 8, 2);
		b(w, i + 15, j + 4, k + 9, glass_pane, 0);
		b(w, i + 15, j + 4, k + 10, glass_pane, 0);
		...
		m(w, i + 15, j + 5, k + 8, 2);
		b(w, i + 15, j + 5, k + 9, glass_pane, 0);
		b(w, i + 15, j + 5, k + 10, glass_pane, 0);
		b(w, i + 15, j + 5, k + 11, glass_pane, 0);
		b(w, i + 15, j + 5, k + 12, glass_pane, 0);
		...
		m(w, i + 15, j + 6, k + 8, 2);
		b(w, i + 15, j + 6, k + 9, glass_pane, 0);
		b(w, i + 15, j + 6, k + 10, glass_pane, 0);
		b(w, i + 15, j + 6, k + 11, glass_pane, 0);
		b(w, i + 15, j + 6, k + 12, glass_pane, 0);
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 8, j + 1, k + 48);
		TileEntityChest chest1 = (TileEntityChest)w.getTileEntity(i + 8, j + 1, k + 49);
	}
