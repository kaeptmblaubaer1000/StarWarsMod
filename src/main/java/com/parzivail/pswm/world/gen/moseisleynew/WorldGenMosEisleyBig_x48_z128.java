 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x48_z128
{
	public static void generate(World w, int i, int j, int k)
	{
		...
		b(w, i, j + 11, k + 10, sandstone_stairs, 0);
		m(w, i, j + 11, k + 10, 2);
		b(w, i, j + 11, k + 11, sandstone, 0);
		b(w, i, j + 11, k + 12, sandstone, 0);
		b(w, i, j + 11, k + 13, sandstone, 0);
		b(w, i, j + 11, k + 14, sandstone, 0);
		b(w, i, j + 11, k + 15, sandstone, 0);
		b(w, i, j + 12, k, air, 0);
		...
		m(w, i, j + 12, k + 12, 1);
		b(w, i, j + 12, k + 13, sandstone, 0);
		m(w, i, j + 12, k + 13, 1);
		b(w, i, j + 12, k + 14, sandstone, 0);
		m(w, i, j + 12, k + 14, 1);
		...
		b(w, i, j + 14, k + 12, sandstone, 0);
		m(w, i, j + 14, k + 12, 1);
		b(w, i, j + 14, k + 13, sandstone, 0);
		m(w, i, j + 14, k + 13, 1);
		b(w, i, j + 14, k + 14, sandstone, 0);
		m(w, i, j + 14, k + 14, 1);
		...
		b(w, i, j + 15, k + 12, sandstone, 0);
		m(w, i, j + 15, k + 12, 1);
		b(w, i, j + 15, k + 13, sandstone, 0);
		m(w, i, j + 15, k + 13, 1);
		b(w, i, j + 15, k + 14, sandstone, 0);
		m(w, i, j + 15, k + 14, 1);
		...
		b(w, i, j + 16, k + 12, sandstone, 0);
		m(w, i, j + 16, k + 12, 1);
		b(w, i, j + 16, k + 13, sandstone, 0);
		m(w, i, j + 16, k + 13, 1);
		b(w, i, j + 16, k + 14, sandstone, 0);
		m(w, i, j + 16, k + 14, 1);
		...
		b(w, i, j + 17, k + 12, sandstone, 0);
		m(w, i, j + 17, k + 12, 1);
		b(w, i, j + 17, k + 13, sandstone, 0);
		m(w, i, j + 17, k + 13, 1);
		b(w, i, j + 17, k + 14, sandstone, 0);
		m(w, i, j + 17, k + 14, 1);
	...
	public static void generate_1(World w, int i, int j, int k)
	{
		...
		m(w, i + 1, j + 4, k + 11, 7);
		b(w, i + 1, j + 4, k + 12, stone_slab, 0);
		m(w, i + 1, j + 4, k + 12, 9);
		b(w, i + 1, j + 4, k + 13, stone_slab, 0);
		m(w, i + 1, j + 4, k + 13, 9);
		...
		m(w, i + 2, j + 3, k + 11, 1);
		b(w, i + 2, j + 3, k + 12, sandstone_stairs, 0);
		m(w, i + 2, j + 3, k + 12, 7);
	...
	public static void generate_2(World w, int i, int j, int k)
	{
		...
		m(w, i + 2, j + 5, k + 14, 1);
		b(w, i + 2, j + 5, k + 15, sandstone_stairs, 0);
		m(w, i + 2, j + 5, k + 15, 3);
		b(w, i + 2, j + 6, k, air, 0);
		...
		b(w, i + 2, j + 6, k + 12, sandstone_stairs, 0);
		m(w, i + 2, j + 6, k + 12, 2);
		b(w, i + 2, j + 6, k + 13, sandstone, 0);
		m(w, i + 2, j + 6, k + 13, 1);
		b(w, i + 2, j + 6, k + 14, sandstone_stairs, 0);
		m(w, i + 2, j + 6, k + 14, 3);
	...
	public static void generate_3(World w, int i, int j, int k)
	{
		...
		b(w, i + 4, j + 1, k, bed, 0);
		m(w, i + 4, j + 1, k, 9);
		b(w, i + 4, j + 1, k + 1, bed, 0);
		m(w, i + 4, j + 1, k + 1, 9);
		b(w, i + 4, j + 1, k + 2, chest, 0);
		m(w, i + 4, j + 1, k + 2, 5);
		b(w, i + 4, j + 1, k + 3, crafting_table, 0);
		b(w, i + 4, j + 1, k + 4, bed, 0);
		m(w, i + 4, j + 1, k + 4, 9);
		b(w, i + 4, j + 1, k + 5, bed, 0);
		m(w, i + 4, j + 1, k + 5, 9);
		b(w, i + 4, j + 1, k + 6, blockTable, 0);
		m(w, i + 4, j + 1, k + 6, 2);
		...
		b(w, i + 4, j + 8, k + 2, sandstone_stairs, 0);
		b(w, i + 4, j + 8, k + 3, sandstone_stairs, 0);
	...
	public static void generate_4(World w, int i, int j, int k)
	{
		...
		b(w, i + 5, j + 1, k, bed, 0);
		m(w, i + 5, j + 1, k, 1);
		b(w, i + 5, j + 1, k + 1, bed, 0);
		m(w, i + 5, j + 1, k + 1, 1);
		b(w, i + 5, j + 1, k + 2, air, 0);
		b(w, i + 5, j + 1, k + 3, air, 0);
		b(w, i + 5, j + 1, k + 4, bed, 0);
		m(w, i + 5, j + 1, k + 4, 1);
		b(w, i + 5, j + 1, k + 5, bed, 0);
		m(w, i + 5, j + 1, k + 5, 1);
		...
		b(w, i + 5, j + 8, k, air, 0);
		b(w, i + 5, j + 8, k + 1, sandstone_stairs, 0);
		...
		b(w, i + 5, j + 9, k + 2, sandstone_stairs, 0);
	...
	public static void generate_5(World w, int i, int j, int k)
	{
		...
		b(w, i + 6, j + 8, k + 5, sandstone_stairs, 0);
		m(w, i + 6, j + 8, k + 5, 3);
	...
	public static void generate_6(World w, int i, int j, int k)
	{
		...
		b(w, i + 7, j + 1, k + 2, carpet, 0);
		m(w, i + 7, j + 1, k + 2, 8);
		b(w, i + 7, j + 1, k + 3, carpet, 0);
		m(w, i + 7, j + 1, k + 3, 8);
		...
		b(w, i + 7, j + 9, k + 5, sandstone_stairs, 0);
		m(w, i + 7, j + 9, k + 5, 3);
		...
		b(w, i + 7, j + 10, k + 2, stone_slab, 0);
		m(w, i + 7, j + 10, k + 2, 1);
		b(w, i + 7, j + 10, k + 3, stone_slab, 0);
		m(w, i + 7, j + 10, k + 3, 1);
	...
	public static void generate_7(World w, int i, int j, int k)
	{
		...
		m(w, i + 8, j + 1, k + 1, 8);
		b(w, i + 8, j + 1, k + 2, carpet, 0);
		m(w, i + 8, j + 1, k + 2, 8);
		b(w, i + 8, j + 1, k + 3, carpet, 0);
		m(w, i + 8, j + 1, k + 3, 8);
		b(w, i + 8, j + 1, k + 4, carpet, 0);
		m(w, i + 8, j + 1, k + 4, 8);
		...
		b(w, i + 8, j + 8, k + 6, sandstone_stairs, 0);
		m(w, i + 8, j + 8, k + 6, 3);
		...
		b(w, i + 8, j + 10, k + 2, stone_slab, 0);
		m(w, i + 8, j + 10, k + 2, 1);
		b(w, i + 8, j + 10, k + 3, stone_slab, 0);
		m(w, i + 8, j + 10, k + 3, 1);
	...
	public static void generate_8(World w, int i, int j, int k)
	{
		...
		m(w, i + 9, j + 1, k + 1, 8);
		b(w, i + 9, j + 1, k + 2, carpet, 0);
		m(w, i + 9, j + 1, k + 2, 8);
		b(w, i + 9, j + 1, k + 3, carpet, 0);
		m(w, i + 9, j + 1, k + 3, 8);
		b(w, i + 9, j + 1, k + 4, carpet, 0);
		m(w, i + 9, j + 1, k + 4, 8);
		b(w, i + 9, j + 1, k + 5, air, 0);
		b(w, i + 9, j + 1, k + 6, blockTable, 0);
		m(w, i + 9, j + 1, k + 6, 2);
		...
		b(w, i + 9, j + 8, k + 5, sandstone_stairs, 0);
		m(w, i + 9, j + 8, k + 5, 3);
		...
		b(w, i + 9, j + 9, k, air, 0);
		b(w, i + 9, j + 9, k + 1, stone_slab, 0);
		m(w, i + 9, j + 9, k + 1, 1);
		b(w, i + 9, j + 9, k + 2, sandstone, 0);
		b(w, i + 9, j + 9, k + 3, sandstone, 0);
		b(w, i + 9, j + 9, k + 4, stone_slab, 0);
		m(w, i + 9, j + 9, k + 4, 1);
	...
	public static void generate_9(World w, int i, int j, int k)
	{
		...
		b(w, i + 10, j + 1, k + 2, carpet, 0);
		m(w, i + 10, j + 1, k + 2, 8);
		b(w, i + 10, j + 1, k + 3, carpet, 0);
		m(w, i + 10, j + 1, k + 3, 8);
		...
		b(w, i + 10, j + 8, k + 1, sandstone_stairs, 0);
		m(w, i + 10, j + 8, k + 1, 1);
	...
	public static void generate_10(World w, int i, int j, int k)
	{
		...
		m(w, i + 11, j + 8, k + 2, 1);
		b(w, i + 11, j + 8, k + 3, sandstone_stairs, 0);
		m(w, i + 11, j + 8, k + 3, 1);
	...
	public static void generate_11(World w, int i, int j, int k)
	{
		...
		b(w, i + 12, j + 4, k, sandstone_stairs, 0);
		m(w, i + 12, j + 4, k, 7);
		b(w, i + 12, j + 4, k + 1, stone_slab, 0);
		m(w, i + 12, j + 4, k + 1, 9);
		b(w, i + 12, j + 4, k + 2, stone_slab, 0);
		m(w, i + 12, j + 4, k + 2, 9);
		b(w, i + 12, j + 4, k + 3, stone_slab, 0);
		m(w, i + 12, j + 4, k + 3, 9);
		b(w, i + 12, j + 4, k + 4, stone_slab, 0);
		m(w, i + 12, j + 4, k + 4, 9);
		b(w, i + 12, j + 4, k + 5, sandstone_stairs, 0);
		m(w, i + 12, j + 4, k + 5, 6);
	...
	public static void generate_12(World w, int i, int j, int k)
	{
		...
		b(w, i + 13, j + 3, k + 4, sandstone_stairs, 0);
		m(w, i + 13, j + 3, k + 4, 6);
	...
	public static void generate_13(World w, int i, int j, int k)
	{
		...
		m(w, i + 14, j + 3, k + 1, 1);
		b(w, i + 14, j + 3, k + 2, sandstone_stairs, 0);
		m(w, i + 14, j + 3, k + 2, 7);
		...
		b(w, i + 14, j + 4, k + 1, stone_slab, 0);
		m(w, i + 14, j + 4, k + 1, 1);
		b(w, i + 14, j + 4, k + 2, sandstone_stairs, 0);
		m(w, i + 14, j + 4, k + 2, 1);
		b(w, i + 14, j + 4, k + 3, sandstone_stairs, 0);
		m(w, i + 14, j + 4, k + 3, 1);
		b(w, i + 14, j + 4, k + 4, stone_slab, 0);
		m(w, i + 14, j + 4, k + 4, 1);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 52, j + 1, k + 130);
		TileEntityChest chest1 = (TileEntityChest)w.getTileEntity(i + 49, j + 1, k + 143);
		TileEntityChest chest2 = (TileEntityChest)w.getTileEntity(i + 48, j + 1, k + 143);
	}
