...
public class WorldGenMosEisleyBig_x112_z32
{
	public static void generate(World w, int i, int j, int k)
	{
		...
		b(w, i, j + 4, k + 8, air, 0);
		b(w, i, j + 4, k + 9, air, 0);
		b(w, i, j + 4, k + 10, sandstone_stairs, 0);
		m(w, i, j + 4, k + 10, 2);
	...
	public static void generate_2(World w, int i, int j, int k)
	{
		...
		b(w, i + 3, j + 4, k + 14, sandstone_stairs, 0);
		m(w, i + 3, j + 4, k + 14, 1);
	...
	public static void generate_7(World w, int i, int j, int k)
	{
		...
		b(w, i + 8, j + 5, k + 1, sandstone_stairs, 0);
	...
	public static void generate_9(World w, int i, int j, int k)
	{
		...
		b(w, i + 10, j + 11, k, sandstone_stairs, 0);
		m(w, i + 10, j + 11, k, 3);
	...
	public static void generate_11(World w, int i, int j, int k)
	{
		...
		b(w, i + 12, j + 8, k + 13, stone_slab, 0);
		m(w, i + 12, j + 8, k + 13, 1);
		b(w, i + 12, j + 8, k + 14, sandstone_stairs, 0);
		m(w, i + 12, j + 8, k + 14, 1);
		b(w, i + 12, j + 8, k + 15, sandstone_stairs, 0);
		m(w, i + 12, j + 8, k + 15, 1);
		...
		b(w, i + 12, j + 11, k, sandstone_stairs, 0);
		m(w, i + 12, j + 11, k, 3);
	...
	public static void generate_13(World w, int i, int j, int k)
	{
		...
		b(w, i + 14, j + 5, k + 14, stone_slab, 0);
		m(w, i + 14, j + 5, k + 14, 1);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 120, j + 1, k + 32);
	}
