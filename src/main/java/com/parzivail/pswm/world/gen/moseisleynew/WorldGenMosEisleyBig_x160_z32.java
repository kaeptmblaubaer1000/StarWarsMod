...
public class WorldGenMosEisleyBig_x160_z32
{
	public static void generate(World w, int i, int j, int k)
	{
		...
		b(w, i, j + 1, k + 8, air, 0);
		b(w, i, j + 1, k + 9, air, 0);
		b(w, i, j + 1, k + 10, carpet, 0);
		m(w, i, j + 1, k + 10, 8);
		b(w, i, j + 1, k + 11, carpet, 0);
		m(w, i, j + 1, k + 11, 8);
		...
		b(w, i, j + 3, k + 15, sandstone_stairs, 0);
		m(w, i, j + 3, k + 15, 5);
		b(w, i, j + 4, k, air, 0);
		b(w, i, j + 4, k + 1, air, 0);
		b(w, i, j + 4, k + 2, air, 0);
		...
		b(w, i + 1, j + 1, k + 6, chest, 0);
		m(w, i + 1, j + 1, k + 6, 3);
		b(w, i + 1, j + 1, k + 7, air, 0);
		b(w, i + 1, j + 1, k + 8, air, 0);
		b(w, i + 1, j + 1, k + 9, carpet, 0);
		m(w, i + 1, j + 1, k + 9, 8);
		b(w, i + 1, j + 1, k + 10, carpet, 0);
		m(w, i + 1, j + 1, k + 10, 8);
		b(w, i + 1, j + 1, k + 11, carpet, 0);
		m(w, i + 1, j + 1, k + 11, 8);
		b(w, i + 1, j + 1, k + 12, carpet, 0);
		m(w, i + 1, j + 1, k + 12, 8);
	...
	public static void generate_1(World w, int i, int j, int k)
	{
		...
		b(w, i + 1, j + 8, k + 6, sandstone_stairs, 0);
		m(w, i + 1, j + 8, k + 6, 2);
		...
		b(w, i + 1, j + 8, k + 13, sandstone_stairs, 0);
		m(w, i + 1, j + 8, k + 13, 3);
		...
		b(w, i + 1, j + 10, k + 9, stone_slab, 0);
		m(w, i + 1, j + 10, k + 9, 1);
		b(w, i + 1, j + 10, k + 10, stone_slab, 0);
		m(w, i + 1, j + 10, k + 10, 1);
		...
		b(w, i + 2, j + 1, k + 6, crafting_table, 0);
		b(w, i + 2, j + 1, k + 7, air, 0);
		b(w, i + 2, j + 1, k + 8, air, 0);
		b(w, i + 2, j + 1, k + 9, carpet, 0);
		m(w, i + 2, j + 1, k + 9, 8);
		b(w, i + 2, j + 1, k + 10, carpet, 0);
		m(w, i + 2, j + 1, k + 10, 8);
		b(w, i + 2, j + 1, k + 11, carpet, 0);
		m(w, i + 2, j + 1, k + 11, 8);
		b(w, i + 2, j + 1, k + 12, carpet, 0);
		m(w, i + 2, j + 1, k + 12, 8);
	...
	public static void generate_2(World w, int i, int j, int k)
	{
		...
		b(w, i + 2, j + 8, k + 6, sandstone_stairs, 0);
		m(w, i + 2, j + 8, k + 6, 2);
		...
		b(w, i + 2, j + 8, k + 13, sandstone_stairs, 0);
		m(w, i + 2, j + 8, k + 13, 3);
		...
		b(w, i + 2, j + 10, k + 9, stone_slab, 0);
		m(w, i + 2, j + 10, k + 9, 1);
		b(w, i + 2, j + 10, k + 10, stone_slab, 0);
		m(w, i + 2, j + 10, k + 10, 1);
		...
		b(w, i + 3, j + 1, k + 6, bed, 0);
		m(w, i + 3, j + 1, k + 6, 10);
		b(w, i + 3, j + 1, k + 7, bed, 0);
		m(w, i + 3, j + 1, k + 7, 2);
		b(w, i + 3, j + 1, k + 8, air, 0);
		b(w, i + 3, j + 1, k + 9, air, 0);
		b(w, i + 3, j + 1, k + 10, carpet, 0);
		m(w, i + 3, j + 1, k + 10, 8);
		b(w, i + 3, j + 1, k + 11, carpet, 0);
		m(w, i + 3, j + 1, k + 11, 8);
		...
		b(w, i + 3, j + 3, k + 4, sandstone_stairs, 0);
		m(w, i + 3, j + 3, k + 4, 2);
	...
	public static void generate_3(World w, int i, int j, int k)
	{
		...
		b(w, i + 3, j + 8, k + 7, sandstone_stairs, 0);
		m(w, i + 3, j + 8, k + 7, 2);
		...
		b(w, i + 4, j + 1, k + 6, bed, 0);
		m(w, i + 4, j + 1, k + 6, 10);
		b(w, i + 4, j + 1, k + 7, bed, 0);
		m(w, i + 4, j + 1, k + 7, 2);
	...
	public static void generate_4(World w, int i, int j, int k)
	{
		...
		m(w, i + 4, j + 9, k + 9, 1);
		b(w, i + 4, j + 9, k + 10, sandstone_stairs, 0);
		m(w, i + 4, j + 9, k + 10, 1);
		...
		b(w, i + 5, j + 3, k + 12, torch, 0);
		m(w, i + 5, j + 3, k + 12, 2);
		b(w, i + 5, j + 3, k + 13, torch, 0);
		m(w, i + 5, j + 3, k + 13, 4);
	...
	public static void generate_6(World w, int i, int j, int k)
	{
		...
		b(w, i + 7, j + 3, k + 8, sandstone_stairs, 0);
		m(w, i + 7, j + 3, k + 8, 1);
	...
	public static void generate_10(World w, int i, int j, int k)
	{
		...
		b(w, i + 11, j + 11, k + 3, sandstone_stairs, 0);
	...
	public static void generate_11(World w, int i, int j, int k)
	{
		...
		b(w, i + 12, j + 11, k + 3, sandstone_stairs, 0);
		m(w, i + 12, j + 11, k + 3, 3);
	...
	public static void generate_12(World w, int i, int j, int k)
	{
		...
		b(w, i + 13, j + 2, k, sandstone_stairs, 0);
		m(w, i + 13, j + 2, k, 3);
		...
		b(w, i + 13, j + 6, k, sandstone_stairs, 0);
		m(w, i + 13, j + 6, k, 3);
		...
		b(w, i + 13, j + 10, k, sandstone_stairs, 0);
		m(w, i + 13, j + 10, k, 3);
		...
		b(w, i + 13, j + 11, k + 2, sandstone, 0);
		b(w, i + 13, j + 11, k + 3, sandstone_stairs, 0);
		m(w, i + 13, j + 11, k + 3, 3);
	...
	public static void generate_13(World w, int i, int j, int k)
	{
		...
		b(w, i + 14, j + 5, k + 1, sandstone_stairs, 0);
		m(w, i + 14, j + 5, k + 1, 1);
		...
		b(w, i + 14, j + 9, k + 1, sandstone_stairs, 0);
		m(w, i + 14, j + 9, k + 1, 1);
		...
		b(w, i + 14, j + 11, k + 3, sandstone_stairs, 0);
		m(w, i + 14, j + 11, k + 3, 3);
		...
		b(w, i + 14, j + 19, k, sandstone, 0);
		b(w, i + 14, j + 19, k + 1, sandstone, 0);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		b(w, i + 15, j + 4, k, sandstone_stairs, 0);
		m(w, i + 15, j + 4, k, 2);
		...
		b(w, i + 15, j + 8, k, sandstone_stairs, 0);
		m(w, i + 15, j + 8, k, 2);
		...
		b(w, i + 15, j + 12, k, sandstone_stairs, 0);
		m(w, i + 15, j + 12, k, 2);
		...
		b(w, i + 15, j + 15, k + 1, torch, 0);
		m(w, i + 15, j + 15, k + 1, 4);
		b(w, i + 15, j + 15, k + 2, sandstone, 0);
		m(w, i + 15, j + 15, k + 2, 1);
		...
		b(w, i + 15, j + 17, k + 1, sandstone, 0);
		b(w, i + 15, j + 17, k + 2, sandstone, 0);
		m(w, i + 15, j + 17, k + 2, 1);
		...
		b(w, i + 15, j + 18, k, sandstone, 0);
		b(w, i + 15, j + 18, k + 1, sandstone, 0);
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 161, j + 1, k + 38);
	}
