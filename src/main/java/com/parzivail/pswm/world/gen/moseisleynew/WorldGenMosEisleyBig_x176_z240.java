...
public class WorldGenMosEisleyBig_x176_z240
{
	public static void generate(World w, int i, int j, int k)
	{
		...
		b(w, i, j + 1, k, air, 0);
		b(w, i, j + 1, k + 1, carpet, 0);
		m(w, i, j + 1, k + 1, 8);
		b(w, i, j + 1, k + 2, carpet, 0);
		m(w, i, j + 1, k + 2, 8);
		b(w, i, j + 1, k + 3, carpet, 0);
		m(w, i, j + 1, k + 3, 8);
		b(w, i, j + 1, k + 4, carpet, 0);
		m(w, i, j + 1, k + 4, 8);
		b(w, i, j + 1, k + 5, air, 0);
		b(w, i, j + 1, k + 6, air, 0);
		...
		b(w, i, j + 8, k + 6, sandstone_stairs, 0);
		m(w, i, j + 8, k + 6, 3);
		b(w, i, j + 8, k + 7, air, 0);
		b(w, i, j + 8, k + 8, air, 0);
		b(w, i, j + 8, k + 9, air, 0);
		...
		b(w, i, j + 10, k + 2, stone_slab, 0);
		m(w, i, j + 10, k + 2, 1);
		b(w, i, j + 10, k + 3, stone_slab, 0);
		m(w, i, j + 10, k + 3, 1);
		...
		b(w, i + 1, j + 1, k + 2, carpet, 0);
		m(w, i + 1, j + 1, k + 2, 8);
		b(w, i + 1, j + 1, k + 3, carpet, 0);
		m(w, i + 1, j + 1, k + 3, 8);
	...
	public static void generate_1(World w, int i, int j, int k)
	{
		...
		b(w, i + 1, j + 10, k + 2, stone_slab, 0);
		m(w, i + 1, j + 10, k + 2, 1);
		b(w, i + 1, j + 10, k + 3, stone_slab, 0);
		m(w, i + 1, j + 10, k + 3, 1);
	...
	public static void generate_3(World w, int i, int j, int k)
	{
		...
		m(w, i + 4, j + 1, k + 1, 11);
		b(w, i + 4, j + 1, k + 2, crafting_table, 0);
		b(w, i + 4, j + 1, k + 3, chest, 0);
		m(w, i + 4, j + 1, k + 3, 4);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 180, j + 1, k + 243);
	}
