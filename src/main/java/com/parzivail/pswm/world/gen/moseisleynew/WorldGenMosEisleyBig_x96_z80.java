...
public class WorldGenMosEisleyBig_x96_z80
{
	public static void generate(World w, int i, int j, int k)
	{
		...
		b(w, i, j + 4, k + 7, sandstone_stairs, 0);
		m(w, i, j + 4, k + 7, 1);
		b(w, i, j + 4, k + 8, air, 0);
		b(w, i, j + 4, k + 9, air, 0);
	...
	public static void generate_1(World w, int i, int j, int k)
	{
		...
		b(w, i + 2, j + 2, k + 8, sandstone_stairs, 0);
	...
	public static void generate_4(World w, int i, int j, int k)
	{
		...
		b(w, i + 5, j + 4, k, air, 0);
		b(w, i + 5, j + 4, k + 1, sandstone_stairs, 0);
		m(w, i + 5, j + 4, k + 1, 6);
		b(w, i + 5, j + 4, k + 2, sandstone, 0);
		b(w, i + 5, j + 4, k + 3, sandstone, 0);
		b(w, i + 5, j + 4, k + 4, sandstone_stairs, 0);
		m(w, i + 5, j + 4, k + 4, 3);
	...
	public static void generate_6(World w, int i, int j, int k)
	{
		...
		b(w, i + 7, j + 4, k + 2, sandstone_stairs, 0);
		m(w, i + 7, j + 4, k + 2, 3);
