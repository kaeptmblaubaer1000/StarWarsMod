 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x32_z112
{
	...
	public static void generate_1(World w, int i, int j, int k)
	{
		...
		b(w, i + 2, j + 1, k + 8, sandstone_stairs, 0);
		m(w, i + 2, j + 1, k + 8, 1);
	...
	public static void generate_2(World w, int i, int j, int k)
	{
		...
		b(w, i + 3, j + 3, k, sandstone_stairs, 0);
		m(w, i + 3, j + 3, k, 6);
		...
		b(w, i + 3, j + 4, k, sandstone_stairs, 0);
		b(w, i + 3, j + 4, k + 1, stone_slab, 0);
		m(w, i + 3, j + 4, k + 1, 1);
	...
	public static void generate_3(World w, int i, int j, int k)
	{
		...
		b(w, i + 4, j + 3, k, air, 0);
		b(w, i + 4, j + 3, k + 1, sandstone_stairs, 0);
		m(w, i + 4, j + 3, k + 1, 6);
	...
	public static void generate_4(World w, int i, int j, int k)
	{
		...
		m(w, i + 5, j + 6, k + 13, 1);
		b(w, i + 5, j + 6, k + 14, sandstone_stairs, 0);
		m(w, i + 5, j + 6, k + 14, 7);
		b(w, i + 5, j + 6, k + 15, stone_slab, 0);
		m(w, i + 5, j + 6, k + 15, 9);
		b(w, i + 5, j + 7, k, air, 0);
	...
	public static void generate_5(World w, int i, int j, int k)
	{
		...
		b(w, i + 6, j + 8, k, sandstone_stairs, 0);
	...
	public static void generate_6(World w, int i, int j, int k)
	{
		...
		b(w, i + 7, j + 1, k, carpet, 0);
		m(w, i + 7, j + 1, k, 8);
		b(w, i + 7, j + 1, k + 1, air, 0);
		b(w, i + 7, j + 1, k + 2, air, 0);
		b(w, i + 7, j + 1, k + 3, jukebox, 0);
		...
		b(w, i + 7, j + 8, k + 1, sandstone_stairs, 0);
		...
		b(w, i + 7, j + 9, k, sandstone_stairs, 0);
	...
	public static void generate_7(World w, int i, int j, int k)
	{
		...
		b(w, i + 8, j + 1, k, carpet, 0);
		m(w, i + 8, j + 1, k, 8);
		b(w, i + 8, j + 1, k + 1, carpet, 0);
		m(w, i + 8, j + 1, k + 1, 8);
		...
		b(w, i + 8, j + 8, k + 2, sandstone_stairs, 0);
		m(w, i + 8, j + 8, k + 2, 3);
	...
	public static void generate_8(World w, int i, int j, int k)
	{
		...
		b(w, i + 9, j + 1, k, carpet, 0);
		m(w, i + 9, j + 1, k, 8);
		b(w, i + 9, j + 1, k + 1, carpet, 0);
		m(w, i + 9, j + 1, k + 1, 8);
	...
	public static void generate_9(World w, int i, int j, int k)
	{
		...
		b(w, i + 10, j + 8, k + 3, sandstone_stairs, 0);
		m(w, i + 10, j + 8, k + 3, 3);
		...
		b(w, i + 10, j + 9, k + 2, sandstone_stairs, 0);
		m(w, i + 10, j + 9, k + 2, 3);
	...
	public static void generate_11(World w, int i, int j, int k)
	{
		...
		b(w, i + 12, j + 1, k + 1, bed, 0);
		m(w, i + 12, j + 1, k + 1, 3);
		b(w, i + 12, j + 1, k + 2, bed, 0);
		m(w, i + 12, j + 1, k + 2, 3);
	...
	public static void generate_12(World w, int i, int j, int k)
	{
		...
		b(w, i + 13, j + 1, k, chest, 0);
		m(w, i + 13, j + 1, k, 4);
		b(w, i + 13, j + 1, k + 1, bed, 0);
		m(w, i + 13, j + 1, k + 1, 11);
		b(w, i + 13, j + 1, k + 2, bed, 0);
		m(w, i + 13, j + 1, k + 2, 11);
		b(w, i + 13, j + 1, k + 3, blockTable, 0);
		m(w, i + 13, j + 1, k + 3, 3);
	...
	public static void generate_13(World w, int i, int j, int k)
	{
		...
		b(w, i + 15, j + 3, k + 1, sandstone_stairs, 0);
		m(w, i + 15, j + 3, k + 1, 1);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 38, j + 1, k + 115);
		TileEntityChest chest1 = (TileEntityChest)w.getTileEntity(i + 45, j + 1, k + 112);
	}
