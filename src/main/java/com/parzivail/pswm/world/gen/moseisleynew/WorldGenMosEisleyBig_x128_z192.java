 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x128_z192
{
	...
	public static void generate_1(World w, int i, int j, int k)
	{
		...
		b(w, i + 1, j + 4, k + 12, sandstone_stairs, 0);
		m(w, i + 1, j + 4, k + 12, 2);
	...
	public static void generate_2(World w, int i, int j, int k)
	{
		...
		b(w, i + 2, j + 4, k + 11, sandstone_stairs, 0);
		b(w, i + 2, j + 4, k + 12, sandstone, 0);
		b(w, i + 2, j + 4, k + 13, torch, 0);
		m(w, i + 2, j + 4, k + 13, 3);
	...
	public static void generate_3(World w, int i, int j, int k)
	{
		...
		b(w, i + 4, j + 4, k + 9, sandstone_stairs, 0);
	...
	public static void generate_8(World w, int i, int j, int k)
	{
		...
		b(w, i + 9, j + 4, k + 10, sandstone_stairs, 0);
		m(w, i + 9, j + 4, k + 10, 4);
	...
	public static void generate_11(World w, int i, int j, int k)
	{
		...
		b(w, i + 12, j + 2, k + 15, stone_slab, 0);
		m(w, i + 12, j + 2, k + 15, 1);
	...
	public static void generate_12(World w, int i, int j, int k)
	{
		...
		b(w, i + 13, j + 1, k + 13, stone_slab, 0);
		m(w, i + 13, j + 1, k + 13, 1);
		b(w, i + 13, j + 1, k + 14, stone_slab, 0);
		m(w, i + 13, j + 1, k + 14, 1);
		b(w, i + 13, j + 1, k + 15, stone_slab, 0);
		m(w, i + 13, j + 1, k + 15, 1);
		...
		b(w, i + 13, j + 4, k + 11, sandstone_stairs, 0);
		m(w, i + 13, j + 4, k + 11, 1);
	...
	public static void generate_13(World w, int i, int j, int k)
	{
		...
		b(w, i + 14, j + 1, k + 15, stone_slab, 0);
		m(w, i + 14, j + 1, k + 15, 1);
