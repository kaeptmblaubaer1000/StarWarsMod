 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x32_z0
{
	public static void generate(World w, int i, int j, int k)
	{
		...
		b(w, i, j + 8, k + 7, air, 0);
		b(w, i, j + 8, k + 8, air, 0);
		b(w, i, j + 8, k + 9, sandstone_stairs, 0);
		m(w, i, j + 8, k + 9, 1);
		...
		b(w, i, j + 9, k + 8, air, 0);
		b(w, i, j + 9, k + 9, air, 0);
		b(w, i, j + 9, k + 10, sandstone_stairs, 0);
		m(w, i, j + 9, k + 10, 1);
		...
		b(w, i + 1, j + 1, k + 7, blockTable, 0);
		m(w, i + 1, j + 1, k + 7, 3);
		b(w, i + 1, j + 1, k + 8, bed, 0);
		m(w, i + 1, j + 1, k + 8, 11);
		b(w, i + 1, j + 1, k + 9, bed, 0);
		m(w, i + 1, j + 1, k + 9, 11);
		b(w, i + 1, j + 1, k + 10, crafting_table, 0);
		b(w, i + 1, j + 1, k + 11, chest, 0);
		m(w, i + 1, j + 1, k + 11, 4);
		b(w, i + 1, j + 1, k + 12, bed, 0);
		m(w, i + 1, j + 1, k + 12, 11);
		b(w, i + 1, j + 1, k + 13, bed, 0);
		m(w, i + 1, j + 1, k + 13, 11);
		b(w, i + 1, j + 1, k + 14, blockTable, 0);
		m(w, i + 1, j + 1, k + 14, 3);
	...
	public static void generate_1(World w, int i, int j, int k)
	{
		...
		b(w, i + 1, j + 8, k + 10, sandstone_stairs, 0);
		m(w, i + 1, j + 8, k + 10, 1);
		b(w, i + 1, j + 8, k + 11, sandstone_stairs, 0);
		m(w, i + 1, j + 8, k + 11, 1);
	...
	public static void generate_2(World w, int i, int j, int k)
	{
		...
		b(w, i + 3, j + 3, k + 9, sandstone_stairs, 0);
		m(w, i + 3, j + 3, k + 9, 1);
	...
	public static void generate_13(World w, int i, int j, int k)
	{
		...
		m(w, i + 14, j + 11, k + 4, 2);
		b(w, i + 14, j + 11, k + 5, sandstone, 0);
		b(w, i + 14, j + 11, k + 6, sandstone, 0);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		b(w, i + 15, j + 6, k + 7, sandstone_stairs, 0);
		m(w, i + 15, j + 6, k + 7, 3);
		...
		b(w, i + 15, j + 10, k + 7, sandstone_stairs, 0);
		m(w, i + 15, j + 10, k + 7, 3);
		...
		b(w, i + 15, j + 15, k + 5, sandstone, 0);
		m(w, i + 15, j + 15, k + 5, 1);
		b(w, i + 15, j + 15, k + 6, torch, 0);
		m(w, i + 15, j + 15, k + 6, 3);
		b(w, i + 15, j + 15, k + 7, air, 0);
		b(w, i + 15, j + 15, k + 8, torch, 0);
		m(w, i + 15, j + 15, k + 8, 4);
		...
		b(w, i + 15, j + 17, k + 5, sandstone, 0);
		m(w, i + 15, j + 17, k + 5, 1);
		b(w, i + 15, j + 17, k + 6, sandstone, 0);
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 33, j + 1, k + 11);
	}
