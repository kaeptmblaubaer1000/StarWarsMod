...
public class WorldGenMosEisleyBig_x144_z224
{
	...
	public static void generate_6(World w, int i, int j, int k)
	{
		...
		m(w, i + 7, j + 1, k + 8, 3);
		b(w, i + 7, j + 1, k + 9, blockTable, 0);
		b(w, i + 7, j + 1, k + 10, blockTable, 0);
		b(w, i + 7, j + 1, k + 11, blockTable, 0);
