...
public class WorldGenMosEisleyBig_x144_z112
{
	public static void generate(World w, int i, int j, int k)
	{
		...
		b(w, i, j + 9, k, air, 0);
		b(w, i, j + 9, k + 1, air, 0);
		b(w, i, j + 9, k + 2, sandstone_stairs, 0);
	...
	public static void generate_1(World w, int i, int j, int k)
	{
		...
		b(w, i + 2, j + 1, k + 2, carpet, 0);
		m(w, i + 2, j + 1, k + 2, 8);
		b(w, i + 2, j + 1, k + 3, carpet, 0);
		m(w, i + 2, j + 1, k + 3, 8);
	...
	public static void generate_2(World w, int i, int j, int k)
	{
		...
		b(w, i + 2, j + 10, k + 2, stone_slab, 0);
		m(w, i + 2, j + 10, k + 2, 1);
		b(w, i + 2, j + 10, k + 3, stone_slab, 0);
		m(w, i + 2, j + 10, k + 3, 1);
		...
		b(w, i + 3, j + 1, k, air, 0);
		b(w, i + 3, j + 1, k + 1, carpet, 0);
		m(w, i + 3, j + 1, k + 1, 8);
		b(w, i + 3, j + 1, k + 2, carpet, 0);
		m(w, i + 3, j + 1, k + 2, 8);
		b(w, i + 3, j + 1, k + 3, carpet, 0);
		m(w, i + 3, j + 1, k + 3, 8);
		b(w, i + 3, j + 1, k + 4, carpet, 0);
		m(w, i + 3, j + 1, k + 4, 8);
	...
	public static void generate_3(World w, int i, int j, int k)
	{
		...
		b(w, i + 3, j + 10, k + 2, stone_slab, 0);
		m(w, i + 3, j + 10, k + 2, 1);
		b(w, i + 3, j + 10, k + 3, stone_slab, 0);
		m(w, i + 3, j + 10, k + 3, 1);
		...
		m(w, i + 4, j, k + 15, 1);
		b(w, i + 4, j + 1, k, air, 0);
		b(w, i + 4, j + 1, k + 1, carpet, 0);
		m(w, i + 4, j + 1, k + 1, 8);
		b(w, i + 4, j + 1, k + 2, carpet, 0);
		m(w, i + 4, j + 1, k + 2, 8);
		b(w, i + 4, j + 1, k + 3, carpet, 0);
		m(w, i + 4, j + 1, k + 3, 8);
		b(w, i + 4, j + 1, k + 4, carpet, 0);
		m(w, i + 4, j + 1, k + 4, 8);
	...
	public static void generate_4(World w, int i, int j, int k)
	{
		...
		b(w, i + 5, j + 1, k + 2, carpet, 0);
		m(w, i + 5, j + 1, k + 2, 8);
		b(w, i + 5, j + 1, k + 3, carpet, 0);
		m(w, i + 5, j + 1, k + 3, 8);
	...
	public static void generate_8(World w, int i, int j, int k)
	{
		...
		m(w, i + 9, j + 3, k + 1, 1);
		b(w, i + 9, j + 3, k + 2, sandstone_stairs, 0);
		m(w, i + 9, j + 3, k + 2, 7);
