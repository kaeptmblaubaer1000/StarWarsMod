 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x32_z256
{
	...
	public static void generate_5(World w, int i, int j, int k)
	{
		...
		b(w, i + 6, j + 3, k + 8, sandstone_stairs, 0);
		b(w, i + 6, j + 3, k + 9, air, 0);
		b(w, i + 6, j + 3, k + 10, air, 0);
		b(w, i + 6, j + 3, k + 11, air, 0);
		b(w, i + 6, j + 3, k + 12, sandstone_stairs, 0);
	...
	public static void generate_7(World w, int i, int j, int k)
	{
		...
		b(w, i + 8, j + 3, k + 6, sandstone_stairs, 0);
		m(w, i + 8, j + 3, k + 6, 2);
		...
		b(w, i + 8, j + 3, k + 14, sandstone_stairs, 0);
		m(w, i + 8, j + 3, k + 14, 3);
	...
	public static void generate_8(World w, int i, int j, int k)
	{
		...
		m(w, i + 9, j + 15, k + 8, 1);
		b(w, i + 9, j + 15, k + 9, torch, 0);
		m(w, i + 9, j + 15, k + 9, 3);
		b(w, i + 9, j + 15, k + 10, air, 0);
		b(w, i + 9, j + 15, k + 11, torch, 0);
		m(w, i + 9, j + 15, k + 11, 4);
	...
	public static void generate_9(World w, int i, int j, int k)
	{
		...
		b(w, i + 10, j + 5, k + 9, sandstone_stairs, 0);
		m(w, i + 10, j + 5, k + 9, 1);
		...
		b(w, i + 10, j + 7, k + 11, sandstone_stairs, 0);
		...
		b(w, i + 10, j + 11, k + 7, sandstone_stairs, 0);
		m(w, i + 10, j + 11, k + 7, 2);
		b(w, i + 10, j + 11, k + 8, sandstone, 0);
		b(w, i + 10, j + 11, k + 9, air, 0);
		b(w, i + 10, j + 11, k + 10, sandstone, 0);
		b(w, i + 10, j + 11, k + 11, sandstone_stairs, 0);
		b(w, i + 10, j + 11, k + 12, sandstone, 0);
		b(w, i + 10, j + 11, k + 13, sandstone_stairs, 0);
		m(w, i + 10, j + 11, k + 13, 3);
		...
		b(w, i + 10, j + 12, k + 12, sandstone, 0);
		m(w, i + 10, j + 12, k + 12, 1);
		...
		b(w, i + 10, j + 14, k + 12, sandstone, 0);
		m(w, i + 10, j + 14, k + 12, 1);
		...
		b(w, i + 10, j + 15, k + 12, sandstone, 0);
		m(w, i + 10, j + 15, k + 12, 1);
		...
		b(w, i + 10, j + 16, k + 12, sandstone, 0);
		m(w, i + 10, j + 16, k + 12, 1);
		...
		b(w, i + 10, j + 19, k + 11, sandstone, 0);
	...
	public static void generate_10(World w, int i, int j, int k)
	{
		...
		b(w, i + 11, j + 4, k + 10, sandstone_stairs, 0);
		m(w, i + 11, j + 4, k + 10, 3);
		...
		b(w, i + 11, j + 11, k + 7, sandstone_stairs, 0);
		m(w, i + 11, j + 11, k + 7, 2);
		...
		b(w, i + 11, j + 12, k + 8, sandstone, 0);
		m(w, i + 11, j + 12, k + 8, 1);
		b(w, i + 11, j + 12, k + 9, sandstone, 0);
		b(w, i + 11, j + 12, k + 10, sandstone_stairs, 0);
		m(w, i + 11, j + 12, k + 10, 3);
		b(w, i + 11, j + 12, k + 11, air, 0);
		b(w, i + 11, j + 12, k + 12, sandstone, 0);
		m(w, i + 11, j + 12, k + 12, 1);
		...
		b(w, i + 11, j + 15, k + 8, sandstone, 0);
		m(w, i + 11, j + 15, k + 8, 1);
		b(w, i + 11, j + 15, k + 9, torch, 0);
		m(w, i + 11, j + 15, k + 9, 3);
		b(w, i + 11, j + 15, k + 10, air, 0);
		b(w, i + 11, j + 15, k + 11, torch, 0);
		m(w, i + 11, j + 15, k + 11, 4);
		b(w, i + 11, j + 15, k + 12, sandstone, 0);
		m(w, i + 11, j + 15, k + 12, 1);
		...
		b(w, i + 11, j + 19, k + 10, sandstone, 0);
	...
	public static void generate_11(World w, int i, int j, int k)
	{
		...
		b(w, i + 12, j + 3, k + 6, sandstone_stairs, 0);
		m(w, i + 12, j + 3, k + 6, 2);
		...
		b(w, i + 12, j + 11, k + 13, sandstone_stairs, 0);
		m(w, i + 12, j + 11, k + 13, 3);
	...
	public static void generate_12(World w, int i, int j, int k)
	{
		...
		m(w, i + 13, j + 4, k + 7, 2);
		b(w, i + 13, j + 4, k + 8, sandstone_stairs, 0);
		m(w, i + 13, j + 4, k + 8, 7);
		b(w, i + 13, j + 4, k + 9, stone_slab, 0);
		m(w, i + 13, j + 4, k + 9, 9);
		b(w, i + 13, j + 4, k + 10, stone_slab, 0);
		m(w, i + 13, j + 4, k + 10, 9);
		b(w, i + 13, j + 4, k + 11, stone_slab, 0);
		m(w, i + 13, j + 4, k + 11, 9);
	...
	public static void generate_13(World w, int i, int j, int k)
	{
		...
		m(w, i + 14, j + 3, k + 8, 1);
		b(w, i + 14, j + 3, k + 9, sandstone_stairs, 0);
		m(w, i + 14, j + 3, k + 9, 7);
		...
		m(w, i + 14, j + 5, k + 11, 1);
		b(w, i + 14, j + 5, k + 12, sandstone_stairs, 0);
		m(w, i + 14, j + 5, k + 12, 3);
		...
		b(w, i + 14, j + 6, k + 9, sandstone_stairs, 0);
		m(w, i + 14, j + 6, k + 9, 2);
		b(w, i + 14, j + 6, k + 10, sandstone, 0);
		m(w, i + 14, j + 6, k + 10, 1);
		b(w, i + 14, j + 6, k + 11, sandstone_stairs, 0);
		m(w, i + 14, j + 6, k + 11, 3);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 44, j + 1, k + 264);
		TileEntityChest chest1 = (TileEntityChest)w.getTileEntity(i + 45, j + 1, k + 264);
	}
