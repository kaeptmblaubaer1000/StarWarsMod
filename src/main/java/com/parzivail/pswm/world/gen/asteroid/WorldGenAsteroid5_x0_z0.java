 ...
 */
//@formatter:off
public class WorldGenAsteroid5_x0_z0
{
	public static void generate(World w, int i, int j, int k)
	{
		...
		b(w, i, j + 2, k + 2, air, 0);
		b(w, i, j + 2, k + 3, air, 0);
		b(w, i, j + 2, k + 4, stone, 0);
		b(w, i, j + 2, k + 5, air, 0);
		b(w, i, j + 2, k + 6, air, 0);
		b(w, i, j + 2, k + 7, air, 0);
		b(w, i, j + 2, k + 8, stone, 0);
		b(w, i, j + 2, k + 9, air, 0);
		...
		b(w, i + 1, j + 1, k + 4, stone, 0);
		b(w, i + 1, j + 1, k + 5, stone, 0);
		b(w, i + 1, j + 1, k + 6, stone, 0);
		...
		b(w, i + 1, j + 2, k + 2, stone, 0);
		b(w, i + 1, j + 2, k + 3, stone, 0);
		b(w, i + 1, j + 2, k + 4, stone, 0);
		...
		b(w, i + 1, j + 4, k, air, 0);
		b(w, i + 1, j + 4, k + 1, stone, 0);
		b(w, i + 1, j + 4, k + 2, stone, 0);
		b(w, i + 1, j + 4, k + 3, stone, 0);
		...
		b(w, i + 2, j + 1, k + 3, stone, 0);
		b(w, i + 2, j + 1, k + 4, stone, 0);
		...
		b(w, i + 2, j + 2, k, air, 0);
		b(w, i + 2, j + 2, k + 1, stone, 0);
		b(w, i + 2, j + 2, k + 2, stone, 0);
		b(w, i + 2, j + 2, k + 3, stone, 0);
		...
		b(w, i + 3, j + 1, k + 2, stone, 0);
		b(w, i + 3, j + 1, k + 3, stone, 0);
		b(w, i + 3, j + 1, k + 4, stone, 0);
	...
	public static void generate_1(World w, int i, int j, int k)
	{
		...
		b(w, i + 4, j + 1, k + 3, stone, 0);
		b(w, i + 4, j + 1, k + 4, stone, 0);
		...
		b(w, i + 5, j, k + 1, air, 0);
		b(w, i + 5, j, k + 2, air, 0);
		b(w, i + 5, j, k + 3, stone, 0);
		b(w, i + 5, j, k + 4, stone, 0);
		...
		b(w, i + 6, j, k + 1, air, 0);
		b(w, i + 6, j, k + 2, air, 0);
		b(w, i + 6, j, k + 3, stone, 0);
		b(w, i + 6, j, k + 4, stone, 0);
		...
		b(w, i + 7, j, k + 1, air, 0);
		b(w, i + 7, j, k + 2, air, 0);
		b(w, i + 7, j, k + 3, stone, 0);
		b(w, i + 7, j, k + 4, stone, 0);
	...
	public static void generate_2(World w, int i, int j, int k)
	{
		...
		b(w, i + 8, j, k + 1, air, 0);
		b(w, i + 8, j, k + 2, air, 0);
		b(w, i + 8, j, k + 3, stone, 0);
		b(w, i + 8, j, k + 4, stone, 0);
		...
		b(w, i + 9, j, k + 1, air, 0);
		b(w, i + 9, j, k + 2, air, 0);
		b(w, i + 9, j, k + 3, stone, 0);
		b(w, i + 9, j, k + 4, stone, 0);
		...
		b(w, i + 9, j + 5, k + 3, stone, 0);
		b(w, i + 9, j + 5, k + 4, stone, 0);
		b(w, i + 9, j + 5, k + 5, stone, 0);
		b(w, i + 9, j + 5, k + 6, stone, 0);
		b(w, i + 9, j + 5, k + 7, stone, 0);
		...
		b(w, i + 10, j, k + 4, stone, 0);
		b(w, i + 10, j, k + 5, stone, 0);
		...
		b(w, i + 10, j + 1, k + 1, stone, 0);
		b(w, i + 10, j + 1, k + 2, stone, 0);
		...
		b(w, i + 11, j + 1, k + 2, stone, 0);
		b(w, i + 11, j + 1, k + 3, stone, 0);
		...
		b(w, i + 11, j + 2, k, stone, 0);
		b(w, i + 11, j + 2, k + 1, stone, 0);
		...
		b(w, i + 11, j + 6, k + 5, stone, 0);
		b(w, i + 11, j + 6, k + 6, stone, 0);
	...
	public static void generate_3(World w, int i, int j, int k)
	{
		...
		b(w, i + 12, j + 1, k + 3, stone, 0);
		b(w, i + 12, j + 1, k + 4, stone, 0);
		...
		b(w, i + 12, j + 2, k + 1, stone, 0);
		b(w, i + 12, j + 2, k + 2, stone, 0);
		...
		b(w, i + 12, j + 6, k + 5, stone, 0);
		b(w, i + 12, j + 6, k + 6, stone, 0);
		...
		b(w, i + 13, j + 1, k + 4, stone, 0);
		b(w, i + 13, j + 1, k + 5, stone, 0);
		b(w, i + 13, j + 1, k + 6, stone, 0);
		b(w, i + 13, j + 1, k + 7, stone, 0);
		b(w, i + 13, j + 1, k + 8, stone, 0);
		...
		b(w, i + 14, j + 2, k + 7, stone, 0);
		b(w, i + 14, j + 2, k + 8, stone, 0);
		...
		b(w, i + 14, j + 3, k + 5, stone, 0);
		b(w, i + 14, j + 3, k + 6, stone, 0);
		...
		b(w, i + 15, j + 3, k + 5, stone, 0);
		b(w, i + 15, j + 3, k + 6, stone, 0);
		b(w, i + 15, j + 3, k + 7, stone, 0);
		b(w, i + 15, j + 3, k + 8, stone, 0);
		...
		b(w, i + 15, j + 4, k + 5, stone, 0);
		b(w, i + 15, j + 4, k + 6, stone, 0);
