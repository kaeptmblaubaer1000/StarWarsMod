 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x32_z208
{
	public static void generate(World w, int i, int j, int k)
	{
		...
		b(w, i, j + 3, k + 8, air, 0);
		b(w, i, j + 3, k + 9, air, 0);
		b(w, i, j + 3, k + 10, sandstone_stairs, 0);
		m(w, i, j + 3, k + 10, 2);
	...
	public static void generate_11(World w, int i, int j, int k)
	{
		...
		b(w, i + 12, j + 6, k, stone_slab, 0);
		m(w, i + 12, j + 6, k, 9);
		b(w, i + 12, j + 6, k + 1, stone_slab, 0);
		m(w, i + 12, j + 6, k + 1, 9);
		b(w, i + 12, j + 6, k + 2, stone_slab, 0);
		m(w, i + 12, j + 6, k + 2, 9);
		b(w, i + 12, j + 6, k + 3, stone_slab, 0);
		m(w, i + 12, j + 6, k + 3, 9);
		b(w, i + 12, j + 6, k + 4, sandstone_stairs, 0);
		m(w, i + 12, j + 6, k + 4, 6);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 32, j + 1, k + 220);
		TileEntityChest chest1 = (TileEntityChest)w.getTileEntity(i + 33, j + 1, k + 220);
	}
