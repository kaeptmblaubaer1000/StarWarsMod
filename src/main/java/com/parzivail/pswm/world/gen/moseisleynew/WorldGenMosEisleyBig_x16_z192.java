 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x16_z192
{
	public static void generate(World w, int i, int j, int k)
	{
		...
		b(w, i, j + 7, k + 15, sandstone_stairs, 0);
		m(w, i, j + 7, k + 15, 2);
		b(w, i, j + 8, k, air, 0);
		b(w, i, j + 8, k + 1, air, 0);
		b(w, i, j + 8, k + 2, air, 0);
	...
	public static void generate_1(World w, int i, int j, int k)
	{
		...
		b(w, i + 1, j + 7, k + 15, sandstone_stairs, 0);
		m(w, i + 1, j + 7, k + 15, 2);
		b(w, i + 1, j + 8, k, air, 0);
	...
	public static void generate_2(World w, int i, int j, int k)
	{
		...
		b(w, i + 2, j + 7, k + 15, sandstone_stairs, 0);
		m(w, i + 2, j + 7, k + 15, 2);
		b(w, i + 2, j + 8, k, air, 0);
	...
	public static void generate_5(World w, int i, int j, int k)
	{
		...
		m(w, i + 6, j, k + 15, 1);
		b(w, i + 6, j + 1, k, sandstone_stairs, 0);
	...
	public static void generate_6(World w, int i, int j, int k)
	{
		...
		m(w, i + 7, j + 1, k, 1);
		b(w, i + 7, j + 1, k + 1, chest, 0);
		m(w, i + 7, j + 1, k + 1, 5);
		b(w, i + 7, j + 1, k + 2, chest, 0);
		m(w, i + 7, j + 1, k + 2, 5);
		...
		b(w, i + 7, j + 5, k, sandstone_stairs, 0);
	...
	public static void generate_7(World w, int i, int j, int k)
	{
		...
		b(w, i + 8, j + 5, k + 4, sandstone_stairs, 0);
		m(w, i + 8, j + 5, k + 4, 2);
		...
		b(w, i + 8, j + 6, k, sandstone_stairs, 0);
		...
		m(w, i + 8, j + 15, k + 2, 1);
		b(w, i + 8, j + 15, k + 3, torch, 0);
		m(w, i + 8, j + 15, k + 3, 1);
		b(w, i + 8, j + 15, k + 4, air, 0);
		b(w, i + 8, j + 15, k + 5, torch, 0);
		m(w, i + 8, j + 15, k + 5, 1);
		...
		b(w, i + 8, j + 18, k + 4, sandstone, 0);
		b(w, i + 8, j + 18, k + 5, sandstone, 0);
	...
	public static void generate_8(World w, int i, int j, int k)
	{
		...
		b(w, i + 9, j + 2, k + 5, sandstone_stairs, 0);
		...
		m(w, i + 9, j + 4, k, 1);
		b(w, i + 9, j + 4, k + 1, stone_slab, 0);
		m(w, i + 9, j + 4, k + 1, 9);
		b(w, i + 9, j + 4, k + 2, air, 0);
		b(w, i + 9, j + 4, k + 3, sandstone_stairs, 0);
		m(w, i + 9, j + 4, k + 3, 1);
		...
		b(w, i + 9, j + 10, k + 5, sandstone_stairs, 0);
		...
		m(w, i + 9, j + 12, k + 2, 1);
		b(w, i + 9, j + 12, k + 3, sandstone_stairs, 0);
		m(w, i + 9, j + 12, k + 3, 1);
		...
		b(w, i + 9, j + 17, k + 4, sandstone, 0);
		b(w, i + 9, j + 17, k + 5, sandstone, 0);
		...
		b(w, i + 9, j + 18, k + 2, sandstone, 0);
		m(w, i + 9, j + 18, k + 2, 1);
		b(w, i + 9, j + 18, k + 3, sandstone, 0);
		b(w, i + 9, j + 18, k + 4, sandstone, 0);
		b(w, i + 9, j + 18, k + 5, sandstone, 0);
		b(w, i + 9, j + 18, k + 6, sandstone, 0);
		m(w, i + 9, j + 18, k + 6, 1);
	...
	public static void generate_9(World w, int i, int j, int k)
	{
		...
		b(w, i + 10, j + 3, k + 4, sandstone_stairs, 0);
		m(w, i + 10, j + 3, k + 4, 3);
		...
		b(w, i + 10, j + 6, k, sandstone_stairs, 0);
		m(w, i + 10, j + 6, k, 1);
		...
		b(w, i + 10, j + 11, k + 1, sandstone_stairs, 0);
		m(w, i + 10, j + 11, k + 1, 2);
		...
		m(w, i + 10, j + 15, k + 2, 1);
		b(w, i + 10, j + 15, k + 3, torch, 0);
		m(w, i + 10, j + 15, k + 3, 2);
		b(w, i + 10, j + 15, k + 4, air, 0);
		b(w, i + 10, j + 15, k + 5, torch, 0);
		m(w, i + 10, j + 15, k + 5, 2);
		b(w, i + 10, j + 15, k + 6, sandstone, 0);
		m(w, i + 10, j + 15, k + 6, 1);
		...
		b(w, i + 10, j + 18, k + 4, sandstone, 0);
		b(w, i + 10, j + 18, k + 5, sandstone, 0);
	...
	public static void generate_10(World w, int i, int j, int k)
	{
		...
		m(w, i + 11, j + 1, k, 1);
		b(w, i + 11, j + 1, k + 1, crafting_table, 0);
		b(w, i + 11, j + 1, k + 2, furnace, 0);
		m(w, i + 11, j + 1, k + 2, 4);
		...
		b(w, i + 11, j + 5, k, sandstone_stairs, 0);
		m(w, i + 11, j + 5, k, 1);
		...
		m(w, i + 11, j + 11, k + 1, 2);
		b(w, i + 11, j + 11, k + 2, sandstone, 0);
		b(w, i + 11, j + 11, k + 3, sandstone, 0);
	...
	public static void generate_11(World w, int i, int j, int k)
	{
		...
		m(w, i + 12, j + 11, k + 1, 1);
		b(w, i + 12, j + 11, k + 2, sandstone_stairs, 0);
		m(w, i + 12, j + 11, k + 2, 1);
	...
	public static void generate_12(World w, int i, int j, int k)
	{
		...
		b(w, i + 13, j + 3, k + 6, sandstone_stairs, 0);
		m(w, i + 13, j + 3, k + 6, 1);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 23, j + 1, k + 193);
		TileEntityChest chest1 = (TileEntityChest)w.getTileEntity(i + 23, j + 1, k + 194);
	}
