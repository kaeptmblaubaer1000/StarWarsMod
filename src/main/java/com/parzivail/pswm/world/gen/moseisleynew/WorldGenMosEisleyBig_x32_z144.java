 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x32_z144
{
	...
	public static void generate_1(World w, int i, int j, int k)
	{
		...
		m(w, i + 1, j + 5, k + 9, 7);
		b(w, i + 1, j + 5, k + 10, stone_slab, 0);
		m(w, i + 1, j + 5, k + 10, 9);
		b(w, i + 1, j + 5, k + 11, stone_slab, 0);
		m(w, i + 1, j + 5, k + 11, 9);
		...
		b(w, i + 2, j + 4, k + 7, sandstone_stairs, 0);
		m(w, i + 2, j + 4, k + 7, 2);
	...
	public static void generate_2(World w, int i, int j, int k)
	{
		...
		b(w, i + 3, j + 4, k + 7, sandstone_stairs, 0);
		m(w, i + 3, j + 4, k + 7, 2);
	...
	public static void generate_7(World w, int i, int j, int k)
	{
		...
		b(w, i + 8, j + 3, k + 8, sandstone_stairs, 0);
		m(w, i + 8, j + 3, k + 8, 7);
	...
	public static void generate_8(World w, int i, int j, int k)
	{
		...
		m(w, i + 9, j + 2, k + 8, 1);
		b(w, i + 9, j + 2, k + 9, glass_pane, 0);
		b(w, i + 9, j + 2, k + 10, glass_pane, 0);
		b(w, i + 9, j + 2, k + 11, glass_pane, 0);
		b(w, i + 9, j + 2, k + 12, glass_pane, 0);
