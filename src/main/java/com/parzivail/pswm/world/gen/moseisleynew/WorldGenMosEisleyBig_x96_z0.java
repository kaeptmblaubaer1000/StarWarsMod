...
public class WorldGenMosEisleyBig_x96_z0
{
	...
	public static void generate_4(World w, int i, int j, int k)
	{
		...
		m(w, i + 5, j + 1, k + 2, 1);
		b(w, i + 5, j + 1, k + 3, chest, 0);
		m(w, i + 5, j + 1, k + 3, 5);
		b(w, i + 5, j + 1, k + 4, jukebox, 0);
		...
		b(w, i + 5, j + 8, k + 6, sandstone_stairs, 0);
		b(w, i + 5, j + 8, k + 7, sandstone_stairs, 0);
	...
	public static void generate_5(World w, int i, int j, int k)
	{
		...
		b(w, i + 6, j + 1, k + 9, bed, 0);
		b(w, i + 6, j + 1, k + 10, bed, 0);
		m(w, i + 6, j + 1, k + 10, 8);
		...
		b(w, i + 6, j + 8, k + 8, sandstone_stairs, 0);
		...
		b(w, i + 6, j + 9, k + 6, sandstone_stairs, 0);
		b(w, i + 6, j + 9, k + 7, sandstone_stairs, 0);
	...
	public static void generate_6(World w, int i, int j, int k)
	{
		...
		b(w, i + 7, j + 1, k + 9, bed, 0);
		b(w, i + 7, j + 1, k + 10, bed, 0);
		m(w, i + 7, j + 1, k + 10, 8);
		...
		m(w, i + 7, j + 3, k, 1);
		b(w, i + 7, j + 3, k + 1, sandstone_stairs, 0);
		m(w, i + 7, j + 3, k + 1, 5);
		...
		b(w, i + 7, j + 3, k + 12, sandstone_stairs, 0);
		m(w, i + 7, j + 3, k + 12, 3);
	...
	public static void generate_7(World w, int i, int j, int k)
	{
		...
		b(w, i + 8, j + 8, k + 10, sandstone_stairs, 0);
		m(w, i + 8, j + 8, k + 10, 3);
		...
		b(w, i + 8, j + 10, k + 6, stone_slab, 0);
		m(w, i + 8, j + 10, k + 6, 1);
		b(w, i + 8, j + 10, k + 7, stone_slab, 0);
		m(w, i + 8, j + 10, k + 7, 1);
	...
	public static void generate_8(World w, int i, int j, int k)
	{
		...
		b(w, i + 9, j + 1, k + 10, crafting_table, 0);
		...
		b(w, i + 9, j + 3, k, sandstone_stairs, 0);
		m(w, i + 9, j + 3, k, 4);
		...
		b(w, i + 9, j + 4, k, sandstone_stairs, 0);
		m(w, i + 9, j + 4, k, 2);
		b(w, i + 9, j + 4, k + 1, sandstone, 0);
		b(w, i + 9, j + 4, k + 2, stone_slab, 0);
		m(w, i + 9, j + 4, k + 2, 9);
		...
		b(w, i + 9, j + 8, k + 10, sandstone_stairs, 0);
		m(w, i + 9, j + 8, k + 10, 3);
		...
		b(w, i + 9, j + 9, k + 4, sandstone_stairs, 0);
		m(w, i + 9, j + 9, k + 4, 2);
		...
		b(w, i + 9, j + 10, k + 6, stone_slab, 0);
		m(w, i + 9, j + 10, k + 6, 1);
		b(w, i + 9, j + 10, k + 7, stone_slab, 0);
		m(w, i + 9, j + 10, k + 7, 1);
	...
	public static void generate_10(World w, int i, int j, int k)
	{
		...
		b(w, i + 11, j + 4, k + 2, sandstone_stairs, 0);
		m(w, i + 11, j + 4, k + 2, 4);
		...
		m(w, i + 11, j + 9, k + 6, 1);
		b(w, i + 11, j + 9, k + 7, sandstone_stairs, 0);
		m(w, i + 11, j + 9, k + 7, 1);
	...
	public static void generate_11(World w, int i, int j, int k)
	{
		...
		m(w, i + 12, j + 8, k + 6, 1);
		b(w, i + 12, j + 8, k + 7, sandstone_stairs, 0);
		m(w, i + 12, j + 8, k + 7, 1);
	...
	public static void generate_13(World w, int i, int j, int k)
	{
		...
		b(w, i + 14, j + 3, k + 8, sandstone_stairs, 0);
		m(w, i + 14, j + 3, k + 8, 1);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 104, j + 1, k + 10);
		TileEntityChest chest1 = (TileEntityChest)w.getTileEntity(i + 101, j + 1, k + 3);
	}
