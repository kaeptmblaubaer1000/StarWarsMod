 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x128_z144
{
	...
	public static void generate_2(World w, int i, int j, int k)
	{
		...
		b(w, i + 3, j + 1, k + 4, sandstone_stairs, 0);
		m(w, i + 3, j + 1, k + 4, 2);
		b(w, i + 3, j + 1, k + 5, sandstone, 0);
		m(w, i + 3, j + 1, k + 5, 1);
		b(w, i + 3, j + 1, k + 6, sandstone_stairs, 0);
		m(w, i + 3, j + 1, k + 6, 3);
		...
		m(w, i + 3, j + 6, k + 5, 1);
		b(w, i + 3, j + 6, k + 6, sandstone_stairs, 0);
		m(w, i + 3, j + 6, k + 6, 7);
		b(w, i + 3, j + 6, k + 7, stone_slab, 0);
		m(w, i + 3, j + 6, k + 7, 9);
		b(w, i + 3, j + 6, k + 8, stone_slab, 0);
		m(w, i + 3, j + 6, k + 8, 9);
		b(w, i + 3, j + 6, k + 9, stone_slab, 0);
		m(w, i + 3, j + 6, k + 9, 9);
		b(w, i + 3, j + 6, k + 10, stone_slab, 0);
		m(w, i + 3, j + 6, k + 10, 9);
	...
	public static void generate_3(World w, int i, int j, int k)
	{
		...
		m(w, i + 4, j + 1, k + 6, 2);
		b(w, i + 4, j + 1, k + 7, sandstone_stairs, 0);
		...
		m(w, i + 4, j + 4, k + 6, 2);
		b(w, i + 4, j + 4, k + 7, sandstone_stairs, 0);
		m(w, i + 4, j + 4, k + 7, 7);
		b(w, i + 4, j + 4, k + 8, air, 0);
		b(w, i + 4, j + 4, k + 9, air, 0);
		b(w, i + 4, j + 4, k + 10, sandstone_stairs, 0);
		m(w, i + 4, j + 4, k + 10, 6);
	...
	public static void generate_4(World w, int i, int j, int k)
	{
		...
		b(w, i + 5, j + 7, k, sandstone_stairs, 0);
		m(w, i + 5, j + 7, k, 2);
		...
		b(w, i + 5, j + 9, k + 6, stone_slab, 0);
		m(w, i + 5, j + 9, k + 6, 1);
		b(w, i + 5, j + 9, k + 7, stone_slab, 0);
		m(w, i + 5, j + 9, k + 7, 1);
		b(w, i + 5, j + 9, k + 8, stone_slab, 0);
		m(w, i + 5, j + 9, k + 8, 1);
		b(w, i + 5, j + 9, k + 9, stone_slab, 0);
		m(w, i + 5, j + 9, k + 9, 1);
		b(w, i + 5, j + 9, k + 10, stone_slab, 0);
		m(w, i + 5, j + 9, k + 10, 1);
	...
	public static void generate_5(World w, int i, int j, int k)
	{
		...
		b(w, i + 6, j + 7, k, sandstone_stairs, 0);
		m(w, i + 6, j + 7, k, 2);
	...
	public static void generate_6(World w, int i, int j, int k)
	{
		...
		b(w, i + 7, j + 7, k, sandstone_stairs, 0);
		m(w, i + 7, j + 7, k, 2);
	...
	public static void generate_8(World w, int i, int j, int k)
	{
		...
		b(w, i + 9, j + 2, k + 2, sandstone_stairs, 0);
		m(w, i + 9, j + 2, k + 2, 3);
	...
	public static void generate_9(World w, int i, int j, int k)
	{
		...
		b(w, i + 10, j + 1, k + 6, sandstone_stairs, 0);
		m(w, i + 10, j + 1, k + 6, 3);
		...
		b(w, i + 10, j + 5, k + 1, sandstone_stairs, 0);
		m(w, i + 10, j + 5, k + 1, 5);
		...
		b(w, i + 10, j + 7, k, sandstone_stairs, 0);
		m(w, i + 10, j + 7, k, 2);
	...
	public static void generate_10(World w, int i, int j, int k)
	{
		...
		b(w, i + 11, j + 7, k, sandstone_stairs, 0);
		m(w, i + 11, j + 7, k, 2);
	...
	public static void generate_11(World w, int i, int j, int k)
	{
		...
		b(w, i + 12, j + 1, k, sandstone_stairs, 0);
		m(w, i + 12, j + 1, k, 2);
		...
		b(w, i + 12, j + 7, k, sandstone_stairs, 0);
		m(w, i + 12, j + 7, k, 2);
	...
	public static void generate_12(World w, int i, int j, int k)
	{
		...
		b(w, i + 13, j + 5, k + 1, sandstone_stairs, 0);
		m(w, i + 13, j + 5, k + 1, 4);
		...
		b(w, i + 13, j + 9, k + 14, stone_slab, 0);
		m(w, i + 13, j + 9, k + 14, 1);
		...
		b(w, i + 14, j + 1, k, sandstone_stairs, 0);
		m(w, i + 14, j + 1, k, 2);
		generate_13(w, i, j, k);
	}
	...
	public static void generate_13(World w, int i, int j, int k)
	{
		...
		b(w, i + 14, j + 1, k + 7, sandstone_stairs, 0);
		...
		b(w, i + 14, j + 2, k + 2, sandstone_stairs, 0);
		m(w, i + 14, j + 2, k + 2, 3);
		...
		b(w, i + 14, j + 9, k + 14, stone_slab, 0);
		m(w, i + 14, j + 9, k + 14, 1);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		b(w, i + 15, j + 7, k, sandstone_stairs, 0);
		m(w, i + 15, j + 7, k, 2);
		...
		b(w, i + 15, j + 9, k + 13, stone_slab, 0);
		m(w, i + 15, j + 9, k + 13, 1);
		b(w, i + 15, j + 9, k + 14, stone_slab, 0);
		m(w, i + 15, j + 9, k + 14, 1);
