...
public class WorldGenMosEisleyBig_x144_z144
{
	public static void generate(World w, int i, int j, int k)
	{
		...
		b(w, i, j + 7, k, sandstone_stairs, 0);
		m(w, i, j + 7, k, 2);
	...
	public static void generate_1(World w, int i, int j, int k)
	{
		...
		b(w, i + 1, j + 7, k, sandstone_stairs, 0);
		m(w, i + 1, j + 7, k, 2);
	...
	public static void generate_2(World w, int i, int j, int k)
	{
		...
		b(w, i + 2, j + 7, k, sandstone_stairs, 0);
		m(w, i + 2, j + 7, k, 2);
		...
		m(w, i + 3, j + 4, k + 6, 2);
		b(w, i + 3, j + 4, k + 7, glass_pane, 0);
		b(w, i + 3, j + 4, k + 8, glass_pane, 0);
		b(w, i + 3, j + 4, k + 9, glass_pane, 0);
		b(w, i + 3, j + 4, k + 10, glass_pane, 0);
		...
		m(w, i + 3, j + 5, k + 6, 2);
		b(w, i + 3, j + 5, k + 7, glass_pane, 0);
		b(w, i + 3, j + 5, k + 8, glass_pane, 0);
		b(w, i + 3, j + 5, k + 9, glass_pane, 0);
		b(w, i + 3, j + 5, k + 10, glass_pane, 0);
		...
		m(w, i + 3, j + 6, k + 6, 2);
		b(w, i + 3, j + 6, k + 7, glass_pane, 0);
		b(w, i + 3, j + 6, k + 8, glass_pane, 0);
		b(w, i + 3, j + 6, k + 9, glass_pane, 0);
		b(w, i + 3, j + 6, k + 10, glass_pane, 0);
	...
	public static void generate_9(World w, int i, int j, int k)
	{
		...
		b(w, i + 10, j + 1, k + 14, furnace, 0);
		m(w, i + 10, j + 1, k + 14, 5);
		b(w, i + 10, j + 1, k + 15, crafting_table, 0);
	...
	public static void generate_13(World w, int i, int j, int k)
	{
		...
		b(w, i + 14, j + 1, k + 13, blockTable, 0);
		m(w, i + 14, j + 1, k + 13, 1);
		...
		b(w, i + 15, j + 1, k + 13, blockTable, 0);
		m(w, i + 15, j + 1, k + 13, 1);
		b(w, i + 15, j + 1, k + 14, blockTable, 0);
		m(w, i + 15, j + 1, k + 14, 1);
