...
public class WorldGenMosEisleyBig_x64_z240
{
	...
	public static void generate_3(World w, int i, int j, int k)
	{
		...
		b(w, i + 4, j + 1, k + 10, anvil, 0);
		b(w, i + 4, j + 1, k + 11, chest, 0);
		m(w, i + 4, j + 1, k + 11, 5);
		b(w, i + 4, j + 1, k + 12, chest, 0);
		m(w, i + 4, j + 1, k + 12, 5);
	...
	public static void generate_13(World w, int i, int j, int k)
	{
		...
		b(w, i + 14, j + 1, k + 10, jukebox, 0);
		b(w, i + 14, j + 1, k + 11, crafting_table, 0);
		b(w, i + 14, j + 1, k + 12, furnace, 0);
		m(w, i + 14, j + 1, k + 12, 4);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 68, j + 1, k + 251);
		TileEntityChest chest1 = (TileEntityChest)w.getTileEntity(i + 68, j + 1, k + 252);
	}
