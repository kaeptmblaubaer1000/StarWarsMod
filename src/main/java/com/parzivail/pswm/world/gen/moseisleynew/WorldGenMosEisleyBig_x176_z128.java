...
public class WorldGenMosEisleyBig_x176_z128
{
	...
	public static void generate_2(World w, int i, int j, int k)
	{
		...
		b(w, i + 3, j + 3, k + 1, torch, 0);
		m(w, i + 3, j + 3, k + 1, 1);
		b(w, i + 3, j + 3, k + 2, air, 0);
		b(w, i + 3, j + 3, k + 3, air, 0);
		b(w, i + 3, j + 3, k + 4, torch, 0);
		m(w, i + 3, j + 3, k + 4, 1);
	...
	public static void generate_3(World w, int i, int j, int k)
	{
		...
		b(w, i + 3, j + 8, k + 3, sandstone_stairs, 0);
		...
		b(w, i + 4, j + 9, k + 2, sandstone_stairs, 0);
	...
	public static void generate_9(World w, int i, int j, int k)
	{
		...
		b(w, i + 10, j + 1, k + 1, crafting_table, 0);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 184, j + 1, k + 132);
	}
