 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x16_z176
{
	...
	public static void generate_1(World w, int i, int j, int k)
	{
		...
		m(w, i + 1, j + 3, k + 4, 1);
		b(w, i + 1, j + 3, k + 5, sandstone_stairs, 0);
		m(w, i + 1, j + 3, k + 5, 7);
		...
		b(w, i + 2, j + 3, k + 7, sandstone_stairs, 0);
		m(w, i + 2, j + 3, k + 7, 6);
	...
	public static void generate_2(World w, int i, int j, int k)
	{
		...
		m(w, i + 3, j + 4, k + 3, 7);
		b(w, i + 3, j + 4, k + 4, stone_slab, 0);
		m(w, i + 3, j + 4, k + 4, 9);
		b(w, i + 3, j + 4, k + 5, stone_slab, 0);
		m(w, i + 3, j + 4, k + 5, 9);
		b(w, i + 3, j + 4, k + 6, stone_slab, 0);
		m(w, i + 3, j + 4, k + 6, 9);
		b(w, i + 3, j + 4, k + 7, stone_slab, 0);
		m(w, i + 3, j + 4, k + 7, 9);
		b(w, i + 3, j + 4, k + 8, sandstone_stairs, 0);
		m(w, i + 3, j + 4, k + 8, 6);
	...
	public static void generate_3(World w, int i, int j, int k)
	{
		...
		b(w, i + 4, j + 8, k + 5, sandstone_stairs, 0);
	...
	public static void generate_4(World w, int i, int j, int k)
	{
		...
		b(w, i + 5, j + 1, k + 5, carpet, 0);
		m(w, i + 5, j + 1, k + 5, 8);
		b(w, i + 5, j + 1, k + 6, carpet, 0);
		m(w, i + 5, j + 1, k + 6, 8);
		b(w, i + 5, j + 1, k + 7, air, 0);
		b(w, i + 5, j + 1, k + 8, air, 0);
		b(w, i + 5, j + 1, k + 9, jukebox, 0);
		...
		b(w, i + 5, j + 9, k + 5, sandstone_stairs, 0);
	...
	public static void generate_5(World w, int i, int j, int k)
	{
		...
		b(w, i + 6, j + 1, k + 2, blockTable, 0);
		m(w, i + 6, j + 1, k + 2, 3);
		b(w, i + 6, j + 1, k + 3, air, 0);
		b(w, i + 6, j + 1, k + 4, carpet, 0);
		m(w, i + 6, j + 1, k + 4, 8);
		b(w, i + 6, j + 1, k + 5, carpet, 0);
		m(w, i + 6, j + 1, k + 5, 8);
		b(w, i + 6, j + 1, k + 6, carpet, 0);
		m(w, i + 6, j + 1, k + 6, 8);
		b(w, i + 6, j + 1, k + 7, carpet, 0);
		m(w, i + 6, j + 1, k + 7, 8);
	...
	public static void generate_6(World w, int i, int j, int k)
	{
		...
		b(w, i + 7, j + 1, k + 4, carpet, 0);
		m(w, i + 7, j + 1, k + 4, 8);
		b(w, i + 7, j + 1, k + 5, carpet, 0);
		m(w, i + 7, j + 1, k + 5, 8);
		b(w, i + 7, j + 1, k + 6, carpet, 0);
		m(w, i + 7, j + 1, k + 6, 8);
		b(w, i + 7, j + 1, k + 7, carpet, 0);
		m(w, i + 7, j + 1, k + 7, 8);
		...
		b(w, i + 7, j + 9, k + 8, sandstone_stairs, 0);
		m(w, i + 7, j + 9, k + 8, 3);
		...
		b(w, i + 7, j + 10, k + 5, stone_slab, 0);
		m(w, i + 7, j + 10, k + 5, 1);
		b(w, i + 7, j + 10, k + 6, stone_slab, 0);
		m(w, i + 7, j + 10, k + 6, 1);
	...
	public static void generate_7(World w, int i, int j, int k)
	{
		...
		b(w, i + 8, j + 8, k + 9, sandstone_stairs, 0);
		m(w, i + 8, j + 8, k + 9, 3);
	...
	public static void generate_9(World w, int i, int j, int k)
	{
		...
		b(w, i + 10, j + 1, k + 7, bed, 0);
		m(w, i + 10, j + 1, k + 7, 3);
		b(w, i + 10, j + 1, k + 8, bed, 0);
		m(w, i + 10, j + 1, k + 8, 3);
	...
	public static void generate_10(World w, int i, int j, int k)
	{
		...
		m(w, i + 11, j + 1, k + 2, 3);
		b(w, i + 11, j + 1, k + 3, bed, 0);
		m(w, i + 11, j + 1, k + 3, 11);
		b(w, i + 11, j + 1, k + 4, bed, 0);
		m(w, i + 11, j + 1, k + 4, 11);
		b(w, i + 11, j + 1, k + 5, crafting_table, 0);
		b(w, i + 11, j + 1, k + 6, chest, 0);
		m(w, i + 11, j + 1, k + 6, 4);
		b(w, i + 11, j + 1, k + 7, bed, 0);
		m(w, i + 11, j + 1, k + 7, 11);
		b(w, i + 11, j + 1, k + 8, bed, 0);
		m(w, i + 11, j + 1, k + 8, 11);
		b(w, i + 11, j + 1, k + 9, blockTable, 0);
		m(w, i + 11, j + 1, k + 9, 3);
	...
	public static void generate_12(World w, int i, int j, int k)
	{
		...
		b(w, i + 13, j + 3, k + 7, sandstone_stairs, 0);
		m(w, i + 13, j + 3, k + 7, 1);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 20, j + 1, k + 185);
		TileEntityChest chest1 = (TileEntityChest)w.getTileEntity(i + 27, j + 1, k + 182);
	}
