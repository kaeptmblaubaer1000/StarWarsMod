...
public class WorldGenMosEisleyBig_x176_z176
{
	public static void generate(World w, int i, int j, int k)
	{
		...
		b(w, i, j + 11, k + 5, sandstone_stairs, 0);
		m(w, i, j + 11, k + 5, 3);
	...
	public static void generate_1(World w, int i, int j, int k)
	{
		...
		b(w, i + 1, j + 11, k + 5, sandstone_stairs, 0);
		m(w, i + 1, j + 11, k + 5, 3);
		...
		m(w, i + 1, j + 15, k, 1);
		b(w, i + 1, j + 15, k + 1, torch, 0);
		m(w, i + 1, j + 15, k + 1, 1);
		b(w, i + 1, j + 15, k + 2, air, 0);
		b(w, i + 1, j + 15, k + 3, torch, 0);
		m(w, i + 1, j + 15, k + 3, 1);
		b(w, i + 1, j + 15, k + 4, sandstone, 0);
		m(w, i + 1, j + 15, k + 4, 1);
		...
		b(w, i + 2, j + 4, k, air, 0);
		b(w, i + 2, j + 4, k + 1, sandstone_stairs, 0);
	...
	public static void generate_2(World w, int i, int j, int k)
	{
		...
		b(w, i + 2, j + 8, k, air, 0);
		b(w, i + 2, j + 8, k + 1, sandstone_stairs, 0);
		...
		b(w, i + 2, j + 11, k + 4, sandstone, 0);
		b(w, i + 2, j + 11, k + 5, sandstone_stairs, 0);
		m(w, i + 2, j + 11, k + 5, 3);
		...
		m(w, i + 2, j + 12, k, 1);
		b(w, i + 2, j + 12, k + 1, sandstone_stairs, 0);
		...
		b(w, i + 2, j + 19, k + 1, sandstone, 0);
		b(w, i + 2, j + 19, k + 2, sandstone, 0);
		...
		b(w, i + 3, j + 5, k + 2, sandstone_stairs, 0);
		m(w, i + 3, j + 5, k + 2, 2);
	...
	public static void generate_3(World w, int i, int j, int k)
	{
		...
		b(w, i + 3, j + 9, k + 2, sandstone_stairs, 0);
		m(w, i + 3, j + 9, k + 2, 2);
		...
		b(w, i + 3, j + 11, k + 5, sandstone_stairs, 0);
		m(w, i + 3, j + 11, k + 5, 3);
		...
		m(w, i + 3, j + 15, k, 1);
		b(w, i + 3, j + 15, k + 1, torch, 0);
		m(w, i + 3, j + 15, k + 1, 2);
		b(w, i + 3, j + 15, k + 2, air, 0);
		b(w, i + 3, j + 15, k + 3, torch, 0);
		m(w, i + 3, j + 15, k + 3, 2);
		...
		b(w, i + 4, j + 3, k + 6, sandstone_stairs, 0);
		m(w, i + 4, j + 3, k + 6, 3);
	...
	public static void generate_4(World w, int i, int j, int k)
	{
		...
		b(w, i + 5, j + 11, k, sandstone_stairs, 0);
		m(w, i + 5, j + 11, k, 1);
		b(w, i + 5, j + 11, k + 1, sandstone_stairs, 0);
		m(w, i + 5, j + 11, k + 1, 1);
		...
		m(w, i + 5, j + 11, k + 4, 1);
		b(w, i + 5, j + 11, k + 5, sandstone_stairs, 0);
		m(w, i + 5, j + 11, k + 5, 3);
	...
	public static void generate_5(World w, int i, int j, int k)
	{
		...
		b(w, i + 6, j + 3, k, sandstone_stairs, 0);
		m(w, i + 6, j + 3, k, 1);
		b(w, i + 6, j + 3, k + 1, air, 0);
		b(w, i + 6, j + 3, k + 2, air, 0);
		b(w, i + 6, j + 3, k + 3, air, 0);
		b(w, i + 6, j + 3, k + 4, sandstone_stairs, 0);
		m(w, i + 6, j + 3, k + 4, 1);
	...
	public static void generate_9(World w, int i, int j, int k)
	{
		...
		b(w, i + 10, j + 3, k + 8, sandstone_stairs, 0);
	...
	public static void generate_10(World w, int i, int j, int k)
	{
		...
		b(w, i + 11, j + 7, k + 7, sandstone_stairs, 0);
		b(w, i + 11, j + 7, k + 8, sandstone_stairs, 0);
		b(w, i + 11, j + 7, k + 9, sandstone_stairs, 0);
		b(w, i + 11, j + 7, k + 10, sandstone_stairs, 0);
	...
	public static void generate_11(World w, int i, int j, int k)
	{
		...
		b(w, i + 12, j + 8, k + 7, stone_slab, 0);
		m(w, i + 12, j + 8, k + 7, 1);
		b(w, i + 12, j + 8, k + 8, sandstone_stairs, 0);
		b(w, i + 12, j + 8, k + 9, sandstone_stairs, 0);
		b(w, i + 12, j + 8, k + 10, sandstone_stairs, 0);
		b(w, i + 12, j + 8, k + 11, sandstone_stairs, 0);
		b(w, i + 12, j + 8, k + 12, sandstone_stairs, 0);
		b(w, i + 12, j + 8, k + 13, sandstone_stairs, 0);
		b(w, i + 12, j + 8, k + 14, stone_slab, 0);
		m(w, i + 12, j + 8, k + 14, 1);
	...
	public static void generate_12(World w, int i, int j, int k)
	{
		...
		b(w, i + 13, j + 7, k + 6, sandstone_stairs, 0);
		m(w, i + 13, j + 7, k + 6, 2);
		...
		b(w, i + 13, j + 8, k + 7, sandstone_stairs, 0);
		m(w, i + 13, j + 8, k + 7, 2);
		...
		b(w, i + 13, j + 8, k + 14, sandstone_stairs, 0);
		m(w, i + 13, j + 8, k + 14, 3);
	...
	public static void generate_13(World w, int i, int j, int k)
	{
		...
		b(w, i + 14, j + 3, k + 5, sandstone_stairs, 0);
		m(w, i + 14, j + 3, k + 5, 2);
		...
		b(w, i + 14, j + 7, k + 6, sandstone_stairs, 0);
		m(w, i + 14, j + 7, k + 6, 2);
		...
		b(w, i + 14, j + 7, k + 15, sandstone_stairs, 0);
		m(w, i + 14, j + 7, k + 15, 3);
		...
		b(w, i + 14, j + 8, k + 7, sandstone_stairs, 0);
		m(w, i + 14, j + 8, k + 7, 2);
		...
		b(w, i + 14, j + 8, k + 14, sandstone_stairs, 0);
		m(w, i + 14, j + 8, k + 14, 3);
		...
		b(w, i + 15, j + 1, k + 7, crafting_table, 0);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		b(w, i + 15, j + 7, k + 6, sandstone_stairs, 0);
		m(w, i + 15, j + 7, k + 6, 2);
		...
		b(w, i + 15, j + 7, k + 15, sandstone_stairs, 0);
		m(w, i + 15, j + 7, k + 15, 3);
		...
		b(w, i + 15, j + 8, k + 7, stone_slab, 0);
		m(w, i + 15, j + 8, k + 7, 1);
		b(w, i + 15, j + 8, k + 8, sandstone_stairs, 0);
		m(w, i + 15, j + 8, k + 8, 1);
		b(w, i + 15, j + 8, k + 9, sandstone_stairs, 0);
		m(w, i + 15, j + 8, k + 9, 1);
		b(w, i + 15, j + 8, k + 10, sandstone_stairs, 0);
		m(w, i + 15, j + 8, k + 10, 1);
		b(w, i + 15, j + 8, k + 11, sandstone_stairs, 0);
		m(w, i + 15, j + 8, k + 11, 1);
		b(w, i + 15, j + 8, k + 12, sandstone_stairs, 0);
		m(w, i + 15, j + 8, k + 12, 1);
		b(w, i + 15, j + 8, k + 13, sandstone_stairs, 0);
		m(w, i + 15, j + 8, k + 13, 1);
		b(w, i + 15, j + 8, k + 14, stone_slab, 0);
		m(w, i + 15, j + 8, k + 14, 1);
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 180, j + 1, k + 176);
		TileEntityChest chest1 = (TileEntityChest)w.getTileEntity(i + 188, j + 1, k + 185);
	}
