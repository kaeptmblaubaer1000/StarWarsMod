...
public class WorldGenMosEisleyBig_x144_z256
{
	...
	public static void generate_4(World w, int i, int j, int k)
	{
		...
		b(w, i + 5, j + 2, k, stone_slab, 0);
		m(w, i + 5, j + 2, k, 1);
		b(w, i + 5, j + 2, k + 1, stone_slab, 0);
		m(w, i + 5, j + 2, k + 1, 1);
		b(w, i + 5, j + 2, k + 2, stone_slab, 0);
		m(w, i + 5, j + 2, k + 2, 1);
		b(w, i + 5, j + 2, k + 3, stone_slab, 0);
		m(w, i + 5, j + 2, k + 3, 1);
