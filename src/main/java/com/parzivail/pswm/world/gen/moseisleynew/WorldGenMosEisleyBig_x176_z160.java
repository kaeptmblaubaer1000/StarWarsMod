...
public class WorldGenMosEisleyBig_x176_z160
{
	public static void generate(World w, int i, int j, int k)
	{
		...
		m(w, i, j + 1, k + 14, 1);
		b(w, i, j + 1, k + 15, crafting_table, 0);
		b(w, i, j + 2, k, air, 0);
		b(w, i, j + 2, k + 1, air, 0);
		b(w, i, j + 2, k + 2, air, 0);
		b(w, i, j + 2, k + 3, air, 0);
		...
		m(w, i, j + 4, k + 14, 1);
		b(w, i, j + 4, k + 15, sandstone_stairs, 0);
		m(w, i, j + 4, k + 15, 5);
		b(w, i, j + 5, k, air, 0);
		b(w, i, j + 5, k + 1, air, 0);
		b(w, i, j + 5, k + 2, air, 0);
		...
		b(w, i, j + 5, k + 14, sandstone_stairs, 0);
		...
		b(w, i, j + 11, k + 15, sandstone_stairs, 0);
		m(w, i, j + 11, k + 15, 2);
		b(w, i, j + 12, k, air, 0);
	...
	public static void generate_1(World w, int i, int j, int k)
	{
		...
		b(w, i + 1, j + 3, k + 14, sandstone_stairs, 0);
		m(w, i + 1, j + 3, k + 14, 5);
		...
		b(w, i + 1, j + 6, k + 14, sandstone_stairs, 0);
		...
		b(w, i + 2, j + 4, k, sandstone_stairs, 0);
		m(w, i + 2, j + 4, k, 5);
	...
	public static void generate_2(World w, int i, int j, int k)
	{
		...
		b(w, i + 3, j + 3, k + 14, sandstone_stairs, 0);
		m(w, i + 3, j + 3, k + 14, 4);
		b(w, i + 3, j + 3, k + 15, air, 0);
		b(w, i + 3, j + 4, k, stone_slab, 0);
		m(w, i + 3, j + 4, k, 9);
	...
	public static void generate_3(World w, int i, int j, int k)
	{
		...
		m(w, i + 4, j + 4, k + 14, 1);
		b(w, i + 4, j + 4, k + 15, sandstone_stairs, 0);
		m(w, i + 4, j + 4, k + 15, 4);
	...
	public static void generate_4(World w, int i, int j, int k)
	{
		...
		b(w, i + 4, j + 11, k + 15, sandstone_stairs, 0);
		m(w, i + 4, j + 11, k + 15, 2);
		...
		b(w, i + 5, j + 6, k + 1, sandstone_stairs, 0);
		m(w, i + 5, j + 6, k + 1, 1);
	...
	public static void generate_5(World w, int i, int j, int k)
	{
		...
		b(w, i + 5, j + 11, k + 15, sandstone_stairs, 0);
		m(w, i + 5, j + 11, k + 15, 2);
		...
		b(w, i + 6, j + 1, k, crafting_table, 0);
		...
		b(w, i + 6, j + 4, k, sandstone_stairs, 0);
		m(w, i + 6, j + 4, k, 4);
		...
		b(w, i + 6, j + 5, k + 1, sandstone_stairs, 0);
		m(w, i + 6, j + 5, k + 1, 1);
	...
	public static void generate_8(World w, int i, int j, int k)
	{
		...
		b(w, i + 9, j + 7, k + 6, sandstone_stairs, 0);
		b(w, i + 9, j + 7, k + 7, sandstone_stairs, 0);
		b(w, i + 9, j + 7, k + 8, sandstone_stairs, 0);
		b(w, i + 9, j + 7, k + 9, sandstone_stairs, 0);
		b(w, i + 9, j + 7, k + 10, sandstone_stairs, 0);
		b(w, i + 9, j + 7, k + 11, sandstone_stairs, 0);
		b(w, i + 9, j + 7, k + 12, sandstone_stairs, 0);
	...
	public static void generate_9(World w, int i, int j, int k)
	{
		...
		b(w, i + 10, j + 1, k + 5, crafting_table, 0);
		...
		b(w, i + 10, j + 7, k + 4, sandstone_stairs, 0);
		m(w, i + 10, j + 7, k + 4, 2);
		...
		b(w, i + 10, j + 7, k + 13, sandstone_stairs, 0);
		m(w, i + 10, j + 7, k + 13, 3);
		...
		m(w, i + 10, j + 8, k + 5, 1);
		b(w, i + 10, j + 8, k + 6, sandstone_stairs, 0);
		b(w, i + 10, j + 8, k + 7, sandstone_stairs, 0);
		b(w, i + 10, j + 8, k + 8, sandstone_stairs, 0);
		b(w, i + 10, j + 8, k + 9, sandstone_stairs, 0);
		b(w, i + 10, j + 8, k + 10, sandstone_stairs, 0);
		b(w, i + 10, j + 8, k + 11, sandstone_stairs, 0);
		b(w, i + 10, j + 8, k + 12, stone_slab, 0);
		m(w, i + 10, j + 8, k + 12, 1);
	...
	public static void generate_10(World w, int i, int j, int k)
	{
		...
		b(w, i + 11, j + 1, k + 2, sandstone_stairs, 0);
		m(w, i + 11, j + 1, k + 2, 2);
		...
		m(w, i + 11, j + 3, k + 13, 2);
		b(w, i + 11, j + 3, k + 14, sandstone_stairs, 0);
		m(w, i + 11, j + 3, k + 14, 3);
		...
		b(w, i + 11, j + 7, k + 4, sandstone_stairs, 0);
		m(w, i + 11, j + 7, k + 4, 2);
		...
		b(w, i + 11, j + 8, k + 5, sandstone_stairs, 0);
		m(w, i + 11, j + 8, k + 5, 2);
		...
		b(w, i + 11, j + 8, k + 12, sandstone_stairs, 0);
		m(w, i + 11, j + 8, k + 12, 3);
	...
	public static void generate_11(World w, int i, int j, int k)
	{
		...
		m(w, i + 12, j + 3, k + 13, 2);
		b(w, i + 12, j + 3, k + 14, sandstone_stairs, 0);
		m(w, i + 12, j + 3, k + 14, 3);
		...
		b(w, i + 12, j + 8, k + 5, sandstone_stairs, 0);
		m(w, i + 12, j + 8, k + 5, 2);
	...
	public static void generate_12(World w, int i, int j, int k)
	{
		...
		m(w, i + 13, j + 8, k + 5, 1);
		b(w, i + 13, j + 8, k + 6, sandstone_stairs, 0);
		m(w, i + 13, j + 8, k + 6, 1);
		b(w, i + 13, j + 8, k + 7, sandstone_stairs, 0);
		m(w, i + 13, j + 8, k + 7, 1);
		b(w, i + 13, j + 8, k + 8, sandstone_stairs, 0);
		m(w, i + 13, j + 8, k + 8, 1);
		b(w, i + 13, j + 8, k + 9, sandstone_stairs, 0);
		m(w, i + 13, j + 8, k + 9, 1);
		b(w, i + 13, j + 8, k + 10, sandstone_stairs, 0);
		m(w, i + 13, j + 8, k + 10, 1);
		b(w, i + 13, j + 8, k + 11, sandstone_stairs, 0);
		m(w, i + 13, j + 8, k + 11, 1);
		b(w, i + 13, j + 8, k + 12, stone_slab, 0);
		m(w, i + 13, j + 8, k + 12, 1);
	...
	public static void generate_13(World w, int i, int j, int k)
	{
		...
		m(w, i + 14, j + 7, k + 6, 1);
		b(w, i + 14, j + 7, k + 7, sandstone_stairs, 0);
		m(w, i + 14, j + 7, k + 7, 1);
		b(w, i + 14, j + 7, k + 8, sandstone_stairs, 0);
		m(w, i + 14, j + 7, k + 8, 1);
		b(w, i + 14, j + 7, k + 9, sandstone_stairs, 0);
		m(w, i + 14, j + 7, k + 9, 1);
		b(w, i + 14, j + 7, k + 10, sandstone_stairs, 0);
		m(w, i + 14, j + 7, k + 10, 1);
		b(w, i + 14, j + 7, k + 11, sandstone_stairs, 0);
		m(w, i + 14, j + 7, k + 11, 1);
		...
		b(w, i + 15, j + 1, k + 7, sandstone_stairs, 0);
		m(w, i + 15, j + 1, k + 7, 3);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 178, j + 1, k + 160);
		TileEntityChest chest1 = (TileEntityChest)w.getTileEntity(i + 180, j + 1, k + 175);
		TileEntityChest chest2 = (TileEntityChest)w.getTileEntity(i + 189, j + 1, k + 167);
	}
