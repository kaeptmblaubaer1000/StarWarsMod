 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x64_z192
{
	...
	public static void generate_1(World w, int i, int j, int k)
	{
		...
		b(w, i + 2, j + 4, k + 5, sandstone_stairs, 0);
		m(w, i + 2, j + 4, k + 5, 3);
	...
	public static void generate_6(World w, int i, int j, int k)
	{
		...
		b(w, i + 7, j + 1, k + 5, sandstone_stairs, 0);
		m(w, i + 7, j + 1, k + 5, 1);
	...
	public static void generate_8(World w, int i, int j, int k)
	{
		...
		b(w, i + 9, j + 2, k, sandstone, 0);
		b(w, i + 9, j + 2, k + 1, sandstone, 0);
		b(w, i + 9, j + 2, k + 2, sandstone, 0);
		...
		b(w, i + 9, j + 3, k, sandstone, 0);
		b(w, i + 9, j + 3, k + 1, sandstone, 0);
		b(w, i + 9, j + 3, k + 2, sandstone, 0);
		...
		b(w, i + 9, j + 4, k, sandstone, 0);
		b(w, i + 9, j + 4, k + 1, sandstone, 0);
		b(w, i + 9, j + 4, k + 2, sandstone, 0);
	...
	public static void generate_13(World w, int i, int j, int k)
	{
		...
		b(w, i + 14, j + 11, k + 13, stone_slab, 0);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		b(w, i + 15, j + 11, k + 13, stone_slab, 0);
		m(w, i + 15, j + 11, k + 13, 1);
		b(w, i + 15, j + 11, k + 14, stone_slab, 0);
		m(w, i + 15, j + 11, k + 14, 1);
