...
public class WorldGenMosEisleyBig_x96_z256
{
	...
	public static void generate_4(World w, int i, int j, int k)
	{
		...
		b(w, i + 5, j + 7, k, stone_slab, 0);
		m(w, i + 5, j + 7, k, 1);
		b(w, i + 5, j + 7, k + 1, stone_slab, 0);
		m(w, i + 5, j + 7, k + 1, 1);
		...
		m(w, i + 5, j + 7, k + 4, 1);
		b(w, i + 5, j + 7, k + 5, stone_slab, 0);
		m(w, i + 5, j + 7, k + 5, 1);
		b(w, i + 5, j + 7, k + 6, stone_slab, 0);
		m(w, i + 5, j + 7, k + 6, 1);
		b(w, i + 5, j + 7, k + 7, stone_slab, 0);
		m(w, i + 5, j + 7, k + 7, 1);
		b(w, i + 5, j + 7, k + 8, stone_slab, 0);
		m(w, i + 5, j + 7, k + 8, 1);
		b(w, i + 5, j + 7, k + 9, stone_slab, 0);
		m(w, i + 5, j + 7, k + 9, 1);
		b(w, i + 5, j + 7, k + 10, stone_slab, 0);
		m(w, i + 5, j + 7, k + 10, 1);
		b(w, i + 5, j + 7, k + 11, stone_slab, 0);
		m(w, i + 5, j + 7, k + 11, 1);
		b(w, i + 5, j + 7, k + 12, stone_slab, 0);
		m(w, i + 5, j + 7, k + 12, 1);
	...
	public static void generate_5(World w, int i, int j, int k)
	{
		...
		b(w, i + 6, j + 6, k, sandstone_stairs, 0);
		m(w, i + 6, j + 6, k, 4);
		...
		m(w, i + 6, j + 6, k + 4, 4);
		b(w, i + 6, j + 6, k + 5, sandstone_stairs, 0);
		m(w, i + 6, j + 6, k + 5, 4);
		b(w, i + 6, j + 6, k + 6, sandstone_stairs, 0);
		m(w, i + 6, j + 6, k + 6, 4);
		b(w, i + 6, j + 6, k + 7, sandstone_stairs, 0);
		m(w, i + 6, j + 6, k + 7, 4);
		b(w, i + 6, j + 6, k + 8, sandstone_stairs, 0);
		m(w, i + 6, j + 6, k + 8, 4);
		b(w, i + 6, j + 6, k + 9, sandstone_stairs, 0);
		m(w, i + 6, j + 6, k + 9, 4);
		b(w, i + 6, j + 6, k + 10, sandstone_stairs, 0);
		m(w, i + 6, j + 6, k + 10, 4);
		b(w, i + 6, j + 6, k + 11, sandstone_stairs, 0);
		m(w, i + 6, j + 6, k + 11, 4);
		...
		b(w, i + 6, j + 7, k, stone_slab, 0);
		m(w, i + 6, j + 7, k, 1);
		b(w, i + 6, j + 7, k + 1, stone_slab, 0);
		m(w, i + 6, j + 7, k + 1, 1);
		b(w, i + 6, j + 7, k + 2, stone_slab, 0);
		m(w, i + 6, j + 7, k + 2, 1);
		b(w, i + 6, j + 7, k + 3, stone_slab, 0);
		m(w, i + 6, j + 7, k + 3, 1);
		b(w, i + 6, j + 7, k + 4, stone_slab, 0);
		m(w, i + 6, j + 7, k + 4, 1);
		b(w, i + 6, j + 7, k + 5, stone_slab, 0);
		m(w, i + 6, j + 7, k + 5, 1);
		b(w, i + 6, j + 7, k + 6, stone_slab, 0);
		m(w, i + 6, j + 7, k + 6, 1);
		b(w, i + 6, j + 7, k + 7, stone_slab, 0);
		m(w, i + 6, j + 7, k + 7, 1);
		b(w, i + 6, j + 7, k + 8, stone_slab, 0);
		m(w, i + 6, j + 7, k + 8, 1);
		b(w, i + 6, j + 7, k + 9, stone_slab, 0);
		m(w, i + 6, j + 7, k + 9, 1);
		b(w, i + 6, j + 7, k + 10, stone_slab, 0);
		m(w, i + 6, j + 7, k + 10, 1);
		b(w, i + 6, j + 7, k + 11, stone_slab, 0);
		m(w, i + 6, j + 7, k + 11, 1);
		b(w, i + 6, j + 7, k + 12, stone_slab, 0);
		m(w, i + 6, j + 7, k + 12, 1);
	...
	public static void generate_6(World w, int i, int j, int k)
	{
		...
		b(w, i + 7, j + 2, k, glass_pane, 0);
		b(w, i + 7, j + 2, k + 1, glass_pane, 0);
		b(w, i + 7, j + 2, k + 2, glass_pane, 0);
		b(w, i + 7, j + 2, k + 3, glass_pane, 0);
		b(w, i + 7, j + 2, k + 4, glass_pane, 0);
		b(w, i + 7, j + 2, k + 5, glass_pane, 0);
		...
		b(w, i + 7, j + 3, k, glass_pane, 0);
		b(w, i + 7, j + 3, k + 1, glass_pane, 0);
		b(w, i + 7, j + 3, k + 2, glass_pane, 0);
		b(w, i + 7, j + 3, k + 3, glass_pane, 0);
		b(w, i + 7, j + 3, k + 4, glass_pane, 0);
		b(w, i + 7, j + 3, k + 5, glass_pane, 0);
		...
		b(w, i + 7, j + 4, k, glass_pane, 0);
		b(w, i + 7, j + 4, k + 1, glass_pane, 0);
		b(w, i + 7, j + 4, k + 2, glass_pane, 0);
		b(w, i + 7, j + 4, k + 3, glass_pane, 0);
		b(w, i + 7, j + 4, k + 4, glass_pane, 0);
		b(w, i + 7, j + 4, k + 5, glass_pane, 0);
	...
	public static void generate_7(World w, int i, int j, int k)
	{
		...
		m(w, i + 8, j + 6, k + 10, 1);
		b(w, i + 8, j + 6, k + 11, sandstone_stairs, 0);
		m(w, i + 8, j + 6, k + 11, 1);
	...
	public static void generate_9(World w, int i, int j, int k)
	{
		...
		b(w, i + 10, j + 1, k + 3, blockTable, 0);
		b(w, i + 10, j + 1, k + 4, blockTable, 0);
		b(w, i + 10, j + 1, k + 5, blockTable, 0);
	...
	public static void generate_11(World w, int i, int j, int k)
	{
		...
		b(w, i + 12, j + 2, k + 9, sandstone_stairs, 0);
		m(w, i + 12, j + 2, k + 9, 1);
		b(w, i + 12, j + 2, k + 10, sandstone_stairs, 0);
		m(w, i + 12, j + 2, k + 10, 1);
		b(w, i + 12, j + 2, k + 11, sandstone_stairs, 0);
		m(w, i + 12, j + 2, k + 11, 1);
		...
		m(w, i + 12, j + 6, k + 1, 5);
		b(w, i + 12, j + 6, k + 2, sandstone_stairs, 0);
		m(w, i + 12, j + 6, k + 2, 5);
		b(w, i + 12, j + 6, k + 3, double_stone_slab, 0);
		m(w, i + 12, j + 6, k + 3, 1);
	...
	public static void generate_12(World w, int i, int j, int k)
	{
		...
		b(w, i + 13, j + 1, k + 7, sandstone_stairs, 0);
		m(w, i + 13, j + 1, k + 7, 2);
	...
	public static void generate_13(World w, int i, int j, int k)
	{
		...
		b(w, i + 14, j + 1, k + 3, blockTable, 0);
		b(w, i + 14, j + 1, k + 4, blockTable, 0);
		b(w, i + 14, j + 1, k + 5, blockTable, 0);
		...
		b(w, i + 14, j + 8, k + 1, sandstone_stairs, 0);
		m(w, i + 14, j + 8, k + 1, 5);
		...
		b(w, i + 14, j + 10, k, sandstone_stairs, 0);
		m(w, i + 14, j + 10, k, 5);
