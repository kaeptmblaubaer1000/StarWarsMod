...
public class WorldGenMosEisleyBig_x176_z48
{
	...
	public static void generate_2(World w, int i, int j, int k)
	{
		...
		b(w, i + 3, j + 1, k, chest, 0);
		m(w, i + 3, j + 1, k, 5);
		b(w, i + 3, j + 1, k + 1, chest, 0);
		m(w, i + 3, j + 1, k + 1, 5);
	...
	public static void generate_8(World w, int i, int j, int k)
	{
		...
		b(w, i + 9, j + 1, k + 9, chest, 0);
		m(w, i + 9, j + 1, k + 9, 3);
		b(w, i + 9, j + 1, k + 10, air, 0);
		b(w, i + 9, j + 1, k + 11, sandstone_stairs, 0);
		m(w, i + 9, j + 1, k + 11, 3);
		b(w, i + 9, j + 1, k + 12, air, 0);
		b(w, i + 9, j + 1, k + 13, blockTable, 0);
		m(w, i + 9, j + 1, k + 13, 2);
		b(w, i + 9, j + 1, k + 14, blockTable, 0);
		m(w, i + 9, j + 1, k + 14, 2);
		b(w, i + 9, j + 1, k + 15, blockTable, 0);
		m(w, i + 9, j + 1, k + 15, 2);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		b(w, i + 15, j + 4, k + 12, sandstone_stairs, 0);
		m(w, i + 15, j + 4, k + 12, 7);
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 179, j + 1, k + 49);
		TileEntityChest chest1 = (TileEntityChest)w.getTileEntity(i + 179, j + 1, k + 48);
		TileEntityChest chest2 = (TileEntityChest)w.getTileEntity(i + 186, j + 1, k + 57);
		TileEntityChest chest3 = (TileEntityChest)w.getTileEntity(i + 185, j + 1, k + 57);
	}
