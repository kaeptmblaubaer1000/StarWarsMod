 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x64_z64
{
	...
	public static void generate_3(World w, int i, int j, int k)
	{
		...
		m(w, i + 4, j + 5, k + 1, 1);
		b(w, i + 4, j + 5, k + 2, sandstone_stairs, 0);
		m(w, i + 4, j + 5, k + 2, 3);
	...
	public static void generate_4(World w, int i, int j, int k)
	{
		...
		b(w, i + 5, j + 1, k + 2, crafting_table, 0);
	...
	public static void generate_6(World w, int i, int j, int k)
	{
		...
		b(w, i + 7, j + 4, k, sandstone_stairs, 0);
		m(w, i + 7, j + 4, k, 3);
		...
		b(w, i + 7, j + 8, k, sandstone_stairs, 0);
		m(w, i + 7, j + 8, k, 3);
		...
		b(w, i + 7, j + 12, k, sandstone_stairs, 0);
		m(w, i + 7, j + 12, k, 3);
	...
	public static void generate_8(World w, int i, int j, int k)
	{
		...
		b(w, i + 9, j + 2, k, sandstone_stairs, 0);
		m(w, i + 9, j + 2, k, 2);
		...
		b(w, i + 9, j + 6, k, sandstone_stairs, 0);
		m(w, i + 9, j + 6, k, 2);
	...
	public static void generate_11(World w, int i, int j, int k)
	{
		...
		m(w, i + 12, j + 2, k + 12, 1);
		b(w, i + 12, j + 2, k + 13, glass_pane, 0);
		b(w, i + 12, j + 2, k + 14, glass_pane, 0);
		b(w, i + 12, j + 2, k + 15, glass_pane, 0);
	...
	public static void generate_12(World w, int i, int j, int k)
	{
		...
		b(w, i + 13, j + 1, k + 12, stone_slab, 0);
		m(w, i + 13, j + 1, k + 12, 1);
	...
	public static void generate_13(World w, int i, int j, int k)
	{
		...
		m(w, i + 14, j + 1, k + 10, 1);
		b(w, i + 14, j + 1, k + 11, stone_slab, 0);
		m(w, i + 14, j + 1, k + 11, 1);
		...
		m(w, i + 15, j + 1, k + 14, 1);
		b(w, i + 15, j + 1, k + 15, blockTable, 0);
		m(w, i + 15, j + 1, k + 15, 1);
		...
		b(w, i + 15, j + 2, k + 10, glass_pane, 0);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		b(w, i + 15, j + 3, k + 10, glass_pane, 0);
