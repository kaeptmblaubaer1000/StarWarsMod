 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x48_z256
{
	...
	public static void generate_6(World w, int i, int j, int k)
	{
		...
		m(w, i + 7, j + 1, k + 2, 9);
		b(w, i + 7, j + 1, k + 3, chest, 0);
		m(w, i + 7, j + 1, k + 3, 5);
		b(w, i + 7, j + 1, k + 4, crafting_table, 0);
	...
	public static void generate_7(World w, int i, int j, int k)
	{
		...
		b(w, i + 8, j + 1, k + 5, bed, 0);
		m(w, i + 8, j + 1, k + 5, 1);
		b(w, i + 8, j + 1, k + 6, bed, 0);
		m(w, i + 8, j + 1, k + 6, 1);
	...
	public static void generate_9(World w, int i, int j, int k)
	{
		...
		m(w, i + 10, j + 10, k + 3, 1);
		b(w, i + 10, j + 10, k + 4, stone_slab, 0);
		m(w, i + 10, j + 10, k + 4, 1);
	...
	public static void generate_10(World w, int i, int j, int k)
	{
		...
		m(w, i + 11, j + 1, k + 3, 8);
		b(w, i + 11, j + 1, k + 4, carpet, 0);
		m(w, i + 11, j + 1, k + 4, 8);
		b(w, i + 11, j + 1, k + 5, carpet, 0);
		m(w, i + 11, j + 1, k + 5, 8);
		...
		b(w, i + 11, j + 9, k + 1, sandstone_stairs, 0);
		m(w, i + 11, j + 9, k + 1, 2);
		...
		m(w, i + 11, j + 10, k + 3, 1);
		b(w, i + 11, j + 10, k + 4, stone_slab, 0);
		m(w, i + 11, j + 10, k + 4, 1);
	...
	public static void generate_11(World w, int i, int j, int k)
	{
		...
		b(w, i + 12, j + 1, k + 2, carpet, 0);
		m(w, i + 12, j + 1, k + 2, 8);
		b(w, i + 12, j + 1, k + 3, carpet, 0);
		m(w, i + 12, j + 1, k + 3, 8);
		b(w, i + 12, j + 1, k + 4, carpet, 0);
		m(w, i + 12, j + 1, k + 4, 8);
		b(w, i + 12, j + 1, k + 5, carpet, 0);
		m(w, i + 12, j + 1, k + 5, 8);
		b(w, i + 12, j + 1, k + 6, air, 0);
		b(w, i + 12, j + 1, k + 7, blockTable, 0);
		m(w, i + 12, j + 1, k + 7, 2);
		...
		b(w, i + 12, j + 9, k + 2, stone_slab, 0);
		m(w, i + 12, j + 9, k + 2, 1);
		b(w, i + 12, j + 9, k + 3, sandstone, 0);
		b(w, i + 12, j + 9, k + 4, sandstone, 0);
		b(w, i + 12, j + 9, k + 5, stone_slab, 0);
		m(w, i + 12, j + 9, k + 5, 1);
	...
	public static void generate_12(World w, int i, int j, int k)
	{
		...
		b(w, i + 13, j + 1, k, jukebox, 0);
		b(w, i + 13, j + 1, k + 1, air, 0);
		b(w, i + 13, j + 1, k + 2, air, 0);
		b(w, i + 13, j + 1, k + 3, carpet, 0);
		m(w, i + 13, j + 1, k + 3, 8);
		b(w, i + 13, j + 1, k + 4, carpet, 0);
		m(w, i + 13, j + 1, k + 4, 8);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		m(w, i + 15, j + 4, k + 1, 7);
		b(w, i + 15, j + 4, k + 2, stone_slab, 0);
		m(w, i + 15, j + 4, k + 2, 9);
		b(w, i + 15, j + 4, k + 3, stone_slab, 0);
		m(w, i + 15, j + 4, k + 3, 9);
		b(w, i + 15, j + 4, k + 4, stone_slab, 0);
		m(w, i + 15, j + 4, k + 4, 9);
		b(w, i + 15, j + 4, k + 5, stone_slab, 0);
		m(w, i + 15, j + 4, k + 5, 9);
		b(w, i + 15, j + 4, k + 6, sandstone_stairs, 0);
		m(w, i + 15, j + 4, k + 6, 6);
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 55, j + 1, k + 259);
		TileEntityChest chest1 = (TileEntityChest)w.getTileEntity(i + 62, j + 1, k + 256);
	}
