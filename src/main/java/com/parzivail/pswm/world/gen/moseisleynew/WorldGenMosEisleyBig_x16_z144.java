 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x16_z144
{
	public static void generate(World w, int i, int j, int k)
	{
		...
		b(w, i, j + 5, k + 9, sandstone_stairs, 0);
		m(w, i, j + 5, k + 9, 7);
		b(w, i, j + 5, k + 10, stone_slab, 0);
		m(w, i, j + 5, k + 10, 9);
		b(w, i, j + 5, k + 11, stone_slab, 0);
		m(w, i, j + 5, k + 11, 9);
		b(w, i, j + 5, k + 12, sandstone_stairs, 0);
		m(w, i, j + 5, k + 12, 6);
	...
	public static void generate_2(World w, int i, int j, int k)
	{
		...
		b(w, i + 3, j + 4, k + 3, sandstone_stairs, 0);
	...
	public static void generate_3(World w, int i, int j, int k)
	{
		...
		b(w, i + 4, j + 1, k + 4, stone_slab, 0);
		m(w, i + 4, j + 1, k + 4, 1);
		b(w, i + 4, j + 1, k + 5, stone_slab, 0);
		m(w, i + 4, j + 1, k + 5, 1);
	...
	public static void generate_4(World w, int i, int j, int k)
	{
		...
		b(w, i + 5, j + 1, k + 4, stone_slab, 0);
		m(w, i + 5, j + 1, k + 4, 1);
		b(w, i + 5, j + 1, k + 5, stone_slab, 0);
		m(w, i + 5, j + 1, k + 5, 1);
		...
		b(w, i + 5, j + 2, k + 3, blockMV, 0);
		b(w, i + 5, j + 2, k + 4, air, 0);
		b(w, i + 5, j + 2, k + 5, air, 0);
		b(w, i + 5, j + 2, k + 6, stone_slab, 0);
		m(w, i + 5, j + 2, k + 6, 1);
		...
		b(w, i + 5, j + 5, k, air, 0);
		b(w, i + 5, j + 5, k + 1, sandstone_stairs, 0);
	...
	public static void generate_5(World w, int i, int j, int k)
	{
		...
		m(w, i + 6, j + 1, k + 3, 1);
		b(w, i + 6, j + 1, k + 4, stone_slab, 0);
		m(w, i + 6, j + 1, k + 4, 1);
		b(w, i + 6, j + 1, k + 5, stone_slab, 0);
		m(w, i + 6, j + 1, k + 5, 1);
		...
		b(w, i + 6, j + 6, k + 2, sandstone_stairs, 0);
	...
	public static void generate_6(World w, int i, int j, int k)
	{
		...
		m(w, i + 7, j + 1, k + 3, 1);
		b(w, i + 7, j + 1, k + 4, stone_slab, 0);
		m(w, i + 7, j + 1, k + 4, 1);
		b(w, i + 7, j + 1, k + 5, stone_slab, 0);
		m(w, i + 7, j + 1, k + 5, 1);
	...
	public static void generate_7(World w, int i, int j, int k)
	{
		...
		m(w, i + 8, j + 1, k + 3, 1);
		b(w, i + 8, j + 1, k + 4, stone_slab, 0);
		m(w, i + 8, j + 1, k + 4, 1);
		b(w, i + 8, j + 1, k + 5, stone_slab, 0);
		m(w, i + 8, j + 1, k + 5, 1);
		b(w, i + 8, j + 1, k + 6, sandstone_stairs, 0);
		m(w, i + 8, j + 1, k + 6, 3);
	...
	public static void generate_8(World w, int i, int j, int k)
	{
		...
		m(w, i + 9, j + 1, k + 3, 1);
		b(w, i + 9, j + 1, k + 4, stone_slab, 0);
		m(w, i + 9, j + 1, k + 4, 1);
		b(w, i + 9, j + 1, k + 5, stone_slab, 0);
		m(w, i + 9, j + 1, k + 5, 1);
	...
	public static void generate_9(World w, int i, int j, int k)
	{
		...
		m(w, i + 10, j + 1, k + 3, 1);
		b(w, i + 10, j + 1, k + 4, stone_slab, 0);
		m(w, i + 10, j + 1, k + 4, 1);
		b(w, i + 10, j + 1, k + 5, stone_slab, 0);
		m(w, i + 10, j + 1, k + 5, 1);
		...
		m(w, i + 10, j + 1, k + 9, 3);
		b(w, i + 10, j + 1, k + 10, blockTable, 0);
	...
	public static void generate_10(World w, int i, int j, int k)
	{
		...
		m(w, i + 11, j + 1, k + 3, 1);
		b(w, i + 11, j + 1, k + 4, stone_slab, 0);
		m(w, i + 11, j + 1, k + 4, 1);
		b(w, i + 11, j + 1, k + 5, stone_slab, 0);
		m(w, i + 11, j + 1, k + 5, 1);
		...
		b(w, i + 11, j + 5, k + 2, sandstone_stairs, 0);
		m(w, i + 11, j + 5, k + 2, 4);
		...
		b(w, i + 11, j + 6, k + 1, sandstone_stairs, 0);
		m(w, i + 11, j + 6, k + 1, 1);
		b(w, i + 11, j + 6, k + 2, sandstone_stairs, 0);
		m(w, i + 11, j + 6, k + 2, 1);
	...
	public static void generate_11(World w, int i, int j, int k)
	{
		...
		b(w, i + 12, j + 1, k + 4, stone_slab, 0);
		m(w, i + 12, j + 1, k + 4, 1);
		b(w, i + 12, j + 1, k + 5, stone_slab, 0);
		m(w, i + 12, j + 1, k + 5, 1);
		...
		b(w, i + 12, j + 5, k + 1, sandstone_stairs, 0);
		m(w, i + 12, j + 5, k + 1, 1);
	...
	public static void generate_12(World w, int i, int j, int k)
	{
		...
		m(w, i + 13, j + 1, k + 9, 3);
		b(w, i + 13, j + 1, k + 10, blockTable, 0);
		...
		b(w, i + 13, j + 4, k + 1, sandstone_stairs, 0);
		m(w, i + 13, j + 4, k + 1, 1);
		b(w, i + 13, j + 4, k + 2, sandstone_stairs, 0);
		m(w, i + 13, j + 4, k + 2, 1);
	...
	public static void generate_13(World w, int i, int j, int k)
	{
		...
		b(w, i + 14, j + 4, k + 3, sandstone_stairs, 0);
		m(w, i + 14, j + 4, k + 3, 1);
