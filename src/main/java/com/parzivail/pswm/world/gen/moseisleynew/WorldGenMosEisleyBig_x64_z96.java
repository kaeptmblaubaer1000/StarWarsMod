 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x64_z96
{
	...
	public static void generate_5(World w, int i, int j, int k)
	{
		...
		b(w, i + 6, j + 8, k, air, 0);
		b(w, i + 6, j + 8, k + 1, sandstone_stairs, 0);
		m(w, i + 6, j + 8, k + 1, 2);
		...
		b(w, i + 6, j + 9, k + 2, sandstone_stairs, 0);
		m(w, i + 6, j + 9, k + 2, 2);
	...
	public static void generate_7(World w, int i, int j, int k)
	{
		...
		b(w, i + 8, j + 1, k + 8, crafting_table, 0);
	...
	public static void generate_12(World w, int i, int j, int k)
	{
		...
		b(w, i + 13, j + 4, k + 14, sandstone_stairs, 0);
		m(w, i + 13, j + 4, k + 14, 2);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 69, j + 1, k + 102);
	}
