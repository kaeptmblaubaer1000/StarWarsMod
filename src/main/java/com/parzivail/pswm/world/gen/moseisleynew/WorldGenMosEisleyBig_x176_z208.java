...
public class WorldGenMosEisleyBig_x176_z208
{
	...
	public static void generate_1(World w, int i, int j, int k)
	{
		...
		b(w, i + 1, j + 3, k + 8, sandstone_stairs, 0);
	...
	public static void generate_3(World w, int i, int j, int k)
	{
		...
		b(w, i + 3, j + 8, k + 9, sandstone_stairs, 0);
		b(w, i + 3, j + 8, k + 10, sandstone_stairs, 0);
		...
		b(w, i + 4, j + 4, k + 5, sandstone_stairs, 0);
		m(w, i + 4, j + 4, k + 5, 5);
	...
	public static void generate_4(World w, int i, int j, int k)
	{
		...
		b(w, i + 5, j + 1, k + 8, carpet, 0);
		m(w, i + 5, j + 1, k + 8, 8);
		b(w, i + 5, j + 1, k + 9, carpet, 0);
		m(w, i + 5, j + 1, k + 9, 8);
		b(w, i + 5, j + 1, k + 10, air, 0);
		b(w, i + 5, j + 1, k + 11, air, 0);
		b(w, i + 5, j + 1, k + 12, bed, 0);
		b(w, i + 5, j + 1, k + 13, bed, 0);
		m(w, i + 5, j + 1, k + 13, 8);
		...
		b(w, i + 5, j + 4, k + 3, stone_slab, 0);
		m(w, i + 5, j + 4, k + 3, 1);
		b(w, i + 5, j + 4, k + 4, sandstone, 0);
		b(w, i + 5, j + 4, k + 5, stone_slab, 0);
		m(w, i + 5, j + 4, k + 5, 9);
	...
	public static void generate_5(World w, int i, int j, int k)
	{
		...
		m(w, i + 6, j + 1, k + 7, 8);
		b(w, i + 6, j + 1, k + 8, carpet, 0);
		m(w, i + 6, j + 1, k + 8, 8);
		b(w, i + 6, j + 1, k + 9, carpet, 0);
		m(w, i + 6, j + 1, k + 9, 8);
		b(w, i + 6, j + 1, k + 10, carpet, 0);
		m(w, i + 6, j + 1, k + 10, 8);
		...
		b(w, i + 6, j + 10, k + 9, stone_slab, 0);
		m(w, i + 6, j + 10, k + 9, 1);
		b(w, i + 6, j + 10, k + 10, stone_slab, 0);
		m(w, i + 6, j + 10, k + 10, 1);
	...
	public static void generate_6(World w, int i, int j, int k)
	{
		...
		m(w, i + 7, j + 1, k + 7, 8);
		b(w, i + 7, j + 1, k + 8, carpet, 0);
		m(w, i + 7, j + 1, k + 8, 8);
		b(w, i + 7, j + 1, k + 9, carpet, 0);
		m(w, i + 7, j + 1, k + 9, 8);
		b(w, i + 7, j + 1, k + 10, carpet, 0);
		m(w, i + 7, j + 1, k + 10, 8);
		b(w, i + 7, j + 1, k + 11, air, 0);
		b(w, i + 7, j + 1, k + 12, air, 0);
		b(w, i + 7, j + 1, k + 13, crafting_table, 0);
		...
		b(w, i + 7, j + 4, k + 3, sandstone_stairs, 0);
		m(w, i + 7, j + 4, k + 3, 2);
		...
		b(w, i + 7, j + 9, k + 12, sandstone_stairs, 0);
		m(w, i + 7, j + 9, k + 12, 3);
		...
		b(w, i + 7, j + 10, k + 9, stone_slab, 0);
		m(w, i + 7, j + 10, k + 9, 1);
		b(w, i + 7, j + 10, k + 10, stone_slab, 0);
		m(w, i + 7, j + 10, k + 10, 1);
	...
	public static void generate_7(World w, int i, int j, int k)
	{
		...
		b(w, i + 8, j + 1, k + 8, carpet, 0);
		m(w, i + 8, j + 1, k + 8, 8);
		b(w, i + 8, j + 1, k + 9, carpet, 0);
		m(w, i + 8, j + 1, k + 9, 8);
		b(w, i + 8, j + 1, k + 10, air, 0);
		b(w, i + 8, j + 1, k + 11, air, 0);
		b(w, i + 8, j + 1, k + 12, bed, 0);
		b(w, i + 8, j + 1, k + 13, bed, 0);
		m(w, i + 8, j + 1, k + 13, 8);
		...
		b(w, i + 8, j + 8, k + 12, sandstone_stairs, 0);
		m(w, i + 8, j + 8, k + 12, 3);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 179, j + 1, k + 214);
		TileEntityChest chest1 = (TileEntityChest)w.getTileEntity(i + 182, j + 1, k + 221);
	}
