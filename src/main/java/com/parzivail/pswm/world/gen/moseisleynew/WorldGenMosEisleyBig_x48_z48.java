 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x48_z48
{
	...
	public static void generate_3(World w, int i, int j, int k)
	{
		...
		b(w, i + 4, j + 1, k + 5, chest, 0);
		m(w, i + 4, j + 1, k + 5, 5);
		b(w, i + 4, j + 1, k + 6, chest, 0);
		m(w, i + 4, j + 1, k + 6, 5);
		...
		b(w, i + 4, j + 4, k + 6, sandstone_stairs, 0);
		m(w, i + 4, j + 4, k + 6, 5);
	...
	public static void generate_5(World w, int i, int j, int k)
	{
		...
		b(w, i + 6, j + 2, k + 2, sandstone_stairs, 0);
		...
		b(w, i + 6, j + 4, k + 4, sandstone_stairs, 0);
		m(w, i + 6, j + 4, k + 4, 1);
		b(w, i + 6, j + 4, k + 5, air, 0);
		b(w, i + 6, j + 4, k + 6, stone_slab, 0);
		m(w, i + 6, j + 4, k + 6, 9);
		...
		b(w, i + 6, j + 12, k + 4, sandstone_stairs, 0);
		m(w, i + 6, j + 12, k + 4, 1);
	...
	public static void generate_6(World w, int i, int j, int k)
	{
		...
		b(w, i + 7, j + 7, k + 3, sandstone_stairs, 0);
		m(w, i + 7, j + 7, k + 3, 2);
		...
		b(w, i + 7, j + 11, k + 3, sandstone_stairs, 0);
		m(w, i + 7, j + 11, k + 3, 2);
	...
	public static void generate_7(World w, int i, int j, int k)
	{
		...
		b(w, i + 8, j + 1, k + 1, bed, 0);
		m(w, i + 8, j + 1, k + 1, 10);
		b(w, i + 8, j + 1, k + 2, bed, 0);
		m(w, i + 8, j + 1, k + 2, 2);
		b(w, i + 8, j + 1, k + 3, air, 0);
		b(w, i + 8, j + 1, k + 4, air, 0);
		b(w, i + 8, j + 1, k + 5, furnace, 0);
		m(w, i + 8, j + 1, k + 5, 4);
		b(w, i + 8, j + 1, k + 6, crafting_table, 0);
		...
		b(w, i + 8, j + 3, k + 2, torch, 0);
		m(w, i + 8, j + 3, k + 2, 2);
		b(w, i + 8, j + 3, k + 3, air, 0);
		b(w, i + 8, j + 3, k + 4, air, 0);
		b(w, i + 8, j + 3, k + 5, torch, 0);
		m(w, i + 8, j + 3, k + 5, 2);
		...
		b(w, i + 8, j + 4, k + 6, sandstone_stairs, 0);
		m(w, i + 8, j + 4, k + 6, 4);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 52, j + 1, k + 54);
		TileEntityChest chest1 = (TileEntityChest)w.getTileEntity(i + 52, j + 1, k + 53);
	}
