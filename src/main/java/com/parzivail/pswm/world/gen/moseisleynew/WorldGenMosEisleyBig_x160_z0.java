...
public class WorldGenMosEisleyBig_x160_z0
{
	...
	public static void generate_3(World w, int i, int j, int k)
	{
		...
		b(w, i + 4, j + 1, k + 6, furnace, 0);
		m(w, i + 4, j + 1, k + 6, 5);
		b(w, i + 4, j + 1, k + 7, crafting_table, 0);
		b(w, i + 4, j + 1, k + 8, jukebox, 0);
	...
	public static void generate_6(World w, int i, int j, int k)
	{
		...
		b(w, i + 7, j + 4, k + 12, sandstone_stairs, 0);
		m(w, i + 7, j + 4, k + 12, 5);
	...
	public static void generate_10(World w, int i, int j, int k)
	{
		...
		b(w, i + 11, j + 4, k + 12, sandstone_stairs, 0);
		m(w, i + 11, j + 4, k + 12, 4);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 174, j + 1, k + 6);
		TileEntityChest chest1 = (TileEntityChest)w.getTileEntity(i + 174, j + 1, k + 7);
	}
