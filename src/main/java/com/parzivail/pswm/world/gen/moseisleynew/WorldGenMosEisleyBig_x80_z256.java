...
public class WorldGenMosEisleyBig_x80_z256
{
	...
	public static void generate_4(World w, int i, int j, int k)
	{
		...
		b(w, i + 5, j + 1, k + 10, furnace, 0);
		m(w, i + 5, j + 1, k + 10, 5);
		b(w, i + 5, j + 1, k + 11, crafting_table, 0);
		b(w, i + 5, j + 1, k + 12, jukebox, 0);
	...
	public static void generate_8(World w, int i, int j, int k)
	{
		...
		b(w, i + 9, j + 1, k + 9, blockTable, 0);
		m(w, i + 9, j + 1, k + 9, 1);
		b(w, i + 9, j + 1, k + 10, blockTable, 0);
		m(w, i + 9, j + 1, k + 10, 1);
	...
	public static void generate_10(World w, int i, int j, int k)
	{
		...
		m(w, i + 11, j + 1, k + 9, 1);
		b(w, i + 11, j + 1, k + 10, blockTable, 0);
		m(w, i + 11, j + 1, k + 10, 1);
	...
	public static void generate_13(World w, int i, int j, int k)
	{
		...
		b(w, i + 14, j + 1, k + 13, bed, 0);
		m(w, i + 14, j + 1, k + 13, 10);
		b(w, i + 14, j + 1, k + 14, bed, 0);
		m(w, i + 14, j + 1, k + 14, 2);
		...
		b(w, i + 15, j + 1, k + 10, chest, 0);
		m(w, i + 15, j + 1, k + 10, 4);
		b(w, i + 15, j + 1, k + 11, chest, 0);
		m(w, i + 15, j + 1, k + 11, 4);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 95, j + 1, k + 267);
		TileEntityChest chest1 = (TileEntityChest)w.getTileEntity(i + 95, j + 1, k + 266);
		TileEntityChest chest2 = (TileEntityChest)w.getTileEntity(i + 91, j + 1, k + 257);
	}
