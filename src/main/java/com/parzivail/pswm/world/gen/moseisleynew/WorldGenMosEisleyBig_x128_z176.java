 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x128_z176
{
	...
	public static void generate_1(World w, int i, int j, int k)
	{
		...
		b(w, i + 1, j + 9, k, stone_slab, 0);
		m(w, i + 1, j + 9, k, 1);
		b(w, i + 1, j + 9, k + 1, stone_slab, 0);
		m(w, i + 1, j + 9, k + 1, 1);
