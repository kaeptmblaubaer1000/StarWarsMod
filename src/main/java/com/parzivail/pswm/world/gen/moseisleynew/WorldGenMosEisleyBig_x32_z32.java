 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x32_z32
{
	...
	public static void generate_4(World w, int i, int j, int k)
	{
		...
		b(w, i + 5, j + 4, k, sandstone_stairs, 0);
		m(w, i + 5, j + 4, k, 3);
	...
	public static void generate_10(World w, int i, int j, int k)
	{
		...
		b(w, i + 11, j + 1, k + 3, crafting_table, 0);
		...
		b(w, i + 11, j + 8, k + 10, stone_slab, 0);
		m(w, i + 11, j + 8, k + 10, 1);
	...
	public static void generate_12(World w, int i, int j, int k)
	{
		...
		b(w, i + 13, j + 7, k + 11, sandstone_stairs, 0);
		m(w, i + 13, j + 7, k + 11, 3);
	...
	public static void generate_13(World w, int i, int j, int k)
	{
		...
		m(w, i + 14, j + 8, k + 7, 1);
		b(w, i + 14, j + 8, k + 8, sandstone_stairs, 0);
		m(w, i + 14, j + 8, k + 8, 1);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		m(w, i + 15, j + 7, k + 6, 1);
		b(w, i + 15, j + 7, k + 7, sandstone_stairs, 0);
		m(w, i + 15, j + 7, k + 7, 1);
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 46, j + 1, k + 37);
	}
