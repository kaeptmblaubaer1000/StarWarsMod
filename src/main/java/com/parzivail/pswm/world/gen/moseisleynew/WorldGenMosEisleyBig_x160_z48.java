...
public class WorldGenMosEisleyBig_x160_z48
{
	public static void generate(World w, int i, int j, int k)
	{
		...
		m(w, i, j + 11, k + 9, 1);
		b(w, i, j + 11, k + 10, stone_slab, 0);
		m(w, i, j + 11, k + 10, 1);
		b(w, i, j + 11, k + 11, stone_slab, 0);
		m(w, i, j + 11, k + 11, 1);
	...
	public static void generate_1(World w, int i, int j, int k)
	{
		...
		b(w, i + 1, j + 4, k, sandstone_stairs, 0);
		m(w, i + 1, j + 4, k, 3);
		...
		m(w, i + 1, j + 11, k + 9, 1);
		b(w, i + 1, j + 11, k + 10, stone_slab, 0);
		m(w, i + 1, j + 11, k + 10, 1);
		b(w, i + 1, j + 11, k + 11, stone_slab, 0);
		m(w, i + 1, j + 11, k + 11, 1);
		...
		b(w, i + 2, j + 3, k, sandstone_stairs, 0);
		m(w, i + 2, j + 3, k, 4);
