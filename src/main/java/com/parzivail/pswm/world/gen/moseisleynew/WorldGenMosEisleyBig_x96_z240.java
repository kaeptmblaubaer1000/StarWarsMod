...
public class WorldGenMosEisleyBig_x96_z240
{
	...
	public static void generate_5(World w, int i, int j, int k)
	{
		...
		m(w, i + 6, j + 6, k + 13, 4);
		b(w, i + 6, j + 6, k + 14, sandstone_stairs, 0);
		m(w, i + 6, j + 6, k + 14, 4);
	...
	public static void generate_9(World w, int i, int j, int k)
	{
		...
		b(w, i + 10, j + 1, k + 14, stone_slab, 0);
		m(w, i + 10, j + 1, k + 14, 1);
		...
		b(w, i + 10, j + 10, k + 13, torch, 0);
		m(w, i + 10, j + 10, k + 13, 4);
	...
	public static void generate_10(World w, int i, int j, int k)
	{
		...
		b(w, i + 11, j + 1, k + 15, stone_slab, 0);
		m(w, i + 11, j + 1, k + 15, 1);
