 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x112_z256
{
	public static void generate(World w, int i, int j, int k)
	{
		...
		b(w, i, j + 6, k + 13, sandstone_stairs, 0);
		m(w, i, j + 6, k + 13, 7);
		...
		b(w, i, j + 7, k + 3, stone_slab, 0);
		m(w, i, j + 7, k + 3, 1);
		b(w, i, j + 7, k + 4, stone_slab, 0);
		m(w, i, j + 7, k + 4, 1);
		...
		b(w, i, j + 7, k + 13, stone_slab, 0);
		m(w, i, j + 7, k + 13, 1);
		b(w, i, j + 7, k + 14, stone_slab, 0);
		m(w, i, j + 7, k + 14, 1);
		b(w, i, j + 7, k + 15, sandstone, 0);
		b(w, i, j + 8, k, air, 0);
		b(w, i, j + 8, k + 1, air, 0);
		b(w, i, j + 8, k + 2, glass_pane, 0);
		b(w, i, j + 8, k + 3, air, 0);
		b(w, i, j + 8, k + 4, air, 0);
		b(w, i, j + 8, k + 5, stone_slab, 0);
		m(w, i, j + 8, k + 5, 1);
		b(w, i, j + 8, k + 6, air, 0);
		b(w, i, j + 8, k + 7, air, 0);
		b(w, i, j + 8, k + 8, air, 0);
		...
		b(w, i, j + 10, k + 2, sandstone_stairs, 0);
	...
	public static void generate_1(World w, int i, int j, int k)
	{
		...
		b(w, i + 1, j + 6, k + 13, sandstone_stairs, 0);
		m(w, i + 1, j + 6, k + 13, 7);
		...
		b(w, i + 1, j + 7, k + 3, stone_slab, 0);
		m(w, i + 1, j + 7, k + 3, 1);
		b(w, i + 1, j + 7, k + 4, stone_slab, 0);
		m(w, i + 1, j + 7, k + 4, 1);
		...
		b(w, i + 1, j + 7, k + 13, stone_slab, 0);
		m(w, i + 1, j + 7, k + 13, 1);
		b(w, i + 1, j + 7, k + 14, stone_slab, 0);
		m(w, i + 1, j + 7, k + 14, 1);
		b(w, i + 1, j + 7, k + 15, sandstone, 0);
		b(w, i + 1, j + 8, k, air, 0);
		b(w, i + 1, j + 8, k + 1, air, 0);
		b(w, i + 1, j + 8, k + 2, glass_pane, 0);
		b(w, i + 1, j + 8, k + 3, air, 0);
		b(w, i + 1, j + 8, k + 4, air, 0);
		b(w, i + 1, j + 8, k + 5, stone_slab, 0);
		m(w, i + 1, j + 8, k + 5, 1);
		...
		b(w, i + 2, j + 1, k + 3, blockTable, 0);
		b(w, i + 2, j + 1, k + 4, blockTable, 0);
		b(w, i + 2, j + 1, k + 5, blockTable, 0);
	...
	public static void generate_2(World w, int i, int j, int k)
	{
		...
		b(w, i + 2, j + 6, k + 13, sandstone_stairs, 0);
		m(w, i + 2, j + 6, k + 13, 7);
		...
		m(w, i + 2, j + 7, k + 8, 3);
		b(w, i + 2, j + 7, k + 9, blockTable, 0);
		b(w, i + 2, j + 7, k + 10, sandstone_stairs, 0);
		m(w, i + 2, j + 7, k + 10, 2);
		...
		b(w, i + 2, j + 8, k + 2, glass_pane, 0);
		b(w, i + 2, j + 8, k + 3, air, 0);
		b(w, i + 2, j + 8, k + 4, air, 0);
		b(w, i + 2, j + 8, k + 5, stone_slab, 0);
		m(w, i + 2, j + 8, k + 5, 1);
	...
	public static void generate_3(World w, int i, int j, int k)
	{
		...
		b(w, i + 3, j + 10, k, sandstone_stairs, 0);
		m(w, i + 3, j + 10, k, 4);
		...
		m(w, i + 4, j + 7, k + 2, 1);
		b(w, i + 4, j + 7, k + 3, stone_slab, 0);
		m(w, i + 4, j + 7, k + 3, 1);
		b(w, i + 4, j + 7, k + 4, stone_slab, 0);
		m(w, i + 4, j + 7, k + 4, 1);
	...
	public static void generate_4(World w, int i, int j, int k)
	{
		...
		m(w, i + 5, j + 6, k + 1, 4);
		b(w, i + 5, j + 6, k + 2, sandstone_stairs, 0);
		m(w, i + 5, j + 6, k + 2, 4);
		b(w, i + 5, j + 6, k + 3, double_stone_slab, 0);
		m(w, i + 5, j + 6, k + 3, 1);
		...
		b(w, i + 5, j + 7, k + 2, stone_slab, 0);
		m(w, i + 5, j + 7, k + 2, 1);
		b(w, i + 5, j + 7, k + 3, stone_slab, 0);
		m(w, i + 5, j + 7, k + 3, 1);
		b(w, i + 5, j + 7, k + 4, stone_slab, 0);
		m(w, i + 5, j + 7, k + 4, 1);
	...
	public static void generate_5(World w, int i, int j, int k)
	{
		...
		m(w, i + 6, j + 7, k + 2, 1);
		b(w, i + 6, j + 7, k + 3, sandstone_stairs, 0);
		m(w, i + 6, j + 7, k + 3, 1);
		...
		b(w, i + 6, j + 8, k + 1, stone_slab, 0);
		m(w, i + 6, j + 8, k + 1, 1);
		b(w, i + 6, j + 8, k + 2, stone_slab, 0);
		m(w, i + 6, j + 8, k + 2, 1);
		b(w, i + 6, j + 8, k + 3, stone_slab, 0);
		m(w, i + 6, j + 8, k + 3, 1);
		b(w, i + 6, j + 8, k + 4, stone_slab, 0);
		m(w, i + 6, j + 8, k + 4, 1);
		b(w, i + 6, j + 8, k + 5, stone_slab, 0);
		m(w, i + 6, j + 8, k + 5, 1);
	...
	public static void generate_7(World w, int i, int j, int k)
	{
		...
		m(w, i + 8, j + 7, k + 1, 3);
		b(w, i + 8, j + 7, k + 2, blockTable, 0);
		b(w, i + 8, j + 7, k + 3, blockTable, 0);
	...
	public static void generate_8(World w, int i, int j, int k)
	{
		...
		m(w, i + 9, j + 7, k + 1, 3);
		b(w, i + 9, j + 7, k + 2, blockTable, 0);
		b(w, i + 9, j + 7, k + 3, blockTable, 0);
		b(w, i + 9, j + 7, k + 4, sandstone_stairs, 0);
		m(w, i + 9, j + 7, k + 4, 2);
	...
	public static void generate_9(World w, int i, int j, int k)
	{
		...
		b(w, i + 10, j + 4, k + 5, sandstone_stairs, 0);
		m(w, i + 10, j + 4, k + 5, 7);
		b(w, i + 10, j + 4, k + 6, stone_slab, 0);
		m(w, i + 10, j + 4, k + 6, 9);
		b(w, i + 10, j + 4, k + 7, stone_slab, 0);
		m(w, i + 10, j + 4, k + 7, 9);
		b(w, i + 10, j + 4, k + 8, stone_slab, 0);
		m(w, i + 10, j + 4, k + 8, 9);
		b(w, i + 10, j + 4, k + 9, sandstone_stairs, 0);
		m(w, i + 10, j + 4, k + 9, 6);
	...
	public static void generate_10(World w, int i, int j, int k)
	{
		...
		m(w, i + 11, j + 4, k + 4, 2);
		b(w, i + 11, j + 4, k + 5, sandstone_stairs, 0);
		m(w, i + 11, j + 4, k + 5, 7);
		b(w, i + 11, j + 4, k + 6, stone_slab, 0);
		m(w, i + 11, j + 4, k + 6, 9);
		b(w, i + 11, j + 4, k + 7, stone_slab, 0);
		m(w, i + 11, j + 4, k + 7, 9);
		b(w, i + 11, j + 4, k + 8, stone_slab, 0);
		m(w, i + 11, j + 4, k + 8, 9);
		b(w, i + 11, j + 4, k + 9, sandstone_stairs, 0);
		m(w, i + 11, j + 4, k + 9, 6);
		...
		b(w, i + 11, j + 6, k, sandstone_stairs, 0);
		m(w, i + 11, j + 6, k, 5);
		...
		m(w, i + 11, j + 6, k + 3, 5);
		b(w, i + 11, j + 6, k + 4, sandstone_stairs, 0);
		m(w, i + 11, j + 6, k + 4, 5);
		b(w, i + 11, j + 6, k + 5, sandstone_stairs, 0);
		m(w, i + 11, j + 6, k + 5, 5);
		b(w, i + 11, j + 6, k + 6, sandstone_stairs, 0);
		m(w, i + 11, j + 6, k + 6, 5);
		b(w, i + 11, j + 6, k + 7, sandstone_stairs, 0);
		m(w, i + 11, j + 6, k + 7, 5);
		b(w, i + 11, j + 6, k + 8, sandstone_stairs, 0);
		m(w, i + 11, j + 6, k + 8, 5);
		b(w, i + 11, j + 6, k + 9, sandstone_stairs, 0);
		m(w, i + 11, j + 6, k + 9, 5);
		b(w, i + 11, j + 6, k + 10, sandstone_stairs, 0);
		m(w, i + 11, j + 6, k + 10, 5);
		b(w, i + 11, j + 6, k + 11, sandstone_stairs, 0);
		m(w, i + 11, j + 6, k + 11, 5);
		...
		b(w, i + 11, j + 7, k, stone_slab, 0);
		m(w, i + 11, j + 7, k, 1);
		b(w, i + 11, j + 7, k + 1, stone_slab, 0);
		m(w, i + 11, j + 7, k + 1, 1);
		b(w, i + 11, j + 7, k + 2, stone_slab, 0);
		m(w, i + 11, j + 7, k + 2, 1);
		b(w, i + 11, j + 7, k + 3, stone_slab, 0);
		m(w, i + 11, j + 7, k + 3, 1);
		b(w, i + 11, j + 7, k + 4, stone_slab, 0);
		m(w, i + 11, j + 7, k + 4, 1);
		b(w, i + 11, j + 7, k + 5, stone_slab, 0);
		m(w, i + 11, j + 7, k + 5, 1);
		b(w, i + 11, j + 7, k + 6, stone_slab, 0);
		m(w, i + 11, j + 7, k + 6, 1);
		b(w, i + 11, j + 7, k + 7, stone_slab, 0);
		m(w, i + 11, j + 7, k + 7, 1);
		b(w, i + 11, j + 7, k + 8, stone_slab, 0);
		m(w, i + 11, j + 7, k + 8, 1);
		b(w, i + 11, j + 7, k + 9, stone_slab, 0);
		m(w, i + 11, j + 7, k + 9, 1);
		b(w, i + 11, j + 7, k + 10, stone_slab, 0);
		m(w, i + 11, j + 7, k + 10, 1);
		b(w, i + 11, j + 7, k + 11, stone_slab, 0);
		m(w, i + 11, j + 7, k + 11, 1);
	...
	public static void generate_11(World w, int i, int j, int k)
	{
		...
		b(w, i + 12, j + 7, k, stone_slab, 0);
		m(w, i + 12, j + 7, k, 1);
		b(w, i + 12, j + 7, k + 1, stone_slab, 0);
		m(w, i + 12, j + 7, k + 1, 1);
		b(w, i + 12, j + 7, k + 2, stone_slab, 0);
		m(w, i + 12, j + 7, k + 2, 1);
		b(w, i + 12, j + 7, k + 3, stone_slab, 0);
		m(w, i + 12, j + 7, k + 3, 1);
		b(w, i + 12, j + 7, k + 4, stone_slab, 0);
		m(w, i + 12, j + 7, k + 4, 1);
		b(w, i + 12, j + 7, k + 5, stone_slab, 0);
		m(w, i + 12, j + 7, k + 5, 1);
		b(w, i + 12, j + 7, k + 6, stone_slab, 0);
		m(w, i + 12, j + 7, k + 6, 1);
		b(w, i + 12, j + 7, k + 7, stone_slab, 0);
		m(w, i + 12, j + 7, k + 7, 1);
		b(w, i + 12, j + 7, k + 8, stone_slab, 0);
		m(w, i + 12, j + 7, k + 8, 1);
		b(w, i + 12, j + 7, k + 9, stone_slab, 0);
		m(w, i + 12, j + 7, k + 9, 1);
		b(w, i + 12, j + 7, k + 10, stone_slab, 0);
		m(w, i + 12, j + 7, k + 10, 1);
		b(w, i + 12, j + 7, k + 11, stone_slab, 0);
		m(w, i + 12, j + 7, k + 11, 1);
