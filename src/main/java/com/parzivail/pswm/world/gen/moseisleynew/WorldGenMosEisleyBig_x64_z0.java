 ...
 */
//@formatter:off
public class WorldGenMosEisleyBig_x64_z0
{
	public static void generate(World w, int i, int j, int k)
	{
		...
		b(w, i, j + 1, k + 6, air, 0);
		b(w, i, j + 1, k + 7, air, 0);
		b(w, i, j + 1, k + 8, blockTable, 0);
		b(w, i, j + 1, k + 9, blockTable, 0);
	...
	public static void generate_5(World w, int i, int j, int k)
	{
		...
		b(w, i + 6, j + 1, k + 6, jukebox, 0);
		b(w, i + 6, j + 1, k + 7, crafting_table, 0);
		b(w, i + 6, j + 1, k + 8, furnace, 0);
		m(w, i + 6, j + 1, k + 8, 4);
