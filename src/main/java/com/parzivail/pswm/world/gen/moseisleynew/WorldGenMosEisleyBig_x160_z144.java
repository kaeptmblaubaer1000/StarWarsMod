...
public class WorldGenMosEisleyBig_x160_z144
{
	public static void generate(World w, int i, int j, int k)
	{
		...
		b(w, i, j + 1, k + 13, blockTable, 0);
		m(w, i, j + 1, k + 13, 1);
		b(w, i, j + 1, k + 14, blockTable, 0);
		m(w, i, j + 1, k + 14, 1);
	...
	public static void generate_5(World w, int i, int j, int k)
	{
		...
		b(w, i + 6, j + 9, k, sandstone_stairs, 0);
		m(w, i + 6, j + 9, k, 3);
	...
	public static void generate_9(World w, int i, int j, int k)
	{
		...
		b(w, i + 10, j + 4, k, sandstone_stairs, 0);
		m(w, i + 10, j + 4, k, 6);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 164, j + 1, k + 158);
		TileEntityChest chest1 = (TileEntityChest)w.getTileEntity(i + 164, j + 1, k + 159);
	}
