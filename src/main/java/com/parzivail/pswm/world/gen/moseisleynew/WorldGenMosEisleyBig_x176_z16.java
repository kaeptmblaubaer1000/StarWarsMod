...
public class WorldGenMosEisleyBig_x176_z16
{
	public static void generate(World w, int i, int j, int k)
	{
		...
		m(w, i + 1, j + 1, k + 13, 2);
		b(w, i + 1, j + 1, k + 14, crafting_table, 0);
	...
	public static void generate_1(World w, int i, int j, int k)
	{
		...
		m(w, i + 1, j + 4, k + 13, 2);
		b(w, i + 1, j + 4, k + 14, sandstone_stairs, 0);
		m(w, i + 1, j + 4, k + 14, 7);
		...
		m(w, i + 2, j + 3, k + 14, 1);
		b(w, i + 2, j + 3, k + 15, sandstone_stairs, 0);
		m(w, i + 2, j + 3, k + 15, 7);
		b(w, i + 2, j + 4, k, air, 0);
	...
	public static void generate_2(World w, int i, int j, int k)
	{
		...
		b(w, i + 2, j + 5, k + 14, sandstone_stairs, 0);
		m(w, i + 2, j + 5, k + 14, 2);
	...
	public static void generate_8(World w, int i, int j, int k)
	{
		...
		b(w, i + 9, j + 7, k + 14, sandstone_stairs, 0);
	...
	public static void generate_9(World w, int i, int j, int k)
	{
		...
		b(w, i + 10, j + 1, k + 10, crafting_table, 0);
		...
		b(w, i + 10, j + 8, k + 10, stone_slab, 0);
		m(w, i + 10, j + 8, k + 10, 1);
	...
	public static void generate_12(World w, int i, int j, int k)
	{
		...
		m(w, i + 13, j + 8, k + 12, 1);
		b(w, i + 13, j + 8, k + 13, sandstone_stairs, 0);
		m(w, i + 13, j + 8, k + 13, 1);
	...
	public static void generate_13(World w, int i, int j, int k)
	{
		...
		m(w, i + 14, j + 7, k + 13, 1);
		b(w, i + 14, j + 7, k + 14, sandstone_stairs, 0);
		m(w, i + 14, j + 7, k + 14, 1);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 189, j + 1, k + 28);
	}
