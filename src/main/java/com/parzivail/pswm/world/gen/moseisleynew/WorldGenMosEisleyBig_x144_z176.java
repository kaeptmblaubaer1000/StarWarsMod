...
public class WorldGenMosEisleyBig_x144_z176
{
	...
	public static void generate_1(World w, int i, int j, int k)
	{
		...
		b(w, i + 2, j + 1, k + 11, blockTable, 0);
		m(w, i + 2, j + 1, k + 11, 2);
		b(w, i + 2, j + 1, k + 12, bed, 0);
		m(w, i + 2, j + 1, k + 12, 9);
		b(w, i + 2, j + 1, k + 13, bed, 0);
		m(w, i + 2, j + 1, k + 13, 9);
		b(w, i + 2, j + 1, k + 14, chest, 0);
		m(w, i + 2, j + 1, k + 14, 5);
		b(w, i + 2, j + 1, k + 15, crafting_table, 0);
		b(w, i + 2, j + 2, k, air, 0);
	...
	public static void generate_2(World w, int i, int j, int k)
	{
		...
		b(w, i + 3, j + 1, k + 12, bed, 0);
		m(w, i + 3, j + 1, k + 12, 1);
		b(w, i + 3, j + 1, k + 13, bed, 0);
		m(w, i + 3, j + 1, k + 13, 1);
	...
	public static void generate_3(World w, int i, int j, int k)
	{
		...
		b(w, i + 3, j + 9, k + 15, sandstone_stairs, 0);
	...
	public static void generate_4(World w, int i, int j, int k)
	{
		...
		b(w, i + 5, j + 1, k + 14, carpet, 0);
		m(w, i + 5, j + 1, k + 14, 8);
		b(w, i + 5, j + 1, k + 15, carpet, 0);
		m(w, i + 5, j + 1, k + 15, 8);
		b(w, i + 5, j + 2, k, air, 0);
		...
		b(w, i + 5, j + 10, k + 14, stone_slab, 0);
		m(w, i + 5, j + 10, k + 14, 1);
		b(w, i + 5, j + 10, k + 15, stone_slab, 0);
		m(w, i + 5, j + 10, k + 15, 1);
	...
	public static void generate_5(World w, int i, int j, int k)
	{
		...
		b(w, i + 6, j + 1, k + 13, carpet, 0);
		m(w, i + 6, j + 1, k + 13, 8);
		b(w, i + 6, j + 1, k + 14, carpet, 0);
		m(w, i + 6, j + 1, k + 14, 8);
		b(w, i + 6, j + 1, k + 15, carpet, 0);
		m(w, i + 6, j + 1, k + 15, 8);
		b(w, i + 6, j + 2, k, air, 0);
		...
		b(w, i + 6, j + 10, k + 14, stone_slab, 0);
		m(w, i + 6, j + 10, k + 14, 1);
		b(w, i + 6, j + 10, k + 15, stone_slab, 0);
		m(w, i + 6, j + 10, k + 15, 1);
	...
	public static void generate_6(World w, int i, int j, int k)
	{
		...
		b(w, i + 7, j + 1, k + 13, carpet, 0);
		m(w, i + 7, j + 1, k + 13, 8);
		b(w, i + 7, j + 1, k + 14, carpet, 0);
		m(w, i + 7, j + 1, k + 14, 8);
	...
	public static void generate_7(World w, int i, int j, int k)
	{
		...
		m(w, i + 8, j + 9, k + 14, 1);
		b(w, i + 8, j + 9, k + 15, sandstone_stairs, 0);
		m(w, i + 8, j + 9, k + 15, 1);
	...
	public static void generate_8(World w, int i, int j, int k)
	{
		...
		m(w, i + 9, j + 8, k + 14, 1);
		b(w, i + 9, j + 8, k + 15, sandstone_stairs, 0);
		m(w, i + 9, j + 8, k + 15, 1);
		b(w, i + 9, j + 9, k, air, 0);
	...
	public static void generate_11(World w, int i, int j, int k)
	{
		...
		m(w, i + 12, j + 4, k + 1, 9);
		b(w, i + 12, j + 4, k + 2, sandstone_stairs, 0);
		m(w, i + 12, j + 4, k + 2, 6);
		...
		b(w, i + 12, j + 4, k + 13, stone_slab, 0);
		m(w, i + 12, j + 4, k + 13, 1);
	...
	public static void generate_12(World w, int i, int j, int k)
	{
		...
		b(w, i + 13, j + 4, k + 3, sandstone_stairs, 0);
		m(w, i + 13, j + 4, k + 3, 6);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 146, j + 1, k + 190);
		TileEntityChest chest1 = (TileEntityChest)w.getTileEntity(i + 153, j + 1, k + 187);
	}
