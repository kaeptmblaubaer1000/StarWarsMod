...
public class WorldGenMosEisleyBig_x80_z144
{
	public static void generate(World w, int i, int j, int k)
	{
		...
		b(w, i, j + 1, k + 4, crafting_table, 0);
		b(w, i, j + 1, k + 5, air, 0);
		b(w, i, j + 1, k + 6, air, 0);
		b(w, i, j + 1, k + 7, carpet, 0);
		m(w, i, j + 1, k + 7, 8);
		b(w, i, j + 1, k + 8, carpet, 0);
		m(w, i, j + 1, k + 8, 8);
		b(w, i, j + 1, k + 9, carpet, 0);
		m(w, i, j + 1, k + 9, 8);
		...
		b(w, i, j + 3, k + 14, sandstone_stairs, 0);
		m(w, i, j + 3, k + 14, 5);
		...
		b(w, i, j + 8, k + 2, air, 0);
		b(w, i, j + 8, k + 3, air, 0);
		b(w, i, j + 8, k + 4, sandstone_stairs, 0);
		m(w, i, j + 8, k + 4, 2);
		...
		b(w, i, j + 8, k + 11, sandstone_stairs, 0);
		m(w, i, j + 8, k + 11, 3);
		...
		b(w, i, j + 9, k + 3, air, 0);
		b(w, i, j + 9, k + 4, air, 0);
		b(w, i, j + 9, k + 5, sandstone_stairs, 0);
		m(w, i, j + 9, k + 5, 2);
		...
		b(w, i, j + 10, k + 7, stone_slab, 0);
		m(w, i, j + 10, k + 7, 1);
		b(w, i, j + 10, k + 8, stone_slab, 0);
		m(w, i, j + 10, k + 8, 1);
		...
		b(w, i + 1, j + 1, k + 4, chest, 0);
		m(w, i + 1, j + 1, k + 4, 3);
		b(w, i + 1, j + 1, k + 5, air, 0);
		b(w, i + 1, j + 1, k + 6, air, 0);
		b(w, i + 1, j + 1, k + 7, carpet, 0);
		m(w, i + 1, j + 1, k + 7, 8);
		b(w, i + 1, j + 1, k + 8, carpet, 0);
		m(w, i + 1, j + 1, k + 8, 8);
	...
	public static void generate_1(World w, int i, int j, int k)
	{
		...
		b(w, i + 1, j + 10, k + 7, stone_slab, 0);
		m(w, i + 1, j + 10, k + 7, 1);
		b(w, i + 1, j + 10, k + 8, stone_slab, 0);
		m(w, i + 1, j + 10, k + 8, 1);
	...
	public static void generate_2(World w, int i, int j, int k)
	{
		...
		b(w, i + 3, j + 4, k + 12, sandstone_stairs, 0);
		m(w, i + 3, j + 4, k + 12, 4);
	...
	public static void generate_3(World w, int i, int j, int k)
	{
		...
		b(w, i + 4, j + 1, k + 10, jukebox, 0);
		b(w, i + 4, j + 1, k + 11, chest, 0);
		m(w, i + 4, j + 1, k + 11, 4);
	...
	public static void generate_14(World w, int i, int j, int k)
	{
		...
		TileEntityChest chest0 = (TileEntityChest)w.getTileEntity(i + 81, j + 1, k + 148);
		TileEntityChest chest1 = (TileEntityChest)w.getTileEntity(i + 84, j + 1, k + 155);
	}
