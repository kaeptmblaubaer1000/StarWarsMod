...
public class WorldGenMosEisleyBig_x96_z64
{
	public static void generate(World w, int i, int j, int k)
	{
		...
		b(w, i, j + 1, k + 8, stone_slab, 0);
		m(w, i, j + 1, k + 8, 1);
		b(w, i, j + 1, k + 9, stone_slab, 0);
		m(w, i, j + 1, k + 9, 1);
		...
		b(w, i, j + 2, k + 7, blockMV, 0);
		b(w, i, j + 2, k + 8, air, 0);
		b(w, i, j + 2, k + 9, air, 0);
		b(w, i, j + 2, k + 10, stone_slab, 0);
		m(w, i, j + 2, k + 10, 1);
	...
	public static void generate_4(World w, int i, int j, int k)
	{
		...
		b(w, i + 5, j + 5, k + 13, sandstone_stairs, 0);
		m(w, i + 5, j + 5, k + 13, 7);
		b(w, i + 5, j + 5, k + 14, stone_slab, 0);
		m(w, i + 5, j + 5, k + 14, 9);
		b(w, i + 5, j + 5, k + 15, stone_slab, 0);
		m(w, i + 5, j + 5, k + 15, 9);
		b(w, i + 5, j + 6, k, air, 0);
	...
	public static void generate_9(World w, int i, int j, int k)
	{
		...
		b(w, i + 10, j + 1, k + 14, blockTable, 0);
		m(w, i + 10, j + 1, k + 14, 1);
		b(w, i + 10, j + 1, k + 15, blockTable, 0);
		m(w, i + 10, j + 1, k + 15, 1);
	...
	public static void generate_10(World w, int i, int j, int k)
	{
		...
		m(w, i + 11, j + 1, k + 10, 1);
		b(w, i + 11, j + 1, k + 11, stone_slab, 0);
		m(w, i + 11, j + 1, k + 11, 1);
	...
	public static void generate_11(World w, int i, int j, int k)
	{
		...
		b(w, i + 12, j + 1, k + 12, stone_slab, 0);
		m(w, i + 12, j + 1, k + 12, 1);
	...
	public static void generate_12(World w, int i, int j, int k)
	{
		...
		m(w, i + 13, j + 2, k + 12, 1);
		b(w, i + 13, j + 2, k + 13, glass_pane, 0);
		b(w, i + 13, j + 2, k + 14, glass_pane, 0);
		b(w, i + 13, j + 2, k + 15, glass_pane, 0);
