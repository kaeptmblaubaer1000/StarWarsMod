...
public class ArmorRebelYPilot extends ItemArmor
{
	...
	public ArmorRebelYPilot(ArmorMaterial par2EnumArmorMaterial, int par3, int par4)
	{
		super(par2EnumArmorMaterial, par3, par4);
		this.setUnlocalizedName(Resources.MODID + "." + "rebelYPilot" + this.names[par4]);
		this.setTextureName(Resources.MODID + ":" + "rebelYPilot" + this.names[par4]);
