...
public class MessageHoloTableUpdate extends Message<MessageHoloTableUpdate>
{
	...
	public MessageHoloTableUpdate(TileEntityHoloTableSmall table)
	{
	...
	{
		TileEntityHoloTableSmall table = (TileEntityHoloTableSmall)MinecraftServer.getServer().worldServerForDimension(this.dim).getTileEntity((int)this.position.xCoord, (int)this.position.yCoord, (int)this.position.zCoord);
