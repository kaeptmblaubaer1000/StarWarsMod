...
import com.parzivail.pswm.vehicle.VehicTIEBomber;
...
public class ItemSpawnTIEBomber extends ItemSpawnVehicle
{
	public static String name = "spawntiebomber";
	...
	{
		return new VehicTIEBomber(world, i, j, k);
	}
}