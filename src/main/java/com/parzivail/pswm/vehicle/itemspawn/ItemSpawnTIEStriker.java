...
public class ItemSpawnTIEStriker extends ItemSpawnVehicle
{
	public static String name = "spawntiestriker";

	public ItemSpawnTIEStriker()
	{
		super(name);
	...
	{
		return new VehicTIEStriker(world, i, j, k);
	}
}
