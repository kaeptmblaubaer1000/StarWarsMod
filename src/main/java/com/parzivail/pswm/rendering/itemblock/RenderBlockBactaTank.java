...
public class RenderBlockBactaTank implements IItemRenderer
{
	private TileEntitySpecialRenderer render;
	private TileEntity tile;

	public RenderBlockBactaTank()
	{
		render = new RenderBactaTank();
		tile = new TileEntityBactaTank();
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data)
	{
		...
		switch (type)
		{
			case INVENTORY:
				...
				GL11.glScalef(.325f, .325f, -.325f);
				GL11.glTranslatef(0, -2.35f, 0);
