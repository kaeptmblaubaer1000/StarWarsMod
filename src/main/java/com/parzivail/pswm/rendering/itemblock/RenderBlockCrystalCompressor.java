...
import com.parzivail.pswm.rendering.RenderCrystalCompressor;
...
public class RenderBlockCrystalCompressor implements IItemRenderer
{
	private TileEntitySpecialRenderer render;
	private TileEntity tile;

	public RenderBlockCrystalCompressor()
	{
		render = new RenderCrystalCompressor();
		tile = new TileEntityCrystalCompressor();
