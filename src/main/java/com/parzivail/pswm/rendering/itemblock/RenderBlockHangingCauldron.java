...
public class RenderBlockHangingCauldron implements IItemRenderer
{
	private TileEntitySpecialRenderer render;
	private TileEntity tile;

	public RenderBlockHangingCauldron()
	{
		render = new RenderHangingCauldron();
		tile = new TileEntityHangingCauldron();
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data)
	{
		...
		switch (type)
		{
			case INVENTORY:
				...
				GL11.glScalef(1, 1, -1);
				GL11.glScalef(.575f, .575f, -.575f);
				GL11.glTranslatef(0, -1, 0);
				GL11.glTranslatef(-1f, .75f, 0);
