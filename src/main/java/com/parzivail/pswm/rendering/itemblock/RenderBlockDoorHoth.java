...
import com.parzivail.pswm.rendering.RenderDoorHoth;
...
public class RenderBlockDoorHoth implements IItemRenderer
{
	private TileEntitySpecialRenderer render;
	private TileEntity tile;

	public RenderBlockDoorHoth()
	{
		render = new RenderDoorHoth();
		tile = new TileEntityDoorHoth();
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data)
	{
		...
		switch (type)
		{
			...
			case EQUIPPED:
				...
				GL11.glTranslatef(-0.5f, 1.5f, -5f);
