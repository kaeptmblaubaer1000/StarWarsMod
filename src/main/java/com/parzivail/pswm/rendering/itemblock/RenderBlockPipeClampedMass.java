...
import com.parzivail.pswm.rendering.RenderPipeClampedMass;
...
public class RenderBlockPipeClampedMass implements IItemRenderer
{
	private TileEntitySpecialRenderer render;
	private TileEntity tile;

	public RenderBlockPipeClampedMass()
	{
		render = new RenderPipeClampedMass();
		tile = new TileEntityPipeClampedMass();
