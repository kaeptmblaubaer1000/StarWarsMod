...
import com.parzivail.pswm.rendering.RenderMudTable;
...
public class RenderBlockMudTable implements IItemRenderer
{
	...
	{
		render = new RenderMudTable();
		tile = new TileEntityMudTable();
