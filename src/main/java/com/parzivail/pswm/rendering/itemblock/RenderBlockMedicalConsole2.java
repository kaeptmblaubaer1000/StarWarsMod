...
import com.parzivail.pswm.rendering.RenderMedicalConsole2;
import com.parzivail.pswm.tileentities.TileEntityMedicalConsole2;
...
public class RenderBlockMedicalConsole2 implements IItemRenderer
{
	private TileEntitySpecialRenderer render;
	private TileEntity tile;

	public RenderBlockMedicalConsole2()
	{
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data)
	{
		...
		switch (type)
		{
			case INVENTORY:
				...
				GL11.glTranslatef(0.4f, -0.43f, 0.2f);
