...
import com.parzivail.pswm.rendering.RenderTatooineTable;
...
public class RenderBlockTatooineTable implements IItemRenderer
{
	...
	{
		render = new RenderTatooineTable();
		tile = new TileEntityTatooineTable();
