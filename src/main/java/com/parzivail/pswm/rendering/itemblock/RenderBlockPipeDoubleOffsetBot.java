...
import com.parzivail.pswm.rendering.RenderPipeDoubleOffsetBot;
...
public class RenderBlockPipeDoubleOffsetBot implements IItemRenderer
{
	private TileEntitySpecialRenderer render;
	private TileEntity tile;

	public RenderBlockPipeDoubleOffsetBot()
	{
		render = new RenderPipeDoubleOffsetBot();
		tile = new TileEntityPipeDoubleOffsetBot();
