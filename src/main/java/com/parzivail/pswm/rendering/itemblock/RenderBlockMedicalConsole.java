...
import com.parzivail.pswm.rendering.RenderMedicalConsole;
...
public class RenderBlockMedicalConsole implements IItemRenderer
{
	private TileEntitySpecialRenderer render;
	private TileEntity tile;

	public RenderBlockMedicalConsole()
	{
		render = new RenderMedicalConsole();
		tile = new TileEntityMedicalConsole();
