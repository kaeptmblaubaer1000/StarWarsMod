...
import com.parzivail.pswm.rendering.RenderPipeMass;
...
public class RenderBlockPipeMass implements IItemRenderer
{
	private TileEntitySpecialRenderer render;
	private TileEntity tile;

	public RenderBlockPipeMass()
	{
		render = new RenderPipeMass();
		tile = new TileEntityPipeMass();
