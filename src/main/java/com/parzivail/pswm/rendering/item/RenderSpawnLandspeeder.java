...
public class RenderSpawnLandspeeder implements IItemRenderer
{
	private static ResourceLocation texture = new ResourceLocation(Resources.MODID, "textures/models/landspeeder.png");

	private ModelLandspeeder model;

	public RenderSpawnLandspeeder()
	{
		this.model = new ModelLandspeeder();
	}
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data)
	{
		...
		switch (type)
		{
			case INVENTORY:
				...
				GL11.glScalef(0.053F, -0.053F, 0.053F);
			...
			case EQUIPPED_FIRST_PERSON:
				GL11.glPushMatrix();
				GL11.glDisable(GL11.GL_CULL_FACE);
				GL11.glScalef(0.026F, -0.026F, 0.026F);
				GL11.glTranslatef(8, -46, 23);
