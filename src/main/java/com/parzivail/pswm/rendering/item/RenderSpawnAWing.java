...
public class RenderSpawnAWing implements IItemRenderer
{
	private static ResourceLocation texture = new ResourceLocation(Resources.MODID, "textures/models/awing.png");

	private ModelAWing model;

	public RenderSpawnAWing()
	{
		this.model = new ModelAWing();
	}
