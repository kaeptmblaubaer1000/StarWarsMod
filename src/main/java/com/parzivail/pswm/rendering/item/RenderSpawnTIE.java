...
public class RenderSpawnTIE implements IItemRenderer
{
	private static ResourceLocation texture = new ResourceLocation(Resources.MODID, "textures/models/tie.png");

	private ModelTIE model;

	public RenderSpawnTIE()
	{
		this.model = new ModelTIE();
	}
