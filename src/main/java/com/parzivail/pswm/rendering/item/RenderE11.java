...
import com.parzivail.pswm.models.weapons.ModelE11;
...
{
	private static ResourceLocation texture = new ResourceLocation(Resources.MODID, "textures/models/weapons/e11.png");

	private ModelE11 model;

	public RenderE11()
	{
		this.model = new ModelE11();
	}
