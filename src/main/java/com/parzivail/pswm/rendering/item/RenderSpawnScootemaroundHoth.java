...
public class RenderSpawnScootemaroundHoth implements IItemRenderer
{
	private static ResourceLocation texture = new ResourceLocation(Resources.MODID, "textures/models/hothScoot.png");

	private ModelHothScoot model;

	public RenderSpawnScootemaroundHoth()
	{
		this.model = new ModelHothScoot();
	}
