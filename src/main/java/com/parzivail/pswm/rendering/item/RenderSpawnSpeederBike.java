...
public class RenderSpawnSpeederBike implements IItemRenderer
{
	private static ResourceLocation texture = new ResourceLocation(Resources.MODID, "textures/models/speederbike.png");

	private ModelSpeederBike model;

	public RenderSpawnSpeederBike()
	{
