...
public class RenderSpawnTIEInterceptor implements IItemRenderer
{
	private static ResourceLocation texture = new ResourceLocation(Resources.MODID, "textures/models/tieInterceptor.png");

	private ModelTIEInterceptor model;

	public RenderSpawnTIEInterceptor()
	{
		this.model = new ModelTIEInterceptor();
	}
