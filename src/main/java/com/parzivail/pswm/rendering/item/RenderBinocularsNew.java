...
public class RenderBinocularsNew implements IItemRenderer
{
	private static ResourceLocation texture = new ResourceLocation(Resources.MODID, "textures/models/binoculars_new.png");

	private ModelBinocularsNew model;

	public RenderBinocularsNew()
	{
		this.model = new ModelBinocularsNew();
	}
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data)
	{
		...
		switch (type)
		{
			...
			case EQUIPPED_FIRST_PERSON:
				GL11.glPushMatrix();
				GL11.glDisable(GL11.GL_CULL_FACE);
				GL11.glScalef(0.023F, -0.023F, 0.023F);
				GL11.glTranslatef(8, -49, 28);
