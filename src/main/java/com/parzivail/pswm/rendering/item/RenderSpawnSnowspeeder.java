...
public class RenderSpawnSnowspeeder implements IItemRenderer
{
	private static ResourceLocation texture = new ResourceLocation(Resources.MODID, "textures/models/snowspeeder.png");

	private ModelSnowspeeder model;

	public RenderSpawnSnowspeeder()
	{
		this.model = new ModelSnowspeeder();
	}
