...
import com.parzivail.pswm.models.weapons.ModelA280;
...
{
    private static ResourceLocation texture = new ResourceLocation(Resources.MODID, "textures/models/weapons/a280.png");
    
	private ModelA280 model;

	public RenderA280()
	{
		this.model = new ModelA280();
	}
