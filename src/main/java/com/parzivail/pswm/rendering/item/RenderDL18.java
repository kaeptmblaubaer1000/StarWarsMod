...
import com.parzivail.pswm.models.weapons.ModelDL18;
...
{
    private static ResourceLocation texture = new ResourceLocation(Resources.MODID, "textures/models/weapons/dl18.png");
    
	private ModelDL18 model;

	public RenderDL18()
	{
		this.model = new ModelDL18();
	}
