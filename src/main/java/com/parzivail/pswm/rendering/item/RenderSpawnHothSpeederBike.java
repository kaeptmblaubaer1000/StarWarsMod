...
public class RenderSpawnHothSpeederBike implements IItemRenderer
{
	private static ResourceLocation texture = new ResourceLocation(Resources.MODID, "textures/models/hothSpeederbike.png");

	private ModelSpeederBike model;

	public RenderSpawnHothSpeederBike()
	{
		this.model = new ModelSpeederBike();
	}
