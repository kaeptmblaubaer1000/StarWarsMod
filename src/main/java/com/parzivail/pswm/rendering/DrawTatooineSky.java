...
public class DrawTatooineSky extends IRenderHandler
{
	...
	private static Vec3 ghomrassenOffset = Vec3.createVectorHelper(0, 0, 20);
	...
	private static Vec3 guermessaOffset = Vec3.createVectorHelper(32, 0, 0);
	...
	private static Vec3 cheniniOffset = Vec3.createVectorHelper(44, 0, -4);
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc)
	{
		...
		mc.renderEngine.bindTexture(sunTexture);
		tessellator1.startDrawingQuads();
		tessellator1.addVertexWithUV(-f10 + sun2OffsetX, 100.0D + sun2OffsetY, -f10 + sun2OffsetZ, 0.0D, 0.0D);
		tessellator1.addVertexWithUV(f10 + sun2OffsetX, 100.0D + sun2OffsetY, -f10 + sun2OffsetZ, 1.0D, 0.0D);
		...
		tessellator1.startDrawingQuads();
		tessellator1.addVertex(-f10 + cheniniOffset.xCoord, 99.9D + cheniniOffset.yCoord, -f10 + cheniniOffset.zCoord);
		tessellator1.addVertex(f10 + cheniniOffset.xCoord, 99.9D + cheniniOffset.yCoord, -f10 + cheniniOffset.zCoord);
		tessellator1.addVertex(f10 + cheniniOffset.xCoord, 99.9D + cheniniOffset.yCoord, f10 + cheniniOffset.zCoord);
		tessellator1.addVertex(-f10 + cheniniOffset.xCoord, 99.9D + cheniniOffset.yCoord, f10 + cheniniOffset.zCoord);
		tessellator1.draw();
		...
		tessellator1.startDrawingQuads();
		tessellator1.addVertexWithUV(-f10 + cheniniOffset.xCoord, 100.0D + cheniniOffset.yCoord, -f10 + cheniniOffset.zCoord, 0.0D, 0.0D);
		tessellator1.addVertexWithUV(f10 + cheniniOffset.xCoord, 100.0D + cheniniOffset.yCoord, -f10 + cheniniOffset.zCoord, 1.0D, 0.0D);
		tessellator1.addVertexWithUV(f10 + cheniniOffset.xCoord, 100.0D + cheniniOffset.yCoord, f10 + cheniniOffset.zCoord, 1.0D, 1.0D);
		tessellator1.addVertexWithUV(-f10 + cheniniOffset.xCoord, 100.0D + cheniniOffset.yCoord, f10 + cheniniOffset.zCoord, 0.0D, 1.0D);
		tessellator1.draw();
		GL11.glDisable(3553);
		GL11.glColor4f(0.0F, 0.0F, 0.0F, 1.0F);
		f10 = moonSize / 3.5F / ghomrassenSizeMod;
		tessellator1.startDrawingQuads();
		tessellator1.addVertex(-f10 + ghomrassenOffset.xCoord, 99.9D + ghomrassenOffset.yCoord, -f10 + ghomrassenOffset.zCoord);
		tessellator1.addVertex(f10 + ghomrassenOffset.xCoord, 99.9D + ghomrassenOffset.yCoord, -f10 + ghomrassenOffset.zCoord);
		tessellator1.addVertex(f10 + ghomrassenOffset.xCoord, 99.9D + ghomrassenOffset.yCoord, f10 + ghomrassenOffset.zCoord);
		tessellator1.addVertex(-f10 + ghomrassenOffset.xCoord, 99.9D + ghomrassenOffset.yCoord, f10 + ghomrassenOffset.zCoord);
		tessellator1.draw();
		...
		tessellator1.startDrawingQuads();
		tessellator1.addVertexWithUV(-f10 + ghomrassenOffset.xCoord, 100.0D + ghomrassenOffset.yCoord, -f10 + ghomrassenOffset.zCoord, 0.0D, 0.0D);
		tessellator1.addVertexWithUV(f10 + ghomrassenOffset.xCoord, 100.0D + ghomrassenOffset.yCoord, -f10 + ghomrassenOffset.zCoord, 1.0D, 0.0D);
		tessellator1.addVertexWithUV(f10 + ghomrassenOffset.xCoord, 100.0D + ghomrassenOffset.yCoord, f10 + ghomrassenOffset.zCoord, 1.0D, 1.0D);
		tessellator1.addVertexWithUV(-f10 + ghomrassenOffset.xCoord, 100.0D + ghomrassenOffset.yCoord, f10 + ghomrassenOffset.zCoord, 0.0D, 1.0D);
		tessellator1.draw();
		GL11.glDisable(3553);
		GL11.glColor4f(0.0F, 0.0F, 0.0F, 1.0F);
		f10 = moonSize / 3.5F / guermessaSizeMod;
		tessellator1.startDrawingQuads();
		tessellator1.addVertex(-f10 + guermessaOffset.xCoord, 99.9D + guermessaOffset.yCoord, -f10 + guermessaOffset.zCoord);
		tessellator1.addVertex(f10 + guermessaOffset.xCoord, 99.9D + guermessaOffset.yCoord, -f10 + guermessaOffset.zCoord);
		tessellator1.addVertex(f10 + guermessaOffset.xCoord, 99.9D + guermessaOffset.yCoord, f10 + guermessaOffset.zCoord);
		tessellator1.addVertex(-f10 + guermessaOffset.xCoord, 99.9D + guermessaOffset.yCoord, f10 + guermessaOffset.zCoord);
		tessellator1.draw();
		...
		tessellator1.startDrawingQuads();
		tessellator1.addVertexWithUV(-f10 + guermessaOffset.xCoord, 100.0D + guermessaOffset.yCoord, -f10 + guermessaOffset.zCoord, 0.0D, 0.0D);
		tessellator1.addVertexWithUV(f10 + guermessaOffset.xCoord, 100.0D + guermessaOffset.yCoord, -f10 + guermessaOffset.zCoord, 1.0D, 0.0D);
		tessellator1.addVertexWithUV(f10 + guermessaOffset.xCoord, 100.0D + guermessaOffset.yCoord, f10 + guermessaOffset.zCoord, 1.0D, 1.0D);
		tessellator1.addVertexWithUV(-f10 + guermessaOffset.xCoord, 100.0D + guermessaOffset.yCoord, f10 + guermessaOffset.zCoord, 0.0D, 1.0D);
		tessellator1.draw();
		GL11.glDisable(3553);
		GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
		GL11.glDisable(3042);
