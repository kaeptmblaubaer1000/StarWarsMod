...
public class DrawKashyyykSky extends IRenderHandler
{
	...
	private static Vec3 moon1Offset = Vec3.createVectorHelper(14, 0, 10);
	private static float moon1SizeMod = 0.8F;
	private static Vec3 moon2Offset = Vec3.createVectorHelper(-32, 0, 0);
	private static float moon2SizeMod = 1.1F;
	private static Vec3 moon3Offset = Vec3.createVectorHelper(-6, 0, -30);
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc)
	{
		...
		tessellator1.startDrawingQuads();
		tessellator1.addVertex(-f10 + moon3Offset.xCoord, 99.9D + moon3Offset.yCoord, -f10 + moon3Offset.zCoord);
		tessellator1.addVertex(f10 + moon3Offset.xCoord, 99.9D + moon3Offset.yCoord, -f10 + moon3Offset.zCoord);
		tessellator1.addVertex(f10 + moon3Offset.xCoord, 99.9D + moon3Offset.yCoord, f10 + moon3Offset.zCoord);
		tessellator1.addVertex(-f10 + moon3Offset.xCoord, 99.9D + moon3Offset.yCoord, f10 + moon3Offset.zCoord);
		tessellator1.draw();
		...
		tessellator1.startDrawingQuads();
		tessellator1.addVertexWithUV(-f10 + moon3Offset.xCoord, 100.0D + moon3Offset.yCoord, -f10 + moon3Offset.zCoord, 0.0D, 0.0D);
		tessellator1.addVertexWithUV(f10 + moon3Offset.xCoord, 100.0D + moon3Offset.yCoord, -f10 + moon3Offset.zCoord, 1.0D, 0.0D);
		tessellator1.addVertexWithUV(f10 + moon3Offset.xCoord, 100.0D + moon3Offset.yCoord, f10 + moon3Offset.zCoord, 1.0D, 1.0D);
		tessellator1.addVertexWithUV(-f10 + moon3Offset.xCoord, 100.0D + moon3Offset.yCoord, f10 + moon3Offset.zCoord, 0.0D, 1.0D);
		tessellator1.draw();
		GL11.glDisable(3553);
		GL11.glColor4f(0.0F, 0.0F, 0.0F, 1.0F);
		f10 = moonSize / 3.5F / moon1SizeMod;
		tessellator1.startDrawingQuads();
		tessellator1.addVertex(-f10 + moon1Offset.xCoord, 99.9D + moon1Offset.yCoord, -f10 + moon1Offset.zCoord);
		tessellator1.addVertex(f10 + moon1Offset.xCoord, 99.9D + moon1Offset.yCoord, -f10 + moon1Offset.zCoord);
		tessellator1.addVertex(f10 + moon1Offset.xCoord, 99.9D + moon1Offset.yCoord, f10 + moon1Offset.zCoord);
		tessellator1.addVertex(-f10 + moon1Offset.xCoord, 99.9D + moon1Offset.yCoord, f10 + moon1Offset.zCoord);
		tessellator1.draw();
		...
		mc.renderEngine.bindTexture(moon1Texture);
		tessellator1.startDrawingQuads();
		tessellator1.addVertexWithUV(-f10 + moon1Offset.xCoord, 100.0D + moon1Offset.yCoord, -f10 + moon1Offset.zCoord, 0.0D, 0.0D);
		tessellator1.addVertexWithUV(f10 + moon1Offset.xCoord, 100.0D + moon1Offset.yCoord, -f10 + moon1Offset.zCoord, 1.0D, 0.0D);
		tessellator1.addVertexWithUV(f10 + moon1Offset.xCoord, 100.0D + moon1Offset.yCoord, f10 + moon1Offset.zCoord, 1.0D, 1.0D);
		tessellator1.addVertexWithUV(-f10 + moon1Offset.xCoord, 100.0D + moon1Offset.yCoord, f10 + moon1Offset.zCoord, 0.0D, 1.0D);
		tessellator1.draw();
		GL11.glDisable(3553);
		GL11.glColor4f(0.0F, 0.0F, 0.0F, 1.0F);
		f10 = moonSize / 3.5F / moon2SizeMod;
		tessellator1.startDrawingQuads();
		tessellator1.addVertex(-f10 + moon2Offset.xCoord, 99.9D + moon2Offset.yCoord, -f10 + moon2Offset.zCoord);
		tessellator1.addVertex(f10 + moon2Offset.xCoord, 99.9D + moon2Offset.yCoord, -f10 + moon2Offset.zCoord);
		tessellator1.addVertex(f10 + moon2Offset.xCoord, 99.9D + moon2Offset.yCoord, f10 + moon2Offset.zCoord);
		tessellator1.addVertex(-f10 + moon2Offset.xCoord, 99.9D + moon2Offset.yCoord, f10 + moon2Offset.zCoord);
		tessellator1.draw();
		...
		mc.renderEngine.bindTexture(moon1Texture);
		tessellator1.startDrawingQuads();
		tessellator1.addVertexWithUV(-f10 + moon2Offset.xCoord, 100.0D + moon2Offset.yCoord, -f10 + moon2Offset.zCoord, 0.0D, 0.0D);
		tessellator1.addVertexWithUV(f10 + moon2Offset.xCoord, 100.0D + moon2Offset.yCoord, -f10 + moon2Offset.zCoord, 1.0D, 0.0D);
		tessellator1.addVertexWithUV(f10 + moon2Offset.xCoord, 100.0D + moon2Offset.yCoord, f10 + moon2Offset.zCoord, 1.0D, 1.0D);
		tessellator1.addVertexWithUV(-f10 + moon2Offset.xCoord, 100.0D + moon2Offset.yCoord, f10 + moon2Offset.zCoord, 0.0D, 1.0D);
		tessellator1.draw();
		GL11.glDisable(3553);
		GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
		GL11.glDisable(3042);
 ...
 * v1.2.0-dev7.jar!\com\parzi\starwarsmod\rendering\DrawKashyyykSky.class Java
