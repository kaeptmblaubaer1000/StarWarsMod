...
public class RenderSpawnAstromech2Imperial implements IItemRenderer
{
	private static ResourceLocation texture = new ResourceLocation(Resources.MODID, "textures/models/astromechImperial2.png");

	private ModelDroidAstromech2 model;

	public RenderSpawnAstromech2Imperial()
	{
		this.model = new ModelDroidAstromech2();
	}
