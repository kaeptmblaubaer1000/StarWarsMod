...
public class RenderSpawnProtocolHoth implements IItemRenderer
{
	private static ResourceLocation texture = new ResourceLocation(Resources.MODID, "textures/models/protocol2.png");

	private ModelDroidProtocol model;

	public RenderSpawnProtocolHoth()
	{
		this.model = new ModelDroidProtocol();
	}
