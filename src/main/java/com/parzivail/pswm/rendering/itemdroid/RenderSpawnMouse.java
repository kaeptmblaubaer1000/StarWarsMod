...
public class RenderSpawnMouse implements IItemRenderer
{
	private static ResourceLocation texture = new ResourceLocation(Resources.MODID, "textures/models/mouse.png");

	private ModelDroidMouse model;

	public RenderSpawnMouse()
	{
		this.model = new ModelDroidMouse();
	}
