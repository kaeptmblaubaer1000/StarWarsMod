...
public class RenderSpawnAstromechBB8 implements IItemRenderer
{
	private static ResourceLocation texture = new ResourceLocation(Resources.MODID, "textures/models/astromechBB8.png");

	private ModelDroidBb8 model;

	public RenderSpawnAstromechBB8()
	{
		this.model = new ModelDroidBb8();
	}
