...
public class RenderSpawnAstromech1 implements IItemRenderer
{
	private static ResourceLocation texture = new ResourceLocation(Resources.MODID, "textures/models/astromech.png");

	private ModelDroidAstromech model;

	public RenderSpawnAstromech1()
	{
