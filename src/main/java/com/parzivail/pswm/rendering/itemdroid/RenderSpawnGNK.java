...
public class RenderSpawnGNK implements IItemRenderer
{
	private static ResourceLocation texture = new ResourceLocation(Resources.MODID, "textures/models/gnk.png");

	private ModelDroidGNK model;

	public RenderSpawnGNK()
	{
		this.model = new ModelDroidGNK();
	}
