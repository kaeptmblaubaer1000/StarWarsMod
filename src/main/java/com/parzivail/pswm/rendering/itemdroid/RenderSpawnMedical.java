...
public class RenderSpawnMedical implements IItemRenderer
{
	private static ResourceLocation texture = new ResourceLocation(Resources.MODID, "textures/models/surgical.png");

	private ModelDroidSurgical model;

	public RenderSpawnMedical()
	{
		this.model = new ModelDroidSurgical();
	}
