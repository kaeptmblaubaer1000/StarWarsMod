...
public class RenderSpawnProtocol implements IItemRenderer
{
	private static ResourceLocation texture = new ResourceLocation(Resources.MODID, "textures/models/protocol.png");

	private ModelDroidProtocol model;

	public RenderSpawnProtocol()
	{
