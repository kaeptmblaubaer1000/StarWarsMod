...
public class RenderSpawnAstromech2 implements IItemRenderer
{
	private static ResourceLocation texture = new ResourceLocation(Resources.MODID, "textures/models/astromech2.png");

	private ModelDroidAstromech2 model;

	public RenderSpawnAstromech2()
	{
