...
public class RenderSpawnProbe implements IItemRenderer
{
	private static ResourceLocation texture = new ResourceLocation(Resources.MODID, "textures/models/probe.png");

	private ModelDroidProbe model;

	public RenderSpawnProbe()
	{
		this.model = new ModelDroidProbe();
	}
