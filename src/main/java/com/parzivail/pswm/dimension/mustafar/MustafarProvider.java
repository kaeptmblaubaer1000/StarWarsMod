...
public class MustafarProvider extends WorldProvider
{
	...
	{
		return new BiomeChunkProviderMustafar(this.worldObj, this.getSeed());
	}
	...
	{
		this.worldChunkMgr = new WorldChunkManagerHell(StarWarsMod.biomeMustafar, 1F);
		// this.worldChunkMgr = new ChunkManagerTatooine(this.worldObj);
		this.dimensionId = ConfigOptions.dimMustafarId;
	}
