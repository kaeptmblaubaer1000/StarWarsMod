...
public class BiomeChunkProviderDagobah extends ChunkProviderGenerate
{
	...
	public BiomeChunkProviderDagobah(World world, long seed, boolean features)
	{
		...
		this.worldObj.skylightSubtracted = -5;
	}
