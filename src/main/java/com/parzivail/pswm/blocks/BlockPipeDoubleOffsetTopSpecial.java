...
import com.parzivail.pswm.tileentities.TileEntityPipeDoubleOffsetTopSpecial;
...
public class BlockPipeDoubleOffsetTopSpecial extends PBlockContainer implements IDebugProvider
{
	public BlockPipeDoubleOffsetTopSpecial()
	{
		super("pipeDoubleOffsetTopSpecial", Material.iron);
	...
	{
		return new TileEntityPipeDoubleOffsetTopSpecial();
	}
