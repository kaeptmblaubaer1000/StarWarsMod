...
public class BlockPipeDoubleOffsetBotSpecial extends PBlockContainer implements IDebugProvider
{
	public BlockPipeDoubleOffsetBotSpecial()
	{
		super("pipeDoubleOffsetBotSpecial", Material.iron);
	...
	{
		return new TileEntityPipeDoubleOffsetBotSpecial();
	}
