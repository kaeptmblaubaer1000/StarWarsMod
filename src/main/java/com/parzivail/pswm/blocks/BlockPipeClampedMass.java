...
public class BlockPipeClampedMass extends PBlockContainer
{
	public BlockPipeClampedMass()
	{
		super("pipeClampedMass", Material.iron);
	...
	{
		return new TileEntityPipeClampedMass();
	}
