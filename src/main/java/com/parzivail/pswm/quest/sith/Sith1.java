...
public class Sith1 extends Quest
{
	public Sith1()
	{
		...
		this.tree.response1DT.response1DT.response1DT.npcHeader = "Judging by the Lightsaber in your possession, you have ventured to the planet Ilum and entered it's Crystal Caves.";
