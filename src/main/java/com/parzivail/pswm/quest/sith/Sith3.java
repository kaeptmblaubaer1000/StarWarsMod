...
public class Sith3 extends Quest
{
	public Sith3()
	{
		...
		this.tree.response1DT.npcHeader = "Hidden somewhere in the Ilum Temple, in fact, you may already be in possession of it.";
		this.tree.response1DT.response1 = "Next";
		this.tree.response1DT.response1DT = new DialogTree();
		this.tree.response1DT.response1DT.npcHeader = "Hidden in the tree in which your old Jedi Master lives in refuge.";
		this.tree.response1DT.response1DT.response1 = "Next";
		this.tree.response1DT.response1DT.response1DT = new DialogTree();
		this.tree.response1DT.response1DT.response1DT.npcHeader = "Hidden in Ancient Temple Ruins on the planet where the Rebels have their Main Base.";
		...
		this.tree.response1DT.response1DT.response1DT.response1DT.npcHeader = "Hidden with a Black Market Dealer somewhere in Mos Eisley. You will have to buy the shard from him, as he knows not of it's power.";
		...
		this.tree.response1DT.response1DT.response1DT.response1DT.response1DT.npcHeader = "Hidden deep within the Imperial Base on Endor, in a secret chamber for their leader.";
		...
		this.tree.response1DT.response1DT.response1DT.response1DT.response1DT.response1DT.npcHeader = "As a reward for becoming my Apprentice, I will give you one of the shards, as I have kept it in my possession for safekeeping";
