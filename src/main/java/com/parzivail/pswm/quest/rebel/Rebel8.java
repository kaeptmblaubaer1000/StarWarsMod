...
import static com.parzivail.pswm.StarWarsItems.spawnProtocol;
import static com.parzivail.pswm.StarWarsMod.network;
import static com.parzivail.pswm.items.ItemQuestLog.isQuestDone;
import static com.parzivail.pswm.items.ItemQuestLog.setQuestDone;
import static com.parzivail.pswm.quest.QuestBank.rebel7;
...
public class Rebel8 extends Quest
{
	...
	{
		return !isQuestDone(player, this) && rebel7.isQuestComplete(player) && hasItems(player, new ItemStack(spawnProtocol, 1));
	}
