...
public class Imperial1 extends Quest
{
	public Imperial1()
	{
		...
		this.tree.response1DT.npcHeader = "It better be or you won't be a Stormtrooper for long. Go get a rifle from the Quartermaster and hit the target range. Bring me back at least five targets so I know you really are good enough for my army.";
		...
		this.tree.response2DT.npcHeader = "We aren't just here to shoot Rebels, Trooper. First things first, grab a rifle from the Quartermaster and hit the target range. Bring at least five targets back to me to prove you deserve to be here.";
		...
		this.tree.response3DT.npcHeader = "Is that so? Then go see the Quartermaster for a rifle and hit the target range. Bring me back at least five targets, and I expect to be \"wowed\" according to your previous achievement.";
