...
import static com.parzivail.pswm.quest.QuestBank.imperial6_3;
...
public class Imperial7 extends Quest
{
	...
	{
		return !isQuestDone(player, this) && imperial6_3.isQuestComplete(player) && ItemUtils.hasItems(player, new ItemStack(StarWarsItems.reactorCore, 4));
	}
	...
	public void end(EntityPlayer player)
	{
		...
		StarWarsMod.network.sendToServer(new MessageSetPlayerHolding(player, new ItemStack(StarWarsItems.silverImperialCredit, 7), true));
