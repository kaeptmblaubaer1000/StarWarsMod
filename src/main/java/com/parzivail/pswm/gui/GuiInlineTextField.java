...
public class GuiInlineTextField extends Gui
{
	...
	private int enabledColor = GLPalette.WHITE;
	...
	public GuiInlineTextField(int componentId, FontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height)
	{
		this.id = componentId;
