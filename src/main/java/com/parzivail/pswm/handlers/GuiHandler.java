...
public class GuiHandler implements IGuiHandler
{
	...
	public Object getClientGuiElement(int id, EntityPlayer player, World world, int x, int y, int z)
	{
		if (id == Resources.GUI_MV)
			...
			return new GuiQuestNpc(((BlockNpcBase)world.getBlock(x, y, z)).getQuestForPlayer(((TileEntityStaticNpc)world.getTileEntity(x, y, z)), player), player, ((TileEntityStaticNpc)world.getTileEntity(x, y, z)));
		...
		else if (id == Resources.GUI_SHIPWRIGHT)
			return new GuiShipwright(player);
		return null;
	}
	...
	public Object getServerGuiElement(int id, EntityPlayer player, World world, int x, int y, int z)
	{
		...
		else if (id == Resources.GUI_QUARTERMASTER || id == Resources.GUI_QUARTERMASTER_EMPIRE || id == Resources.GUI_QUESTNPC || id == Resources.GUI_ANTENNA || id == Resources.GUI_QUEST || id == Resources.GUI_LSFORGE || id == Resources.GUI_SCANNER || id == Resources.GUI_HYPERDRIVE || id == Resources.GUI_ROBES || id == Resources.GUI_JEDI_SITH || id == Resources.GUI_SHIPWRIGHT)
