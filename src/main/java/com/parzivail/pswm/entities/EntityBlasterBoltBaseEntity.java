...
public abstract class EntityBlasterBoltBaseEntity extends EntityThrowable
{
	...
	public EntityBlasterBoltBaseEntity(World world)
	{
		this(world, 0, 0, 0, 0, 0xFF0000, 5.0f);
	}

	public EntityBlasterBoltBaseEntity(World world, float dx, float dy, float dz, float length, int rgb, float damage)
	{
		super(world);
		this.damage = damage;
		setSize(0.1f, 0.1f);
