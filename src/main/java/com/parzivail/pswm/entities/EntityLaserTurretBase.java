...
public abstract class EntityLaserTurretBase extends EntityThrowable
{
	...
	public EntityLaserTurretBase(World par1World, double par2, double par4, double par6, float damage)
	{
	...
	public EntityLaserTurretBase(World par1World, EntityLivingBase par2EntityLivingBase, EntityLivingBase par3EntityLivingBase, float damage)
	{
		...
		double d1 = par3EntityLivingBase.boundingBox.minY + par3EntityLivingBase.height / 5.0F - this.posY;
	...
	public EntityLaserTurretBase(World par1World, EntityLivingBase sender, float damage)
	{
	...
	public EntityLaserTurretBase(World par1World, float damage)
	{
		super(par1World);
		this.damage = damage;
	}
