 ...
 * @author Colby
 */
public class AiMelee extends EntityAIBase
{
	World worldObj;
	...
	public AiMelee(EntityCreature p_i1636_1_, double p_i1636_2_, boolean p_i1636_4_, float damage)
	{
	...
	public void updateTask()
	{
		...
		if (d0 <= d1 && this.attackTick <= 20)
		{
			...
			entitylivingbase.attackEntityFrom(StarWarsMod.meleeDamageSource, damage);
		}
	}
}
