...
public class ItemSpawnT85 extends net.minecraft.item.Item
{
	public String name = "spawnT85";
	...
	{
		if (player.capabilities.isCreativeMode || player.inventory.consumeInventoryItem(StarWarsItems.spawnT85))
			if (!world.isRemote)
			{
				VehicT85 newVehic = new VehicT85(world);
