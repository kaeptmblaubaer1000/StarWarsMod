...
public class ItemSpawnSnowspeeder extends net.minecraft.item.Item
{
	public String name = "spawnSnowspeeder";
	...
	{
		if (player.capabilities.isCreativeMode || player.inventory.consumeInventoryItem(StarWarsItems.spawnSnowspeeder))
			if (!world.isRemote)
			{
