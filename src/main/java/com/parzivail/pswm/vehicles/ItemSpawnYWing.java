...
public class ItemSpawnYWing extends net.minecraft.item.Item
{
	public String name = "spawnYwing";
	...
	{
		if (player.capabilities.isCreativeMode || player.inventory.consumeInventoryItem(StarWarsItems.spawnYwing))
			if (!world.isRemote)
			{
