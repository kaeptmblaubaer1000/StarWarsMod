...
public class ItemSpawnATST extends net.minecraft.item.Item
{
	public String name = "spawnAtst";

	public ItemSpawnATST()
	{
	...
	{
		if (player.capabilities.isCreativeMode || player.inventory.consumeInventoryItem(StarWarsItems.spawnAtst))
			if (!world.isRemote)
			{
