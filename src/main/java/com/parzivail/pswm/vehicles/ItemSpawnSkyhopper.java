...
public class ItemSpawnSkyhopper extends net.minecraft.item.Item
{
	public String name = "spawnSkyhopper";
	...
	{
		if (player.capabilities.isCreativeMode || player.inventory.consumeInventoryItem(StarWarsItems.spawnSkyhopper))
			if (!world.isRemote)
			{
