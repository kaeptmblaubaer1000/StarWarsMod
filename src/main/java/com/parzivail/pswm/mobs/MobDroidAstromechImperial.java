...
public class MobDroidAstromechImperial extends EntityTameable
{
	private EntityAITempt aiTempt;

	public MobDroidAstromechImperial(World par1World)
	{
		super(par1World);
	...
	{
		this.dropItem(StarWarsMod.spawnAstromechImperial, 1);
	}
