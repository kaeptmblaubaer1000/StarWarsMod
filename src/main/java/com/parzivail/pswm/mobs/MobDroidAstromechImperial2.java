...
public class MobDroidAstromechImperial2 extends EntityTameable
{
	private EntityAITempt aiTempt;

	public MobDroidAstromechImperial2(World par1World)
	{
		super(par1World);
		...
		this.tasks.addTask(7, new com.parzivail.pswm.ai.AiFreqMove(this, 0.8D, 10));
	...
	{
		this.dropItem(StarWarsMod.spawnAstromechImperial2, 1);
	}
	...
	{
		return Resources.MODID + ":" + "mob.astromech.die";
	}

	@Override
	protected String getHurtSound()
	{
		return Resources.MODID + ":" + "mob.astromech.hit";
	}

	@Override
	protected String getLivingSound()
	{
		return Resources.MODID + ":" + "mob.astromechImperial.say";
	}
