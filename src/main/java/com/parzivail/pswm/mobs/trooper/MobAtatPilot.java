...
public class MobAtatPilot extends EntityMob implements IMob, IRangedAttackMob
{
	...
	public MobAtatPilot(World par1World)
	{
		...
		setCurrentItemOrArmor(4, new ItemStack(StarWarsMod.atatPilotHelmet, 1));
		setCurrentItemOrArmor(3, new ItemStack(StarWarsMod.atatPilotChest, 1));
		setCurrentItemOrArmor(2, new ItemStack(StarWarsMod.atatPilotLegs, 1));
		setCurrentItemOrArmor(1, new ItemStack(StarWarsMod.atatPilotBoots, 1));
	...
	public boolean attackEntityFrom(DamageSource source, float amount)
	{
		...
		if (entity instanceof EntityPlayer)
		{
			...
			for (int i = 0; i < list.size(); i++)
			{
				...
				if (entity1 instanceof MobAtatPilot)
				{
					MobAtatPilot s = (MobAtatPilot)entity1;
