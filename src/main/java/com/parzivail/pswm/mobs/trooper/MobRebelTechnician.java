...
public class MobRebelTechnician extends MobTrooper
{
	...
	public MobRebelTechnician(World par1World)
	{
		super(par1World);
	}
	...
	public boolean attackEntityFrom(DamageSource source, float amount)
	{
		...
		if (entity instanceof EntityPlayer)
		{
			...
			{
				if (aList instanceof MobRebelTechnician)
				{
					MobRebelTechnician s = (MobRebelTechnician)aList;
