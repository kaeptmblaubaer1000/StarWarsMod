...
public class MobStormtrooper extends EntityTameable implements IMob, IRangedAttackMob
{
	...
	public MobStormtrooper(World par1World)
	{
		...
		setCurrentItemOrArmor(4, new ItemStack(StarWarsItems.stormtrooperHelmet, 1));
		setCurrentItemOrArmor(3, new ItemStack(StarWarsItems.stormtrooperChest, 1));
		setCurrentItemOrArmor(2, new ItemStack(StarWarsItems.stormtrooperLegs, 1));
		setCurrentItemOrArmor(1, new ItemStack(StarWarsItems.stormtrooperBoots, 1));
	...
	public boolean attackEntityFrom(DamageSource source, float amount)
	{
		...
		if (entity instanceof EntityPlayer)
		{
			...
			for (int i = 0; i < list.size(); i++)
			{
				...
				if (entity1 instanceof MobStormtrooper)
				{
					MobStormtrooper s = (MobStormtrooper)entity1;
