...
public class MobStormtrooper extends EntityMob implements IMob, IRangedAttackMob
{
	...
	public MobStormtrooper(World par1World)
	{
		...
		setCurrentItemOrArmor(4, new ItemStack(StarWarsMod.stormtrooperHelmet, 1));
		setCurrentItemOrArmor(3, new ItemStack(StarWarsMod.stormtrooperChest, 1));
		setCurrentItemOrArmor(2, new ItemStack(StarWarsMod.stormtrooperLegs, 1));
		setCurrentItemOrArmor(1, new ItemStack(StarWarsMod.stormtrooperBoots, 1));
