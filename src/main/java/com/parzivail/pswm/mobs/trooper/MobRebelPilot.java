...
public class MobRebelPilot extends EntityMob implements IMob, IRangedAttackMob
{
	...
	public MobRebelPilot(World par1World)
	{
		...
		setCurrentItemOrArmor(4, new ItemStack(StarWarsMod.rebelPilotHelmet, 1));
		setCurrentItemOrArmor(3, new ItemStack(StarWarsMod.rebelPilotChest, 1));
		setCurrentItemOrArmor(2, new ItemStack(StarWarsMod.rebelPilotLegs, 1));
		setCurrentItemOrArmor(1, new ItemStack(StarWarsMod.rebelPilotBoots, 1));
