...
public class MobRebelPilot extends EntityTameable implements IMob, IRangedAttackMob
{
	...
	public MobRebelPilot(World par1World)
	{
		...
		setCurrentItemOrArmor(4, new ItemStack(StarWarsItems.rebelPilotHelmet, 1));
		setCurrentItemOrArmor(3, new ItemStack(StarWarsItems.rebelPilotChest, 1));
		setCurrentItemOrArmor(2, new ItemStack(StarWarsItems.rebelPilotLegs, 1));
		setCurrentItemOrArmor(1, new ItemStack(StarWarsItems.rebelPilotBoots, 1));
