...
public class MobEndorRebel extends MobTrooper
{
	...
	{
		super(par1World);
		setCurrentItemOrArmor(4, new ItemStack(endorHelmet, 1));
		setCurrentItemOrArmor(3, new ItemStack(endorChest, 1));
		setCurrentItemOrArmor(2, new ItemStack(endorLegs, 1));
		setCurrentItemOrArmor(1, new ItemStack(endorBoots, 1));
