...
public class ItemBinocularsNew extends Item
{
	...
	public ItemBinocularsNew(String type)
	{
	...
	{
		if (stack.stackTagCompound != null && stack.getItem() instanceof ItemBinocularsNew)
		{
 ...
 * v1.2.0-dev7.jar!\com\parzi\starwarsmod\items\ItemBinocularsTatooine.class
