...
{
	public String name = "hyperdriveHoth";
	...
	public ItemStack onItemRightClick(ItemStack stack, World world, EntityPlayer player)
	{
		try
		{
			if (player.isSneaking() && player.dimension != Resources.dimHothId && !world.isRemote)
			{
				player.timeUntilPortal = 20;
				StarWarsMod.network.sendToServer(new PacketTeleportPlayerNetwork(player.getCommandSenderName(), player.dimension, Resources.dimHothId));
			}
		}
		catch (Exception e)
		{
 ...
 * v1.2.0-dev7.jar!\com\
 * parzi\starwarsmod\items\hyperdrive\ItemHyperdriveHoth.class Java compiler
